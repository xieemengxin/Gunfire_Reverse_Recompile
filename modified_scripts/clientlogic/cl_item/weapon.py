...
# 取消 Gemini 的武器限制和铭刻互斥排除信息
# 额外铭刻次数限制已放开，只受最大铭刻数控制
...
class CWeapon(CEquip):
    ...
    def GetWeaponExtraInscriptionCost(self):
        ...
        if iPrceReverse:
            iCost = -iCost
        return cl_customconfig.ScaleInt(iCost, cl_customconfig.GetFloat('economy.weapon_extra_inscription_cost_multiplier', 1.0))
