# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/commonative/p1626.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/commonative/p1626.pyc
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, (0, 0, 0), (0, 0, 0), 40, cl_action.GetTrapPerformCustomParam(skill, 'totalTime', 600), [
                3], attshape = ATT_SHAPE_SPHERE, targettype = OBJ_ALL, effect = 0, bindbone = '', PauseForSkill = False, AttackDieBreak = False)
