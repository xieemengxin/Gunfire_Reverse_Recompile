# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/commonative/p1606.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/commonative/p1606.pyc
...
class CCartoon1(DirectPosCartoon):
    ...
    def Hit(cls, skill):
        cl_action.PushVictim(skill, cl_action.GetCartoonEnd(skill, 1), 20, 8, 10000, angle = 0)
        cl_action.PushHeroVictim(skill, cl_action.GetCartoonEnd(skill, 1), 10, 4, 10000, downSpeed = 0, fGravaty = 9.8)
