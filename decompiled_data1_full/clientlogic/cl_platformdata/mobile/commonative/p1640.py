# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/commonative/p1640.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/commonative/p1640.pyc
...
class CCartoon2(SpecifySpeedBulletCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.GetCartoonEnd(skill, 4), (0, -16, 0), 0.3, 100, True, True, 0, 0, None, 0, targettype = OBJ_ENEMY)
