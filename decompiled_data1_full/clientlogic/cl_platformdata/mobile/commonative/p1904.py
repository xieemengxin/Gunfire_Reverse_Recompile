# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/commonative/p1904.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/commonative/p1904.pyc
...
def CreateMonster(oSkill, *args):
    ...
    if not oMonster:
        ...
        return None
    sKey = 'PF1904'
    if oMonster.m_FightType & WARRIOR_ELITE == WARRIOR_ELITE and not oMonster.Query('Devil'):
