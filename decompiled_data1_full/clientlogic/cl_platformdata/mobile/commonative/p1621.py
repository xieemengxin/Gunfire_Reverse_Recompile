# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/commonative/p1621.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/commonative/p1621.pyc
# Source Generated with Decompyle++
# File: p1621.pyc (Python 3.6)
...
class CCartoon1(FlyLinePathCartoon):
    ...
    def Hit(cls, skill):
        if cl_action.CheckVictimType(skill, WARRIOR_HERO, OBJ_ALL):
            cl_action.PushHeroVictim(skill, cl_action.GetCartoonEnd(skill, 1), 10, 3, 10000, downSpeed = 0, fGravaty = 9.8, angle = 0)
            ...
            cl_action.PushVictim(skill, cl_action.GetCartoonEnd(skill, 1), 20, 5, 10000, angle = 0, iCartoonSID = -1, iIgnoreStruckCD = 0, iClient = 0)
            cl_action.PerformDamage(skill, {
