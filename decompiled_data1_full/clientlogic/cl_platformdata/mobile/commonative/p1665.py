# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/commonative/p1665.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/commonative/p1665.pyc
...
from cl_commondefines import ATT_SHAPE_SPHERE, CRT_CHECK_SERVER, OBJ_ENEMY, SKILLCACHE_LSTINT, WARRIOR_SUMMON
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, (0, 0, 0), (0, 0, 0), 50, 500, [
                10], attshape = ATT_SHAPE_SPHERE, targettype = OBJ_ENEMY, effect = 0, bindbone = '', PauseForSkill = True, AttackDieBreak = True)
...
class CCartoon0(TimerCartoon):
    ...
    def Trigger(cls, skill):
        ...
        if not cl_action.CheckSummonIsDestroy(skill, cl_action.GetSkillCacheData(skill, SKILLCACHE_LSTINT)):
