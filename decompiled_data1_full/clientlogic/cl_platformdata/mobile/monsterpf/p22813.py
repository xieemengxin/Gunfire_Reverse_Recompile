# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/monsterpf/p22813.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/monsterpf/p22813.pyc
...
class CCartoon0(MonsterLiftLandCartoon):
    ...
    def End(cls, skill):
        ...
        cl_action.CreateRandomNumWarriorAtPointPos(skill, cl_action.GetSummonPosByBoxSplit(skill, 6, 3, 0.5, False, {
            ...
            'CenterY': 1.01,
            'FloatY': 1.5 }, False), WARRIOR_SUMMON, {
            1023: 10 }, {
            'Radius': 0.5 })
