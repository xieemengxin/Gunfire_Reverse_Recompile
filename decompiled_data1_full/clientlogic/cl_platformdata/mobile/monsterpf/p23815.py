# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/monsterpf/p23815.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/monsterpf/p23815.pyc
...
class CCartoon13(MonsterDashCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgCustomPos(skill, cartoon), 12, 0, 20, True, False, True, checkDis = 1, start = (0, 0, 0), offSetY = 0, staticbreak = False)
...
class CCartoon9(MonsterDashCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgMonsterTurnDirPos(skill, cl_action.CrtArgTargetPos(skill, notContainDying = False), 12, 120 if cl_action.CountDistance3D(skill, cl_action.CrtArgSelfPos(skill), cl_action.CrtArgTargetPos(skill, notContainDying = False)) >= 7 else 10, 20), 12, 0, 5, True, False, True, checkDis = 1, start = (0, 0, 0), offSetY = 0, staticbreak = False)
...
class CCartoon4(MonsterDashCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgMonsterTurnDirPos(skill, cl_action.CrtArgTargetPos(skill, notContainDying = False), 12, 120 if cl_action.CountDistance3D(skill, cl_action.CrtArgSelfPos(skill), cl_action.CrtArgTargetPos(skill, notContainDying = False)) >= 7 else 10, 20), 12, 0, 10, True, False, True, checkDis = 1, start = (0, 0, 0), offSetY = 0, staticbreak = False)
