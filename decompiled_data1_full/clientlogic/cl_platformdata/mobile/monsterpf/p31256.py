# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/monsterpf/p31256.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/monsterpf/p31256.pyc
# Source Generated with Decompyle++
# File: p31256.pyc (Python 3.6)
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0, 0.5, 0)), cl_action.CrtArgSkillEndPos(skill), [
                20,
                2,
                25], attshape = ATT_SHAPE_SECTOR, targettype = OBJ_ENEMY, pierceStatic = False, explosion = False)
