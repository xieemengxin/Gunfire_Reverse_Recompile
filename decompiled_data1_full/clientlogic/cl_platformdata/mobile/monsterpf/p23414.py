# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/monsterpf/p23414.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/monsterpf/p23414.pyc
# Source Generated with Decompyle++
# File: p23414.pyc (Python 3.6)
...
class CCartoon0(DelegateThrowCartoon):
    ...
    def InitSuccess(cls, skill, i1, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgMuzzlePos(skill, cartoon), cl_action.CrtArgSetParabolaSpeed(skill, cartoon, cl_action.CrtArgSelfPos(skill), cl_action.CrtArgDestPosDirPlane(skill, cl_action.CrtArgSelfPos(skill), cl_math.Vec3Minus(cl_action.GetMonsterMuzzlePos(skill, (0, 0, -5)), cl_action.CrtArgSelfPos(skill)), cl_action.CrtArgRandomNum(skill, 5, 15), cl_action.CrtArgRandomNum(skill, -170, 170)), cl_action.CrtArgRandomNum(skill, 8, 12), -5, 1), 15, 0.1, (0, -7, 0), (1.2, 1.2), 0, False, liveTime = 0, innerRadius = 0.01, pierce = 0)
