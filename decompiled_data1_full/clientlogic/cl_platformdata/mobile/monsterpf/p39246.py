# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/monsterpf/p39246.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/monsterpf/p39246.pyc
...
class CCartoon13(TimerCartoon):
    ...
    def Active(cls, skill):
        ...
        if cl_action.GetAttackSID(skill) == 39251:
            ...
            cl_action.SetSkillVarCache(skill, 'live', cl_action.GetLiveHeroID(skill, True))
...
class CCartoon1(TimerCartoon):
    ...
    def Trigger(cls, skill):
        if cl_action.GetAttackSID(skill) == 39251:
            if cl_action.GetMonsterPerformRecord(skill, 39246) == 2:
                if len(cl_action.GetLiveHeroID(skill, True)) > 2:
                    ...
                    cartoon = { }
                    CCartoon3.Init(skill, cartoon, casting = 1, index = 0)
            elif len(cl_action.GetLiveHeroID(skill, True)) > 1:
                cl_action.CreateMonsterAtPos(skill, 39261, cl_action.CrtArgSelfPos(skill), 0, False, 'demonking')
                if cl_action.CheckHasState(skill, 7998):
                    cartoon = { }
                    CCartoon4.Init(skill, cartoon, casting = 1, index = 0)
