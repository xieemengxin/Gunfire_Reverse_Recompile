# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/monsterpf/p31642.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/monsterpf/p31642.pyc
...
class CCartoon0(RayCastCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0.2, 3.67, -2.97)), cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0.2, 3.67, -2.97)), cl_action.GetCartoonEnd(skill, 5), 1, 60, 50, targettype = OBJ_ENEMY, effect = 0, liveTime = 0, trailEffect = 0, effectLiveTime = 5, radius = 0, flyoverdis = 0)
...
class CCartoon19(DirectPosCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.GetCartoonEnd(skill, 9), (0, 0, 0), [
...
class CCartoon9(RayCastCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0.2, 3.67, -2.97)), cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0.2, 3.67, -2.97)), cl_action.GetCartoonEnd(skill, 16), 1, 60, 50, targettype = OBJ_ENEMY, effect = 0, liveTime = 0, trailEffect = 0, effectLiveTime = 5, radius = 0, flyoverdis = 0)
