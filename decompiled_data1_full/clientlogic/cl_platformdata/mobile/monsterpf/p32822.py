# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/monsterpf/p32822.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/monsterpf/p32822.pyc
...
class CCartoon2(TimerCartoon):
    ...
    def Trigger(cls, skill):
        cl_action.CreateRandomNumWarriorAtPointPos(skill, cl_action.GetSummonPosByBoxSplit(skill, 12, 4, cl_action.GetWarriorModelRadius(skill, WARRIOR_MONSTER, 32822, 'NavMesh'), True, {
            cl_action.GetSkillCacheData(skill, SKILLCACHE_BALLISTICTYPE): 10 }, { }, False), WARRIOR_MONSTER, {
            32822: 10 }, { })
