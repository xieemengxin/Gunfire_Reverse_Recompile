# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/monsterpf/p30877.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/monsterpf/p30877.pyc
# Source Generated with Decompyle++
# File: p30877.pyc (Python 3.6)
...
class CCartoon0(DelegateThrowCartoon):
    ...
    def InitSuccess(cls, skill, i1, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0.1, 1.7, -0.4)), cl_action.CrtArgSetParabolaSpeed(skill, cartoon, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0.1, 1.7, -0.4)), cl_action.CrtArgTargetBodyShiftPos(skill, 1, 100, 0, 20, 2, 5, 0.5, 1.5), 30, 0, 1.7), 6, 1.5, (0, 18, 0), (0.5, 0.5), 0, True, liveTime = 0, innerRadius = 0.1, pierce = 1)
