# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/monsterpf/p39218.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/monsterpf/p39218.pyc
# Source Generated with Decompyle++
# File: p39218.pyc (Python 3.6)
...
class CCartoon2(DelegateThrowCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0, 3, -0.7)), cl_action.CrtArgSetParabolaSpeed(skill, cartoon, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0, 3, -0.7)), cl_action.CrtArgTargetPos(skill, notContainDying = False), 45, -10, 1), 45, 1, (0, 8, 0), (0.45, 0.45), 200, True, liveTime = 0, innerRadius = 0.1, pierce = 1)
...
class CCartoon6(TimerCartoon):
    ...
    def Trigger(cls, skill):
        cl_action.MonsterAttackerFacePos(skill, cl_action.CrtArgTargetGroundPos(skill), 0)

    Trigger = classmethod(Trigger)
    
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, 10, 16)
