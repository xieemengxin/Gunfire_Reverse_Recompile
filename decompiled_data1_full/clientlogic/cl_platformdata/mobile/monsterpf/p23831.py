# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/monsterpf/p23831.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/monsterpf/p23831.pyc
# Source Generated with Decompyle++
# File: p23831.pyc (Python 3.6)
...
class CCartoon1(RayCastCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0, 2.5, 1)), cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0, 2.5, 1)), cl_action.CrtArgTargetPos(skill), 1, 100, 30, targettype = OBJ_ENEMY, effect = 0, liveTime = 0, trailEffect = None, effectLiveTime = 0, radius = 0.2, flyoverdis = 0)
