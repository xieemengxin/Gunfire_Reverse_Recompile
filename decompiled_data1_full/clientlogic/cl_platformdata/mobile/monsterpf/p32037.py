# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/monsterpf/p32037.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/monsterpf/p32037.pyc
...
class CCartoon0(TimerCartoon):
    ...
    def End(cls, skill):
        for i2 in range(0, len(cl_action.GetSkillVarCache(skill, 'PosList')), 1):
            cartoon = { }
