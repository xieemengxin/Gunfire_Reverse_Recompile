# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/monsterpf/p20611.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/monsterpf/p20611.pyc
# Source Generated with Decompyle++
# File: p20611.pyc (Python 3.6)
...
class CCartoon1(DelegateThrowCartoon):
    ...
    def InitSuccess(cls, skill, i2, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.GetCartoonEnd(skill, 4), cl_action.CrtArgSetParabolaSpeed(skill, cartoon, cl_action.GetCartoonEnd(skill, 4), cl_action.CrtArgDestPosDirPlane(skill, cl_action.GetCartoonEnd(skill, 4), (1, 0, 1), 3, cl_action.CrtArgRandomNum(skill, -170, 170)), 12, -9, 2), 12, 0.1, (0, 1, 0), (0.25, 0.45), 185, False, liveTime = 0, innerRadius = 0.01, pierce = 0)
...
class CCartoon4(DelegateThrowCartoon):
    ...
    def InitSuccess(cls, skill, i1, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0.1, 1.7, -0.4)), cl_action.CrtArgSetParabolaSpeed(skill, cartoon, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0.1, 1.7, -0.4)), cl_action.CrtArgTargetPos(skill, notContainDying = False), 12, -9, 0), 12, 0.1, (0, 9, 0), (0.25, 0.45), 185, False, liveTime = 0, innerRadius = 0.01, pierce = 0)
