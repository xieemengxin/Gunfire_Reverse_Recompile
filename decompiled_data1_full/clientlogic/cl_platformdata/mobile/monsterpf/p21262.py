# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/monsterpf/p21262.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/monsterpf/p21262.pyc
...
class CCartoon1(GroundFlyCartoon):
    ...
    def InitSuccess(cls, skill, i1, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgSelfPos(skill), cl_action.CrtArgGetCustomDir(skill, cl_action.CrtArgSelfPos(skill), cl_action.CrtArgDestPosDirPlane(skill, cl_action.CrtArgSelfPos(skill), cl_action.GetSkillServerCache(skill, 'FaceDir'), 99, ((i1 + 1) // 2) * -1 ** i1 * 15), (0, 0, 0)), 45, 500, 0.5, 45, tolerateRadius = 0.5, targettype = OBJ_ENEMY, effect = 0)
