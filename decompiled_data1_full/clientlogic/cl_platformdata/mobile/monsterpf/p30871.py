# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/monsterpf/p30871.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/monsterpf/p30871.pyc
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgSelfPos(skill), cl_action.CrtArgSkillEndPos(skill), [
                5,
                1.5,
                75], attshape = ATT_SHAPE_SECTOR, targettype = OBJ_ENEMY, pierceStatic = False)
