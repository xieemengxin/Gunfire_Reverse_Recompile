# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/monsterpf/p39247.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/monsterpf/p39247.pyc
...
class CCartoon7(RayCastCartoon):
    ...
    def InitSuccess(cls, skill, i1, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgDestPosDirPlane(skill, cl_action.GetMonsterMuzzlePos(skill, (0, 1.2, 0)), cl_action.CrtArgDestPosDirPlane(skill, cl_action.GetMonsterMuzzlePos(skill, (0, 1.2, 0)), cl_action.GetMonsterMuzzlePos(skill, (0, 1.2, 0)), 9999, cl_action.ToInt(skill, cl_action.GetTimerCartoonCurTimes(skill, 1) * 7 * cl_action.GetSkillCacheData(skill, SKILLCACHE_INT))), 5, cl_action.ToInt(skill, i1 * 36 * cl_action.GetSkillCacheData(skill, SKILLCACHE_INT))), cl_action.CrtArgDestPosDirPlane(skill, cl_action.GetMonsterMuzzlePos(skill, (0, 1.2, 0)), cl_action.CrtArgDestPosDirPlane(skill, cl_action.GetMonsterMuzzlePos(skill, (0, 1.2, 0)), cl_action.GetMonsterMuzzlePos(skill, (0, 1.2, 0)), 9999, cl_action.ToInt(skill, cl_action.GetTimerCartoonCurTimes(skill, 1) * 7 * cl_action.GetSkillCacheData(skill, SKILLCACHE_INT))), 5, cl_action.ToInt(skill, i1 * 36 * cl_action.GetSkillCacheData(skill, SKILLCACHE_INT))), cl_action.StartAndEndAtSameHeight(skill, cl_action.GetMonsterMuzzlePos(skill, (0, 1.2, 0)), cl_action.CrtArgDestPosDirPlane(skill, cl_action.GetMonsterMuzzlePos(skill, (0, 1.2, 0)), cl_action.CrtArgDestPosDirPlane(skill, cl_action.GetMonsterMuzzlePos(skill, (0, 1.2, 0)), cl_action.GetMonsterMuzzlePos(skill, (0, 1.2, 0)), 9999, cl_action.ToInt(skill, cl_action.GetTimerCartoonCurTimes(skill, 1) * 7 * cl_action.GetSkillCacheData(skill, SKILLCACHE_INT))), 9999, cl_action.ToInt(skill, i1 * 36 * cl_action.GetSkillCacheData(skill, SKILLCACHE_INT)))), 99, 35, cl_action.GetPlayRound(skill) + 7, targettype = OBJ_ENEMY, liveTime = 0, radius = 0.65, flyoverdis = 0, passid = 0, extCheck = CRT_EXTCHECK_NONE)
