# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/monsterpf/p21211.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/monsterpf/p21211.pyc
...
class CCartoon1(DirectPosCartoon):
    ...
    def Hit(cls, skill):
        ...
        cl_action.PushHeroVictim(skill, (0, 0, 0), 10, 5 * (cl_action.CalAttenuationByDis(skill, cl_action.GetCartoonStart(skill, 1), 30, 15, 5, 2) / 100), 10000, downSpeed = 0, fGravaty = 9.8)
