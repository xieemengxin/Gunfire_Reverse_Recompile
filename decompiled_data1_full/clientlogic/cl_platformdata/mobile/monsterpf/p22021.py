# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/monsterpf/p22021.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/monsterpf/p22021.pyc
...
class CCartoon3(TimerCartoon):
    ...
    def Trigger(cls, skill):
        ...
        for i1 in range(0, cl_action.GetSkillCacheData(skill, SKILLCACHE_BALLISTICTYPE), 1):
            ...
            cl_action.SetSkillVarCache(skill, 'waittime', cl_action.GetSkillVarCache(skill, 'waittime') + (25 - i1 * (cl_action.GetPlayRound(skill) + 2) if 25 - i1 * (cl_action.GetPlayRound(skill) + 2) > cl_action.GetAttackerAttr(skill, 'AttSpeed') else cl_action.GetAttackerAttr(skill, 'AttSpeed')))
