# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/monsterpf/p22223.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/monsterpf/p22223.pyc
# Source Generated with Decompyle++
# File: p22223.pyc (Python 3.6)
...
class CCartoon4(DelegateThrowCartoon):
    ...
    def InitSuccess(cls, skill, i1, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgMuzzlePos(skill, cartoon), cl_math.Vec3MulV(cl_action.CrtArgGetCustomDir(skill, cl_action.CrtArgCustomPos(skill, cartoon), cl_action.CrtArgCustomStartPos(skill, cartoon), (0, 0, 0)), (1, 0, 1)), 10, 0.33, (0, 0, 0), (0.4, 0.4), 100, False, liveTime = 0, innerRadius = 0, pierce = 0)
