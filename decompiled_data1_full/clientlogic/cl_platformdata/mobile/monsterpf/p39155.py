# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/monsterpf/p39155.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/monsterpf/p39155.pyc
...
class CCartoon5(TimerCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.ToInt(skill, 125 - cl_action.GetPlayRound(skill) * 5), 1)
...
class CCartoon2(RayCastCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.GetMonsterMuzzlePos(skill, (0, 2, 0)), cl_action.GetMonsterMuzzlePos(skill, (0, 2, 0)), cl_action.StartAndEndAtSameHeight(skill, cl_action.GetMonsterMuzzlePos(skill, (0, 2, 0)), cl_action.CrtArgDestPosDirPlane(skill, cl_action.GetMonsterMuzzlePos(skill, (0, 2, 0)), cl_action.CrtArgGetCustomDir(skill, cl_action.GetMonsterMuzzlePos(skill, (0, 2, 0)), cl_action.CrtArgTargetPos(skill, notContainDying = False), (0, 0, 0)), 99, 0)), 30, 100, cl_action.ToInt(skill, cl_action.GetPlayRound(skill) * 5 + 50), targettype = OBJ_ENEMY, effect = 0, liveTime = 0, trailEffect = 0, effectLiveTime = 1, radius = 1.5, flyoverdis = 0)
