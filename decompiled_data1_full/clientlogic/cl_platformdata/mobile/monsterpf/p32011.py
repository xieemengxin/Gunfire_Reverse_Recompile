# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/monsterpf/p32011.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/monsterpf/p32011.pyc
...
class CCartoon0(CastingPosCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, (0, 0, 0), (0.9, 0.5, -0.7), 25, 300, [
                18,
                3,
