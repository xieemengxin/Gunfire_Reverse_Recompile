# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/monsterpf/p23819.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/monsterpf/p23819.pyc
...
from cl_commondefines import ATT_SHAPE_SPHERE, CRT_CHECK_SERVER, OBJ_ALLNOSELF, OBJ_ENEMY, WARRIOR_HERO, WARRIOR_PROTEGE
...
class CCartoon5(DirectPosCartoon):
    ...
    def Hit(cls, skill):
        if cl_action.CheckVictimType(skill, WARRIOR_HERO, OBJ_ENEMY):
            ...
            cl_action.PushVictim(skill, (0, 0, 0), 20, 6, 10000, angle = 0)
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0, 0.1, 0)), (0, 0, 0), [
                5], attshape = ATT_SHAPE_SPHERE, targettype = OBJ_ALLNOSELF, pierceStatic = False, explosion = False)
