# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/monsterpf/p39151.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/monsterpf/p39151.pyc
...
def Action(skill):
    if cl_action.GetMonsterPhase(skill) > 2:
        ...
        for i1 in range(0, len(cl_action.GetSkillVarCache(skill, 'lstpos')), 1):
            cl_action.AddClientEffect(skill, 1013, cl_math.Vec3Add(cl_action.GetSkillVarCache(skill, 'lstpos')[i1], (0, 2.3, 0)), time = 100)
        ...
        for i3 in range(0, len(cl_action.GetSkillVarCache(skill, 'lstpos')), 1):
            cl_action.AddClientEffect(skill, 1013, cl_math.Vec3Add(cl_action.GetSkillVarCache(skill, 'lstpos')[i3], (0, 2.3, 0)), time = 100)
    ...
    for i5 in range(0, len(cl_action.GetSkillVarCache(skill, 'lstpos')), 1):
        cl_action.AddClientEffect(skill, 1013, cl_math.Vec3Add(cl_action.GetSkillVarCache(skill, 'lstpos')[i5], (0, 2.3, 0)), time = 100)
