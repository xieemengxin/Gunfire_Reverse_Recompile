# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/monsterpf/p33815.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/monsterpf/p33815.pyc
...
class CCartoon1(DirectPosCartoon):
    ...
    def Hit(cls, skill):
        ...
        cl_action.PushHeroVictim(skill, (0, 0, 0), 20, 5 * (cl_action.CalAttenuationByDis(skill, cl_action.GetCartoonStart(skill, 1), 100, 40, 6, 3) / 100), 10000, downSpeed = 0, fGravaty = 9.8, angle = 0)
