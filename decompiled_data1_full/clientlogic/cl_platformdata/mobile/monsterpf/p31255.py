# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/monsterpf/p31255.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/monsterpf/p31255.pyc
# Source Generated with Decompyle++
# File: p31255.pyc (Python 3.6)
...
class CCartoon4(GroundFlyCartoon):
    m_SID = 4
    ...
    def InitSuccess(cls, skill, i1, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0, 0.1, -5)), cl_action.CrtArgGetCustomDir(skill, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0, 0.1, -5)), cl_action.CrtArgDestPosDirPlane(skill, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0, 0.1, -5)), cl_action.CrtArgGetCustomDir(skill, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0, 0.1, -5)), cl_action.CrtArgCustomPos(skill, cartoon), (0, 0, 0)), 99, 360 - i1 * 45), (0, 0, 0)), 30, 500, 0.5, 45, tolerateRadius = 0.5, targettype = OBJ_ENEMY, effect = 0)
