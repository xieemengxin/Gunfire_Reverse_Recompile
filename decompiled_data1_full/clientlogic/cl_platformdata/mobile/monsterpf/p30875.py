# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/monsterpf/p30875.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/monsterpf/p30875.pyc
# Source Generated with Decompyle++
# File: p30875.pyc (Python 3.6)
...
class CCartoon4(TimerCartoon):
    ...
    def Trigger(cls, skill):
        cl_action.AttackerUsePerform(skill, 30877, { }, 0)
...
class CCartoon6(TimerCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, 36, cl_action.GetSkillCacheData(skill, SKILLCACHE_BALLISTICTYPE))
