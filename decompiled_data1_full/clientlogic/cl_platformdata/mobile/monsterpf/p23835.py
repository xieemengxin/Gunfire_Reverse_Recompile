# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/monsterpf/p23835.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/monsterpf/p23835.pyc
...
class CCartoon5(MonsterDashCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgTargetPos(skill), 130, 25, 12, True, True, True, checkDis = 0, start = (0, 0, 0))
