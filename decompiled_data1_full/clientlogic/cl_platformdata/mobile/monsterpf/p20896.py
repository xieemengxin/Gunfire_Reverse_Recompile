# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/monsterpf/p20896.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/monsterpf/p20896.pyc
...
class CCartoon0(MonsterDashCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (-10, 0, 0)), 40, 20, 8, False, True, True, checkDis = 0.8, start = (0, 0, 0))
