# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/monsterpf/p22034.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/monsterpf/p22034.pyc
...
def Action(skill):
    cl_action.SetSkillCacheExtraTrajectory(skill, 1 if cl_action.GetSkillCustomData(skill, 'IsRight') else 0)
