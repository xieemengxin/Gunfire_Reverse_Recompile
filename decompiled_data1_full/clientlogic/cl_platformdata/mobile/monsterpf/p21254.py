# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/monsterpf/p21254.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/monsterpf/p21254.pyc
...
class CCartoon1(GroundFlyCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgSelfPos(skill), cl_action.CrtArgSelfFace(skill), 30, 500, 0.5, 45, 0.5, targettype = OBJ_ENEMY, effect = 0)
