# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/monsterpf/p20894.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/monsterpf/p20894.pyc
# Source Generated with Decompyle++
# File: p20894.pyc (Python 3.6)
...
from cl_commondefines import ATT_SHAPE_SECTOR, CRT_CHECK_SERVER, FIGHT3_KEY_IGNOREKNOCKBACK, FIGHT3_KEY_IGNORETHUMP, OBJ_ENEMY
...
class CCartoon3(MonsterDashCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0, 0, -10)), cl_action.GetAttackerAttr(skill, 'DodgeTime'), 25, 15, True, True, True, checkDis = 1.2, start = (0, 0, 0), offSetY = 0, staticbreak = False)
