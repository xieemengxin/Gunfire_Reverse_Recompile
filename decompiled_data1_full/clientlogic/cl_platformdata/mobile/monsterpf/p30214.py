# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/monsterpf/p30214.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/monsterpf/p30214.pyc
...
class CCartoon8(CastingPosCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgTargetPosGroudPos(skill, cl_action.GetCartoonEnd(skill, 7)), (0, 0, 0), 25, 600, [
...
class CCartoon4(CastingPosCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgTargetPosGroudPos(skill, cl_action.GetCartoonEnd(skill, 1)), (0, 0, 0), 25, 600, [
                1], attshape = ATT_SHAPE_SPHERE, targettype = OBJ_ENEMY, bindbone = '', PauseForSkill = False, AttackDieBreak = False)
