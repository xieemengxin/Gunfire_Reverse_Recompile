# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/monsterpf/p31254.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/monsterpf/p31254.pyc
# Source Generated with Decompyle++
# File: p31254.pyc (Python 3.6)
...
class CCartoon1(GroundFlyCartoon):
    ...
    def InitSuccess(cls, skill, i1, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgSelfPos(skill), cl_action.CrtArgSelfFace(skill), 30, 500, 0.5, 45, tolerateRadius = 0.5, targettype = OBJ_ENEMY, effect = 0)
