# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/monsterpf/p23816.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/monsterpf/p23816.pyc
...
class CCartoon5(MonsterDashCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0, 0, -10)), 70, 25, 1, True, True, True, checkDis = 1, start = (0, 0, 0), offSetY = 0, staticbreak = False)
