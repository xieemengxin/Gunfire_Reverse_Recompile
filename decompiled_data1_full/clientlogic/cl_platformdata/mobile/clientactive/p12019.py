# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/clientactive/p12019.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/clientactive/p12019.pyc
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if not skill.m_CheckType == CRT_CHECK_SERVER:
            if not cls.EnableCheck(skill, start = cl_math.Vec3Add(cl_action.CrtArgSelfPos(skill), (0, 0.8, 0))):
                return None
            cls.EnableShow(skill, 1, cl_action.GetSkillCacheData(skill, SKILLCACHE_LSTINT)[0], 30, targettype = OBJ_ENEMY, effect = 0, liveTime = 0, trailEffect = 0, effectLiveTime = 0, lineDistance = 0.1, angle = 8, lockWeakness = False, lockAngle = 0, lockDis = 0, IgnoreDefalutDis = 100, iIgnoreMonsterID = 0, FilterDie = True, lockFromCartoon = False)
