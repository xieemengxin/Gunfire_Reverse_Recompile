# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/clientactive/p12007.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/clientactive/p12007.pyc
# Source Generated with Decompyle++
# File: p12007.pyc (Python 3.6)
...
class CCartoon0(DoubleClickUseCartoon):
    ...
    def End(cls, skill):
        cl_action.CustomPerformAction(skill, 12007, 'StartCareerPF', { })
        cartoon = { }
...
def StartCareerPF(oSkill, *args):
    ...
    if not oAttack:
        return None
    oAttack.m_GamblerCon.StartCareerPF(oSkill)
