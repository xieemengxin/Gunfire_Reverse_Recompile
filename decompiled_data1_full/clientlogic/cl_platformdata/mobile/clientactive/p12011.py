# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/clientactive/p12011.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/clientactive/p12011.pyc
    ...
    def InitSuccess(cls, skill, i1, cartoon):
        if not skill.m_CheckType == CRT_CHECK_SERVER:
            if not cls.EnableCheck(skill, start = (cl_action.GetSkillCustomArg(skill, 'X') / 100, cl_action.GetSkillCustomArg(skill, 'Y') / 100, cl_action.GetSkillCustomArg(skill, 'Z') / 100)):
                return None
            cls.EnableShow(skill, 1, 20, 20, targettype = OBJ_ENEMY, effect = 0, liveTime = 0, trailEffect = 0, effectLiveTime = 0, lineDistance = 1, angle = 20, lockWeakness = False, lockAngle = 20, lockDis = 100, IgnoreDefalutDis = 0, iIgnoreMonsterID = cl_action.GetSkillCustomArg(skill, 'CurVID'), FilterDie = True)
