# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/clientactive/p12021.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/clientactive/p12021.pyc
...
class CCartoon0(LightningChainCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if not skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableShow(skill, 1, 20, 20, cl_action.GetCartoonHitTargetInOrder(skill, 1), 'Bip001 Prop2', 2, bKeepStart = False)
