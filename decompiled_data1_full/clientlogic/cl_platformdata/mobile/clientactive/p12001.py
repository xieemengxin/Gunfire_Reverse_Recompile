# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/clientactive/p12001.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/clientactive/p12001.pyc
# Source Generated with Decompyle++
# File: p12001.pyc (Python 3.6)
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if not skill.m_CheckType == CRT_CHECK_SERVER:
            if not cls.EnableCheck(skill, start = cl_action.CrtArgMuzzlePos(skill, cartoon)):
                return None
            cls.EnableShow(skill, 0.25, 30, 0, -1800, 50, 1, targettype = OBJ_ENEMY, effect = 0, liveTime = 0, trailEffect = 0, effectLiveTime = 0, damradius = 0)
