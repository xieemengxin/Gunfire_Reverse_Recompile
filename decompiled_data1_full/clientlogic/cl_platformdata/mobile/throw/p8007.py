# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/throw/p8007.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/throw/p8007.pyc
...
class CCartoon1(DirectPosCartoon):
    ...
    def Active(cls, skill):
        cl_action.CheckSightCentrePosDis(skill, cl_action.GetCartoonStart(skill, 1), 30)
    ...
    def Hit(cls, skill):
        cl_action.PushVictim(skill, cl_action.GetCartoonEnd(skill, 1), 20, 3, 10000, angle = 0, iCartoonSID = -1, iIgnoreStruckCD = 0, iClient = 0)
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgTargetPos(skill, notContainDying = False), (0, 0, 0), [
