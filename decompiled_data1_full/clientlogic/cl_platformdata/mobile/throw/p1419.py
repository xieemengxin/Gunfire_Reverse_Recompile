# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/throw/p1419.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/throw/p1419.pyc
...
class CCartoon2(DirectPosCartoon):
    ...
    def Active(cls, skill):
        cl_action.CheckSightCentrePosDis(skill, cl_action.GetCartoonStart(skill, 2), 20)
...
class CCartoon5(TimerCartoon):
    ...
    def Active(cls, skill):
        cl_action.SetSkillVarCache(skill, 'raypos', cl_action.CrtArgSightCentrePosByDis(skill, 0.01, 1, 20))
        cartoon = { }
