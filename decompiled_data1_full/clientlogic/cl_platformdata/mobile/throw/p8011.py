# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/throw/p8011.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/throw/p8011.pyc
...
class CCartoon2(DirectPosCartoon):
    ...
    def Hit(cls, skill):
        cl_action.PushVictim(skill, cl_action.GetCartoonEnd(skill, 2), 20, 4, 10000, angle = 0, iCartoonSID = -1, iIgnoreStruckCD = 0, iClient = 0)
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgWarriorPos(skill, cl_action.GetSkillVID(skill)), (0, 0, 0), [
