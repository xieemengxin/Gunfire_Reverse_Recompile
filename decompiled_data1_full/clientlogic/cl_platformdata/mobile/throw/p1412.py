# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/throw/p1412.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/throw/p1412.pyc
...
class CCartoon0(LightningChainCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if not skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableShow(skill, skill.m_Cache['DamInterval'], skill.m_Cache['Radius'], skill.m_Cache['BulletSpeed'], cl_action.GetSkillAID(skill), 'Bip001 Prop2', 1, bKeepStart = False)
