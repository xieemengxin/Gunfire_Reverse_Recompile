# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/throw/p7144.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/throw/p7144.pyc
...
class CCartoon6(RayCastCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0, 1.25, -2)), cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0, 1.25, -2)), cl_action.CrtArgBodyPos(skill, 0, 0, 0, 0), 1, 90, 80, targettype = OBJ_ENEMY, liveTime = 0, radius = 0.25, flyoverdis = 0, passid = 0, extCheck = CRT_EXTCHECK_NONE)
