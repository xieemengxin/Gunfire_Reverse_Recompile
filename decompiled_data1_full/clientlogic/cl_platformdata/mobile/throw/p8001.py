# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/throw/p8001.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/throw/p8001.pyc
...
class CCartoon1(DirectPosCartoon):
    ...
    def Active(cls, skill):
        cl_action.SetShapeInfo(skill, True, cl_math.Vec3Add(cl_action.GetSkillVarCache(skill, 'skillpos'), (0, 0.1, 0)), ATT_SHAPE_SPHERE, [
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_math.Vec3Add(cl_action.GetSkillVarCache(skill, 'skillpos'), (0, 0.1, 0)), (0, 0, 0), [
...
class CCartoon0(TimerCartoon):
    ...
    def Active(cls, skill):
        cl_action.SetSkillServerCache(skill, 'EndPos', cl_math.Vec3Add(cl_action.GetSkillVarCache(skill, 'skillpos'), (0, 0.1, 0)))
...
def Action(skill):
    cl_action.SetSkillVarCache(skill, 'skillpos', cl_action.CrtArgTargetPos(skill, notContainDying = False))
