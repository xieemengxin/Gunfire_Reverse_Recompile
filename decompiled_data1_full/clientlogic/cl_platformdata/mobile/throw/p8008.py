# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/throw/p8008.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/throw/p8008.pyc
...
def Action(skill):
    for i1 in range(0, len(cl_action.GetSkillCacheData(skill, SKILLCACHE_LSTINT)), 1):
        ...
        cl_action.PerformDamage(skill, {
            'Att': cl_action.GetSkillCustomData(skill, 'DamAtt') * cl_action.GetSkillCustomData(skill, 'DamTimes') })
