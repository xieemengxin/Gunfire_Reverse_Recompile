# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/daytrialpf/p16793.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/daytrialpf/p16793.pyc
# Source Generated with Decompyle++
# File: p16793.pyc (Python 3.6)
...
def DoCallBackAction0(oEventCB, oWarrior):
    if cl_evcon.GetFormula(oWarrior, oEventCB, (lambda *a: Func339(*a))) == 1 and cl_evcon.CheckDamIsExplosion(oWarrior, oEventCB):
        ...
        cl_evact.EventTargetDamage(oWarrior, oEventCB, (lambda *a: Func528(*a) * 0.2), DAM_TYPE_WEAPON | DAM_TYPE_TRUE | DAM_USE_ALL, 1, 1, 1, 0, -1, -1, -1, None, None, None, None)
