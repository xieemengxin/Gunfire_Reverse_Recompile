# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/daytrialpf/p16732.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/daytrialpf/p16732.pyc
# Source Generated with Decompyle++
# File: p16732.pyc (Python 3.6)
...
def DoCallBackAction0(oEventCB, oWarrior):
    if cl_evcon.GetFormula(oWarrior, oEventCB, (lambda *a: Func207(*a) / 40)) <= cl_evcon.GetFormula(oWarrior, oEventCB, (lambda *a: Func304(*a, **{
'sAttr': 'HPMax' }) / 100 + Func410(*a, **{
'sid': 1264 }))):
        cl_evact.EventGetTargetByType(oWarrior, oEventCB, OBJ_SELF)
        cl_evact.PassiveChangeAttr(oWarrior, oEventCB, 'HPMax', (lambda *a: (-Func207(*a) / 40) * 100), 0)
        cl_evact.PassiveSetStateCount(oWarrior, oEventCB, 1264, (lambda *a: Func207(*a) / 40))
        cl_evact.PassiveSetStateCount(oWarrior, oEventCB, 1296, (lambda *a: Func207(*a) / 40))
...
'sid': 1270 }) * 100)) < cl_evcon.GetFormula(oWarrior, oEventCB, (lambda *a: (Func207(*a) / 40) * 100 - Func410(*a, **{
'sid': 1264 }) * 100)):
            cl_evact.EventGetTargetByType(oWarrior, oEventCB, OBJ_SELF)
...
'sid': 1270 })), 0)
            ...
            cl_evact.EventGetTargetByType(oWarrior, oEventCB, OBJ_SELF)
            cl_evact.PassiveSetStateCount(oWarrior, oEventCB, 1270, (lambda *a: Func207(*a) / 40 - Func410(*a, **{
'sid': 1264 })))
            cl_evact.PassiveChangeAttr(oWarrior, oEventCB, 'ShieldMax', (lambda *a: Func410(*a, **{
'sid': 1264 }) * 100 - (Func207(*a) / 40) * 100), 0)
            cl_evact.PassiveChangeAttr(oWarrior, oEventCB, 'ArmorMax', (lambda *a: Func410(*a, **{
'sid': 1264 }) * 100 - (Func207(*a) / 40) * 100), 0)
            cl_evact.PassiveSetStateCount(oWarrior, oEventCB, 1296, (lambda *a: Func207(*a) / 40))
