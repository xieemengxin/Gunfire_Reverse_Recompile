# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/daytrialpf/p14422.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/daytrialpf/p14422.pyc
# Source Generated with Decompyle++
# File: p14422.pyc (Python 3.6)
...
def DoCallBackAction0(oEventCB, oWarrior):
    if cl_evcon.CheckHitWeakness(oWarrior, oEventCB, None):
        ...
        if cl_evcon.CheckHasState(oWarrior, oEventCB, 1249) or cl_evcon.GetTargetStateCount(oWarrior, oEventCB, 1249, None, None) < 5:
            ...
            cl_evact.PassiveAddTargetState(oWarrior, oEventCB, 1368, 710, { }, 1, 0, None)
        else:
