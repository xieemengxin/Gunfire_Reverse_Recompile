# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/summonconfig/c1028.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/summonconfig/c1028.pyc
...
class CSummonData(summonconfigdata.CSummonData):
    ...
    m_BaseAttr = {
        ...
        'DefThump': 0,
        'ThumpFrame': 0,
        'Att': (lambda *a: 300 + (Func205(*a) - 1) * 100),
        'MoveSpeed': 0,
        'AttSpeed': 0,
        'Toughness': 0,
        'TurnSpeed': 0,
