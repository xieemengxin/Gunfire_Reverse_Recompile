# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st32600.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st32600.pyc
# Source Generated with Decompyle++
# File: st32600.pyc (Python 3.6)
...
def OnDie(dInfo, oLifeCycle, oListener, oVictim, dMsgInfo):
    if (oVictim.m_FightType & WARRIOR_MONSTER == WARRIOR_MONSTER or oVictim.m_FightType & WARRIOR_SUMMON == WARRIOR_SUMMON) and oVictim.m_DataSID in dInfo['SummonID'] and cl_math.CheckDistance3D(oListener.GetPos(), oVictim.GetPos(), dInfo['Range']):
        oTalent = oListener.m_TalentCon.GetPerform(5418)
        if not oTalent:
            return None
