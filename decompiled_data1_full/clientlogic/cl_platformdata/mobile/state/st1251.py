# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st1251.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st1251.pyc
# Source Generated with Decompyle++
# File: st1251.pyc (Python 3.6)
...
from cl_newformula import Func210, Func404
...
def CallBack0(oEventCB, oTarget):
    cl_evact.StateSetSelfCount(oTarget, oEventCB, (lambda *a: Func210(*a)))


def CallBack1(oEventCB, oTarget):
    cl_evact.EventChangeDamFactor(oTarget, oEventCB, OBJ_ATTACK, (lambda *a: Func404(*a) * 5000), 0, 0, '')
