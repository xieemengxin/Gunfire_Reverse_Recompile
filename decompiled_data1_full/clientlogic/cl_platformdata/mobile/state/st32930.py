# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st32930.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st32930.pyc
# Source Generated with Decompyle++
# File: st32930.pyc (Python 3.6)
...
def CallBack0(oEventCB, oTarget):
    if not oTarget.HP() <= 100 or cl_condition.HasState(oTarget, oEventCB.GetCBLifeCycle(), 32931):
        cl_evact.EventGetTargetByType(oTarget, oEventCB, OBJ_SELF)
        cl_evact.EventTargetDamage(oTarget, oEventCB, (lambda *a: min(int(ceil(Func304(*a, **{
'sAttr': 'HPMax' }) * 0.1)), int(Func304(*a, **{
