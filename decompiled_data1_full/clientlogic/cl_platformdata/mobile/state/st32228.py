# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st32228.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st32228.pyc
# Source Generated with Decompyle++
# File: st32228.pyc (Python 3.6)
...
def CallBack0(oEventCB, oTarget):
    cl_evact.EventChangeDamFactor(oTarget, oEventCB, OBJ_ATTACK, (lambda *a: Func402(*a) * 5000), 0, DAM_TYPE_WEAPON, '')


def CallBack1(oEventCB, oTarget):
    cl_evact.EventChangeDamFactor(oTarget, oEventCB, OBJ_ATTACK, (lambda *a: Func402(*a) * 5000), 0, DAM_TYPE_PERFORM, '')


def CallBack2(oEventCB, oTarget):
    cl_evact.EventGetTargetByType(oTarget, oEventCB, OBJ_SELF)
    cl_evact.EventTargetCure(oTarget, oEventCB, (lambda *a: Func304(*a, **{
'sAttr': 'ArmorMax' }) * (Func402(*a) * 0.1 + 0.2)), CURE_TYPE_PERFORM | DAM_USE_ARMOR, 0, None, None)
