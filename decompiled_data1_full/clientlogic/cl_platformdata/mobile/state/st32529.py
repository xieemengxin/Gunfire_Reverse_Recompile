# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st32529.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st32529.pyc
# Source Generated with Decompyle++
# File: st32529.pyc (Python 3.6)
...
def CallBack0(oEventCB, oTarget):
    cl_evact.EventChangeDamFactor(oTarget, oEventCB, OBJ_ATTACK, (lambda *a: Func404(*a) * Func402(*a) * 10 * 100), 0, DAM_TYPE_WEAPON, '')


def CallBack1(oEventCB, oTarget):
    cl_evact.StateCBChangeSkillDamFactor(oTarget, oEventCB, (lambda *a: Func404(*a) * Func402(*a) * 10 * 100), 0, DAM_TYPE_PERFORM, None, 0)
