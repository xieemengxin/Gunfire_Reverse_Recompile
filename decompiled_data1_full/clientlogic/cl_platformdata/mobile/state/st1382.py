# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st1382.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st1382.pyc
# Source Generated with Decompyle++
# File: st1382.pyc (Python 3.6)
...
def StateCountAction(oTarget, oLifeCycle):
    if cl_condition.StateGetSelfCount(oTarget, oLifeCycle) >= 10:
        ...
        cl_action.StateAddState(oTarget, oLifeCycle, 1122, 300, { }, None)
