# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st33376.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st33376.pyc
# Source Generated with Decompyle++
# File: st33376.pyc (Python 3.6)
...
def CallBack0(oEventCB, oTarget):
    cl_evact.EventCBChangeLuckyHit(oTarget, oEventCB, (lambda *a: Func404(*a) * 0.6))
    if cl_evcon.StateCBGetSelfCount(oTarget, oEventCB) >= 60:
        cl_evact.EventChangeDamFactor(oTarget, oEventCB, OBJ_ATTACK, 0, 1500, DAM_MASK_ELEMENT, '')
