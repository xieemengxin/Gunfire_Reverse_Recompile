# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st1544.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st1544.pyc
# Source Generated with Decompyle++
# File: st1544.pyc (Python 3.6)
...
import cl_evcon
import cl_state
from cl_commondefines import ATTACKERSUBMSG_NORMAL, EQUIP_TYPE_CLOSEWEAPON, EXTGRADE_GROUP2, OBJ_SELF, STATE_ADD_REPLACE, STATE_CLS_HELP, STATE_EFF_NONE
...
def StateActAction(oTarget, oLifeCycle):
    ...
    cl_action.CommonChangeWeaponExtGrade(oTarget, oLifeCycle, EXTGRADE_GROUP2, 3, 0, None)
...
def StateCountAction(oTarget, oLifeCycle):
    if cl_condition.StateGetSelfCount(oTarget, oLifeCycle) == 3:
        cl_action.CommonListenMsgCallBack(oTarget, oLifeCycle, cl_msgcenter.MSG_WAR_ATTACK, ATTACKERSUBMSG_NORMAL, 1, 1, 0)
...
def CallBack1(oEventCB, oTarget):
    cl_evact.EventCBChangeLuckyHit(oTarget, oEventCB, 50)
...
def CallBack3(oEventCB, oTarget):
    cl_evact.EventCBChangeWeaponExtGrade(oTarget, oEventCB, EXTGRADE_GROUP2, 3)
