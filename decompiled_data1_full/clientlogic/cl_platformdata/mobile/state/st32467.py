# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st32467.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st32467.pyc
# Source Generated with Decompyle++
# File: st32467.pyc (Python 3.6)
...
def CallBack0(oEventCB, oTarget):
    if cl_evcon.CheckCostBulletType(oTarget, oEventCB, 4502):
        ...
        if cl_evcon.StateCBGetSelfCount(oTarget, oEventCB) >= cl_evcon.GetFormula(oTarget, oEventCB, (lambda *a: 140 - Func402(*a) * 20)):
            cl_evact.StateAddSelfCount(oTarget, oEventCB, (lambda *a: Func402(*a) * 20 - 140), None)
