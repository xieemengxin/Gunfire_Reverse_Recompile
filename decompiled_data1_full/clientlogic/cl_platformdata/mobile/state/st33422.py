# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st33422.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st33422.pyc
# Source Generated with Decompyle++
# File: st33422.pyc (Python 3.6)
...
def CallBack0(oEventCB, oTarget):
    if not cl_evcon.CheckInPointPerform(oTarget, oEventCB, {
        ...
        if cl_condition.StateGetSelfCount(oTarget, oEventCB.GetCBLifeCycle()) >= 3:
            ...
            cl_evact.StateCBChangeSkillDamFactor(oTarget, oEventCB, 6000, 0, 0, 1, 0)
        else:
