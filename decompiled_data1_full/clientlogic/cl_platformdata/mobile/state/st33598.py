# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st33598.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st33598.pyc
# Source Generated with Decompyle++
# File: st33598.pyc (Python 3.6)
...
def CallBack0(oEventCB, oTarget):
    ...
    if cl_evcon.GetThisTargetNum(oTarget, oEventCB) > 0:
        cl_evact.EventCBUsePerformEvtTarget(oTarget, oEventCB, 1974, {
            ...
            'fragile': oEventCB.GetCBLifeCycle().m_Owner.GetArgValue('StateCount') }, None)
