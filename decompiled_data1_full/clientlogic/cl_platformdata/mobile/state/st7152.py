# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st7152.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st7152.pyc
# Source Generated with Decompyle++
# File: st7152.pyc (Python 3.6)
...
'sAttr': 'HPMax' }) * 45 / 100)):
            cl_action.StateAddState(oTarget, oEventCB.GetCBLifeCycle(), 7151, 0, { }, None)
            cl_evact.StateCBSelfRemove(oTarget, oEventCB)


class CState(cl_state.CState):
    m_SID = 7152
    m_Name = '#NT#蚂蚁怪物举盾（重盾兵）'
    m_IsShow = 1
