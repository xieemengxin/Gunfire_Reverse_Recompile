# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st32952.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st32952.pyc
# Source Generated with Decompyle++
# File: st32952.pyc (Python 3.6)
...
def StateActAction(oTarget, oLifeCycle):
    if not cl_condition.CheckHasPerform(oTarget, oLifeCycle, 1627):
        cl_action.CommonAddPerform(oTarget, oLifeCycle, 1627)
    cl_action.CommonChangePerformAttr(oTarget, oLifeCycle, 1627, 'Att', 0, (lambda *a: 5000 * Func223(*a)))
...
def CallBack0(oEventCB, oTarget):
    cl_action.CommonChangePerformAttr(oTarget, oEventCB.GetCBLifeCycle(), 1627, 'Att', 0, (lambda *a: 5000 * Func223(*a)))
