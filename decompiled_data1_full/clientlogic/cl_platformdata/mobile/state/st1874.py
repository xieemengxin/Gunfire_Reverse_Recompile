# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st1874.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st1874.pyc
# Source Generated with Decompyle++
# File: st1874.pyc (Python 3.6)
...
from cl_newformula import Func404, Func613
...
def CallBack0(oEventCB, oTarget):
    cl_action.StateSetSelfCount(oTarget, oEventCB.GetCBLifeCycle(), (lambda *a: Func613(*a, **{
'iInscriptionType': 1 }) * 5 + Func613(*a, **{
'iInscriptionType': 2 }) * 10 + Func613(*a, **{
'iInscriptionType': 4 }) * 15 + Func613(*a, **{
'iInscriptionType': 3 }) * 20))
