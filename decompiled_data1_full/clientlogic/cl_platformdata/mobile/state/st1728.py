# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st1728.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st1728.pyc
# Source Generated with Decompyle++
# File: st1728.pyc (Python 3.6)
    ...
    if cl_evcon.StateCheckFromSameItem(oTarget, oEventCB) and cl_evcon.EventCBCheckSkillCache(oTarget, oEventCB, SKILLCACHE_INT):
        ...
        if not cl_evcon.CheckTargetHasState(oTarget, oEventCB, 1730, 0, 0, 0, 1):
            if cl_evcon.CheckHitWeakness(oTarget, oEventCB, 0):
                ...
                cl_evact.StateCBAddSelfStateStatistics(oTarget, oEventCB, 1, 'st1728')
                if cl_evcon.CheckWeaponHasInscription(oTarget, oEventCB, 13049) and cl_condition.StateGetSelfCount(oTarget, oEventCB.GetCBLifeCycle()) >= 14:
...
'sKey': 'st1728' })))
                ...
                elif cl_condition.StateGetSelfCount(oTarget, oEventCB.GetCBLifeCycle()) >= 14:
