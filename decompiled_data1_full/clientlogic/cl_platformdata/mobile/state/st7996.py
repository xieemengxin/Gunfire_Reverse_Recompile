# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st7996.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st7996.pyc
# Source Generated with Decompyle++
# File: st7996.pyc (Python 3.6)
...
def CallBack0(oEventCB, oTarget):
    ...
    if cl_evcon.CheckHitWeakness(oTarget, oEventCB, None) and cl_evcon.CheckTargetHasState(oTarget, oEventCB, 7978, 0, 1, None, None) == 0:
        cl_evact.StateCBAddVictimState(oTarget, oEventCB, 7978, 25, 0, { }, 0, None, None)
