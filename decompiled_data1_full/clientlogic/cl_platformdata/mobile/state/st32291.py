# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st32291.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st32291.pyc
# Source Generated with Decompyle++
# File: st32291.pyc (Python 3.6)
...
def CallBack0(oEventCB, oTarget):
    if cl_evcon.CheckWeaponType(oTarget, oEventCB, EQUIP_SNIPER) and cl_evcon.CheckStateAddByIs(oTarget, oEventCB, None):
        ...
        cl_evact.EventChangeDamFactor(oTarget, oEventCB, OBJ_VICTIM, (lambda *a: Func404(*a) * 1500), 0, DAM_TYPE_WEAPON, '')
