# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st32764.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st32764.pyc
# Source Generated with Decompyle++
# File: st32764.pyc (Python 3.6)
...
def CallBack0(oEventCB, oTarget):
    if cl_evcon.EventCBCheckQuality(oTarget, oEventCB, QUALITY_TYPE_LOW):
        cl_evact.StateAddSelfCount(oTarget, oEventCB, 8, None)
    elif cl_evcon.EventCBCheckQuality(oTarget, oEventCB, QUALITY_TYPE_NORMAL):
        cl_evact.StateAddSelfCount(oTarget, oEventCB, 11, None)
    elif cl_evcon.EventCBCheckQuality(oTarget, oEventCB, QUALITY_TYPE_HIGH):
        cl_evact.StateAddSelfCount(oTarget, oEventCB, 14, None)
