# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st32053.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st32053.pyc
...
def CallBack0(oEventCB, oTarget):
    if cl_evcon.CheckCostBulletType(oTarget, oEventCB, 4502):
        ...
        cl_evact.EventSetTargetMark(oTarget, oEventCB, 'p5003Cost', None)


def CallBack2(oEventCB, oTarget):
    cl_evact.EventGetTargetByType(oTarget, oEventCB, OBJ_SELF)
    if cl_evcon.CheckTargetHasMark(oTarget, oEventCB, 'p5003Cost', 1):
        cl_evact.StateCBChangeSkillDamFactor(oTarget, oEventCB, (lambda *a: Func404(*a) * 5000), 0, DAM_TYPE_WEAPON, None, None)
        cl_evact.StateSetSelfCount(oTarget, oEventCB, 0)
        cl_evact.EventClearTargetMark(oTarget, oEventCB, 'p5003Cost', None, None)
