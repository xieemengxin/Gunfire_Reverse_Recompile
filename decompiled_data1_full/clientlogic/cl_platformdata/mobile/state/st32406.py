# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st32406.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st32406.pyc
# Source Generated with Decompyle++
# File: st32406.pyc (Python 3.6)
...
def CallBack0(oEventCB, oTarget):
    cl_evact.EventCBRecordMoveDis(oTarget, oEventCB, 'st32406', OBJECT_OWNER, 0)
    if cl_condition.CalFormula(oTarget, oEventCB.GetCBLifeCycle(), (lambda *a: Func340(*a, **{
'sKey': 'st32406' }))) >= 10:
        cl_evact.EventCBResetMoveDis(oTarget, oEventCB, 'st32406', OBJECT_OWNER, 0, 0)
        cl_evact.StateCBUsePerform(oTarget, oEventCB, 8607, 0, {
            'Att': (lambda *a: (Func597(*a) * 20 + 800 + 300 * Func223(*a)) * 100) }, 1)
