# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st33447.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st33447.pyc
# Source Generated with Decompyle++
# File: st33447.pyc (Python 3.6)
...
import cl_state
from cl_commondefines import ATTACKERSUBMSG_NORMAL, DUAL_STATE_BEGIN, DUAL_STATE_END, OBJ_SELF, STATE_ADD_REPLACE, STATE_CLS_HELP, STATE_EFF_NONE
...
def CallBack3(oEventCB, oTarget):
    if not cl_evcon.CheckFromPointPerform(oTarget, oEventCB, 8608, 0, 0):
        cl_evact.StateCBAddSelfStateStatistics(oTarget, oEventCB, 1, 'st33447')
        if cl_evact.StateCBGetSelfStateStatistics(oTarget, oEventCB, 'st33447') >= cl_evcon.GetFormula(oTarget, oEventCB, (lambda *a: Func429(*a, **{
'sArg': 'Att' }))):
            cl_evact.StateCBSetSelfStateStatistics(oTarget, oEventCB, 'st33447', 0)
