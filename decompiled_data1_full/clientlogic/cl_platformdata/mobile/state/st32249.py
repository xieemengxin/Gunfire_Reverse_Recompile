# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st32249.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st32249.pyc
# Source Generated with Decompyle++
# File: st32249.pyc (Python 3.6)
...
def CallBack0(oEventCB, oTarget):
    if cl_condition.CheckCurLevel(oTarget, oEventCB.GetCBLifeCycle(), 1301003):
        ...
        cl_evact.EventGetTargetByType(oTarget, oEventCB, OBJ_SELF)
        cl_evact.EventTargetGetRangeTargetByFightType(oTarget, oEventCB, 20, WARRIOR_MONSTER, 1, 0, 3, 0, None, None, None)
        cl_evact.EventCBUsePerformEvtTarget(oTarget, oEventCB, 1670, {
            ...
            'TalentSkill': 1 }, None)
        cl_evact.EventTargetGetRangeTargetByFightType(oTarget, oEventCB, 20, WARRIOR_PROTEGE_NORMAL, 1, 0, 1, 0, None, None, None)
        cl_evact.EventCBUsePerformEvtTarget(oTarget, oEventCB, 1670, {
            'TransDamFactor': cl_action.StateGetSelfTransDamFactor(oTarget, oEventCB.GetCBLifeCycle()),
            'TalentSkill': 1 }, None)
        cl_evact.StateCBSelfRemove(oTarget, oEventCB)
