# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st1351.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st1351.pyc
# Source Generated with Decompyle++
# File: st1351.pyc (Python 3.6)
...
def CallBack0(oEventCB, oTarget):
    if cl_evcon.CheckFromPointPerform(oTarget, oEventCB, 1310, 1, None):
        ...
        if cl_evcon.StateCBGetSelfCount(oTarget, oEventCB) >= 2:
            ...
            cl_evact.StateCBAddVictimState(oTarget, oEventCB, 1192, 200, 1, { }, 0, None, None)
