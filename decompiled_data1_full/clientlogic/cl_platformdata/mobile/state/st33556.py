# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st33556.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st33556.pyc
# Source Generated with Decompyle++
# File: st33556.pyc (Python 3.6)
...
def StateActAction(oTarget, oLifeCycle):
    ...
    cl_action.CommonDirectEventCBFunc(oTarget, oLifeCycle, 17, 0, 0)
...
def CallBack17(oEventCB, oTarget):
    cl_evact.EventCBSetWandCount(oTarget, oEventCB, (lambda *a: Func429(*a, **{
'sArg': 'Dam' }) // 100))
