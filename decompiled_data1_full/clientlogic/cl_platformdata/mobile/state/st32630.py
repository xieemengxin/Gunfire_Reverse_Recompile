# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st32630.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st32630.pyc
# Source Generated with Decompyle++
# File: st32630.pyc (Python 3.6)
...
def StateCountAction(oTarget, oLifeCycle):
    if cl_condition.CheckTargetDefendTrend(oTarget, oLifeCycle, DEFEND_TREND_SHIELD):
        ...
        cl_action.CommonChangeAttr(oTarget, oLifeCycle, 'ArmorMax', 0, (lambda *a: Func404(*a) * 1000), 0)
