# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st33120.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st33120.pyc
# Source Generated with Decompyle++
# File: st33120.pyc (Python 3.6)
...
def StateRemoveAction(oTarget, oLifeCycle):
    cl_action.StateTriggerStateDelayBehavior(oTarget, oLifeCycle, 1)
    CustomActionTocixEnd(oTarget, oLifeCycle, { })


class CState(cl_state.CState):
    m_SID = 33120
    m_Name = '#NT#毒气专属2-毒气状态'
    m_DieRemove = 1
    m_IsShow = 1
