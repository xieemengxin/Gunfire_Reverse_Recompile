# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st1795.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st1795.pyc
# Source Generated with Decompyle++
# File: st1795.pyc (Python 3.6)
...
def CallBack2(oEventCB, oTarget):
    if cl_evcon.CheckFromPointPerform(oTarget, oEventCB, 1323, 1, 0) == 0 and cl_evcon.CheckFromPointPerform(oTarget, oEventCB, 1301, 1, 0) == 0 and cl_evcon.CheckFromCareerPerform(oTarget, oEventCB):
        cl_evact.StateCBSelfRemove(oTarget, oEventCB)
