# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st33294.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st33294.pyc
# Source Generated with Decompyle++
# File: st33294.pyc (Python 3.6)
...
def CallBack0(oEventCB, oTarget):
    if cl_evcon.StateCBGetSelfCount(oTarget, oEventCB) >= 1:
        cl_evact.StateCBChangeSkillDamFactor(oTarget, oEventCB, 0, (lambda *a: Func404(*a) * 2000), 0, 1, 0)
