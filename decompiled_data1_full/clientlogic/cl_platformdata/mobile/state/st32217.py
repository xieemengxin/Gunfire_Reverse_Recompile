# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st32217.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st32217.pyc
# Source Generated with Decompyle++
# File: st32217.pyc (Python 3.6)
...
import cl_evcon
import cl_state
from cl_commondefines import ATTACKERSUBMSG_NORMAL, DAM_TYPE_PERFORM, OBJ_SELF, OBJ_VICTIM, PF_TYPE_THROW, STATE_ADD_EXCLUDE, STATE_CLS_HELP, STATE_EFF_NONE
...
def CallBack1(oEventCB, oTarget):
    if cl_evcon.CheckStateAddByIs(oTarget, oEventCB, None) or cl_evcon.CheckPerformType(oTarget, oEventCB, PF_TYPE_THROW, 1):
