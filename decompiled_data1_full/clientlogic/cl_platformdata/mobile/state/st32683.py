# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st32683.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st32683.pyc
# Source Generated with Decompyle++
# File: st32683.pyc (Python 3.6)
...
def CallBack0(oEventCB, oTarget):
    if cl_evcon.CheckStateAddByIs(oTarget, oEventCB, None) or cl_evcon.CheckInPointPerform(oTarget, oEventCB, {
        1411: 1,
        8012: 1 }, 0, 1):
...
def CallBack3(oEventCB, oTarget):
    if cl_evcon.CheckInPointPerform(oTarget, oEventCB, {
        ...
        8012: 1 }, 0, 1):
        cl_evact.EventGetTargetByType(oTarget, oEventCB, OBJ_VICTIM)
        cl_evact.StateCBAddVictimState(oTarget, oEventCB, 32904, 0, 0, { }, 1, 0, None)
