# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st33384.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st33384.pyc
# Source Generated with Decompyle++
# File: st33384.pyc (Python 3.6)
...
def CallBack2(oEventCB, oTarget):
    if cl_evcon.CheckFromCareerPerform(oTarget, oEventCB) and not cl_evcon.CheckInPointPerform(oTarget, oEventCB, {
        1323: 1,
        1301: 1,
        1325: 1 }, 0, 0) and cl_evcon.CheckPerformIsInkPerform(oTarget, oEventCB) == 0 and not cl_evcon.EventCBGetMsgInfo(oTarget, oEventCB, 'TempCareerUseTimes'):
        cl_evact.EventCBAddEventInfoFlag(oTarget, oEventCB, 'TempCareerUseTimes')
        cl_evact.StateCBSelfRemove(oTarget, oEventCB)
