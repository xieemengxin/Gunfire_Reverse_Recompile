# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st32563.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st32563.pyc
# Source Generated with Decompyle++
# File: st32563.pyc (Python 3.6)
...
def StateRemoveAction(oTarget, oLifeCycle):
    ...
    cl_action.StateAddState(oTarget, oLifeCycle, 32597, 70, { }, None)
    cl_action.CommonDirectEventCBFunc(oTarget, oLifeCycle, 3, None, None)
    cl_action.StateAddState(oTarget, oLifeCycle, 32599, 43, { }, None)
