# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st32437.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st32437.pyc
# Source Generated with Decompyle++
# File: st32437.pyc (Python 3.6)
...
def CallBack0(oEventCB, oTarget):
    ...
    cl_evact.EventChangeDamFactor(oTarget, oEventCB, OBJ_ATTACK, (lambda *a: Func410(*a, **{
'sid': 32361 }) * 3000), 0, 0, '')


class CState(cl_state.CState):
    m_SID = 32437
    m_Name = '#NT#觅魂猎手-击败增伤-等级2'
    m_IsShow = 1
