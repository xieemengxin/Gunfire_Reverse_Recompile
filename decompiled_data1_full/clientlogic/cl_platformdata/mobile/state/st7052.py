# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st7052.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st7052.pyc
# Source Generated with Decompyle++
# File: st7052.pyc (Python 3.6)
...
'sAttr': 'HPMax' }) * 40 / 100 + 1)):
            ...
            cl_action.CommonStateStatistics(oTarget, oEventCB.GetCBLifeCycle(), 7052, 1, 'Behavivor')
        if cl_condition.CalFormula(oTarget, oEventCB.GetCBLifeCycle(), (lambda *a: Func437(*a, **{
...
'sAttr': 'HPMax' }) * 20 / 100 + 1)):
            ...
            cl_action.CommonStateStatistics(oTarget, oEventCB.GetCBLifeCycle(), 7052, 2, 'Behavivor')
...
def CallBack1(oEventCB, oTarget):
    ...
    cl_evact.StateCBRemoveState(oTarget, oEventCB, 7111)
    cl_evact.StateCBUsePerform(oTarget, oEventCB, 22014, 0, { }, None)
