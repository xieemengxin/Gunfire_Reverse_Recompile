# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st32276.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st32276.pyc
# Source Generated with Decompyle++
# File: st32276.pyc (Python 3.6)
...
from cl_newformula import Func402, Func410
...
def CallBack0(oEventCB, oTarget):
    ...
    cl_evact.EventChangeDamFactor(oTarget, oEventCB, OBJ_ATTACK, (lambda *a: Func402(*a) * Func410(*a, **{
'sid': 32273 }) * 500), 0, 0, '')
    if cl_evcon.CheckHitWeakness(oTarget, oEventCB, None):
        cl_evact.EventChangeDamFactor(oTarget, oEventCB, OBJ_ATTACK, (lambda *a: Func402(*a) * Func410(*a, **{
'sid': 32273 }) * 500), (lambda *a: Func410(*a, **{
'sid': 32273 }) * 500), 0, '')
