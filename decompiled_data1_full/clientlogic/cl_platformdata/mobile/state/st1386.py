# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st1386.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st1386.pyc
# Source Generated with Decompyle++
# File: st1386.pyc (Python 3.6)
...
import cl_evcon
import cl_state
from cl_commondefines import CURE_TYPE_PERFORM, DAM_USE_ARMOR, DAM_USE_SHIELD, OBJ_SELF, OBJ_VICTIM, STATE_ADD_REPLACE, STATE_CLS_HELP, STATE_EFF_NONE
...
def CallBack0(oEventCB, oTarget):
    if cl_evcon.GetFormula(oTarget, oEventCB, (lambda *a: Func404(*a) * 1 + 0)) > 0:
        cl_evact.EventGetTargetByType(oTarget, oEventCB, OBJ_VICTIM)
        cl_evact.StateAddSelfCount(oTarget, oEventCB, -1, None)
        cl_evact.EventTargetCure(oTarget, oEventCB, (lambda *a: Func302(*a, **{
'sAttr': 'ShieldMax' }) * 100 / 100 + 0), CURE_TYPE_PERFORM | DAM_USE_SHIELD, 0, None, None)
        cl_evact.EventTargetCure(oTarget, oEventCB, (lambda *a: Func302(*a, **{
'sAttr': 'ArmorMax' }) * 100 / 100 + 0), CURE_TYPE_PERFORM | DAM_USE_ARMOR, 0, None, None)
