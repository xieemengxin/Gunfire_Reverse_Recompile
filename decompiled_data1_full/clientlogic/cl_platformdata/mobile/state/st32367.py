# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st32367.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st32367.pyc
# Source Generated with Decompyle++
# File: st32367.pyc (Python 3.6)
...
import cl_evcon
import cl_state
from cl_commondefines import ATTACKERSUBMSG_NORMAL, EQUIP_LASER, OBJ_ATTACK, OBJ_SELF, PF_TYPE_CONSHOOT, STATE_ADD_REPLACE, STATE_CLS_HELP, STATE_EFF_NONE
...
def CallBack1(oEventCB, oTarget):
    if cl_evcon.StateCBGetSelfCount(oTarget, oEventCB) == 0:
        ...
        cl_evact.EventCBSubCareerPerformColdTime(oTarget, oEventCB, 10, 0)
