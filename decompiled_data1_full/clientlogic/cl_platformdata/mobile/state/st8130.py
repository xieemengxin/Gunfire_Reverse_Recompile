# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st8130.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st8130.pyc
# Source Generated with Decompyle++
# File: st8130.pyc (Python 3.6)
...
from cl_newformula import Func204, Func589
...
def StateActAction(oTarget, oLifeCycle):
    ...
    cl_action.CommonChangeAttr(oTarget, oLifeCycle, 'Att', 2000, 0, 0)
    cl_action.CommonChangeAttr(oTarget, oLifeCycle, 'ArmorMax', (lambda *a: Func204(*a) * 2500), 0, 0)
    cl_action.CommonChangeAttr(oTarget, oLifeCycle, 'ShieldMax', (lambda *a: Func204(*a) * 2500), 0, 0)
    cl_action.CommonChangeAttr(oTarget, oLifeCycle, 'HPMax', (lambda *a: Func204(*a) * 2500), 0, 0)
