# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st32004.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st32004.pyc
# Source Generated with Decompyle++
# File: st32004.pyc (Python 3.6)
...
import cl_evcon
import cl_state
from cl_commondefines import ATTACKERSUBMSG_NORMAL, MAIN_SKILL_DURATION_BEGIN, MAIN_SKILL_DURATION_END, OBJ_SELF, STATE_ADD_OVERTIME, STATE_CLS_HELP, STATE_EFF_NONE

def StateActAction(oTarget, oLifeCycle):
    cl_action.CommonSendMessage(oTarget, oLifeCycle, cl_msgcenter.MSG_WAR_MAIN_SKILL_DURATION, MAIN_SKILL_DURATION_BEGIN, {
        'StateSID': 32004 })
    cl_action.CommonDualWield(oTarget, oLifeCycle)
...
def StateRemoveAction(oTarget, oLifeCycle):
    ...
    cl_action.StateAddState(oTarget, oLifeCycle, 32005, 60, { }, None)
...
def CallBack0(oEventCB, oTarget):
    ...
    cl_evact.EventClientBehavior(oTarget, oEventCB, 4162, 0)
