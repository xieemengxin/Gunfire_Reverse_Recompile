# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st7064.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st7064.pyc
...
import cl_evcon
import cl_state
from cl_commondefines import CURE_TYPE_PERFORM, DAM_USE_HP, OBJ_ENEMY, OBJ_SELF, OBJ_VICTIM, SCENE_EVT_SHAPE_SPHERE, STATE_ADD_REPLACE, STATE_CLS_HELP, STATE_EFF_NONE, WARRIOR_ELITE, WARRIOR_HERO
from cl_newformula import Func403, Func404, Func410
...
def CallBack5(oEventCB, oTarget):
    if cl_evcon.StateCBGetSelfCount(oTarget, oEventCB) > 0:
        ...
        if cl_evcon.CheckFightType(oTarget, oEventCB, WARRIOR_ELITE):
            cl_evact.EventGetTargetByType(oTarget, oEventCB, OBJ_SELF)
            cl_evact.EventTargetCure(oTarget, oEventCB, (lambda *a: Func404(*a) * Func403(*a, **{
'sAttr': 'HPMax' }) * 2 / 100 + 0), CURE_TYPE_PERFORM | DAM_USE_HP, 1, None, None)
...
def CallBack10(oEventCB, oTarget):
    ...
    cl_evact.EventGetRangeTargetByTargetType(oTarget, oEventCB, 1000, OBJ_ENEMY, 1)
    cl_evact.StateCBRemoveStateFromSelf(oTarget, oEventCB, 1046)
