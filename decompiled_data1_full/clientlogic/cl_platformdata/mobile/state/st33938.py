# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st33938.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st33938.pyc
# Source Generated with Decompyle++
# File: st33938.pyc (Python 3.6)
...
def StateCountAction(oTarget, oLifeCycle):
    if cl_condition.StateGetSelfCount(oTarget, oLifeCycle) >= oLifeCycle.m_Owner.GetArgValue('MaxFloor'):
        ...
        cl_action.StateAddState(oTarget, oLifeCycle, 33939, oLifeCycle.m_Owner.GetArgValue('DuringTime'), {
