# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st33562.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st33562.pyc
# Source Generated with Decompyle++
# File: st33562.pyc (Python 3.6)
...
def CallBack0(oEventCB, oTarget):
    if cl_evcon.CheckFromMinorPerform(oTarget, oEventCB) == 0 and cl_evcon.CheckEventWeaponClassifyTag(oTarget, oEventCB, 26) and cl_evcon.CheckInPointPerform(oTarget, oEventCB, {
        1315: 1,
        1319: 1,
        8505: 1 }, 1, 0) == 0:
