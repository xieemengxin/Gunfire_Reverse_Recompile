# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st33480.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st33480.pyc
# Source Generated with Decompyle++
# File: st33480.pyc (Python 3.6)
...
def CallBack0(oEventCB, oTarget):
    if not cl_evcon.CheckPerformUnCrtByOwner(oTarget, oEventCB):
        if cl_condition.StateGetSelfCount(oTarget, oEventCB.GetCBLifeCycle()) >= 3:
            ...
            cl_evact.StateCBChangeSkillDamFactor(oTarget, oEventCB, 9000, 0, 0, 1, 0)
        else:
