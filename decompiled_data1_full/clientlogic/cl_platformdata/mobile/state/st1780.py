# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/state/st1780.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/state/st1780.pyc
# Source Generated with Decompyle++
# File: st1780.pyc (Python 3.6)
...
def StateActAction(oTarget, oLifeCycle):
    ...
    cl_action.StateAddSelfCount(oTarget, oLifeCycle, oLifeCycle.m_Owner.GetArgValue('LuckyHit'), None)


def StateCountAction(oTarget, oLifeCycle):
    if not cl_condition.StateGetSelfCount(oTarget, oLifeCycle) > 0:
...
def CallBack1(oEventCB, oTarget):
    if not cl_evcon.CheckIsHit(oTarget, oEventCB):
        cl_evact.StateAddSelfCount(oTarget, oEventCB, -1, None)


class CState(cl_state.CState):
    m_SID = 1780
    m_Name = '#NT#铭刻4843幸运一击状态'
