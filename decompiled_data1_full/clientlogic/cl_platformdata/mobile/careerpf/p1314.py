# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/careerpf/p1314.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/careerpf/p1314.pyc
...
def Action(skill):
    if 1 == cl_action.GetSkillCacheData(skill, SKILLCACHE_PERFORMMODE) or cl_action.IsHeroCtrl(skill):
        cartoon = { }
