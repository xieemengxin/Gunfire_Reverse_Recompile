# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/careerpf/p8504.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/careerpf/p8504.pyc
# Source Generated with Decompyle++
# File: p8504.pyc (Python 3.6)
...
class CCartoon5(CurveCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgCustomTargetPos(skill), (0, 0, 0), 1, 50, 25, 270, 0.7, targettype = OBJ_ENEMY, pierceblock = True, effect = 0, liveTime = 0, trailEffect = 0, effectLiveTime = 1)
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgCustomStartPos(skill, cartoon), (0, 0, 0), [
                0.3], attshape = ATT_SHAPE_SPHERE, targettype = OBJ_ENEMY, pierceStatic = False, explosion = False)
