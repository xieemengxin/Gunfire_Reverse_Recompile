# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/careerpf/p7149.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/careerpf/p7149.pyc
...
class CCartoon1(ThrowByPowerCartoon):
    ...
    def InitSuccess(cls, skill, i1, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0.1, 1, -0.4)), cl_action.CrtArgSetParabolaSpeed(skill, cartoon, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0.1, 1, -0.4)), cl_action.CrtArgSkillEndPos(skill), 36, 0, 0.7), 12, 0.5, (0, 18, 0), (1, 1), 300, True, True, 0, 0, 0, 0, innerRadius = 0, pierce = 0, targettype = OBJ_ENEMY)
