# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/careerpf/p1307.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/careerpf/p1307.pyc
...
class CCartoon0(RayCastCartoon):
    ...
    def Active(cls, skill):
        cl_action.SetAttackerCustomPos(skill, 'BarriarPos', [
            cl_action.GetCartoonStart(skill, 0)][0])
        if cl_action.GetTalentLevel(skill, 2503) == 1:
            if cl_action.CheckHasTalent(skill, 2505):
                ...
                cl_action.CreateRandomNumWarriorAtPointPos(skill, [
                    cl_action.GetCartoonStart(skill, 0)], WARRIOR_SUMMON, {
