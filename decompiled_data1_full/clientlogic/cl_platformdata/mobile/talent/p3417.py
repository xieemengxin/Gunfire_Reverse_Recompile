# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/talent/p3417.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/talent/p3417.pyc
# Source Generated with Decompyle++
# File: p3417.pyc (Python 3.6)
...
def DoCallBackAction0(oEventCB, oWarrior):
    if cl_evcon.CheckRandom(oWarrior, oEventCB, 100, 25):
        ...
        cl_evact.EventCBAddTargetStateCountAndEffectiveTime(oWarrior, oEventCB, 32775, 1, (0, None, ((361, 4347, 'FullEnergyTime'), (lambda a0: a0))), -1)
