# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/talent/p2806.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/talent/p2806.pyc
# Source Generated with Decompyle++
# File: p2806.pyc (Python 3.6)
...
def DoCallBackAction0(oEventCB, oWarrior):
    if cl_evcon.CheckFromPointPerform(oWarrior, oEventCB, 1417, 0, None):
        cl_evact.EventGetTargetByType(oWarrior, oEventCB, OBJ_VICTIM)
        cl_evact.EventChangeDamFactor(oWarrior, oEventCB, OBJ_VICTIM, (lambda *a: Func414(*a, **{
'iState': 32484 }) * 10000), 0, 0, '')
