# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/talent/p3504.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/talent/p3504.pyc
# Source Generated with Decompyle++
# File: p3504.pyc (Python 3.6)
...
from cl_newformula import Func531, Func590

def Action1(oWarrior, oLifeCycle):
    cl_action.CommonAddFlawAddition(oWarrior, oLifeCycle, FLAW_KILLLINE, 2500, 0, 1)
    cl_action.CommonListenMsgCallBack(oWarrior, oLifeCycle, cl_msgcenter.MSG_WAR_HIT_FLAW_BEFORE, -1, 5, 0, 0)
...
def DoCallBackAction3(oEventCB, oWarrior):
    cl_evact.EventGetTargetByType(oWarrior, oEventCB, OBJ_VICTIM)
    if cl_evcon.GetFormula(oWarrior, oEventCB, (lambda *a: Func531(*a) * 100)) <= 3000 and cl_evcon.CheckVictimFightType(oWarrior, oEventCB, WARRIOR_MONSTER) and cl_evcon.CheckTargetDist(oWarrior, oEventCB, 40, 0, None):
