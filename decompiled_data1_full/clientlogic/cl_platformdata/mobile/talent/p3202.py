# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/talent/p3202.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/talent/p3202.pyc
...
def CustomAction(oWarrior, oEventCB, dInfo):
    if 'talent3202-Ratio' not in dInfo:
        return None
    iRatio = dInfo['talent3202-Ratio']
    oWarrior.Set('talent3202-Ratio', iRatio)
