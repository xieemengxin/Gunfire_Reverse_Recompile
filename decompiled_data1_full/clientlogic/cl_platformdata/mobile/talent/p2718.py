# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/talent/p2718.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/talent/p2718.pyc
# Source Generated with Decompyle++
# File: p2718.pyc (Python 3.6)
...
'sid': 2718 }) * 25) / 100 + 0), 1)), 0)
        cl_evact.PassiveCBAddState(oWarrior, oEventCB, 32684, 0, { }, 1, 1, None)
        cl_evact.PassiveSetStateCount(oWarrior, oEventCB, 32684, (lambda *a: max(int((Func517(*a) + Func533(*a)) * (25 + Func331(*a, **{
'sid': 2718 }) * 25) / 100 + 0), 1)))
    else:
        cl_evact.EventCBAddHoldWeaponComBullet(oWarrior, oEventCB, (lambda *a: max(int(Func517(*a) * (25 + Func331(*a, **{
'sid': 2718 }) * 25) / 100 + 0), 1)), MAIN_HOLD)
        cl_evact.PassiveCBAddState(oWarrior, oEventCB, 32684, 0, { }, 1, 1, None)
        cl_evact.PassiveSetStateCount(oWarrior, oEventCB, 32684, (lambda *a: max(int(Func517(*a) * (25 + Func331(*a, **{
'sid': 2718 }) * 25) / 100 + 0), 1)))
