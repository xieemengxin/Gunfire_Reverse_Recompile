# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/talent/p5434.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/talent/p5434.pyc
# Source Generated with Decompyle++
# File: p5434.pyc (Python 3.6)
...
def DoCallBackAction1(oEventCB, oWarrior):
    ...
    if cl_evcon.EventCBGetTargetWithSelfHeightDifference(oWarrior, oEventCB) > 1.5 or cl_evcon.EventCBGetTargetCustomData(oWarrior, oEventCB, 'CommonMonsterFly'):
        cl_action.PassiveAddState(oWarrior, oEventCB.GetCBLifeCycle(), 33942, 300, {
