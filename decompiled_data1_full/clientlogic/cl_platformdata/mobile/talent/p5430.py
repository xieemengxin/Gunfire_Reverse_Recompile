# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/talent/p5430.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/talent/p5430.pyc
# Source Generated with Decompyle++
# File: p5430.pyc (Python 3.6)
...
def Action1(oWarrior, oLifeCycle):
    cl_action.CommonSetPerformArgs(oWarrior, oLifeCycle, 5430, 'MaxCount', 3, None)
...
def Action2(oWarrior, oLifeCycle):
    cl_action.CommonSetPerformArgs(oWarrior, oLifeCycle, 5430, 'MaxCount', 4, None)
...
def DoCallBackAction0(oEventCB, oWarrior):
    if cl_evcon.CheckFromMinorPerform(oWarrior, oEventCB):
        cl_evact.PassiveCBAddState(oWarrior, oEventCB, 33308, 600, { }, 1, 0, 0)
...
'sArgs': 'CostThreshold' }))):
        ...
        if cl_evcon.CheckHasState(oWarrior, oEventCB, 33309):
            cl_action.CommonAddStateCount(oWarrior, oEventCB.GetCBLifeCycle(), 33309, 1, 0)
        else:
            cl_action.PassiveAddState(oWarrior, oEventCB.GetCBLifeCycle(), 33309, 0, {
