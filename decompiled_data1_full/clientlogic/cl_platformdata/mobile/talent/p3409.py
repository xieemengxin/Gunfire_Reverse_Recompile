# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/talent/p3409.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/talent/p3409.pyc
# Source Generated with Decompyle++
# File: p3409.pyc (Python 3.6)
...
def Action1(oWarrior, oLifeCycle):
    cl_action.CommonChangeMaxBullet(oWarrior, oLifeCycle, 4508, 0, 5)
...
def DoCallBackAction4(oEventCB, oWarrior):
    if cl_evcon.GetFormula(oWarrior, oEventCB, (0, None, ((309,), (lambda a0: a0)))) == 1:
        cl_evact.EventAddBagBullet(oWarrior, oEventCB, 4508, 1)
    else:
        cl_evact.EventAddBagBullet(oWarrior, oEventCB, 4508, (0, None, ((309,), (331, 3409), (lambda a0, a1: a0 * (a1 - 1) * 50 / 100))))
