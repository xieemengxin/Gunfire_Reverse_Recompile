# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/talent/p3814.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/talent/p3814.pyc
# Source Generated with Decompyle++
# File: p3814.pyc (Python 3.6)
...
def CustomAction(oListener, oEventCB, dInfo):
    ...
    iKey = oSkill.m_Base['pfid']
    iPerform = dEventInfo['pfid']
    iItemID = dEventInfo['ItemID']
    oPerform = oListener.GetPerform(iPerform, iItemID)
    if not oPerform:
        return None
    oPerform.SetArgValue(iKey, -1)
