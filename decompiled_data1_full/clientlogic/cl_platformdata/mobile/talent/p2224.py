# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/talent/p2224.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/talent/p2224.pyc
# Source Generated with Decompyle++
# File: p2224.pyc (Python 3.6)
...
def DoCallBackAction0(oEventCB, oWarrior):
    ...
    cl_evact.PassiveAddTargetState(oWarrior, oEventCB, 32230, 600, { }, 1, None, None)


def DoCallBackAction1(oEventCB, oWarrior):
    cl_evact.EventGetTargetByType(oWarrior, oEventCB, OBJ_SELF)
    cl_evact.PassiveAddTargetState(oWarrior, oEventCB, 32218, 1000, { }, 1, None, None)
...
'sAttr': 'ArmorMax' }))) <= 0:
        cl_evact.EventGetTargetByType(oWarrior, oEventCB, OBJ_SELF)
        cl_evact.PassiveAddTargetState(oWarrior, oEventCB, 32230, 0, { }, 1, -1, None)
        cl_evact.EventSetTargetMark(oWarrior, oEventCB, 'p2224ForceAttr', None)
    if cl_condition.CalFormula(oWarrior, oEventCB.GetCBLifeCycle(), (lambda *a: Func304(*a, **{
'sAttr': 'ArmorMax' }))) > 0 and cl_evcon.CheckTargetHasMark(oWarrior, oEventCB, 'p2224ForceAttr', 0):
        cl_evact.PassiveCBRemoveTargetState(oWarrior, oEventCB, 32230, 0, None, None)
