# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/talent/p3315.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/talent/p3315.pyc
# Source Generated with Decompyle++
# File: p3315.pyc (Python 3.6)
...
def Action3(oWarrior, oLifeCycle):
    ...
    cl_action.CommonListenMsgCallBack(oWarrior, oLifeCycle, cl_msgcenter.MSG_WAR_ATTACK, ATTACKERSUBMSG_NORMAL, 0, 0, 0)
    cl_action.CommonListenMsgCallBack(oWarrior, oLifeCycle, cl_msgcenter.MSG_WAR_DEALTOTALDAM, ATTACKERSUBMSG_NORMAL, 10, 0, 0)
    cl_action.PassiveSetSelfArgValue(oWarrior, oLifeCycle, 'AttRatio', 12)
    cl_action.PassiveSetSelfArgValue(oWarrior, oLifeCycle, 'LuckyLimit1', 2)
    cl_action.PassiveSetSelfArgValue(oWarrior, oLifeCycle, 'LuckyLimit2', 3)
    cl_action.PassiveSetSelfArgValue(oWarrior, oLifeCycle, 'LuckyLimit3', 4)
    ...
    cl_action.PassiveSetSelfArgValue(oWarrior, oLifeCycle, 'BounceTimes3', 9)
