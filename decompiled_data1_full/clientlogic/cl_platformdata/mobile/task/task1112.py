# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/task/task1112.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/task/task1112.pyc
# Source Generated with Decompyle++
# File: task1112.pyc (Python 3.6)
...
class CTask(CBaseTask):
    m_SID = 1112
    m_Name = '后备能源（2级）'
    m_Description = '完成3个房间前，使用次要技能击败/助攻16个敌人（精英怪算3倍进度）'
    m_Quality = 2
    m_RewardPerformSID = 40058
    m_PunishPerformSID = 40059
    m_TargetStats = {
        1: 16 }
    m_LimitTarget = {
        0: 3 }
