# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/task/task1212.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/task/task1212.pyc
# Source Generated with Decompyle++
# File: task1212.pyc (Python 3.6)
...
class CTask(CBaseTask):
    m_SID = 1212
    m_Name = '后备能源（3级）'
    m_Description = '完成3个房间前，使用次要技能击败/助攻20个敌人（精英怪算3倍进度）'
    m_Quality = 3
    m_RewardPerformSID = 40060
    m_PunishPerformSID = 40061
    m_TargetStats = {
        1: 20 }
    m_LimitTarget = {
        0: 3 }
