# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/task/task1007.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/task/task1007.pyc
# Source Generated with Decompyle++
# File: task1007.pyc (Python 3.6)
...
class CTask(CBaseTask):
    m_SID = 1007
    m_Name = '劳逸结合（1级）'
    m_Description = '完成4个房间，且在主要技能冷却期间受击不超过15次'
    m_Quality = 1
    m_RewardPerformSID = 40038
    m_PunishPerformSID = 40039
    m_TargetStats = {
        0: 4 }
    m_LimitTarget = {
        1: 15 }
