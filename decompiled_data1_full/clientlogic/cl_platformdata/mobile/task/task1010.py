# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/task/task1010.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/task/task1010.pyc
# Source Generated with Decompyle++
# File: task1010.pyc (Python 3.6)
...
class CTask(CBaseTask):
    m_SID = 1010
    m_Name = '揭露弱点（1级）'
    m_Description = '完成3个房间前，完成3次：5秒内击败/助攻3个敌人'
    m_Quality = 1
    m_RewardPerformSID = 40042
    m_PunishPerformSID = 40043
    m_TargetStats = {
        1: 3 }
    m_LimitTarget = {
        0: 3 }
