# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/task/task1210.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/task/task1210.pyc
# Source Generated with Decompyle++
# File: task1210.pyc (Python 3.6)
...
class CTask(CBaseTask):
    m_SID = 1210
    m_Name = '揭露弱点（3级）'
    m_Description = '完成4个房间前，完成8次：5秒内击败/助攻3个敌人'
    m_Quality = 3
    m_RewardPerformSID = 40056
    m_PunishPerformSID = 40057
    m_TargetStats = {
        1: 8 }
    m_LimitTarget = {
        0: 4 }
