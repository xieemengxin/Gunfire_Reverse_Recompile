# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/task/task1208.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/task/task1208.pyc
# Source Generated with Decompyle++
# File: task1208.pyc (Python 3.6)
...
class CTask(CBaseTask):
    m_SID = 1208
    m_Name = '高效火力（3级）'
    m_Description = '接下来的100次射击中，命中至少60次'
    m_Quality = 3
    m_RewardPerformSID = 40064
    m_PunishPerformSID = 40065
    m_TargetStats = {
        1: 60 }
    m_LimitTarget = {
        0: 100 }
