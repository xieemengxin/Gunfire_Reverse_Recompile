# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/task/task1011.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/task/task1011.pyc
# Source Generated with Decompyle++
# File: task1011.pyc (Python 3.6)
...
def DisableAction(oWarrior, oLifeCycle):
    if cl_condition.TaskCheckTaskStatus(oWarrior, oLifeCycle, TASK_STATUS_FAIL):
        cl_action.CommonDegradeHoldWeapon(oWarrior, oLifeCycle, 1)
...
class CTask(CBaseTask):
    m_SID = 1011
    m_Name = '武器锻造（1级）'
    m_Description = '完成3个房间前，完成3次：4秒内使用武器击败/助攻3个敌人（击败/助攻后刷新时间）'
    m_Quality = 1
    m_RewardPerformSID = 0
    m_PunishPerformSID = 40066
    m_TargetStats = {
        1: 3 }
    m_LimitTarget = {
        0: 3 }
