# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/task/task1104.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/task/task1104.pyc
# Source Generated with Decompyle++
# File: task1104.pyc (Python 3.6)
...
class CTask(CBaseTask):
    m_SID = 1104
    m_Name = '元素反应（2级）'
    m_Description = '完成5个房间前，对敌人造成30次燃烧/腐化/电击异常'
    m_Quality = 2
    m_RewardPerformSID = 40019
    m_PunishPerformSID = 40020
    m_TargetStats = {
        0: 30 }
    m_LimitTarget = {
        1: 5 }
