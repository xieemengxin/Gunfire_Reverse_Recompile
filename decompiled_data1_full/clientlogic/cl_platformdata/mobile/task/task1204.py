# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/task/task1204.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/task/task1204.pyc
# Source Generated with Decompyle++
# File: task1204.pyc (Python 3.6)
...
class CTask(CBaseTask):
    m_SID = 1204
    m_Name = '元素反应（3级）'
    m_Description = '完成5个房间前，对敌人造成40次燃烧/腐化/电击异常'
    m_Quality = 3
    m_RewardPerformSID = 40031
    m_PunishPerformSID = 40032
    m_TargetStats = {
        0: 40 }
    m_LimitTarget = {
        1: 5 }
