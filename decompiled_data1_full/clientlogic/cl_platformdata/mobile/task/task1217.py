# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/task/task1217.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/task/task1217.pyc
# Source Generated with Decompyle++
# File: task1217.pyc (Python 3.6)
...
def EnableAction(oWarrior, oLifeCycle):
    ...
    if cl_action.TaskGetSaveInfo(oWarrior, oLifeCycle, '1217Reward') == 0:
        cl_action.TaskSetSaveInfo(oWarrior, oLifeCycle, '1217Reward', 1)
        cl_action.CommonAddSavedData(oWarrior, oLifeCycle, 'ExtraReceiveTaskNum', 1)
        cl_action.CommonAddSavedData(oWarrior, oLifeCycle, 'TaskRefreshTimes', 3)


def DisableAction(oWarrior, oLifeCycle):
    if cl_condition.TaskCheckTaskStatus(oWarrior, oLifeCycle, TASK_STATUS_FAIL):
        cl_action.TaskAddPerform(oWarrior, oLifeCycle, 40072)
