# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/task/task1015.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/task/task1015.pyc
# Source Generated with Decompyle++
# File: task1015.pyc (Python 3.6)
...
class CTask(CBaseTask):
    m_SID = 1015
    m_Name = '以假乱真（1级）'
    m_Description = '完成3个房间前，近3秒内未受到伤害的前提下击败或助攻8个敌人（击败精英怪3倍进度）'
    m_Quality = 1
