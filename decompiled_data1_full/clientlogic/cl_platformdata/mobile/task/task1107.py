# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/task/task1107.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/task/task1107.pyc
# Source Generated with Decompyle++
# File: task1107.pyc (Python 3.6)
...
class CTask(CBaseTask):
    m_SID = 1107
    m_Name = '劳逸结合（2级）'
    m_Description = '完成4个房间，且在主要技能冷却期间受击不超过10次'
    m_Quality = 2
    m_RewardPerformSID = 40046
    m_PunishPerformSID = 40047
    m_TargetStats = {
        0: 4 }
    m_LimitTarget = {
        1: 10 }
