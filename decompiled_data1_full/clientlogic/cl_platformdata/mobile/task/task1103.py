# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/task/task1103.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/task/task1103.pyc
# Source Generated with Decompyle++
# File: task1103.pyc (Python 3.6)
...
class CTask(CBaseTask):
    m_SID = 1103
    m_Name = '精准射击（2级）'
    m_Description = '接下来的60次命中敌人的射击中，造成的暴击次数超过30次'
    m_Quality = 2
    m_RewardPerformSID = 40017
    m_PunishPerformSID = 40018
    m_TargetStats = {
        0: 30 }
    m_LimitTarget = {
        1: 60 }
