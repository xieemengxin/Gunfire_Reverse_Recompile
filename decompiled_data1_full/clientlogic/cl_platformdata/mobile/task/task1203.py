# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/task/task1203.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/task/task1203.pyc
# Source Generated with Decompyle++
# File: task1203.pyc (Python 3.6)
...
class CTask(CBaseTask):
    m_SID = 1203
    m_Name = '精准射击（3级）'
    m_Description = '接下来的60次命中敌人的射击中，造成的暴击次数超过40次'
    m_Quality = 3
    m_RewardPerformSID = 40029
    m_PunishPerformSID = 40030
    m_TargetStats = {
        0: 40 }
    m_LimitTarget = {
        1: 60 }
