# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/task/task1108.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/task/task1108.pyc
# Source Generated with Decompyle++
# File: task1108.pyc (Python 3.6)
...
class CTask(CBaseTask):
    m_SID = 1108
    m_Name = '高效火力（2级）'
    m_Description = '接下来的100次射击中，命中至少50次'
    m_Quality = 2
    m_RewardPerformSID = 40062
    m_PunishPerformSID = 40063
    m_TargetStats = {
        1: 50 }
    m_LimitTarget = {
        0: 100 }
