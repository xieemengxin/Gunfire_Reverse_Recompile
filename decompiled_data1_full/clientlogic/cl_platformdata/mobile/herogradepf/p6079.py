# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/herogradepf/p6079.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/herogradepf/p6079.pyc
# Source Generated with Decompyle++
# File: p6079.pyc (Python 3.6)
...
def DoCallBackAction0(oEventCB, oWarrior):
    if cl_evcon.CheckCostBulletType(oWarrior, oEventCB, 4508):
        if not cl_evcon.CheckKeyInReason(oWarrior, oEventCB, 'PF7005') or cl_evcon.CheckHasState(oWarrior, oEventCB, 32774):
        ...
        elif not cl_evcon.CheckHasState(oWarrior, oEventCB, 32774):
