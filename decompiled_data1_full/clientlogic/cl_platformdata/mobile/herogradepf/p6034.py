# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/herogradepf/p6034.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/herogradepf/p6034.pyc
# Source Generated with Decompyle++
# File: p6034.pyc (Python 3.6)
...
def Action1(oWarrior, oLifeCycle):
    cl_action.PassiveAddState(oWarrior, oLifeCycle, 32293, 0, { }, 1)
...
def DoCallBackAction0(oEventCB, oWarrior):
    if cl_evcon.CheckHitWeakness(oWarrior, oEventCB, 1):
        ...
        if not cl_evcon.CheckTargetDist(oWarrior, oEventCB, 15, 1, None) or cl_evcon.CheckFightType(oWarrior, oEventCB, WARRIOR_BOSSCANNON):
            ...
            cl_evact.PassiveCBAddTargetStateCount(oWarrior, oEventCB, 32293, 1, 0)
