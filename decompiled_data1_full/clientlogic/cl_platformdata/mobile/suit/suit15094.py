# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/suit/suit15094.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/suit/suit15094.pyc
# Source Generated with Decompyle++
# File: suit15094.pyc (Python 3.6)
...
class CSuitData(CBaseSuitData):
    ...
    m_Name = '#NT#鸡械威慑'
    m_Condition = {
        1: (SUIT_BENEDICTION, 13569),
        2: (SUIT_TALENT, (3914, 3)),
        3: (SUIT_TALENT, (3316, 1)),
        4: (SUIT_TALENT, (3915, 1)),
        5: (SUIT_TALENT, (3918, 1)) }
