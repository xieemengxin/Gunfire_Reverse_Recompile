# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/suit/suit15046.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/suit/suit15046.pyc
...
def Action(oTarget):
    return cl_action.RewardPassive(oTarget, 15046, 1)


def RemoveAction(oTarget):
    return cl_action.RemovePassive(oTarget, 15046)
