# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/monsterconfig/c2386.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/monsterconfig/c2386.pyc
# Source Generated with Decompyle++
# File: c2386.pyc (Python 3.6)
...
class CMonsterData(monsterconfigdata.CMonsterData):
    ...
    m_AttPerform = 23861
    m_PerformList = (4111, 4222, 23816, 23817, 23863, 23862)
    m_Betree = 'MonsterLargeFar.FlyingRangedFsm'
    m_BetreeMap = {
        'Default': {
            0: 'MonsterLargeFar.FlyingRangedFsm' },
        'Common': {
