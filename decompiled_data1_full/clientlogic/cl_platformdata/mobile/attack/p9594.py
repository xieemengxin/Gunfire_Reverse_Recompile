# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/attack/p9594.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/attack/p9594.pyc
...
class CCartoon3(ThrowByPowerCartoon):
    ...
    def Hit(cls, skill):
        if cl_action.CheckVictimHasBeaconSunmon(skill, cl_action.GetCartoonHitTargetInOrder(skill, 3)):
            ...
            cl_action.CreateBeaconSummon(skill, 1061, cl_action.GetCartoonHitFirstTargetPos(skill, 3), 2000, 7, 3)
            cl_action.WeaponDamage(skill, {
                'Att': 100 }, { }, sendPFMsg = False)
            cartoon = { }
            CCartoon1.Init(skill, cartoon, casting = 1, index = cl_action.GetCartoonLoopID(skill, 3))
