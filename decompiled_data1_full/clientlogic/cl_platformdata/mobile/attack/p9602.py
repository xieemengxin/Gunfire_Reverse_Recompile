# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/attack/p9602.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/attack/p9602.pyc
    ...
    def InitSuccess(cls, skill, i1, cartoon):
        if not skill.m_CheckType == CRT_CHECK_SERVER:
            ...
            cls.EnableShow(skill, [
                ...
                0.5,
                150,
                24.5], meshCount = 5, totalTime = 10, targettype = OBJ_ENEMY, pierceStatic = False, left2right = True)
