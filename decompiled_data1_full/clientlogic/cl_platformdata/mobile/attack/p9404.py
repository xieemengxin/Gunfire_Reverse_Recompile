# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/attack/p9404.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/attack/p9404.pyc
    ...
    def InitSuccess(cls, skill, i1, cartoon):
        if not skill.m_CheckType == CRT_CHECK_SERVER:
            if not cls.EnableCheck(skill, start = cl_action.CrtArgMuzzlePos(skill, cartoon)):
                return None
            cls.EnableShow(skill, skill.m_Cache['Radius'] if cl_action.CheckHasInscription(skill, 13025) else 0.4, (0, 0, 0), (0.3, 0.75), 60000 if cl_action.CheckHasInscription(skill, 13025) else 300, True, False, 0, innerRadius = 0.1, pierce = 0, ignoreMonster = False, hitUnitBounciness = (0, 0), targettype = OBJ_ENEMY, hitovertype = HIT_OVER_NORMAL, changeRadius = 0.7, maxRadius = 3)
