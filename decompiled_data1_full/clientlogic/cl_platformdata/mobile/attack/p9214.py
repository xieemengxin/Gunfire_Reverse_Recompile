# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/attack/p9214.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/attack/p9214.pyc
...
def Action(skill):
    if cl_action.IsHeroCtrl(skill):
        ...
        cl_action.ModifySkillHitArea(skill, cl_action.GetSkillCacheData(skill, SKILLCACHE_LSTINT)[1])
        cl_action.ModifySkillHitPos(skill, cl_action.GetSkillCacheData(skill, SKILLCACHE_POS))
