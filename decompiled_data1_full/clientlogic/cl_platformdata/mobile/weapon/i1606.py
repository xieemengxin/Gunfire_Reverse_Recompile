# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/weapon/i1606.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/weapon/i1606.pyc
...
from cl_commondefines import DAM_TYPE_NORMAL, EQUIP_TYPE_CLOSEWEAPON, ITEM_MODE_DRILLFOCUS, QUALITY_TYPE_LOW
...
def CallBack0(oEventCB, oOwner):
    if cl_evcon.EventCBCheckItemMode(oOwner, oEventCB, ITEM_MODE_DRILLFOCUS):
        cl_evact.ItemCBRemoveState(oOwner, oEventCB, 1872)
        ...
        cl_evact.ItemCBAddState(oOwner, oEventCB, 1872, 50, { }, 0)
