# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/passive/p4038.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/passive/p4038.pyc
...
from cl_newformula import Func205, Func235
...
def Action1(oWarrior, oLifeCycle):
    ...
    if cl_condition.CalFormula(oWarrior, oLifeCycle, (lambda *a: (Func205(*a) - 0) * 0 + (Func235(*a, **{
'sType': 'RidingAlone' }) - 0) * 1 + 0)) >= 2:
