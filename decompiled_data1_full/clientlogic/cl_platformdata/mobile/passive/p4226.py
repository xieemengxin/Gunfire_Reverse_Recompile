# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/mobile/passive/p4226.pyc
# RelativePath: clientlogic/cl_platformdata/mobile/passive/p4226.pyc
...
def DoCallBackAction1(oEventCB, oWarrior):
    if cl_evcon.GetRefreshMonsterTimeInterval(oWarrior, oEventCB) >= 1000:
        if cl_evcon.GetListenerHPRatio(oWarrior, oEventCB) >= 90:
            if cl_evcon.GetSceneMonsterCnt(oWarrior, oEventCB, 1) <= 4 + 0.5 * (cl_evcon.GetRoomPlayerCnt(oWarrior, oEventCB) - 1):
                cl_evact.EventCBSummonAreaMonster(oWarrior, oEventCB, 3, {
                    212: 10 }, {
