# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/rewardpf/p16004.pyc
# RelativePath: clientlogic/cl_platformdata/pc/rewardpf/p16004.pyc
# Source Generated with Decompyle++
# File: p16004.pyc (Python 3.6)
...
def DoCallBackAction0(oEventCB, oWarrior):
    if cl_evcon.CheckWeaponElementTypeByHoldType(oWarrior, oEventCB, MAIN_HOLD, DAM_TYPE_NORMAL):
        cl_evact.PassiveCBAddState(oWarrior, oEventCB, 1613, 0, { }, 1, 0, None)
...
def DoCallBackAction2(oEventCB, oWarrior):
    if cl_evcon.EventCBCheckWeaponElementType(oWarrior, oEventCB, 'survivor', MAIN_HOLD, DAM_TYPE_ELEMENT):
        cl_action.CommonRemoveState(oWarrior, oEventCB.GetCBLifeCycle(), 1613)
