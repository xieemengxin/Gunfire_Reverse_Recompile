# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/rewardpf/p15170.pyc
# RelativePath: clientlogic/cl_platformdata/pc/rewardpf/p15170.pyc
# Source Generated with Decompyle++
# File: p15170.pyc (Python 3.6)
...
def Action1(oWarrior, oLifeCycle):
    ...
    cl_action.PassiveAddState(oWarrior, oLifeCycle, 1888, 0, { }, -1)
    cl_action.CommonDirectEventCBFunc(oWarrior, oLifeCycle, 2, 0, 0)


def DoCallBackAction0(oEventCB, oWarrior):
    cl_evact.EventChangeDamFactor(oWarrior, oEventCB, OBJ_ATTACK, (lambda *a: (Func207(*a) * 1 / 100) * 100), 0, DAM_TYPE_PERFORM, '')


def DoCallBackAction2(oEventCB, oWarrior):
    cl_evact.PassiveSetStateCount(oWarrior, oEventCB, 1888, (lambda *a: Func207(*a) * 1 / 100))
