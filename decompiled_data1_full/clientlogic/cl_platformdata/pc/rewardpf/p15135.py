# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/rewardpf/p15135.pyc
# RelativePath: clientlogic/cl_platformdata/pc/rewardpf/p15135.pyc
# Source Generated with Decompyle++
# File: p15135.pyc (Python 3.6)
...
def DoCallBackAction0(oEventCB, oWarrior):
    cl_evact.EventChangeDamFactor(oWarrior, oEventCB, OBJ_ATTACK, 3000 + cl_action.CommonGetSuitConditionNum(oWarrior, oEventCB.GetCBLifeCycle(), 15135) * 1000, 0, 0, '')


def DoCallBackAction1(oEventCB, oWarrior):
    if cl_evcon.EventCBCheckSuitReduceSource(oWarrior, oEventCB, 15135):
