# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/wandability/p51298.pyc
# RelativePath: clientlogic/cl_platformdata/pc/wandability/p51298.pyc
# Source Generated with Decompyle++
# File: p51298.pyc (Python 3.6)
...
from cl_commondefines import ABILITY_TYPE_EXCLUSIVE, CHARGECARTOON_SUBMSG_END
...
'sKey': 'StateSID' }))) == 33603 and cl_evcon.GetFormula(oWarrior, oEventCB, (lambda *a: Func651(*a, **{
'sKey': 'Count' }))) >= 5 and cl_evcon.PassiveCBGetPFArgs(oWarrior, oEventCB, 'RewardLevel') <= 0:
        ...
        cl_evact.PassiveCBAddState(oWarrior, oEventCB, 33695, 0, {
...
def DoCallBackAction4(oEventCB, oWarrior):
    ...
    cl_action.CommonRemoveOwnerState(oWarrior, oEventCB.GetCBLifeCycle(), 33695, 0)
