# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/wandability/p51284.pyc
# RelativePath: clientlogic/cl_platformdata/pc/wandability/p51284.pyc
# Source Generated with Decompyle++
# File: p51284.pyc (Python 3.6)
...
def DoCallBackAction0(oEventCB, oWarrior):
    if cl_evcon.CheckReason(oWarrior, oEventCB, 'ColdTime', 0):
        cl_evact.PassiveCBChangeWandAttr(oWarrior, oEventCB, 'ColdTime', cl_action.CommonGetAttrExcludeTargetWandComp(oWarrior, oEventCB.GetCBLifeCycle(), 'ColdTime', {
            2121: 1 }) * 2 // 10, 0, 1)
