# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/wandability/p51293.pyc
# RelativePath: clientlogic/cl_platformdata/pc/wandability/p51293.pyc
# Source Generated with Decompyle++
# File: p51293.pyc (Python 3.6)
...
from cl_commondefines import ABILITY_TYPE_EXCLUSIVE, WANDCOMP_SUBMSG_ADD, WANDCOMP_SUBMSG_REMOVE
...
def DoCallBackAction0(oEventCB, oWarrior):
    cl_evact.PassiveCBChangeWandAttr(oWarrior, oEventCB, 'ColdTime', cl_condition.CommonGetCompNumByType(oWarrior, oEventCB.GetCBLifeCycle(), 1) * -10, 0, 1)
