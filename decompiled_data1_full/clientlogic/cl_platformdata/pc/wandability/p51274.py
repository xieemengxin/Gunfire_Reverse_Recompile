# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/wandability/p51274.pyc
# RelativePath: clientlogic/cl_platformdata/pc/wandability/p51274.pyc
# Source Generated with Decompyle++
# File: p51274.pyc (Python 3.6)
...
from cl_commondefines import ABILITY_QUALITY_FOUR, ABILITY_TYPE_EXCLUSIVE, WANDCOMP_SUBMSG_ADD, WANDCOMP_SUBMSG_REMOVE, WAND_SUBMSG_FINISHCONDITION
...
def DoCallBackAction1(oEventCB, oWarrior):
    cl_action.CommonChangeWandAttr(oWarrior, oEventCB.GetCBLifeCycle(), 'ColdTime', 0, (lambda *a: -20 * Func794(*a)))
