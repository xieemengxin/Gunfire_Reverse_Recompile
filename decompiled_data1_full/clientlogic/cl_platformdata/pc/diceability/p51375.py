# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/diceability/p51375.pyc
# RelativePath: clientlogic/cl_platformdata/pc/diceability/p51375.pyc
# Source Generated with Decompyle++
# File: p51375.pyc (Python 3.6)
...
from cl_commondefines import COST_BAGBULLET_THROW, DICETAG_PERFORM, DICE_PUTOUT_POLL_ONE, JUMPFIGURE_BUYGOODS
...
def Action4(oWarrior, oLifeCycle):
    cl_action.PassiveSetSelfArgValue(oWarrior, oLifeCycle, 'BaseCash', 8)
    cl_action.CommonChangeMaxBullet(oWarrior, oLifeCycle, 4508, 7000, 0)
    cl_action.CommonListenMsgCallBack(oWarrior, oLifeCycle, cl_msgcenter.MSG_WAR_COMCOSTBAGBULLET, COST_BAGBULLET_THROW, 0, 0, 0)
