# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/diceability/p51302.pyc
# RelativePath: clientlogic/cl_platformdata/pc/diceability/p51302.pyc
# Source Generated with Decompyle++
# File: p51302.pyc (Python 3.6)
...
from cl_commondefines import DAM_TYPE_WEAPON, DICETAG_WEAPON, DICE_PUTOUT_POLL_ONE
...
def Action4(oWarrior, oLifeCycle):
    cl_action.CommonChangeBaseDamRatio(oWarrior, oLifeCycle, 0, 12000, DAM_TYPE_WEAPON, 1)


def Action5(oWarrior, oLifeCycle):
    cl_action.CommonChangeBaseDamRatio(oWarrior, oLifeCycle, 0, 20000, DAM_TYPE_WEAPON, 1)
