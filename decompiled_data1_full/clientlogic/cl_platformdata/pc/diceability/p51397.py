# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/diceability/p51397.pyc
# RelativePath: clientlogic/cl_platformdata/pc/diceability/p51397.pyc
# Source Generated with Decompyle++
# File: p51397.pyc (Python 3.6)
...
from cl_commondefines import DICETAG_WEAPON, DICE_PUTOUT_POLL_TWO, STATUS_GEYSER, STATUS_HOOKROPE, STATUS_JUMP
...
def Action2(oWarrior, oLifeCycle):
    ...
    cl_action.CommonChangeAttr(oWarrior, oLifeCycle, 'JumpHeight', 30000, 0, 0)
...
def Action3(oWarrior, oLifeCycle):
    ...
    cl_action.CommonListenMsgCallBack(oWarrior, oLifeCycle, cl_msgcenter.MSG_WAR_PERFORM_START, -1, 0, 0, 0)
    cl_action.CommonListenMsgCallBack(oWarrior, oLifeCycle, cl_msgcenter.MSG_WAR_MOVESTATUSCHANGE, -1, 1, 0, 0)
    cl_action.CommonChangeAttr(oWarrior, oLifeCycle, 'JumpHeight', 50000, 0, 0)
    cl_action.PassiveAddState(oWarrior, oLifeCycle, 33839, 0, {
        'GainEffect': 5,
        'AttSpeedMul': 10000 }, 1)
    if cl_condition.HasState(oWarrior, oLifeCycle, 33805):
...
def Action4(oWarrior, oLifeCycle):
    ...
    cl_action.CommonListenMsgCallBack(oWarrior, oLifeCycle, cl_msgcenter.MSG_WAR_PERFORM_START, -1, 0, 0, 0)
    cl_action.CommonListenMsgCallBack(oWarrior, oLifeCycle, cl_msgcenter.MSG_WAR_MOVESTATUSCHANGE, -1, 1, 0, 0)
    cl_action.CommonChangeAttr(oWarrior, oLifeCycle, 'JumpHeight', 80000, 0, 0)
    cl_action.PassiveAddState(oWarrior, oLifeCycle, 33839, 0, {
        'GainEffect': 5,
        'AttSpeedMul': 10000 }, 1)
    if cl_condition.HasState(oWarrior, oLifeCycle, 33805):
...
def Action5(oWarrior, oLifeCycle):
    ...
    cl_action.CommonListenMsgCallBack(oWarrior, oLifeCycle, cl_msgcenter.MSG_WAR_PERFORM_START, -1, 0, 0, 0)
    cl_action.CommonListenMsgCallBack(oWarrior, oLifeCycle, cl_msgcenter.MSG_WAR_MOVESTATUSCHANGE, -1, 1, 0, 0)
    cl_action.CommonChangeAttr(oWarrior, oLifeCycle, 'JumpHeight', 100000, 0, 0)
    cl_action.PassiveAddState(oWarrior, oLifeCycle, 33839, 0, {
        'GainEffect': 5,
        'AttSpeedMul': 10000 }, 1)
    if cl_condition.HasState(oWarrior, oLifeCycle, 33805):
