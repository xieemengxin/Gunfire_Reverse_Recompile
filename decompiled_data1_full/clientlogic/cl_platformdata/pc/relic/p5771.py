# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/relic/p5771.pyc
# RelativePath: clientlogic/cl_platformdata/pc/relic/p5771.pyc
# Source Generated with Decompyle++
# File: p5771.pyc (Python 3.6)
...
from cl_newformula import Func304, Func306
...
def DoCallBackAction0(oEventCB, oWarrior):
    cl_evact.EventCBChangeLuckyHit(oWarrior, oEventCB, (lambda *a: Func306(*a) * -50 + 50))


def DoCallBackAction1(oEventCB, oWarrior):
    cl_evact.EventCBChangeLuckyHit(oWarrior, oEventCB, (lambda *a: ((Func304(*a, **{
'sAttr': 'HP' }) + Func304(*a, **{
