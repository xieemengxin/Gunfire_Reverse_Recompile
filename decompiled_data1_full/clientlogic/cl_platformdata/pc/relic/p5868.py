# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/relic/p5868.pyc
# RelativePath: clientlogic/cl_platformdata/pc/relic/p5868.pyc
...
from cl_commondefines import DROP_REASON_GAMBLER_ROLLRELIC, NWARRIOR_NPC_EVENT, NWARRIOR_NPC_REFRESH, OBJ_SELF, QUALITY_TYPE_NORMAL, RELIC_SUBMSG_GENERATE_CHOOSE, RELIC_SUBMSG_GENERATE_DROP, RELIC_SUBMSG_GENERATE_GOOD, RELIC_SUBMSG_GENERATE_LOTTERY, RELIC_TYPE_NORMAL
...
def Action1(oWarrior, oLifeCycle):
    ...
    cl_action.CommonListenMsgCallBack(oWarrior, oLifeCycle, cl_msgcenter.MSG_WAR_GENERATE_RELIC_BEFORE, RELIC_SUBMSG_GENERATE_LOTTERY, 0, 0, 0)
...
def Action2(oWarrior, oLifeCycle):
    ...
    cl_action.CommonListenMsgCallBack(oWarrior, oLifeCycle, cl_msgcenter.MSG_WAR_GENERATE_RELIC_BEFORE, RELIC_SUBMSG_GENERATE_LOTTERY, 6, 0, 0)
    cl_action.CommonListenMsgCallBack(oWarrior, oLifeCycle, cl_msgcenter.MSG_WAR_ADDRELICPERFORM, -1, 4, 0, 0)


def DoCallBackAction0(oEventCB, oWarrior):
    if not cl_evcon.CheckNPCType(oWarrior, oEventCB, NWARRIOR_NPC_REFRESH) or cl_evcon.CheckNPCType(oWarrior, oEventCB, NWARRIOR_NPC_EVENT) or cl_evcon.CheckDropReason(oWarrior, oEventCB, DROP_REASON_GAMBLER_ROLLRELIC):
