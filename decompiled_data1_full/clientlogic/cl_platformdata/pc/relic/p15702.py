# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/relic/p15702.pyc
# RelativePath: clientlogic/cl_platformdata/pc/relic/p15702.pyc
# Source Generated with Decompyle++
# File: p15702.pyc (Python 3.6)
...
def DoCallBackAction0(oEventCB, oWarrior):
    ...
    if cl_evcon.PassiveCBCheckTargetHasState(oWarrior, oEventCB, 20026, 0, None, None) or cl_evcon.PassiveCBCheckTargetHasState(oWarrior, oEventCB, 20027, 0, None, None) or cl_evcon.PassiveCBCheckTargetHasState(oWarrior, oEventCB, 20028, 0, None, None):
        ...
        cl_evact.EventCBSetTargetStateMaxCount(oWarrior, oEventCB, 1109, 50, None, None)
...
def DoCallBackAction1(oEventCB, oWarrior):
    ...
    if cl_evcon.PassiveCBCheckTargetHasState(oWarrior, oEventCB, 20026, 0, None, None) or cl_evcon.PassiveCBCheckTargetHasState(oWarrior, oEventCB, 20027, 0, None, None) or cl_evcon.PassiveCBCheckTargetHasState(oWarrior, oEventCB, 20028, 0, None, None):
        ...
        cl_evact.EventCBSetTargetStateMaxCount(oWarrior, oEventCB, 1372, 50, None, None)
