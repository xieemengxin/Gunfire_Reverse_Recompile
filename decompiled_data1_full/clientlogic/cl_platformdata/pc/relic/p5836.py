# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/relic/p5836.pyc
# RelativePath: clientlogic/cl_platformdata/pc/relic/p5836.pyc
# Source Generated with Decompyle++
# File: p5836.pyc (Python 3.6)
...
def DoCallBackAction0(oEventCB, oWarrior):
    if cl_evcon.GetVictimHPRatio(oWarrior, oEventCB) >= 70:
        cl_evact.EventChangeDamFactor(oWarrior, oEventCB, OBJ_ATTACK, 4500, 0, 0, '')


def DoCallBackAction1(oEventCB, oWarrior):
    cl_evact.EventChangeDamFactor(oWarrior, oEventCB, OBJ_ATTACK, (lambda *a: Func531(*a) * 70), 0, 0, '')
