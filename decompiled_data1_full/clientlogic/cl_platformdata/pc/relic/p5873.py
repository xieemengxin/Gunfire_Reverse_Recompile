# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/relic/p5873.pyc
# RelativePath: clientlogic/cl_platformdata/pc/relic/p5873.pyc
...
from cl_newformula import Func210, Func219, Func222, Func410, Func575, Func598, Func614
...
def Action1(oWarrior, oLifeCycle):
    ...
    if not cl_condition.CommonCheckRecycleReward(oWarrior, oLifeCycle, NWARRIOR_DROP_RELIC):
        cl_action.CommonAddRecycleDropReward(oWarrior, oLifeCycle, NWARRIOR_DROP_RELIC, (lambda *a: Func219(*a) * 10 / 100), 0)


def DisableAction1(oWarrior, oLifeCycle):
    cl_action.CommonSetSavedData(oWarrior, oLifeCycle, 'Count', 0)
...
def DoCallBackAction0(oEventCB, oWarrior):
    cl_evact.PassiveSetStateCount(oWarrior, oEventCB, 1886, (lambda *a: min(100, (100 - min((Func222(*a) - Func575(*a) - Func210(*a)) * 10, 90)) + Func598(*a, **{
'sKey': 'Count' }) * 20)))
...
def DoCallBackAction1(oEventCB, oWarrior):
    if cl_evcon.CheckEventRecycleDropType(oWarrior, oEventCB, NWARRIOR_DROP_RELIC) and cl_evcon.GetFormula(oWarrior, oEventCB, (lambda *a: Func614(*a))) > 0 and cl_evcon.EventCBCheckAutoRecycle(oWarrior, oEventCB) == 0:
        ...
        cl_evact.EventCBAddSavedData(oWarrior, oEventCB, 'Count', 1, 0)
...
def DoCallBackAction2(oEventCB, oWarrior):
    cl_evact.PassiveSetStateCount(oWarrior, oEventCB, 1886, (lambda *a: min(100, (100 - min((Func222(*a) - Func575(*a) - Func210(*a)) * 10, 100)) + Func598(*a, **{
'sKey': 'Count' }) * 15)))
