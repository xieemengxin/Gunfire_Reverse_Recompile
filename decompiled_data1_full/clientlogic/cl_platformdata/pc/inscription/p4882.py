# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/inscription/p4882.pyc
# RelativePath: clientlogic/cl_platformdata/pc/inscription/p4882.pyc
# Source Generated with Decompyle++
# File: p4882.pyc (Python 3.6)
...
def DoCallBackAction0(oEventCB, oWarrior):
    if cl_evcon.PassiveCheckInColdTime(oWarrior, oEventCB, 1) and cl_evcon.CheckHitWeakness(oWarrior, oEventCB, None) and cl_evcon.CheckRandom(oWarrior, oEventCB, 100, 80):
        cl_evact.PassiveCBHitWeaknessUsePerform(oWarrior, oEventCB, 1641, 300)
