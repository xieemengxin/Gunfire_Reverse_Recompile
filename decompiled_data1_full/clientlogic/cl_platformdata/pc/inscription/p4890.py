# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/inscription/p4890.pyc
# RelativePath: clientlogic/cl_platformdata/pc/inscription/p4890.pyc
# Source Generated with Decompyle++
# File: p4890.pyc (Python 3.6)
...
def DoCallBackAction0(oEventCB, oWarrior):
    if cl_evcon.CheckHitWeakness(oWarrior, oEventCB, None):
        ...
        cl_evact.PassiveAddTargetState(oWarrior, oEventCB, 1216, 200, { }, 1, 1, None)
...
class CPerform(CCustomPerform):
    ...
    m_ElementType = None
    m_LimitList = ((), (), ())
    m_ExcludeList = ((9, 1, 23), (), (1504, 1306))
