# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/inscription/p4956.pyc
# RelativePath: clientlogic/cl_platformdata/pc/inscription/p4956.pyc
# Source Generated with Decompyle++
# File: p4956.pyc (Python 3.6)
...
def DoCallBackAction0(oEventCB, oWarrior):
    cl_evact.PassiveCBChangeSourceWeaponAttr(oWarrior, oEventCB, 'LuckyHit', 100, 0)
    cl_evact.EventGetTargetByType(oWarrior, oEventCB, OBJ_ATTACK)
    cl_evact.PassiveAddTargetState(oWarrior, oEventCB, 1281, 500, { }, 1, 0, None)
