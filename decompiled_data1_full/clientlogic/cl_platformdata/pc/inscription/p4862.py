# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/inscription/p4862.pyc
# RelativePath: clientlogic/cl_platformdata/pc/inscription/p4862.pyc
# Source Generated with Decompyle++
# File: p4862.pyc (Python 3.6)
...
def DoCallBackAction0(oEventCB, oWarrior):
    if cl_evcon.PassiveCheckFromSameItem(oWarrior, oEventCB) and cl_evcon.CheckHitWeakness(oWarrior, oEventCB, None):
        cl_evact.EventCBDropWeaponBullet(oWarrior, oEventCB, 100, None)
        cl_evact.EventGetTargetByType(oWarrior, oEventCB, OBJ_ATTACK)
        cl_evact.PassiveAddTargetState(oWarrior, oEventCB, 1770, 0, { }, 0, -1, None)
...
class CPerform(CCustomPerform):
    ...
    m_ElementType = None
    m_LimitList = ((), (), ())
    m_ExcludeList = ((12, 15, 16, 19, 1, 23), (), ())
