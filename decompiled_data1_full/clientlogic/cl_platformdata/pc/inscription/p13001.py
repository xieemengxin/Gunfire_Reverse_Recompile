# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/inscription/p13001.pyc
# RelativePath: clientlogic/cl_platformdata/pc/inscription/p13001.pyc
# Source Generated with Decompyle++
# File: p13001.pyc (Python 3.6)
...
def DoCallBackAction0(oEventCB, oWarrior):
    if cl_evcon.CheckSkillCollectInfo(oWarrior, oEventCB, 'p4871', None) >= 3:
        ...
        cl_evact.PassiveAddTargetState(oWarrior, oEventCB, 1768, 0, { }, 0, -1, None)
    else:
        cl_evact.EventGetTargetByType(oWarrior, oEventCB, OBJ_ATTACK)
        if cl_evcon.PassiveCBCheckTargetHasState(oWarrior, oEventCB, 1768, 1, 1, 0):
            cl_evact.PassiveCBRemoveTargetState(oWarrior, oEventCB, 1768, 0, None, None)
