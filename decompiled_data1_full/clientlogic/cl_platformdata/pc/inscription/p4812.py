# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/inscription/p4812.pyc
# RelativePath: clientlogic/cl_platformdata/pc/inscription/p4812.pyc
# Source Generated with Decompyle++
# File: p4812.pyc (Python 3.6)
...
def DoCallBackAction0(oEventCB, oWarrior):
    if cl_evcon.CheckRandom(oWarrior, oEventCB, 100, 30):
        cl_evact.PassiveFillBullet(oWarrior, oEventCB, (lambda *a: Func505(*a) * 50 / 100 + 0), 0)
...
class CPerform(CCustomPerform):
    ...
    m_ElementType = None
    m_LimitList = ((), (), ())
    m_ExcludeList = ((10, 14, 17, 18), (), (1416,))
