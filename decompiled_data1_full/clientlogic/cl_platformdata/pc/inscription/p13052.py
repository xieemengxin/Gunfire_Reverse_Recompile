# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/inscription/p13052.pyc
# RelativePath: clientlogic/cl_platformdata/pc/inscription/p13052.pyc
...
def DoCallBackAction0(oEventCB, oWarrior):
    ...
    if cl_evcon.CheckRandom(oWarrior, oEventCB, 100, (lambda *a: cl_evcon.GetFormula(oWarrior, oEventCB, Func505(*a)) / 2.5)):
        cl_evact.EventChangeDamFactor(oWarrior, oEventCB, OBJ_ATTACK, 0, (lambda *a: Func505(*a) * 100), DAM_TYPE_WEAPON, '')
