# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/inscription/p4931.pyc
# RelativePath: clientlogic/cl_platformdata/pc/inscription/p4931.pyc
# Source Generated with Decompyle++
# File: p4931.pyc (Python 3.6)
...
def DoCallBackAction0(oEventCB, oWarrior):
    ...
    if cl_evcon.CheckTargetInSkillCollect(oWarrior, oEventCB, 'hit4931'):
        cl_evact.PassiveCBChangeSourceWeaponAttr(oWarrior, oEventCB, 'CrazyEff', 15000, 0)
    else:
        cl_evact.EventCBRecordSkillCollectTarget(oWarrior, oEventCB, 'hit4931', None)
