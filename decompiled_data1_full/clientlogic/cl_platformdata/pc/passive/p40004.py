# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/passive/p40004.pyc
# RelativePath: clientlogic/cl_platformdata/pc/passive/p40004.pyc
# Source Generated with Decompyle++
# File: p40004.pyc (Python 3.6)
...
def DisableAction1(oWarrior, oLifeCycle):
    cl_action.CommonRemoveOwnerState(oWarrior, oLifeCycle, 32925, 0)
    cl_action.CommonRemoveOwnerState(oWarrior, oLifeCycle, 32924, 0)
...
def DoCallBackAction0(oEventCB, oWarrior):
    if not cl_evcon.CheckLevelType(oWarrior, oEventCB, LEVEL_TYPE_HALL) or cl_evcon.EventCBCheckLevelGoal(oWarrior, oEventCB):
        cl_action.PassiveAddState(oWarrior, oEventCB.GetCBLifeCycle(), 32925, 200, { }, 1)
...
def DoCallBackAction2(oEventCB, oWarrior):
    ...
    cl_action.CommonRemoveOwnerState(oWarrior, oEventCB.GetCBLifeCycle(), 32925, 0)
    cl_action.CommonRemoveOwnerState(oWarrior, oEventCB.GetCBLifeCycle(), 32924, 0)
