# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/passive/p40034.pyc
# RelativePath: clientlogic/cl_platformdata/pc/passive/p40034.pyc
    ...
    if cl_evcon.CheckEventLevelType(oWarrior, oEventCB, LEVEL_TYPE_FIGHT):
        ...
        if cl_evcon.EventCBCheckIsMonsterGroup(oWarrior, oEventCB, {
            ...
            if not cl_evcon.PassiveCBCheckTargetHasState(oWarrior, oEventCB, 32927, 0, 0, 0):
                cl_evact.PassiveAddTargetState(oWarrior, oEventCB, 32927, 0, { }, 0, 0, 0)
