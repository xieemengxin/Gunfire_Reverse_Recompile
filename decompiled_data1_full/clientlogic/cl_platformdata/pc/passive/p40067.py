# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/passive/p40067.pyc
# RelativePath: clientlogic/cl_platformdata/pc/passive/p40067.pyc
# Source Generated with Decompyle++
# File: p40067.pyc (Python 3.6)
...
def DoCallBackAction0(oEventCB, oWarrior):
    if cl_evcon.PassiveCBGetTaskSaveInfo(oWarrior, oEventCB, 'ChooseUpgradeInscription'):
        cl_action.CommonChangeWeaponExtGrade(oWarrior, oEventCB.GetCBLifeCycle(), EXTGRADE_GROUP2, -2, MAIN_HOLD, None)
...
def DoCallBackAction5(oEventCB, oWarrior):
    cl_evact.PassiveCBTaskTempDisableInscription(oWarrior, oEventCB, 1)
    cl_evact.EventCBChangeWeaponExtGrade(oWarrior, oEventCB, EXTGRADE_GROUP2, -2)
