# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/passive/p50711.pyc
# RelativePath: clientlogic/cl_platformdata/pc/passive/p50711.pyc
# Source Generated with Decompyle++
# File: p50711.pyc (Python 3.6)
...
def DoCallBackAction0(oEventCB, oWarrior):
    ...
    if cl_evcon.CheckSkillCollectInfo(oWarrior, oEventCB, 'CollectHitTarget', 1) == 0 and cl_evcon.PassiveCBGetPFArgs(oWarrior, oEventCB, 'Count') >= 3:
        ...
        cl_evact.PassiveCBOwnerUsePerform2EvtTarget(oWarrior, oEventCB, 8014, 1, { })
