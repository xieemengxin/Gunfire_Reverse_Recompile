# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/passive/p5302.pyc
# RelativePath: clientlogic/cl_platformdata/pc/passive/p5302.pyc
# Source Generated with Decompyle++
# File: p5302.pyc (Python 3.6)
...
def DoCallBackAction0(oEventCB, oWarrior):
    if cl_condition.CheckDualWeapon(oWarrior, oEventCB.GetCBLifeCycle()):
        cl_action.CommonShareMainPerformPFBullet(oWarrior, oEventCB.GetCBLifeCycle(), 9793)


def DoCallBackAction1(oEventCB, oWarrior):
    if cl_condition.CheckDualWeapon(oWarrior, oEventCB.GetCBLifeCycle()):
        cl_action.CommonDisableShareMainPerformPFBullet(oWarrior, oEventCB.GetCBLifeCycle(), 9793)
