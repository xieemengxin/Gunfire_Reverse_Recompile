# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/passive/p40001.pyc
# RelativePath: clientlogic/cl_platformdata/pc/passive/p40001.pyc
# Source Generated with Decompyle++
# File: p40001.pyc (Python 3.6)
...
def Action1(oWarrior, oLifeCycle):
    cl_action.PassiveSetTaskSaveInfo(oWarrior, oLifeCycle, 'Shield', 1000)
    cl_action.PassiveSetTaskSaveInfo(oWarrior, oLifeCycle, 'HP', 1000)
    ...
    if not cl_evcon.PassiveCheckInColdTime(oWarrior, oEventCB, 1):
        ...
        if cl_evcon.CheckFightType(oWarrior, oEventCB, WARRIOR_MONSTER) and cl_evcon.CheckTargetDist(oWarrior, oEventCB, 10, 0, None) and cl_evcon.CheckSrcDamType(oWarrior, oEventCB, DAM_TYPE_PERSISTENCE) == 0:
            if cl_evcon.PassiveCBGetTaskSaveInfo(oWarrior, oEventCB, 'Shield') > 0:
                cl_action.PassiveAddTaskSaveInfo(oWarrior, oEventCB.GetCBLifeCycle(), 'Shield', -100)
                ...
                cl_action.PassiveAddTaskSaveInfo(oWarrior, oEventCB.GetCBLifeCycle(), 'HP', -100)
