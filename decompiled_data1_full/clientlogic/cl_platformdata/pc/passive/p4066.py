# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/passive/p4066.pyc
# RelativePath: clientlogic/cl_platformdata/pc/passive/p4066.pyc
# Source Generated with Decompyle++
# File: p4066.pyc (Python 3.6)
...
def DoCallBackAction0(oEventCB, oWarrior):
    cl_evact.PassiveCBAddState(oWarrior, oEventCB, 7917, 100, { }, 1, None, None)
    if cl_evcon.GetVictimHPRatio(oWarrior, oEventCB) <= 50:
        cl_evact.PassiveCBAddState(oWarrior, oEventCB, 7919, 0, { }, 0, None, None)
    else:
        cl_evact.PassiveCBAddState(oWarrior, oEventCB, 7918, 0, { }, 1, None, None)
