# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/passive/p4149.pyc
# RelativePath: clientlogic/cl_platformdata/pc/passive/p4149.pyc
# Source Generated with Decompyle++
# File: p4149.pyc (Python 3.6)
...
def DoCallBackAction0(oEventCB, oWarrior):
    if cl_evcon.GetLiveMonsterPer(oWarrior, oEventCB) >= 7500:
        ...
        cl_evact.PassiveChangeAttr(oWarrior, oEventCB, 'HPMax', 0, 3000)
        cl_action.CommonChangeBaseDamRatio(oWarrior, oEventCB.GetCBLifeCycle(), 0, 2000, 0, 1)
