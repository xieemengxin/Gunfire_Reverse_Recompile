# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/passive/p4286.pyc
# RelativePath: clientlogic/cl_platformdata/pc/passive/p4286.pyc
# Source Generated with Decompyle++
# File: p4286.pyc (Python 3.6)
...
def DoCallBackAction0(oEventCB, oWarrior):
    if not cl_evcon.CheckFromPointPerform(oWarrior, oEventCB, 4286, 0, 1):
        cl_evact.PassiveCBAddState(oWarrior, oEventCB, 8056, 605, { }, 1, 1, None)
        cl_evact.EventChangeDamFactor(oWarrior, oEventCB, OBJ_ATTACK, 0, -6000, 0, '')


def DoCallBackAction1(oEventCB, oWarrior):
    cl_evact.EventGetTargetByType(oWarrior, oEventCB, OBJ_SELF)
    cl_evact.PassiveCBRemoveTargetState(oWarrior, oEventCB, 8056, 1, None, None)


def DoCallBackAction2(oEventCB, oWarrior):
    CustomAction(oWarrior, oEventCB, {
        'DamReduce': -6000,
        'StoreRemainKey': 'p4286-remain',
        'StoreTotalKey': 'p4286-total',
        'StateSID': 8056,
        'MaxDam': 0x30E4F9B400 })
