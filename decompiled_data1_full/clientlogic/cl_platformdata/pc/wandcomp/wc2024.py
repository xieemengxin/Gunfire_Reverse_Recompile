# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/wandcomp/wc2024.pyc
# RelativePath: clientlogic/cl_platformdata/pc/wandcomp/wc2024.pyc
# Source Generated with Decompyle++
# File: wc2024.pyc (Python 3.6)
...
def TriggerAction1(oWarrior, oLifeCycle):
    cl_action.WandCompAddOwnerState(oWarrior, oLifeCycle, 33553, 0, {
        'StatusEffect': (lambda *a: 1 + Func361(*a, **{
'sid': 51206,
'sArgs': 'ExtraThrowNum' })) }, 1)


def TriggerAction2(oWarrior, oLifeCycle):
    cl_action.WandCompAddOwnerState(oWarrior, oLifeCycle, 33553, 0, {
        'StatusEffect': (lambda *a: 2 + Func361(*a, **{
'sid': 51206,
'sArgs': 'ExtraThrowNum' })) }, 1)
...
def TriggerAction3(oWarrior, oLifeCycle):
    cl_action.WandCompAddOwnerState(oWarrior, oLifeCycle, 33553, 0, {
        'StatusEffect': (lambda *a: 3 + Func361(*a, **{
'sid': 51206,
'sArgs': 'ExtraThrowNum' })) }, 1)
