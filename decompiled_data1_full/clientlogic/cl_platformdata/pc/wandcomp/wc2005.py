# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/wandcomp/wc2005.pyc
# RelativePath: clientlogic/cl_platformdata/pc/wandcomp/wc2005.pyc
# Source Generated with Decompyle++
# File: wc2005.pyc (Python 3.6)
...
def TriggerAction1(oWarrior, oLifeCycle):
    cl_action.WandCompAddOwnerState(oWarrior, oLifeCycle, 33540, (lambda *a: 500 + Func780(*a, **{
'sKey': 'AbilityAddLast' })), { }, 0)
    cl_action.CommonAddStateCount(oWarrior, oLifeCycle, 33540, 3, (lambda *a: 500 + Func780(*a, **{
'sKey': 'AbilityAddLast' })))
...
def TriggerAction2(oWarrior, oLifeCycle):
    cl_action.WandCompAddOwnerState(oWarrior, oLifeCycle, 33540, (lambda *a: 500 + Func780(*a, **{
'sKey': 'AbilityAddLast' })), { }, 0)
    cl_action.CommonAddStateCount(oWarrior, oLifeCycle, 33540, 6, (lambda *a: 500 + Func780(*a, **{
'sKey': 'AbilityAddLast' })))
    cl_action.WandActCompTrigger(oWarrior, oLifeCycle, 1, 1, (lambda *a: 500 + Func780(*a, **{
'sKey': 'AbilityAddLast' })))
...
def TriggerAction3(oWarrior, oLifeCycle):
    cl_action.WandCompAddOwnerState(oWarrior, oLifeCycle, 33540, (lambda *a: 500 + Func780(*a, **{
'sKey': 'AbilityAddLast' })), { }, 0)
    cl_action.CommonAddStateCount(oWarrior, oLifeCycle, 33540, 10, (lambda *a: 500 + Func780(*a, **{
'sKey': 'AbilityAddLast' })))
    cl_action.WandActCompTrigger(oWarrior, oLifeCycle, 1, 1, (lambda *a: 500 + Func780(*a, **{
'sKey': 'AbilityAddLast' })))
