# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/wandcomp/wc1018.pyc
# RelativePath: clientlogic/cl_platformdata/pc/wandcomp/wc1018.pyc
# Source Generated with Decompyle++
# File: wc1018.pyc (Python 3.6)
...
from cl_newformula import Func208, Func215, Func517, Func533, Func742, Func749, Func758, Func777
...
def DoCallBackAction0(oEventCB, oWarrior):
    ...
    cl_action.WandConditionCompSetFinishCount(oWarrior, oEventCB.GetCBLifeCycle(), (lambda *a: max(1, Func517(*a) * (5 - Func749(*a)))))
    cl_action.WandCompSetKeepValue(oWarrior, oEventCB.GetCBLifeCycle(), 'LastMaxBullet', (lambda *a: max(1, Func517(*a) * (5 - Func749(*a)))))
...
'sAttr': 'DeputyHoldMaxBullet' }))))
            if cl_condition.WandCompGetArgValue(oWarrior, oEventCB.GetCBLifeCycle(), 'FinishNum') >= cl_evcon.GetFormula(oWarrior, oEventCB, (lambda *a: (5 - Func749(*a)) * 100)):
