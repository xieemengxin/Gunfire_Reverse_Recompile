# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/wandcomp/wc2118.pyc
# RelativePath: clientlogic/cl_platformdata/pc/wandcomp/wc2118.pyc
# Source Generated with Decompyle++
# File: wc2118.pyc (Python 3.6)
...
def TriggerAction2(oWarrior, oLifeCycle):
    cl_action.WandCompAddOwnerState(oWarrior, oLifeCycle, 33609, (lambda *a: 300 + Func780(*a, **{
'sKey': 'AbilityAddLast' })), {
        'StatusEffect': 2 }, 1)
...
def TriggerAction3(oWarrior, oLifeCycle):
    cl_action.WandCompAddOwnerState(oWarrior, oLifeCycle, 33609, (lambda *a: 500 + Func780(*a, **{
'sKey': 'AbilityAddLast' })), {
        'StatusEffect': 3 }, 1)
