# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/careerpf/p7153.pyc
# RelativePath: clientlogic/cl_platformdata/pc/careerpf/p7153.pyc
...
class CCartoon3(TimerCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, 4 if cl_action.CheckHasState(skill, 33944) else 4 if int(8600 / cl_action.GetSkillCacheData(skill, SKILLCACHE_INT)) < 4 else int(8600 / cl_action.GetSkillCacheData(skill, SKILLCACHE_INT)), 1)
