# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/careerpf/p1303.pyc
# RelativePath: clientlogic/cl_platformdata/pc/careerpf/p1303.pyc
...
class CCartoon1(WinkPosCartoon):
    ...
    def Hit(cls, skill):
        ...
        cl_action.PushVictim(skill, cl_action.GetEndPositionInCrt(skill, 1), 20, 4, 10000, angle = 45 if cl_action.CheckHasTalent(skill, 2215) else 0)
