# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/careerpf/p7171.pyc
# RelativePath: clientlogic/cl_platformdata/pc/careerpf/p7171.pyc
# Source Generated with Decompyle++
# File: p7171.pyc (Python 3.6)
...
from cl_commondefines import ATT_SHAPE_CYLINDER, CRT_CHECK_SERVER, CRT_EXTCHECK_NONE, OBJ_ENEMY, SKILLCACHE_LSTINT, SKILLCACHE_SIGNSPEED
...
class CCartoon1(DirectPosCartoon):
    ...
    def Active(cls, skill):
        ...
        cl_action.StartBackSwing(skill, 4 if int(6700 / cl_action.GetSkillCacheData(skill, SKILLCACHE_LSTINT)[0]) < 4 else int(6700 / cl_action.GetSkillCacheData(skill, SKILLCACHE_LSTINT)[0]))
...
class CCartoon5(TimerCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, 4 if int(3300 / cl_action.GetSkillCacheData(skill, SKILLCACHE_LSTINT)[0]) < 4 else int(3300 / cl_action.GetSkillCacheData(skill, SKILLCACHE_LSTINT)[0]), 1)
