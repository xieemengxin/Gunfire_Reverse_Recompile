# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/careerpf/p1305.pyc
# RelativePath: clientlogic/cl_platformdata/pc/careerpf/p1305.pyc
# Source Generated with Decompyle++
# File: p1305.pyc (Python 3.6)
...
class CCartoon0(TimerCartoon):
    ...
    def Trigger(cls, skill):
        cl_action.AttackerAddState(skill, 32006, skill.m_Cache['AddStateTime'], 0, {
            'TransDamFactor': cl_action.GetTransDamFactor(skill) })
        cl_action.AttackerAddState(skill, 32306, 0, 0, { })
