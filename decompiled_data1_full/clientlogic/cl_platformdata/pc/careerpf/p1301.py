# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/careerpf/p1301.pyc
# RelativePath: clientlogic/cl_platformdata/pc/careerpf/p1301.pyc
...
from cl_item.defines import DEPUTY_HOLD
...
class CPerform(CCustomPerform):
    ...
    def UsePerform(self, oWarrior, oSkill):
        ...
        if oSkill.m_CheckType == CRT_CHECK_SERVER and oWarrior.m_Agent:
            oAgent = oWarrior.m_Agent
            oAgent.StartDelayAttack(DEPUTY_HOLD)
