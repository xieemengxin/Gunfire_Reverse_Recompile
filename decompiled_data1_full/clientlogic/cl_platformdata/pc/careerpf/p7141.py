# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/careerpf/p7141.pyc
# RelativePath: clientlogic/cl_platformdata/pc/careerpf/p7141.pyc
...
from cl_commondefines import ATT_SHAPE_SECTOR, CRT_CHECK_SERVER, OBJ_ENEMY, SKILLCACHE_INT, SKILLCACHE_LSTINT, SKILLCACHE_LSTINTSPECIAL, SKILLCACHE_RANDOM
...
class CCartoon5(DelegateDirectPosCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_math.Vec3Add(cl_action.CrtArgSelfPos(skill), (0, -1, 0)), cl_action.CrtArgSkillEndPos(skill), [
                cl_action.GetSkillCacheData(skill, SKILLCACHE_LSTINT)[0],
                (cl_action.GetSkillCacheData(skill, SKILLCACHE_LSTINT)[0] / cl_action.GetSkillCacheData(skill, SKILLCACHE_LSTINTSPECIAL)[0]) * 5.5,
