# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/careerpf/p7168.pyc
# RelativePath: clientlogic/cl_platformdata/pc/careerpf/p7168.pyc
# Source Generated with Decompyle++
# File: p7168.pyc (Python 3.6)
...
from cl_commondefines import CRT_CHECK_SERVER, OBJ_ENEMY, SKILLCACHE_INT, SKILLCACHE_LSTINT, SKILLCACHE_SIGNSPEED

class CCartoon0(CurveCartoon):
    m_SID = 0
    
    def Active(cls, skill):
        cl_action.SendCurCartoonTriggerMsg(skill, sSubMsgKey = 'default')
    ...
    def End(cls, skill):
        cl_action.SendCurCartoonTriggerMsg(skill, sSubMsgKey = 'SKILL7168')
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0, 0.6, -0.5)), cl_action.CrtArgBodyPos(skill, 0, 0, 0, 0), 1, cl_action.GetSkillCacheData(skill, SKILLCACHE_SIGNSPEED), 25, 330, 0.7, targettype = OBJ_ENEMY, pierceblock = True, liveTime = 0, hittarger = False, iVictim = 0, lockPos = (0, 0, 0), bLockDeadPos = False)
