# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/throw/p8009.pyc
# RelativePath: clientlogic/cl_platformdata/pc/throw/p8009.pyc
...
class CCartoon0(DelegateDirectPosCartoon):
    ...
    def End(cls, skill):
        cl_action.UseExtraThrowPerform(skill, {
            'vEnd': cl_action.GetStartPositionInCrt(skill, 0),
            'DirectPos': 1 }, 30, 0)
        ...
        if cl_action.CheckVictimType(skill, WARRIOR_SERVANT, OBJ_ALL):
            if cl_action.GetTalentLevel(skill, 3318) == 0:
                ...
                cl_action.PerformDamage(skill, {
                    'Att': skill.m_Cache['Att'] * cl_action.GetSkillCustomData(skill, 'DamMul', defaultValue = 1) })
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_math.Vec3Add(cl_action.CrtArgCustomPos(skill, cartoon), (0, 0.2, 0)), (0, 0, 0), [
                skill.m_Cache['Radius']], attshape = ATT_SHAPE_SPHERE, targettype = OBJ_ALLNOSELF, pierceStatic = False, explosion = True, useclientpos = False)
