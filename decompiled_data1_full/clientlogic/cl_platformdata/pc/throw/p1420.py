# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/throw/p1420.pyc
# RelativePath: clientlogic/cl_platformdata/pc/throw/p1420.pyc
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if not skill.m_CheckType == CRT_CHECK_SERVER:
            ...
            cls.EnableCtrl(skill, cl_action.GetCameraCenterPosition(skill, cartoon), cl_action.GetSceneCenterPosition(skill, cartoon), [
                skill.m_Cache['Radius'],
                2,
                45], attshape = ATT_SHAPE_SECTOR, targettype = OBJ_ENEMY, pierceStatic = False, explosion = False, extCheck = CRT_EXTCHECK_NONE, multipleExplode = True, explosionDelay = 10)
...
class CCartoon20(TimerCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        ...
        elif cl_action.GetPerformMode(skill) // 8 < 5:
            pass
        
        skill(cl_action.ToInt, skill(cl_action.GetPerformMode(skill) // 8, 9 if (12 if (4 if 4 == 1 else cl_action.GetPerformMode(skill) // 8 if cl_action.GetPerformMode(skill) // 8 < 5 else 4) == 2 else cl_action.GetPerformMode(skill) // 8 if cl_action.GetPerformMode(skill) // 8 < 5 else 4) == 3 else 6), cl_action.ToInt(skill, (cl_action.GetPerformMode(skill) // 8 if cl_action.GetPerformMode(skill) // 8 < 5 else 4) - 1))
...
class CCartoon18(TimerCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        ...
        skill(cl_action.ToInt, skill(cl_action.GetPerformMode(skill) // 8, 14 if (17 if (20 if 4 == 1 else cl_action.GetPerformMode(skill) // 8 if cl_action.GetPerformMode(skill) // 8 < 5 else 4) == 2 else cl_action.GetPerformMode(skill) // 8 if cl_action.GetPerformMode(skill) // 8 < 5 else 4) == 3 else 10), 1)
...
class CCartoon21(TimerCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        ...
        skill(cl_action.ToInt, skill(cl_action.GetPerformMode(skill) // 8, 30 if (35 if 4 == 2 else cl_action.GetPerformMode(skill) // 8 if cl_action.GetPerformMode(skill) // 8 < 5 else 4) == 3 else 22), cl_action.ToInt(skill, (cl_action.GetPerformMode(skill) // 8 if cl_action.GetPerformMode(skill) // 8 < 5 else 4) - 2))
...
class CCartoon14(TimerCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        ...
        skill(cl_action.ToInt, skill(cl_action.GetPerformMode(skill) // 8, 10 if (15 if 4 == 2 else cl_action.GetPerformMode(skill) // 8 if cl_action.GetPerformMode(skill) // 8 < 5 else 4) == 3 else 5), 1)
...
class CCartoon22(TimerCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        ...
        skill(cl_action.ToInt, skill(cl_action.GetPerformMode(skill) // 8, 12 if (16 if 4 == 2 else cl_action.GetPerformMode(skill) // 8 if cl_action.GetPerformMode(skill) // 8 < 5 else 4) == 3 else 8), cl_action.ToInt(skill, (cl_action.GetPerformMode(skill) // 8 if cl_action.GetPerformMode(skill) // 8 < 5 else 4) * 2 - 3))
...
class CCartoon6(TimerCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        ...
        skill(cl_action.ToInt, skill(cl_action.GetPerformMode(skill) // 8, (4 * -3 + 68) / 2), 1)
...
class CCartoon25(TimerCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        ...
        skill(cl_action.GetPerformMode(skill) // 8, 55(cl_action.ToInt, (skill if 4 == 0 else cl_action.GetPerformMode(skill) // 8 if cl_action.GetPerformMode(skill) // 8 < 5 else 4) * -3 + 68), 1)
