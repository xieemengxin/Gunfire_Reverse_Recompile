# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/summonconfig/c1029.pyc
# RelativePath: clientlogic/cl_platformdata/pc/summonconfig/c1029.pyc
...
class CSummonData(summonconfigdata.CSummonData):
    ...
    m_BaseAttr = {
        ...
        'MoveSpeed': (lambda *a: (Func205(*a) - 1) * 50 + 550),
        'AttSpeed': 0,
        'Toughness': 0,
        'TurnSpeed': 0,
