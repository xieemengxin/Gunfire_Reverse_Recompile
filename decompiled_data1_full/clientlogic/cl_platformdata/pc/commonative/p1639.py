# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/commonative/p1639.pyc
# RelativePath: clientlogic/cl_platformdata/pc/commonative/p1639.pyc
...
class CCartoon0(FlyLinePathCartoon):
    ...
    def Hit(cls, skill):
        if cl_action.CheckVictimType(skill, WARRIOR_HERO, OBJ_ALL):
            cl_action.PushHeroVictim(skill, cl_action.GetEndPositionInCrt(skill, 0), 10, 3, 10000, downSpeed = 0, fGravaty = 9.8, angle = 0)
