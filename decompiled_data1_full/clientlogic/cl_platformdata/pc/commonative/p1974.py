# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/commonative/p1974.pyc
# RelativePath: clientlogic/cl_platformdata/pc/commonative/p1974.pyc
...
class CCartoon4(DirectPosCartoon):
    ...
    def Hit(cls, skill):
        cl_action.VictimAddState(skill, 33395, cl_action.GetSkillCustomData(skill, 'StateTime', defaultValue = 0), 0, {
            'StateCount': cl_action.GetSkillCustomData(skill, 'fragile', defaultValue = 0) })
