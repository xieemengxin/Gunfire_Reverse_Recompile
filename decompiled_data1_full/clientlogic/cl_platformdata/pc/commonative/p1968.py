# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/commonative/p1968.pyc
# RelativePath: clientlogic/cl_platformdata/pc/commonative/p1968.pyc
...
class CCartoon0(TimerCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, 8, cl_action.GetSkillCustomData(skill, 'TriggerCnt', defaultValue = 0))
