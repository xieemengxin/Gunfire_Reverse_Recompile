# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/commonative/p1641.pyc
# RelativePath: clientlogic/cl_platformdata/pc/commonative/p1641.pyc
...
class CCartoon4(SpecifySpeedBulletCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.SkillStartPos(skill), (0, 2.5, 0), 0.5, 80, False, False, 0, 0, None, 0, targettype = OBJ_ENEMY)
