# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/commonative/p1642.pyc
# RelativePath: clientlogic/cl_platformdata/pc/commonative/p1642.pyc
...
class CCartoon1(CurveCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.GetStartPositionInCrt(skill, 0), cl_action.CrtArgTargetPos(skill), 1, 100, 6, 180, 0.5, targettype = OBJ_ENEMY, pierceblock = False, effect = 0, liveTime = 0, trailEffect = None, effectLiveTime = 0)
...
class CCartoon2(SpecifySpeedBulletCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.GetEndPositionInCrt(skill, 4), (0, -8, 0), 0.3, 1000, True, True, 0, 0, None, 0, targettype = OBJ_ENEMY)
