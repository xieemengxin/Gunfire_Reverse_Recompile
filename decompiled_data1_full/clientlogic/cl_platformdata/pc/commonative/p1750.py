# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/commonative/p1750.pyc
# RelativePath: clientlogic/cl_platformdata/pc/commonative/p1750.pyc
# Source Generated with Decompyle++
# File: p1750.pyc (Python 3.6)
...
from cl_commondefines import ATT_SHAPE_SPHERE, CRT_CHECK_SERVER, CRT_EXTCHECK_NONE, OBJ_ENEMY, S6_DICE_DAMAGE, SKILLCACHE_INT, SKILLCACHE_LSTINT
...
class CCartoon0(TimerCartoon):
    ...
    def Trigger(cls, skill):
        cl_action.SendCurCartoonTriggerMsg(skill, dInfo = {
            ...
            'Att': cl_action.GetSkillCustomData(skill, 'Att', defaultValue = 0) }, sSubMsgKey = '')
        cartoon = { }
...
def Action(skill):
    ...
    cl_action.SetSkillServerCache(skill, 'ExShowTips', [
        S6_DICE_DAMAGE][0])
    cl_action.SetSkillCacheData(skill, SKILLCACHE_INT, cl_action.GetSkillCustomData(skill, 'Cnt', defaultValue = 2))
    ...
    if not len(cl_action.GetSkillCacheData(skill, SKILLCACHE_LSTINT)) == 0:
        ...
        if len(cl_action.GetSkillVarCache(skill, 'TempTargetList')) < cl_action.GetSkillCacheData(skill, SKILLCACHE_INT):
            for i1 in range(0, cl_action.GetSkillCacheData(skill, SKILLCACHE_INT) - len(cl_action.GetSkillVarCache(skill, 'TempTargetList')), 1):
