# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/commonative/p1690.pyc
# RelativePath: clientlogic/cl_platformdata/pc/commonative/p1690.pyc
...
class CCartoon1(CurveCartoon):
    ...
    def Hit(cls, skill):
        ...
        skill(cl_action.GetStartPositionInCrt(skill, 1), {
            cl_action.GetSkillCustomData(skill, 'PerformAtt'): cl_action.GetSkillCustomData(skill, 'PerformAtt')(30000, 10000, 30000, 10000, 50, 10) })
