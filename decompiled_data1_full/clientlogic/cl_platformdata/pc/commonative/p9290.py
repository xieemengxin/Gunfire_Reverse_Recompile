# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/commonative/p9290.pyc
# RelativePath: clientlogic/cl_platformdata/pc/commonative/p9290.pyc
...
class CCartoon4(FlySwordCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if not skill.m_CheckType == CRT_CHECK_SERVER:
            if not cls.EnableCheck(skill, start = cl_math.Vec3Add(cl_action.GetCameraCenterPosition(skill, cartoon), cl_action.CrtArgToCameraRotation(skill, (0.5, 0, 0)))):
                return None
