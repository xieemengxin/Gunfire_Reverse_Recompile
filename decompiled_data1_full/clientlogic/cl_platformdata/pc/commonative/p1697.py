# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/commonative/p1697.pyc
# RelativePath: clientlogic/cl_platformdata/pc/commonative/p1697.pyc
...
class CCartoon1(DirectPosCartoon):
    ...
    def Hit(cls, skill):
        if cl_action.CheckVictimSide(skill, WARRIOR_SUMMON, SIDE_TYPE_HERO):
            ...
            cl_action.PushHeroVictim(skill, cl_action.GetEndPositionInCrt(skill, 1), 20, 4, 10000, downSpeed = 0, fGravaty = 9.8, angle = 0)
            cl_action.VictimAddState(skill, 20038, 100, 0, { })
        else:
