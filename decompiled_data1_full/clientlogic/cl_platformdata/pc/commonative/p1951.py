# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/commonative/p1951.pyc
# RelativePath: clientlogic/cl_platformdata/pc/commonative/p1951.pyc
# Source Generated with Decompyle++
# File: p1951.pyc (Python 3.6)
...
class CCartoon1(TimerCartoon):
    ...
    def Trigger(cls, skill):
        cl_action.SetSkillServerCache(skill, 'PerformNextPos', cl_action.RefreshStepPerformNextPos(skill, cl_action.GetGroundPos(skill, cl_action.CrtArgWarriorPos(skill, cl_action.GetSkillAID(skill))), cl_action.GetSkillVarCache(skill, 'PerformLastPos'), 3.8, 0.4, 300))
        cl_action.GetSkillCacheData(skill, SKILLCACHE_LSTPOS).append(cl_action.GetSkillServerCache(skill, 'PerformNextPos'))
        cl_action.SetSkillCacheData(skill, SKILLCACHE_INT, 0 if cl_action.CheckVectorIsZero(skill, cl_action.GetSkillServerCache(skill, 'PerformNextPos')) else 1)
