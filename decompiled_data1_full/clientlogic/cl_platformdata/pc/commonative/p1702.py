# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/commonative/p1702.pyc
# RelativePath: clientlogic/cl_platformdata/pc/commonative/p1702.pyc
# Source Generated with Decompyle++
# File: p1702.pyc (Python 3.6)
    ...
    def Hit(cls, skill):
        if cl_action.CheckVictimType(skill, WARRIOR_MONSTER, OBJ_ALL):
            cl_action.PerformDamage(skill, {
                'Att': cl_action.GetSkillCustomData(skill, 'PerformAtt', defaultValue = 0) })
