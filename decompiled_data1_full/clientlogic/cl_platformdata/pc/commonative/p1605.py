# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/commonative/p1605.pyc
# RelativePath: clientlogic/cl_platformdata/pc/commonative/p1605.pyc
...
from cl_commondefines import ATT_SHAPE_SPHERE, CRT_CHECK_SERVER, CRT_EXTCHECK_NONE, OBJ_ALLNOSELF, SIDE_TYPE_HERO, WARRIOR_HERO, WARRIOR_PET, WARRIOR_SERVANT, WARRIOR_SUMMON
...
class CCartoon1(DirectPosCartoon):
    ...
    def Hit(cls, skill):
        ...
        if cl_action.CheckVictimSide(skill, WARRIOR_SUMMON, SIDE_TYPE_HERO):
            ...
            cl_action.PushHeroVictim(skill, cl_action.GetEndPositionInCrt(skill, 1), 10, 4, 10000, downSpeed = 0, fGravaty = 9.8, angle = 0)
            cl_action.PerformDamage(skill, {
                'Att': 5000 })
        else:
            cl_action.PushVictim(skill, cl_action.GetEndPositionInCrt(skill, 1), 20, 8, 10000, angle = 0, iCartoonSID = -1, iIgnoreStruckCD = 0, iClient = 0)
            cl_action.PerformDamage(skill, {
