# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/deviceactive/p50300.pyc
# RelativePath: clientlogic/cl_platformdata/pc/deviceactive/p50300.pyc
# Source Generated with Decompyle++
# File: p50300.pyc (Python 3.6)
...
class CCartoon0(CheckTeammateRaycastCartoon):
    ...
    def Hit(cls, skill):
        cl_action.ArrangeDevice(skill, cl_action.GetCartoonHitFirstTargetPos(skill, 0), cl_action.GetCartoonFirstHitVectorNormal(skill, 0), { }, 1)
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if not skill.m_CheckType == CRT_CHECK_SERVER:
            if not cls.EnableCheck(skill, start = cl_action.GetCameraCenterPosition(skill, cartoon)):
                return None
            cls.EnableShow(skill, 1, 75, 500, liveTime = 0, radius = 0.3, flyoverdis = 0)
