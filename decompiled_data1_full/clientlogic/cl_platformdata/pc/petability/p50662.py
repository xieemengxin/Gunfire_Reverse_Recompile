# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/petability/p50662.pyc
# RelativePath: clientlogic/cl_platformdata/pc/petability/p50662.pyc
# Source Generated with Decompyle++
# File: p50662.pyc (Python 3.6)
...
def DoCallBackAction0(oEventCB, oWarrior):
    if cl_evcon.EventCBCheckAssistKill(oWarrior, oEventCB):
        ...
        if cl_evcon.PassiveCBGetPFArgs(oWarrior, oEventCB, 'killnum') >= 1:
