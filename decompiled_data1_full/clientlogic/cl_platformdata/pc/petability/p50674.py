# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/petability/p50674.pyc
# RelativePath: clientlogic/cl_platformdata/pc/petability/p50674.pyc
# Source Generated with Decompyle++
# File: p50674.pyc (Python 3.6)
...
def DoCallBackAction0(oEventCB, oWarrior):
    if cl_evcon.CheckHitWeakness(oWarrior, oEventCB, 0):
        if cl_evcon.GetFormula(oWarrior, oEventCB, (0, None, ((304, 'HP'), (lambda a0: a0 + 300)))) > oWarrior.QueryAttr('HPMax'):
            ...
            cl_evact.EventCBAddTargetStateCount(oWarrior, oEventCB, 33213, (0, None, ((304, 'HPMax'), (304, 'HP'), (lambda a0, a1: 300 - a0 - a1))), 1, 0, 300)
