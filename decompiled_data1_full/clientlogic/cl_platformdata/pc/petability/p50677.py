# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/petability/p50677.pyc
# RelativePath: clientlogic/cl_platformdata/pc/petability/p50677.pyc
# Source Generated with Decompyle++
# File: p50677.pyc (Python 3.6)
...
def DoCallBackAction1(oEventCB, oWarrior):
    if not cl_evcon.CheckDamFromSelf(oWarrior, oEventCB):
        cl_evact.EventCBHaltFlow(oWarrior, oEventCB)


def DoCallBackAction2(oEventCB, oWarrior):
    cl_action.SwitchOwnerPhyAble(oWarrior, oEventCB.GetCBLifeCycle(), 0)
    cl_action.CommonTriggerClientBehavior(oWarrior, oEventCB.GetCBLifeCycle(), 50548, 3)
