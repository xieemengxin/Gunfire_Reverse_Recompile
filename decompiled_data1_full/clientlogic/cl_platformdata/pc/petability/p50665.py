# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/petability/p50665.pyc
# RelativePath: clientlogic/cl_platformdata/pc/petability/p50665.pyc
# Source Generated with Decompyle++
# File: p50665.pyc (Python 3.6)
...
def DoCallBackAction1(oEventCB, oWarrior):
    ...
    if oEventCB.GetCBLifeCycle().m_Owner.GetArgValue('TotalReceiveHPDam') >= 5000:
        ...
        cl_evact.PassiveCBSetPFArgs(oWarrior, oEventCB, 'CountNum', cl_evcon.PassiveCBGetPFArgs(oWarrior, oEventCB, 'TotalReceiveHPDam') // 5000)
        cl_evact.PassiveCBAddPFArgs(oWarrior, oEventCB, 'TotalReceiveHPDam', -5000)
