# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/petability/p50551.pyc
# RelativePath: clientlogic/cl_platformdata/pc/petability/p50551.pyc
# Source Generated with Decompyle++
# File: p50551.pyc (Python 3.6)
...
def DoCallBackAction0(oEventCB, oWarrior):
    if cl_evcon.CheckOwnerWeaponElementTypeByHoldType(oWarrior, oEventCB, MAIN_HOLD, DAM_TYPE_NORMAL):
        ...
        cl_evact.PassiveAddTargetState(oWarrior, oEventCB, 33264, 0, { }, 1, 0, None)
...
def DoCallBackAction3(oEventCB, oWarrior):
    if cl_evcon.EventCBCheckWeaponElementType(oWarrior, oEventCB, 'ST33264', MAIN_HOLD, DAM_TYPE_NORMAL):
        cl_evact.EventCBGetTargetByBelongs(oWarrior, oEventCB)
        cl_evact.PassiveAddTargetState(oWarrior, oEventCB, 33264, 0, { }, 1, 0, None)
