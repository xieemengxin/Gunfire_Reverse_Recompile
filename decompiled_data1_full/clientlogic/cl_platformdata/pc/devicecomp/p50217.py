# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/devicecomp/p50217.pyc
# RelativePath: clientlogic/cl_platformdata/pc/devicecomp/p50217.pyc
# Source Generated with Decompyle++
# File: p50217.pyc (Python 3.6)
...
def Action1(oWarrior, oLifeCycle):
    ...
    cl_action.CommonAddPerform(oWarrior, oLifeCycle, 12027)
    cl_action.CommonAddPerform(oWarrior, oLifeCycle, 8014)


def DoCallBackAction0(oEventCB, oWarrior):
    if cl_evcon.CheckFromPointPerform(oWarrior, oEventCB, 1427, 1, 0):
        if cl_condition.CheckDeciveStatus(oWarrior, oEventCB.GetCBLifeCycle(), 0, 1):
            cl_evact.EventCBStartClientSkill(oWarrior, oEventCB, 12027, '', 0, None, { })
