# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/pet/pet2281.pyc
# RelativePath: clientlogic/cl_platformdata/pc/pet/pet2281.pyc
# Source Generated with Decompyle++
# File: pet2281.pyc (Python 3.6)
...
class CPetData(CCustom):
    m_SID = 2281
    m_MonsterDataSID = 2281
    m_Name = '河童'
    m_PetType = PET_TYPE_WIZARD
    m_Quality = PET_QUALITY_NORMAL
    m_AttPerform = 7336
    m_PerformList = (50701, 50714, 50719, 50721)
    m_AbilityGroup = (1018,)
    m_RunSpeedUpMul = 0
