# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/pet/pet2221.pyc
# RelativePath: clientlogic/cl_platformdata/pc/pet/pet2221.pyc
# Source Generated with Decompyle++
# File: pet2221.pyc (Python 3.6)

from cl_commondefines import PET_QUALITY_NORMAL, PET_TYPE_WARRIOR, WARRIOR_ELITE, WARRIOR_SUMMON_STELE
from cl_newformula import Func204, Func221
from cl_resmgr.resdata import CPetData as CCustom

class CPetData(CCustom):
    m_SID = 2221
    m_MonsterDataSID = 2221
    m_Name = '魔化 硝石勇士'
    m_PetType = PET_TYPE_WARRIOR
    m_Quality = PET_QUALITY_NORMAL
    m_AttPerform = 7304
    m_PerformList = (50701, 50714, 50715, 50718, 50721)
    m_AbilityGroup = (1017,)
    m_RunSpeedUpMul = 0
