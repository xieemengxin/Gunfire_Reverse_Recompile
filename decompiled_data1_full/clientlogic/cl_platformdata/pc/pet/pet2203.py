# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/pet/pet2203.pyc
# RelativePath: clientlogic/cl_platformdata/pc/pet/pet2203.pyc
# Source Generated with Decompyle++
# File: pet2203.pyc (Python 3.6)
...
class CPetData(CCustom):
    m_SID = 2203
    m_MonsterDataSID = 2203
    m_Name = '敖龙'
    m_PetType = PET_TYPE_DEFENSE
    m_Quality = PET_QUALITY_NORMAL
    m_AttPerform = 7342
    m_PerformList = (1728, 50701, 50714, 50721)
    m_AbilityGroup = (1015,)
    m_RunSpeedUpMul = 0
