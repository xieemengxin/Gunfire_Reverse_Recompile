# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/pet/pet2201.pyc
# RelativePath: clientlogic/cl_platformdata/pc/pet/pet2201.pyc
# Source Generated with Decompyle++
# File: pet2201.pyc (Python 3.6)
...
class CPetData(CCustom):
    m_SID = 2201
    m_MonsterDataSID = 2201
    m_Name = '流寇纵火者'
    m_PetType = PET_TYPE_SHIELD
    m_Quality = PET_QUALITY_NORMAL
    m_AttPerform = 7312
    m_PerformList = (50701, 50714, 50705, 50721)
    m_AbilityGroup = (1016,)
    m_RunSpeedUpMul = 0
    m_SprintSpeedUpMul = 30000
    m_HateFactor = 2
    m_Betree = 'Pet.CombatPetMoveFsm'
    m_AIConfig = {
        'PFAI': 39273 }
    m_BaseAttrInfo = {
        'HPMax': 80000,
