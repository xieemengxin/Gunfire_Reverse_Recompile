# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/petpf/p7323.pyc
# RelativePath: clientlogic/cl_platformdata/pc/petpf/p7323.pyc
# Source Generated with Decompyle++
# File: p7323.pyc (Python 3.6)
...
class CCartoon1(TimerCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.ToInt(skill, 13 / cl_action.GetSkillVarCache(skill, 'AttackSpeed')), cl_action.GetSkillCacheData(skill, SKILLCACHE_BALLISTICTYPE))
...
def Action(skill):
    ...
    cl_action.SetSkillVarCache(skill, 'AttackSpeed', cl_action.Clamp(skill, 143 / (skill.m_Cache['AttSpeed'] if skill.m_Cache['AttSpeed'] > 0 else 143), 1, 2.86))
    cartoon = { }
