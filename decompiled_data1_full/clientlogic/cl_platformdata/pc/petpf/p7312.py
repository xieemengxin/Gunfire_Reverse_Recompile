# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/petpf/p7312.pyc
# RelativePath: clientlogic/cl_platformdata/pc/petpf/p7312.pyc
# Source Generated with Decompyle++
# File: p7312.pyc (Python 3.6)
...
class CCartoon1(DirectPosCartoon):
    ...
    def Active(cls, skill):
        cl_action.StartBackSwing(skill, cl_action.ToInt(skill, 120 / cl_action.GetSkillVarCache(skill, 'AttackSpeed')))
...
def Action(skill):
    cl_action.SetSkillVarCache(skill, 'AttackSpeed', cl_action.Clamp(skill, 200 / (skill.m_Cache['AttSpeed'] if skill.m_Cache['AttSpeed'] > 0 else 200), 0.4, 2.5))
