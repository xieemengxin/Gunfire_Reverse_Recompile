# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/petpf/p7351.pyc
# RelativePath: clientlogic/cl_platformdata/pc/petpf/p7351.pyc
# Source Generated with Decompyle++
# File: p7351.pyc (Python 3.6)
...
class CCartoon2(DirectPosCartoon):
    ...
    def Hit(cls, skill):
        ...
        cl_action.PerformDamage(skill, {
            'Att': cl_action.ToInt(skill, skill.m_Cache['Att'] * ((cl_action.GetSkillServerCache(skill, 'AttSpeedMul') - 2 if cl_action.GetSkillServerCache(skill, 'AttSpeedMul') > 2 else 0) + 1)) }, dArgs = { })
...
def Action(skill):
    cl_action.SetSkillVarCache(skill, 'AttackSpeed', cl_action.Clamp(skill, 100 / (skill.m_Cache['AttSpeed'] if skill.m_Cache['AttSpeed'] > 0 else 100), 1, 2))
...
from cl_commondefines import DAM_TYPE_THUNDER, PETPF_ACTIVE_ATTACK
