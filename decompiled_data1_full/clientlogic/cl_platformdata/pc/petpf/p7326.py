# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/petpf/p7326.pyc
# RelativePath: clientlogic/cl_platformdata/pc/petpf/p7326.pyc
# Source Generated with Decompyle++
# File: p7326.pyc (Python 3.6)
...
class CCartoon6(EntityCurveCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, (0, 0, 0), cl_action.CrtArgTargetPos(skill, notContainDying = False), 0.3, 1067, 180, 35, 60, 0.5, targettype = OBJ_ENEMY, summonID = cl_action.GetSkillCacheData(skill, SKILLCACHE_LSTINT)[cl_action.GetTimerCartoonCurTimes(skill, 5) - 1], forceDel = True)
...
from cl_commondefines import DAM_TYPE_FIRE, PETPF_ACTIVE_SLIP_SPELL
