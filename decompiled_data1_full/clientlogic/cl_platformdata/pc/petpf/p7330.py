# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/petpf/p7330.pyc
# RelativePath: clientlogic/cl_platformdata/pc/petpf/p7330.pyc
...
from cl_commondefines import CRT_CHECK_SERVER, FIGHT3_KEY_IGNOREKNOCKBACK, FIGHT3_KEY_IGNORETHUMP, OBJ_ENEMY, STATE_EFF_DEBAR
...
class CCartoon6(MonsterDashCartoon):
    ...
    def Hit(cls, skill):
        cl_action.SetCurCartoonCurPos(skill, 6, cl_action.CrtArgHitPos(skill))
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgCustomPos(skill, cartoon), 40, 40, 20, True, False, True, checkDis = 0, start = (0, 0, 0), offSetY = 0, staticbreak = False, CheckTime = 0, StopDis = 0, CheckHalt = False, targettype = OBJ_ENEMY, Collision = True)
...
def Action(skill):
    cl_action.SetSkillVarCache(skill, 'AttackSpeed', cl_action.Clamp(skill, 130 / (skill.m_Cache['AttSpeed'] if skill.m_Cache['AttSpeed'] > 0 else 130), 1, 2.5))
