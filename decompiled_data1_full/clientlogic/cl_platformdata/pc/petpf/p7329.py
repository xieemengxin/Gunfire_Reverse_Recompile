# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/petpf/p7329.pyc
# RelativePath: clientlogic/cl_platformdata/pc/petpf/p7329.pyc
...
class CCartoon0(DirectPosCartoon):
    ...
    def Hit(cls, skill):
        ...
        cl_action.VictimAddState(skill, 8126, 500, 0, { })
        cl_action.VictimAddState(skill, 20039, 500, 0, { })
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0, 0.1, -2)), cl_action.CrtArgSelfPos(skill), [
                7], attshape = ATT_SHAPE_SPHERE, targettype = OBJ_ENEMY, pierceStatic = True, explosion = False, extCheck = CRT_EXTCHECK_NONE, multipleExplode = False, explosionDelay = 0)
