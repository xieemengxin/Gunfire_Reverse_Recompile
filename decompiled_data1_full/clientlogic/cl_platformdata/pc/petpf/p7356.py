# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/petpf/p7356.pyc
# RelativePath: clientlogic/cl_platformdata/pc/petpf/p7356.pyc
# Source Generated with Decompyle++
# File: p7356.pyc (Python 3.6)
...
def Action(skill):
    cl_action.SetSkillVarCache(skill, 'AttackSpeed', cl_action.Clamp(skill, 110 / (skill.m_Cache['AttSpeed'] if skill.m_Cache['AttSpeed'] > 0 else 110), 1, 2.5))
...
class CPerform(CCustomPerform):
    ...
    def UsePerform(self, oWarrior, oSkill):
        ...
        if oWeapon:
            dWeaponAttr = dict(oWeapon.AttrCache())
            dWeaponAttr.pop('AttSpeed')
            oSkill.m_Cache.update(dWeaponAttr)
