# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/petpf/p7332.pyc
# RelativePath: clientlogic/cl_platformdata/pc/petpf/p7332.pyc
# Source Generated with Decompyle++
# File: p7332.pyc (Python 3.6)
...
class CCartoon0(TimerCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.ToInt(skill, 50 / cl_action.GetSkillVarCache(skill, 'AttackSpeed')), 0)
...
def Action(skill):
    ...
    cl_action.SetSkillVarCache(skill, 'AttackSpeed', cl_action.Clamp(skill, 100 / (skill.m_Cache['AttSpeed'] if skill.m_Cache['AttSpeed'] > 0 else 100), 1, 2.5))
    cartoon = { }
