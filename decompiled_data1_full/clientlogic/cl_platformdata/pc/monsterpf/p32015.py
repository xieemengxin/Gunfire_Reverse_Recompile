# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p32015.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p32015.pyc
# Source Generated with Decompyle++
# File: p32015.pyc (Python 3.6)
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, (0, 0, 0), (0.7, 0.3, -0.5), 25, 300, [
                12,
                3,
                70], attshape = ATT_SHAPE_SECTOR, targettype = OBJ_ENEMY, bindbone = 'muzzle', PauseForSkill = True, AttackDieBreak = False)
