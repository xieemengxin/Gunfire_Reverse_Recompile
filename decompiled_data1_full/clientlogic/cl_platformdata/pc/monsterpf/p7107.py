# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p7107.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p7107.pyc
# Source Generated with Decompyle++
# File: p7107.pyc (Python 3.6)
...
class CCartoon1(ThrowByPowerCartoon):
    ...
    def Active(cls, skill):
        cl_action.AddClientEffect(skill, 1001, cl_action.CrtArgTargetPos(skill), time = 0)
    ...
    def InitSuccess(cls, skill, i1, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0.1, 1.7, -0.4)), cl_action.CrtArgSetParabolaSpeed(skill, cartoon, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0.1, 1.7, -0.4)), cl_action.CrtArgTargetPos(skill), 12, -9, 0), 12, 0.1, (0, 9, 0), (0.45, 0.45), 300, False, False, 0, 0, None, 0, innerRadius = 0, pierce = 0, ignoreMonster = False, hitUnitBounciness = (0, 0), targettype = OBJ_ENEMY, hitovertype = HIT_OVER_NORMAL)
