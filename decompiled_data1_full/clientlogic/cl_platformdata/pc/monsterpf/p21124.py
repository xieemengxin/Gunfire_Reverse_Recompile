# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p21124.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p21124.pyc
# Source Generated with Decompyle++
# File: p21124.pyc (Python 3.6)
...
class CCartoon4(TimerCartoon):
    ...
    def End(cls, skill):
        cl_action.AttackerRemoveState(skill, 8135, bSameItem = False)
        cl_action.AttackerAddState(skill, 7160, 0, 0, { })
...
def Action(skill):
    cl_action.SetSkillVarCache(skill, 'EndPos', cl_action.CrtArgSelfPos(skill))
    cartoon = { }
