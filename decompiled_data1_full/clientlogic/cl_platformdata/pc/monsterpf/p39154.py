# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p39154.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p39154.pyc
...
class CCartoon0(RayCastCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.GetMonsterMuzzlePos(skill, (0, 2, 0)), cl_action.GetMonsterMuzzlePos(skill, (0, 2, 0)), cl_action.StartAndEndAtSameHeight(skill, cl_action.GetMonsterMuzzlePos(skill, (0, 2, 0)), cl_action.CrtArgTargetPos(skill)), 10, 100, 70, targettype = OBJ_ENEMY, effect = 0, liveTime = 0, trailEffect = 0, effectLiveTime = 1, radius = 1.5, flyoverdis = 0)
