# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p39017.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p39017.pyc
# Source Generated with Decompyle++
# File: p39017.pyc (Python 3.6)
...
from cl_commondefines import CRT_CHECK_SERVER, FIGHT3_KEY_IGNOREKNOCKBACK, FIGHT3_KEY_IGNORETHUMP, FIGHT3_KEY_IGNOREUNBALANCE, SKILLCACHE_EXTRATRAJECTORY, STATE_EFF_DEBAR
...
class CCartoon1(TimerCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, 1010 - cl_action.GetAllHeroCnt(skill, False, bUseRidingAloneCnt = True) * 100, 1)
...
class CCartoon0(TimerCartoon):
    ...
    def Trigger(cls, skill):
        ...
        if cl_action.GetSkillCacheData(skill, SKILLCACHE_EXTRATRAJECTORY) + 1 >= 4:
            ...
            cl_action.AttackerAddState(skill, 7014, 1010 - cl_action.GetAllHeroCnt(skill, False, bUseRidingAloneCnt = True) * 100, 0, { })
            cartoon = { }
...
class CCartoon2(MonsterJumpCartoon):
    ...
    def End(cls, skill):
        cl_action.SetAttackerCustomIntData(skill, 'PF39017_Stone', 1)
        cl_action.RemoveIgnoreStateEffect(skill, STATE_EFF_DEBAR)
        cartoon = { }
...
def Action(skill):
    ...
    cl_action.SetSkillCacheExtraTrajectory(skill, cl_action.GetMonsterPerformRecord(skill, 39017))
