# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p39245.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p39245.pyc
...
class CCartoon0(TimerCartoon):
    ...
    def Active(cls, skill):
        cl_action.AttackerAddState(skill, 1009, cl_action.ToInt(skill, (cl_math.CalDistance3D(cl_action.GetSkillVarCache(skill, 'start'), cl_action.GetSkillCacheData(skill, SKILLCACHE_POS)) / (37 + cl_action.GetPlayRound(skill) * 8)) * 100) if cl_action.ToInt(skill, (cl_math.CalDistance3D(cl_action.GetSkillVarCache(skill, 'start'), cl_action.GetSkillCacheData(skill, SKILLCACHE_POS)) / (37 + cl_action.GetPlayRound(skill) * 8)) * 100) > 4 else 4, 1, { })
