# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p31233.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p31233.pyc
...
class CCartoon2(TimerCartoon):
    ...
    def Trigger(cls, skill):
        cl_action.CreateRandomNumWarriorAtPointPos(skill, cl_action.GetSummonPosByBoxSplit(skill, 9, 4, cl_action.GetWarriorModelRadius(skill, WARRIOR_MONSTER, 21013, 'NavMesh'), True, {
            ...
            21013: 10 }, {
            'FollowDie': 1,
            'MonsterRate': cl_action.GetPerformArgValue(skill, 'MonsterRate', iDefault = 0) })
