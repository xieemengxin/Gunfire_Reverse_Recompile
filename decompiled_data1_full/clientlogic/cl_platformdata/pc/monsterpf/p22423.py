# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p22423.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p22423.pyc
# Source Generated with Decompyle++
# File: p22423.pyc (Python 3.6)
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgSelfPos(skill), cl_action.CrtArgSkillEndPos(skill), [
                3.5,
                1.5,
                90], attshape = ATT_SHAPE_SECTOR, targettype = OBJ_ENEMY, pierceStatic = False)
