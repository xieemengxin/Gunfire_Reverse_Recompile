# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p22411.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p22411.pyc
# Source Generated with Decompyle++
# File: p22411.pyc (Python 3.6)
...
class CCartoon3(DelegateThrowCartoon):
    ...
    def InitSuccess(cls, skill, i1, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0.1, 1.7, -0.4)), cl_action.CrtArgSetParabolaSpeed(skill, cartoon, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0.1, 1.7, -0.4)), cl_action.CrtArgShiftAngle(skill, cartoon, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0.1, 1.7, -0.4)), cl_action.CrtArgTargetPos(skill, notContainDying = False), ((i1 + 1) // 2) * -1 ** i1 * 15, 0), 20, -18, 1.5), 6, 0.5, (0, 0, 0), (0.5, 0.5), 500, True, liveTime = 0, innerRadius = 0.1, pierce = 1)
