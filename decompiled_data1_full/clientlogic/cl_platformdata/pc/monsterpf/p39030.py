# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p39030.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p39030.pyc
...
class CCartoon2(SectorDiffuseCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, (0, 0, 0), cl_action.GetSkillVarCache(skill, 'EndPos'), 0, 60, 2.2, 50, 2, 20, targettype = OBJ_ENEMY, isOverByFightType = True, fightType = WARRIOR_LUOHOU_PILLAR, isUseSector = True)
