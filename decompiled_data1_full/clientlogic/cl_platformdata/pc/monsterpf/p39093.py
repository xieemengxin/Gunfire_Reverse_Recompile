# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p39093.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p39093.pyc
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.GetEndPositionInCrt(skill, 0), (0, 0, 0), [
                2.5], attshape = ATT_SHAPE_SPHERE, targettype = OBJ_ENEMY, pierceStatic = False, explosion = False, extCheck = CRT_EXTCHECK_NONE, multipleExplode = True, explosionDelay = 10)
...
class CCartoon2(TimerCartoon):
    ...
    def Trigger(cls, skill):
        for i2 in range(0, len(cl_action.GetLiveHeroID(skill, False, fMaxDis = 0)), 1):
            cl_action.SetSkillVictim(skill, cl_action.GetLiveHeroID(skill, False, fMaxDis = 0)[i2])
            cartoon = { }
