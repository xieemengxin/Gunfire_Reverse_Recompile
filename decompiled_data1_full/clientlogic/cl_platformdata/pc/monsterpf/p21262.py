# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p21262.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p21262.pyc
# Source Generated with Decompyle++
# File: p21262.pyc (Python 3.6)
...
class CCartoon1(GroundFlyCartoon):
    ...
    def InitSuccess(cls, skill, i1, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgSelfPos(skill), cl_action.CrtArgGetCustomDir(skill, cl_action.CrtArgSelfPos(skill), cl_action.CrtArgDestPosDirPlane(skill, cl_action.CrtArgSelfPos(skill), cl_action.GetSkillServerCache(skill, 'FaceDir'), 99, ((i1 + 1) // 2) * -1 ** i1 * 15), (0, 0, 0), baseHorizontal = False), 45, 500, 0.5, 45, tolerateRadius = 0.5, climbHeight = 0, targettype = OBJ_ENEMY, HitHero = True, pierceMonster = False)
...
def Action(skill):
    ...
    cl_action.SetSkillServerCache(skill, 'FaceDir', cl_action.CrtArgSelfFace(skill))
    cartoon = { }
