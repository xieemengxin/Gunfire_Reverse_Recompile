# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p20831.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p20831.pyc
# Source Generated with Decompyle++
# File: p20831.pyc (Python 3.6)
...
class CCartoon5(MonsterDashCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgSkillEndPos(skill), 23, 50, 25, True, True, True)
