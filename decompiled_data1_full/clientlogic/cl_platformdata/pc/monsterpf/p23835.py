# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p23835.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p23835.pyc
# Source Generated with Decompyle++
# File: p23835.pyc (Python 3.6)
...
from cl_commondefines import CRT_CHECK_SERVER, FIGHT3_KEY_IGNORETHUMP, OBJ_ALL, STATE_EFF_DEBAR
...
class CCartoon5(MonsterDashCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgTargetPos(skill, notContainDying = False), 130, 25, 12, True, True, True, checkDis = 0, start = (0, 0, 0), offSetY = 0, staticbreak = False, CheckTime = 0, StopDis = 0, CheckHalt = False, targettype = OBJ_ALL, Collision = False)
