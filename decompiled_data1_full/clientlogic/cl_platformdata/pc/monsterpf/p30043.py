# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p30043.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p30043.pyc
# Source Generated with Decompyle++
# File: p30043.pyc (Python 3.6)
...
def Action(skill):
    if cl_action.CheckHasState(skill, 1009):
        ...
        if cl_action.CheckHasState(skill, 7952):
            ...
            if not cl_action.CheckHasState(skill, 8099):
                cartoon = { }
        ...
        if not cl_action.CheckHasState(skill, 8099):
            ...
            if not cl_action.CheckHasState(skill, 8099):
                cartoon = { }
                CCartoon0.Init(skill, cartoon, casting = 0, index = 0)
            elif not cl_action.CheckHasState(skill, 8099):
                cartoon = { }
                CCartoon0.Init(skill, cartoon, casting = 0, index = 0)
