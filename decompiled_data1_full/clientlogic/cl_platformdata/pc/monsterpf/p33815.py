# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p33815.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p33815.pyc
# Source Generated with Decompyle++
# File: p33815.pyc (Python 3.6)
...
class CCartoon1(DirectPosCartoon):
    ...
    def Hit(cls, skill):
        ...
        cl_action.PushHeroVictim(skill, (0, 0, 0), 20, 5 * (cl_action.CalAttenuationByDis(skill, cl_action.GetStartPositionInCrt(skill, 1), 100, 40, 6, 3) / 100), 10000, downSpeed = 0, fGravaty = 9.8, angle = 0)
