# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p39016.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p39016.pyc
# Source Generated with Decompyle++
# File: p39016.pyc (Python 3.6)
...
class CCartoon7(DelegateThrowCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (-1.5, 5, 0)), cl_action.CrtArgSetParabolaSpeed(skill, cartoon, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (-1.5, 5, 0)), cl_action.CrtArgCustomPos(skill, cartoon), 75, 0, 0.5), 25, 0.3, (0, 18, 0), (0.5, 0.5), 300, True, liveTime = 0, innerRadius = 0.1, pierce = 1)
