# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p32422.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p32422.pyc
# Source Generated with Decompyle++
# File: p32422.pyc (Python 3.6)
...
class CCartoon4(DelegateThrowCartoon):
    ...
    def Active(cls, skill):
        cl_action.StartBackSwing(skill, 90)
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0.1, 1, -0.4)), cl_action.CrtArgSetParabolaSpeed(skill, cartoon, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0.1, 1, -0.4)), cl_action.CrtArgTargetBodyShiftPos(skill, 0, 0, 0, 1, 0, 5, 0, 0), 18, -18, 0.5), 12, 0.5, (0, 0, 0), (1, 1), 300, True, liveTime = 0, innerRadius = 0.2, pierce = 1)
