# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p38026.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p38026.pyc
# Source Generated with Decompyle++
# File: p38026.pyc (Python 3.6)
...
class CCartoon3(MonsterDashCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgSkillEndPos(skill), cl_action.GetAttackerAttr(skill, 'DodgeTime'), 25, 0, True, True, True)
