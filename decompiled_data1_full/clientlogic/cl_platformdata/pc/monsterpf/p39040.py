# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p39040.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p39040.pyc
...
class CCartoon2(MonsterMoveCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.GetLineByPos(skill, cl_action.CrtArgDestPosDirPlane(skill, cl_action.CrtArgSelfPos(skill), cl_action.CrtArgSelfFace(skill), 5, 0)), speed = 2.5, iGround = 1)
