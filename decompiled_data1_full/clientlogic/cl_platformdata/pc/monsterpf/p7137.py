# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p7137.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p7137.pyc
# Source Generated with Decompyle++
# File: p7137.pyc (Python 3.6)
...
class CCartoon1(ThrowByPowerCartoon):
    ...
    def InitSuccess(cls, skill, i1, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (-1.5, 5, 0)), cl_action.CrtArgSetParabolaSpeed(skill, cartoon, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (-1.5, 5, 0)), cl_action.CrtArgSkillEndPos(skill), 32, 0, 0), 12, 0.5, (0, 18, 0), (0.5, 0.5), 300, True, True, 0, 0, 0, 0, innerRadius = 0, pierce = 0, ignoreMonster = False, targettype = OBJ_ENEMY, hitovertype = HIT_OVER_NORMAL)
