# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p32811.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p32811.pyc
# Source Generated with Decompyle++
# File: p32811.pyc (Python 3.6)
...
from cl_commondefines import ATT_SHAPE_SPHERE, CRT_CHECK_SERVER, DAM_TYPE_CORRISION, DAM_TYPE_FIRE, DAM_TYPE_THUNDER, OBJ_ENEMY
...
class CCartoon5(EntityCurveCartoon):
    m_SID = 5
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0, 2, -2)), cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (4, 2, -10)), 1, 1041, 20, 14, 0, 0.6, targettype = OBJ_ENEMY, summonID = 0, forceDel = False)
...
class CCartoon4(EntityCurveCartoon):
    m_SID = 4
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0, 2, -2)), cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0, 2, -10)), 1, 1040, 20, 11, 0, 0.6, targettype = OBJ_ENEMY, summonID = 0, forceDel = False)
...
class CCartoon3(EntityCurveCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0, 2, -2)), cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (-4, 2, -10)), 1, 1039, 20, 10, 0, 0.6, targettype = OBJ_ENEMY, summonID = 0, forceDel = False)
