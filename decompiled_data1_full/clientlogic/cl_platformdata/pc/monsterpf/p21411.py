# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p21411.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p21411.pyc
# Source Generated with Decompyle++
# File: p21411.pyc (Python 3.6)
...
class CCartoon1(RayCastCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0, 0.97, 0)), cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0, 0.97, 0)), cl_action.CrtArgMissingPos(skill, 0.5), 1, 45, 35, targettype = OBJ_ENEMY, effect = 0, liveTime = 0, trailEffect = None, effectLiveTime = 0, radius = 0, flyoverdis = 0)
