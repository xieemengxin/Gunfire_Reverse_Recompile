# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p39160.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p39160.pyc
# Source Generated with Decompyle++
# File: p39160.pyc (Python 3.6)
...
from cl_commondefines import ATT_SHAPE_LINE, CRT_CHECK_SERVER, OBJ_ALL, STATE_EFF_DEBAR
...
class CCartoon0(WinkPosCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.GetSkillVarCache(skill, 'winkpos'), 0, 40, [], [], dashshape = ATT_SHAPE_LINE, acceleration = 0, decrease = 0, targettype = OBJ_ALL, hitOver = True, bWaitOverTime = False, upSpeed = 0)
...
def Action(skill):
    ...
    cl_action.SetSkillVarCache(skill, 'winkpos', cl_action.GetMonsterWinkPos(skill, 14, 18, 105, 150))
