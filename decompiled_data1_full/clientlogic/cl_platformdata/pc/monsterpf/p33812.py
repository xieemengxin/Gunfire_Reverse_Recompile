# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p33812.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p33812.pyc
...
class CCartoon2(TimerCartoon):
    ...
    def Trigger(cls, skill):
        cl_action.AttackerUsePerform(skill, 33813, { }, 0, 0)
...
class CCartoon6(MonsterDashCartoon):
    ...
    def End(cls, skill):
        cl_action.AttackerRemoveState(skill, 7130, bSameItem = False)
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgTargetPos(skill, notContainDying = False), 96, 25, 20, True, False, False, checkDis = 0, start = cl_action.CrtArgSelfPos(skill), offSetY = 0, staticbreak = False, CheckTime = 16, StopDis = 0.4, CheckHalt = True, targettype = OBJ_ALL, Collision = False)
...
class CCartoon4(MonsterDashCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgTargetPos(skill, notContainDying = False), 28, 25, 20, True, False, False, checkDis = 0, start = cl_action.CrtArgSelfPos(skill), offSetY = 0, staticbreak = False, CheckTime = 16, StopDis = 0.4, CheckHalt = True, targettype = OBJ_ALL, Collision = False)
...
class CCartoon8(MonsterDashCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgDestPosDirPlane(skill, cl_action.GetSkillVarCache(skill, 'start'), cl_action.CrtArgGetCustomDir(skill, cl_action.GetSkillVarCache(skill, 'start'), cl_action.GetSkillVarCache(skill, 'end'), (0, 0, 0), baseHorizontal = False), 35, 0), 28, 25, 20, True, False, False, checkDis = 0, start = cl_action.CrtArgSelfPos(skill), offSetY = 0, staticbreak = False, CheckTime = 16, StopDis = 0.2, CheckHalt = True, targettype = OBJ_ALL, Collision = False)
...
class CCartoon15(MonsterDashCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgDestPosDirPlane(skill, cl_action.GetSkillVarCache(skill, 'start'), cl_action.CrtArgGetCustomDir(skill, cl_action.GetSkillVarCache(skill, 'start'), cl_action.GetSkillVarCache(skill, 'end'), (0, 0, 0), baseHorizontal = False), 35, 0), 28, 25, 12, True, False, False, checkDis = 0, start = cl_action.CrtArgSelfPos(skill), offSetY = 0, staticbreak = False, CheckTime = 0, StopDis = 0, CheckHalt = False, targettype = OBJ_ALL, Collision = False)
...
class CCartoon18(MonsterDashCartoon):
    ...
    def End(cls, skill):
        ...
        cl_action.AttackerRemoveState(skill, 7124, bSameItem = False)
        cl_action.StartBackSwing(skill, 52)
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgDestPosDirPlane(skill, cl_action.GetSkillVarCache(skill, 'start'), cl_action.CrtArgGetCustomDir(skill, cl_action.GetSkillVarCache(skill, 'start'), cl_action.GetSkillVarCache(skill, 'end'), (0, 0, 0), baseHorizontal = False), 35, 0), 28, 25, 4, True, False, False, checkDis = 0, start = cl_action.CrtArgSelfPos(skill), offSetY = 0, staticbreak = False, CheckTime = 0, StopDis = 0, CheckHalt = False, targettype = OBJ_ALL, Collision = False)
