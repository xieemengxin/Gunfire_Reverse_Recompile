# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p39028.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p39028.pyc
...
class CCartoon3(CircumPathCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.GetSceneObjPos(skill, cl_action.GetSkillVarCache(skill, 'SealWallID')[0]), 45, (0, 0, 0), 2, 1, 5, cl_action.GetSkillVarCache(skill, 'SealWallID')[0])
...
class CCartoon1(CircumPathCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.GetSceneObjPos(skill, cl_action.GetSkillVarCache(skill, 'SealWallID')[1]), -45, (0, 0, 0), 2, 1, 5, cl_action.GetSkillVarCache(skill, 'SealWallID')[1])
