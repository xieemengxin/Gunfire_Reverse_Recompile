# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p31285.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p31285.pyc
# Source Generated with Decompyle++
# File: p31285.pyc (Python 3.6)
...
class CCartoon5(DirectPosCartoon):
    ...
    def Hit(cls, skill):
        ...
        cl_action.StartBackSwing(skill, 0)
...
class CCartoon1(GroundFlyCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgSelfPos(skill), cl_action.CrtArgSelfFace(skill), 50, 100, 1, 45, tolerateRadius = 0.5, climbHeight = 0, targettype = OBJ_ENEMY, HitHero = True, pierceMonster = False)
