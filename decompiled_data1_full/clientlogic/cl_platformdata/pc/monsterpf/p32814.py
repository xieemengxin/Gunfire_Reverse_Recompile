# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p32814.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p32814.pyc
# Source Generated with Decompyle++
# File: p32814.pyc (Python 3.6)
...
class CCartoon1(TimerCartoon):
    ...
    def Trigger(cls, skill):
        cl_action.StartBackSwing(skill, cl_action.GetAttackerAttr(skill, 'PostDodgeTime'))
...
class CCartoon4(TimerCartoon):
    ...
    def Trigger(cls, skill):
        ...
        cl_action.SetSkillVarCache(skill, 'over', cl_action.CrtArgSelfPos(skill))
        cartoon = { }
...
def Action(skill):
    ...
    cl_action.SetTeleportPos(skill, cl_action.CrtArgSkillEndPos(skill))
    cartoon = { }
