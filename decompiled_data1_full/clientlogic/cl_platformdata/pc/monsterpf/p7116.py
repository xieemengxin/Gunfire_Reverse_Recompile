# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p7116.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p7116.pyc
# Source Generated with Decompyle++
# File: p7116.pyc (Python 3.6)
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.ChooseLevelPosLineNear(skill, [
                'bossfire',
                'bossfire1',
                'bossfire2'], (0, 0, 0)), 15, 1.5, 150, 230, 40, 1)
