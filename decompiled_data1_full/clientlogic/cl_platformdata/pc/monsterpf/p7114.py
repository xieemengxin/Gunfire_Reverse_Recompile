# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p7114.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p7114.pyc
...
class CCartoon1(ThrowByPowerCartoon):
    ...
    def InitSuccess(cls, skill, i1, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.GetMuzzlePosition(skill, cartoon), cl_action.CrtArgSetParabolaSpeed(skill, cartoon, cl_action.GetMuzzlePosition(skill, cartoon), cl_action.CrtArgRandomPosInCircle(skill, cartoon, 10, 4), 20, -18, 0), 20, 0.25, (0, 0, 0), (0.2, 0.2), 500, True, False, 0, 0, None, 0, innerRadius = 0, pierce = 0, ignoreMonster = False, hitUnitBounciness = (0, 0), targettype = OBJ_ENEMY, hitovertype = HIT_OVER_NORMAL)
