# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p30835.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p30835.pyc
...
class CCartoon7(DirectPosCartoon):
    ...
    def Hit(cls, skill):
        cl_action.PushHeroVictim(skill, cl_action.GetEndPositionInCrt(skill, 7), 10, 5, 10000, downSpeed = 5, fGravaty = 9.8, angle = 45)
        cl_action.WeaponDamage(skill, {
            'Att': 30 }, { }, sendPFMsg = False)
