# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p31251.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p31251.pyc
# Source Generated with Decompyle++
# File: p31251.pyc (Python 3.6)
...
class CCartoon2(DelegateThrowCartoon):
    ...
    def InitSuccess(cls, skill, i1, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (-0.7, 1.8, -1.2)), cl_action.CrtArgSetParabolaSpeed(skill, cartoon, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (-0.7, 1.8, -1.2)), cl_action.CrtArgSkillEndPos(skill), 50, 0, 1.4), 50, 0.2, (0, 18, 0), (0.5, 0.5), 300, True, liveTime = 0, innerRadius = 0.05, pierce = 1)
...
class CCartoon0(TimerCartoon):
    ...
    def Trigger(cls, skill):
        ...
        cl_action.StartBackSwing(skill, 160)
