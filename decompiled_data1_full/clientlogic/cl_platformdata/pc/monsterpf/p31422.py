# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p31422.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p31422.pyc
# Source Generated with Decompyle++
# File: p31422.pyc (Python 3.6)
...
class CCartoon1(DirectPosCartoon):
    ...
    def Hit(cls, skill):
        ...
        cl_action.PushHeroVictim(skill, (0, 0, 0), 20, 4 * (cl_action.CalAttenuationByDis(skill, cl_action.GetEndPositionInCrt(skill, 1), 100, 50, 4.5, 2.5) / 100), 10000, downSpeed = 0, fGravaty = 9.8, angle = 0)
