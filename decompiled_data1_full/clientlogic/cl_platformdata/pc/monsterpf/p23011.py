# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p23011.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p23011.pyc
# Source Generated with Decompyle++
# File: p23011.pyc (Python 3.6)
...
from cl_commondefines import ATT_SHAPE_SPHERE, CRT_CHECK_SERVER, CRT_EXTCHECK_NONE, OBJ_ENEMY, SKILLCACHE_BALLISTICTYPE
...
class CCartoon4(DelegateThrowCartoon):
    ...
    def InitSuccess(cls, skill, i1, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0.1, 2.4, -0.5)), cl_action.CrtArgSetParabolaSpeed(skill, cartoon, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0.1, 2.4, -0.5)), cl_action.CrtArgTargetBodyShiftPos(skill, 1, 100, 5, 15, 0.6, 1.2, 0.2, 0.8), 30, -18, 0), 30, 0.3, (0, 0, 0), (0.5, 0.5), 500, True, liveTime = 0, innerRadius = 0.15, pierce = 1)
