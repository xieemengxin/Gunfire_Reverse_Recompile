# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p22422.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p22422.pyc
# Source Generated with Decompyle++
# File: p22422.pyc (Python 3.6)
...
class CCartoon6(DelegateThrowCartoon):
    ...
    def InitSuccess(cls, skill, i1, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (-0.1, 0.8, -1.5)), cl_action.CrtArgSetParabolaSpeed(skill, cartoon, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (-0.1, 0.8, -1.5)), cl_action.CrtArgShiftAngle(skill, cartoon, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (-0.1, 0.8, -1.5)), cl_action.CrtArgTargetPos(skill, notContainDying = False), ((i1 + 1) // 2) * -1 ** i1 * 15, 0), 18, -6, 1.5), 12, 0.5, (0, 12, 0), (1, 1), 300, True, liveTime = 0, innerRadius = 0.1, pierce = 1)
