# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p22853.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p22853.pyc
# Source Generated with Decompyle++
# File: p22853.pyc (Python 3.6)
...
from cl_commondefines import CRT_CHECK_SERVER, FIGHT3_KEY_IGNOREKNOCKBACK, FIGHT3_KEY_IGNORETHUMP, SKILLCACHE_LSTPOS
...
class CCartoon2(TimerCartoon):
    ...
    def Trigger(cls, skill):
        cl_action.SetSkillCacheData(skill, SKILLCACHE_LSTPOS, cl_action.RandomPointSectorInMeshList(skill, cl_action.CrtArgWarriorPos(skill, cl_action.GetSkillVID(skill)), cl_math.Vec3Minus(cl_action.CrtArgSelfPos(skill), cl_action.CrtArgWarriorPos(skill, cl_action.GetSkillVID(skill))), 3, 10, 0, 30, 1))
...
def Action(skill):
    ...
    cl_action.SetTeleportPos(skill, cl_action.GetMonsterKeepAwayPos(skill, 8, 360, 8))
    cartoon = { }
