# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p39026.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p39026.pyc
...
class CCartoon0(TimerCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, 15, int((cl_action.GetAllHeroCnt(skill, False, bUseRidingAloneCnt = False) * 2 + 2) // 3))
