# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p22252.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p22252.pyc
...
class CCartoon0(DelegateThrowCartoon):
    ...
    def InitSuccess(cls, skill, i1, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.GetMuzzlePosition(skill, cartoon), cl_action.CrtArgGetCustomDir(skill, cl_action.CrtArgCustomPos(skill, cartoon), cl_action.CrtArgCustomStartPos(skill, cartoon), (0, 0, 0), baseHorizontal = False), 6, 0.33, (0, 0, 0), (0.4, 0.4), 120, False, liveTime = 0, innerRadius = 0, pierce = 0)
