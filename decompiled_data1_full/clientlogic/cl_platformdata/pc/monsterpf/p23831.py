# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p23831.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p23831.pyc
...
class CCartoon1(RayCastCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0, 2.5, 1)), cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0, 2.5, 1)), cl_action.CrtArgTargetPos(skill, notContainDying = False), 1, 100, 30, targettype = OBJ_ENEMY, liveTime = 0, radius = 0.2, flyoverdis = 0, passid = 0, extCheck = CRT_EXTCHECK_NONE)
