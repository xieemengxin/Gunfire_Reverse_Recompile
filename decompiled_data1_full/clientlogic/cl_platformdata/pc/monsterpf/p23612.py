# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p23612.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p23612.pyc
...
class CCartoon1(MonsterDashCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgSkillEndPos(skill), 50, 0, 0, False, True, False, checkDis = 1.2, start = (0, 0, 0), offSetY = 1.5, staticbreak = False, CheckTime = 0, StopDis = 0, CheckHalt = False, targettype = OBJ_ALL, Collision = False)
