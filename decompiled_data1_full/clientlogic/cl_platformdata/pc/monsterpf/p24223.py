# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p24223.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p24223.pyc
...
class CCartoon4(DelegateThrowCartoon):
    ...
    def Active(cls, skill):
        cl_action.StartBackSwing(skill, 76)
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (-0.1, 1, -2)), cl_action.CrtArgSetParabolaSpeed(skill, cartoon, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (-0.1, 1, -2)), cl_action.CrtArgTargetBodyShiftPos(skill, 1, 100, -0.8, 0.6, -0.5, 0.8, -0.8, 0.8), 20, -9, 1.2), 20, 2, (0, 9, 0), (0.5, 0.5), 500, True, liveTime = 0, innerRadius = 0.15, pierce = 1)
