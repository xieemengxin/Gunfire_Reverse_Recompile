# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p39218.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p39218.pyc
...
class CCartoon7(TimerCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.ToInt(skill, cl_action.ToInt(skill, cl_action.GetPlayRound(skill) * -50 + 450) - 35), 1)
...
class CCartoon3(TimerCartoon):
    ...
    def End(cls, skill):
        cl_action.AttackerAddState(skill, 1009, 0, 0, { })
...
class CCartoon2(TimerCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.ToInt(skill, cl_action.GetPlayRound(skill) * -50 + 450), 1)
...
class CCartoon8(DelegateThrowCartoon):
    ...
    def Active(cls, skill):
        if not cl_action.CheckHasState(skill, 7987):
            cartoon = { }
