# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p31231.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p31231.pyc
# Source Generated with Decompyle++
# File: p31231.pyc (Python 3.6)
...
class CCartoon4(DelegateThrowCartoon):
    ...
    def InitSuccess(cls, skill, i1, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (-1.5, 1.6, -0.5)), cl_action.CrtArgSetParabolaSpeed(skill, cartoon, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (-1.5, 1.6, -0.5)), cl_action.CrtArgShiftAngle(skill, cartoon, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (-1.5, 1.6, -0.5)), cl_action.CrtArgSkillEndPos(skill), 15 - i1 * 15, 0), 20, 0, 1.6), 12, 0.5, (0, 18, 0), (0.5, 0.5), 300, True, liveTime = 0, innerRadius = 0.1, pierce = 1)
