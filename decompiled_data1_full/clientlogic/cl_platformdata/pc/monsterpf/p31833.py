# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p31833.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p31833.pyc
# Source Generated with Decompyle++
# File: p31833.pyc (Python 3.6)
...
from cl_commondefines import ATT_SHAPE_RECTANGLE, ATT_SHAPE_SPHERE, CRT_CHECK_SERVER, CRT_EXTCHECK_NONE, FIGHT3_KEY_IGNORETHUMP, FIGHT3_KEY_IGNOREVERTIGO, OBJ_ALL, OBJ_ENEMY, STATE_EFF_DEBAR
...
class CCartoon0(DirectPosCartoon):
    ...
    def Hit(cls, skill):
        ...
        cl_action.PushHeroVictim(skill, (0, 0, 0), 10, 5, 10000, downSpeed = 5, fGravaty = 9.8, angle = 0, bDirectRotation = False)
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgMonsterMuzzlePos(skill, cartoon, (0, 0.1, -2)), cl_action.CrtArgSkillEndPos(skill), [
...
class CCartoon6(MonsterDashCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgCustomPos(skill, cartoon), 156, 125, 12, True, False, False, checkDis = 0, start = (0, 0, 0), offSetY = 0, staticbreak = False, CheckTime = 0, StopDis = 0, CheckHalt = False, targettype = OBJ_ALL, Collision = False)
