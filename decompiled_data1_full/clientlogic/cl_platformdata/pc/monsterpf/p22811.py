# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p22811.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p22811.pyc
# Source Generated with Decompyle++
# File: p22811.pyc (Python 3.6)
...
class CCartoon4(TimerCartoon):
    ...
    def End(cls, skill):
        cl_action.EndUsePerform(skill, 22812)
...
class CCartoon3(TimerCartoon):
    ...
    def Trigger(cls, skill):
        cl_action.AddClientEffect(skill, 1004, cl_action.CrtArgSkillEndPos(skill), time = 0)
        cartoon = { }
...
class CCartoon2(DirectPosCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgSkillEndPos(skill), (0, 0, 0), [
