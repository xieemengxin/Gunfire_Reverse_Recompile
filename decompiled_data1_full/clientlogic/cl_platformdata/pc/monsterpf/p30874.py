# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p30874.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p30874.pyc
# Source Generated with Decompyle++
# File: p30874.pyc (Python 3.6)
...
from cl_commondefines import ATT_SHAPE_SECTOR, ATT_SHAPE_SPHERE, CRT_CHECK_SERVER, CRT_EXTCHECK_NONE, FIGHT3_KEY_IGNOREIMMOBILIZE, FIGHT3_KEY_IGNOREKNOCKBACK, FIGHT3_KEY_IGNORETHUMP, FIGHT3_KEY_IGNOREVERTIGO, OBJ_ENEMY
...
class CCartoon0(TimerCartoon):
    ...
    def End(cls, skill):
        cl_action.SendCurCartoonTriggerMsg(skill, dInfo = {
            'SkillVID': cl_action.GetSkillVID(skill) })
        cl_action.MonsterTeleportToListPos(skill, 6)
        cartoon = { }
    ...
    def Trigger(cls, skill):
        cl_action.SendCurCartoonTriggerMsg(skill, dInfo = {
            'SkillVID': cl_action.GetSkillVID(skill) })
        cl_action.MonsterTeleportToListPos(skill, cl_action.GetTimerCartoonCurTimes(skill, 0) + -1)
        cartoon = { }
...
class CCartoon3(TimerCartoon):
    ...
    def Trigger(cls, skill):
        cl_action.SetSkillVarCache(skill, 'path', cl_action.MonsterChooseRushPath(skill, 6, False, 15, 1))
        cartoon = { }
