# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p22051.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p22051.pyc
# Source Generated with Decompyle++
# File: p22051.pyc (Python 3.6)
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, (0, 0, 0), (0.8, 0.33, 0), 25, cl_action.GetSkillCacheData(skill, SKILLCACHE_INT), [
                8,
                4,
                24], attshape = ATT_SHAPE_SECTOR, targettype = OBJ_ENEMY, bindbone = 'muzzle', PauseForSkill = True, AttackDieBreak = False)
