# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p22024.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p22024.pyc
...
class CCartoon3(TimerCartoon):
    ...
    def Trigger(cls, skill):
        ...
        for i1 in range(0, cl_action.GetSkillCacheData(skill, SKILLCACHE_BALLISTICTYPE), 1):
            ...
            cl_action.SetSkillVarCache(skill, 'waittime', cl_action.GetSkillVarCache(skill, 'waittime') + (30 - i1 * 5 if 30 - i1 * 5 > 13 else 13))
