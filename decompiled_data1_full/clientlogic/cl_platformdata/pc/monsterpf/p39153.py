# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/monsterpf/p39153.pyc
# RelativePath: clientlogic/cl_platformdata/pc/monsterpf/p39153.pyc
...
from cl_commondefines import ATT_SHAPE_SPHERE, CRT_CHECK_SERVER, CRT_EXTCHECK_NONE, FIGHT3_KEY_IGNOREUNBALANCE, OBJ_ALL, OBJ_ALLNOSELF, OBJ_ENEMY, WARRIOR_PHYSXENTITYEFFECT, WARRIOR_SUMMON
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableCtrl(skill, cl_action.CrtArgSelfPos(skill), cl_action.CrtArgTargetPos(skill, notContainDying = False), [
                7], attshape = ATT_SHAPE_SPHERE, targettype = OBJ_ALLNOSELF, pierceStatic = False, explosion = False, extCheck = CRT_EXTCHECK_NONE, multipleExplode = True, explosionDelay = 10)
...
class CCartoon1(DirectPosCartoon):
    ...
    def Hit(cls, skill):
        if cl_action.CheckWarriorHasState(skill, cl_action.GetSkillVID(skill), 7963):
            ...
            cl_action.VictimAddState(skill, 7963, 200, 0, { })
