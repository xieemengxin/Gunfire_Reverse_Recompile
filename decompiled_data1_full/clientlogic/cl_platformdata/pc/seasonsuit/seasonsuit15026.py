# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/seasonsuit/seasonsuit15026.pyc
# RelativePath: clientlogic/cl_platformdata/pc/seasonsuit/seasonsuit15026.pyc
# Source Generated with Decompyle++
# File: seasonsuit15026.pyc (Python 3.6)
...
def Action1(oTarget):
    return cl_action.RewardPassive(oTarget, 15026)


def RemoveAction1(oTarget):
    return cl_action.RemovePassive(oTarget, 15026)
...
class CSuitData(CBaseSeasonSuitData):
    ...
    m_Name = '内力爆破'
    m_Condition = {
        1: (SUIT_TALENT, (2228, 1)),
        2: (SUIT_TALENT, (2222, 1)),
        3: (SUIT_RELIC, 5801),
        4: (SUIT_RELIC, 5832),
        5: (SUIT_RELIC, 5703) }
    m_CondFunc = {
