# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/seasonsuit/seasonsuit15111.pyc
# RelativePath: clientlogic/cl_platformdata/pc/seasonsuit/seasonsuit15111.pyc
# Source Generated with Decompyle++
# File: seasonsuit15111.pyc (Python 3.6)
...
def Action1(oTarget):
    return cl_action.RewardPassive(oTarget, 15121, 1)


def Action2(oTarget):
    return cl_action.RewardPassive(oTarget, 15121, 2)


def Action3(oTarget):
    return cl_action.RewardPassive(oTarget, 15121, 3)


def RemoveAction1(oTarget):
    return cl_action.RemovePassive(oTarget, 15121)
