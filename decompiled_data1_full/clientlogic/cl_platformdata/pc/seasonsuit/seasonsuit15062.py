# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/seasonsuit/seasonsuit15062.pyc
# RelativePath: clientlogic/cl_platformdata/pc/seasonsuit/seasonsuit15062.pyc
# Source Generated with Decompyle++
# File: seasonsuit15062.pyc (Python 3.6)
...
def Action1(oTarget):
    return cl_action.RewardPassive(oTarget, 15082)


def RemoveAction1(oTarget):
    return cl_action.RemovePassive(oTarget, 15082)
...
class CSuitData(CBaseSeasonSuitData):
    ...
    m_Name = '水行法阵'
    m_Condition = {
        1: (SUIT_TALENT, (2918, 1)),
        2: (SUIT_TALENT, (2902, 1)),
        3: (SUIT_RELIC, 5769),
        4: (SUIT_RELIC, 5786),
        5: (SUIT_RELIC, 5773) }
    m_CondFunc = {
