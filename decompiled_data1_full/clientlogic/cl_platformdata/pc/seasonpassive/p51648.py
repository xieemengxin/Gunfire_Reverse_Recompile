# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/seasonpassive/p51648.pyc
# RelativePath: clientlogic/cl_platformdata/pc/seasonpassive/p51648.pyc
# Source Generated with Decompyle++
# File: p51648.pyc (Python 3.6)
...
from cl_commondefines import DAM_TYPE_PERFORM, S7_MODULE_POINT_CHANGE
from cl_newformula import Func308, Func717, Func839, Func840
...
def Action1(oWarrior, oLifeCycle):
    ...
    cl_action.PassiveAddState(oWarrior, oLifeCycle, 39712, 0, { }, 1)
...
'sArg': 'Lv3AddDam' })))
    cl_action.PassiveSetSelfArgValue(oWarrior, oLifeCycle, 'MaxAddDam', (lambda *a: Func717(*a, **{
'sArg': 'Lv3MaxAddDam' })))
    cl_action.PassiveSetSelfArgValue(oWarrior, oLifeCycle, 'MulDam', (lambda *a: Func717(*a, **{
'sArg': 'Lv3MulDam' })))
...
'sArg': 'TotalAddDam' })),
        'SrcLV': (lambda *a: Func308(*a)) }, 39712)


def DoCallBackAction2(oEventCB, oWarrior):
    cl_evact.PassiveCBChangeSkillDamFactor(oWarrior, oEventCB, (lambda *a: Func717(*a, **{
'sArg': 'TotalAddDam' }) + Func717(*a, **{
'sArg': 'TotalMulDam' })), 0, DAM_TYPE_PERFORM, 1, 1)
...
'sArg': 'AddDam' }), Func717(*a, **{
'sArg': 'MaxAddDam' }))))
    cl_evact.PassiveCBSetPFArgs(oWarrior, oEventCB, 'TotalMulDam', (lambda *a: Func840(*a) * Func717(*a, **{
'sArg': 'MulDam' })))
    cl_action.CommonRefreshStateExtraInfo(oWarrior, oEventCB.GetCBLifeCycle(), {
