# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/seasonpassive/p51716.pyc
# RelativePath: clientlogic/cl_platformdata/pc/seasonpassive/p51716.pyc
# Source Generated with Decompyle++
# File: p51716.pyc (Python 3.6)
...
'sAttr': 'CountEnergy' })))
            if cl_evcon.CheckHasState(oWarrior, oEventCB, 39765):
                cl_action.CommonAddStateCount(oWarrior, oEventCB.GetCBLifeCycle(), 39765, (lambda *a: Func717(*a, **{
'sArg': 'AddCount' }) * Func859(*a, **{
'sAttr': 'AddCountMul' })), 0)
            else:
                cl_action.PassiveAddState(oWarrior, oEventCB.GetCBLifeCycle(), 39765, 0, { }, 1)
                cl_action.CommonAddStateCount(oWarrior, oEventCB.GetCBLifeCycle(), 39765, (lambda *a: Func717(*a, **{
'sArg': 'AddCount' }) * Func859(*a, **{
'sAttr': 'AddCountMul' })), 0)
