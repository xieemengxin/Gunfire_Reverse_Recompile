# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/seasonpassive/p51579.pyc
# RelativePath: clientlogic/cl_platformdata/pc/seasonpassive/p51579.pyc
# Source Generated with Decompyle++
# File: p51579.pyc (Python 3.6)
...
def Action4(oWarrior, oLifeCycle):
    ...
    cl_action.PassiveSetSelfArgValue(oWarrior, oLifeCycle, 'EffectTime', 500)
    cl_action.PassiveSetSelfArgValue(oWarrior, oLifeCycle, 'Distance', 2)
    cl_action.CommonListenMsgCallBack(oWarrior, oLifeCycle, cl_msgcenter.MSG_WAR_PERFORM_END, PF_SUBMSG_CAREERPF, 0, 0, 0)
