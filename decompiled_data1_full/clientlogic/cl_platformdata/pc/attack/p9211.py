# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/attack/p9211.pyc
# RelativePath: clientlogic/cl_platformdata/pc/attack/p9211.pyc
...
class CCartoon2(SkillSummonCartoon):
    ...
    def InitSuccess(cls, skill, i1, cartoon):
        if not skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableShow(skill, skill.m_Cache['Pierce'], cl_action.StringToInt(skill, 0), 1027, 0.5, 50, 25, 0, hitInterval = 14, reboundCnt = 0, driveSpeed = 0, driveAccSpeed = 0, targettype = OBJ_ENEMY)
