# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/attack/p9712.pyc
# RelativePath: clientlogic/cl_platformdata/pc/attack/p9712.pyc
# Source Generated with Decompyle++
# File: p9712.pyc (Python 3.6)
...
class CCartoon1(DirectPosCartoon):
    ...
    def InitSuccess(cls, skill, i1, cartoon):
        if not skill.m_CheckType == CRT_CHECK_SERVER:
            if not cls.EnableCheck(skill, start = cl_action.GetMuzzlePos(skill), end = cl_action.GetCameraDirPos(skill, 10)):
                return None
