# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/attack/p9602.pyc
# RelativePath: clientlogic/cl_platformdata/pc/attack/p9602.pyc
# Source Generated with Decompyle++
# File: p9602.pyc (Python 3.6)
    ...
    def InitSuccess(cls, skill, i1, cartoon):
        if not skill.m_CheckType == CRT_CHECK_SERVER:
            ...
            cls.EnableShow(skill, [
                ...
                0.5,
                180,
                24.5], meshCount = 5, totalTime = 10, targettype = OBJ_ENEMY, pierceStatic = False, left2right = True, center2around = False, canCritical = False)
