# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/attack/p9793.pyc
# RelativePath: clientlogic/cl_platformdata/pc/attack/p9793.pyc
...
class CCartoon0(TimerCartoon):
    ...
    def Active(cls, skill):
        if cl_action.CheckHasInscription(skill, 13075):
            cl_action.AttackerAddState(skill, 1901, 0, 1, { })
        else:
            cl_action.AttackerAddState(skill, 1900, 0, 1, { })
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if not skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableShow(skill, 40000, 200)
...
class CCartoon1(TimerCartoon):
    ...
    def End(cls, skill):
        cl_action.AttackerAddState(skill, 1889, 0, 1, { })
        cartoon = { }
