# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/attack/p9415.pyc
# RelativePath: clientlogic/cl_platformdata/pc/attack/p9415.pyc
        ...
        if cl_action.CheckVictimInPointList(skill, cl_action.GetSkillServerCache(skill, 'AnnulusTriggerFisrtHitHight')):
            ...
            for i1 in range(0, cl_action.GetTrajectory(skill), 1):
                cl_action.WeaponDamage(skill, {
                    'Att': 150 if cl_action.CheckVictimInPointList(skill, cl_action.GetSkillServerCache(skill, 'AnnulusTriggerFisrtHitHight')) else 100 if cl_action.CheckVictimInPointList(skill, cl_action.GetSkillServerCache(skill, 'AnnulusTriggerFisrtHit')) else 10 }, { }, sendPFMsg = False)
