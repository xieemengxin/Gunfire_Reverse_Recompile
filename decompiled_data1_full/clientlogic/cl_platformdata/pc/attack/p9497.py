# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/attack/p9497.pyc
# RelativePath: clientlogic/cl_platformdata/pc/attack/p9497.pyc
...
class CCartoon1(DirectPosCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if not skill.m_CheckType == CRT_CHECK_SERVER:
            if not cls.EnableCheck(skill, start = cl_action.GetMuzzlePosition(skill, cartoon), end = cl_action.GetAimTargetPosition(skill, cartoon)):
                return None
