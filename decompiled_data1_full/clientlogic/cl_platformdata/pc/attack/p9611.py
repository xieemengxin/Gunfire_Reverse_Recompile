# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/attack/p9611.pyc
# RelativePath: clientlogic/cl_platformdata/pc/attack/p9611.pyc
# Source Generated with Decompyle++
# File: p9611.pyc (Python 3.6)
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if not skill.m_CheckType == CRT_CHECK_SERVER:
            if not cls.EnableCheck(skill, start = cl_action.GetCameraCenterPosition(skill, cartoon)):
                return None
            cls.EnableShow(skill, 0.1, (0, 0, 0), (0.5, 0.5), 60, True, True, 0, innerRadius = 0.01, pierce = 99, ignoreMonster = False, hitUnitBounciness = (0, 0), targettype = OBJ_ENEMY, hitovertype = HIT_OVER_NORMAL, changeRadius = 0.1, maxRadius = 3, iTriggerBullet = 0, checkWeaknessAngle = 0, checkWeaknessDis = 0)
...
class CCartoon6(MeleeWeaponCartoon):
    ...
    def End(cls, skill):
        if cl_action.GetCartoonHitTargetCount(skill, 6) >= 1 and cl_action.CheckHasInscription(skill, 13121):
            cl_action.AttackerAddState(skill, 33927, 1000, 0, { })
            cl_action.AddAttackerStateCount(skill, 33927, 1, iTime = 0, bFromAttack = False, bFromWeapon = False)
...
class CCartoon3(MeleeWeaponCartoon):
    ...
    def End(cls, skill):
        if cl_action.GetCartoonHitTargetCount(skill, 3) >= 1 and cl_action.CheckHasInscription(skill, 13121):
            cl_action.AttackerAddState(skill, 33927, 1000, 0, { })
            cl_action.AddAttackerStateCount(skill, 33927, 1, iTime = 0, bFromAttack = False, bFromWeapon = False)
