# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/attack/p9215.pyc
# RelativePath: clientlogic/cl_platformdata/pc/attack/p9215.pyc
...
from cl_commondefines import ATT_SHAPE_SPHERE, CRT_CHECK_SERVER, HIT_OVER_NORMAL, MONSTER_PART_WEAKNESS, OBJ_ALL, OBJ_ENEMY, SKILLCACHE_EXTRATRAJECTORY, SKILLCACHE_POS, WARRIOR_MONSTER, WARRIOR_OBSTACLE_NORMAL
...
class CCartoon3(DirectPosCartoon):
    ...
    def Hit(cls, skill):
        ...
        cl_action.SetSkillServerCache(skill, 'NotDrop', 1)
        cl_action.WeaponDamage(skill, {
...
class CCartoon0(ThrowByPowerCartoon):
    ...
    def Hit(cls, skill):
        ...
        if cl_action.CheckVictimType(skill, WARRIOR_MONSTER, OBJ_ALL) and cl_action.CheckVictimType(skill, WARRIOR_OBSTACLE_NORMAL, OBJ_ALL):
            cartoon = { }
    ...
    def InitSuccess(cls, skill, i1, cartoon):
        if not skill.m_CheckType == CRT_CHECK_SERVER:
            if not cls.EnableCheck(skill, start = cl_action.GetMuzzlePosition(skill, cartoon)):
                return None
            cls.EnableShow(skill, 0.7, (0, -10, 0), (1, 1), 500, True, True, 0, innerRadius = 0.05, pierce = skill.m_Cache['Pierce'], ignoreMonster = False, hitUnitBounciness = (0, 0), targettype = OBJ_ENEMY, hitovertype = HIT_OVER_NORMAL, changeRadius = 0, maxRadius = 3, iTriggerBullet = 0, checkWeaknessAngle = 0, checkWeaknessDis = 0)
