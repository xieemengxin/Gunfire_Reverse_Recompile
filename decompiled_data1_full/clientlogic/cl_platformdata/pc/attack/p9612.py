# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/attack/p9612.pyc
# RelativePath: clientlogic/cl_platformdata/pc/attack/p9612.pyc
# Source Generated with Decompyle++
# File: p9612.pyc (Python 3.6)
...
class CCartoon0(MeleeWeaponCartoon):
    ...
    def End(cls, skill):
        if cl_action.GetCartoonHitTargetCount(skill, 0) >= 1 and cl_action.CheckHasInscription(skill, 13121):
            cl_action.AttackerAddState(skill, 33927, 1000, 0, { })
            cl_action.AddAttackerStateCount(skill, 33927, 1, iTime = 0, bFromAttack = False, bFromWeapon = False)
