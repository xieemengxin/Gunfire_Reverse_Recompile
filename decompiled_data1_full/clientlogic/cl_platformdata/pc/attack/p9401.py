# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/attack/p9401.pyc
# RelativePath: clientlogic/cl_platformdata/pc/attack/p9401.pyc
...
class CCartoon3(DirectPosCartoon):
    ...
    def Hit(cls, skill):
        cl_action.PushVictim(skill, cl_action.GetEndPositionInCrt(skill, 3), 20, 5, 8000, angle = 0, iCartoonSID = -1, iIgnoreStruckCD = 0, iClient = 0)
