# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/attack/p9605.pyc
# RelativePath: clientlogic/cl_platformdata/pc/attack/p9605.pyc
# Source Generated with Decompyle++
# File: p9605.pyc (Python 3.6)
    ...
    def InitSuccess(cls, skill, i1, cartoon):
        if not skill.m_CheckType == CRT_CHECK_SERVER:
            ...
            cls.EnableShow(skill, [
                ...
                0.5,
                10,
                20], meshCount = 1, totalTime = 10, targettype = OBJ_ENEMY, pierceStatic = False, left2right = False, center2around = True, canCritical = True)
