# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/attack/p9092.pyc
# RelativePath: clientlogic/cl_platformdata/pc/attack/p9092.pyc
# Source Generated with Decompyle++
# File: p9092.pyc (Python 3.6)
...
class CCartoon0(ChargeCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if not skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableShow(skill, skill.m_Cache['ChargeTime'] // 3, cl_action.GetWeaponIntAttr(skill, 'CurBullet') if cl_action.CheckHasInscription(skill, 4960) else 4, 1, False, True, halfEnd = False, offsetTime = 0, breaktips = True)
