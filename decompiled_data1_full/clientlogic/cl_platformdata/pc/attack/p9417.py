# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/attack/p9417.pyc
# RelativePath: clientlogic/cl_platformdata/pc/attack/p9417.pyc
...
class CCartoon3(DirectPosCartoon):
    ...
    def Hit(cls, skill):
        cl_action.PushVictim(skill, cl_action.GetEndPositionInCrt(skill, 3), 20, 1.5, 5000, angle = 0, iCartoonSID = -1, iIgnoreStruckCD = 0, iClient = 0)
...
class CCartoon0(DirectPosCartoon):
    ...
    def Hit(cls, skill):
        cl_action.PushVictim(skill, cl_action.GetEndPositionInCrt(skill, 0), 20, 1.5, 5000, angle = 0, iCartoonSID = -1, iIgnoreStruckCD = 0, iClient = 0)
        cl_action.WeaponDamage(skill, {
            'Att': 100 }, { }, sendPFMsg = True)
