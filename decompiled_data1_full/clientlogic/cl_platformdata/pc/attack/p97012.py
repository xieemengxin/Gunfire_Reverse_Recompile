# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/attack/p97012.pyc
# RelativePath: clientlogic/cl_platformdata/pc/attack/p97012.pyc
# Source Generated with Decompyle++
# File: p97012.pyc (Python 3.6)
...
class CCartoon1(TimerCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if not skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableShow(skill, int(40 / (3 if skill.m_Cache['AttSpeed'] / 220 > 3 else skill.m_Cache['AttSpeed'] / 220)), 0)
