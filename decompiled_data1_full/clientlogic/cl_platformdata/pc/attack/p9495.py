# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/attack/p9495.pyc
# RelativePath: clientlogic/cl_platformdata/pc/attack/p9495.pyc
...
class CCartoon1(RayCastCartoon):
    ...
    def Hit(cls, skill):
        if not cl_action.CheckHasState(skill, 1511):
            ...
            cl_action.CreateBeaconSummon(skill, 1017, cl_action.GetCartoonHitFirstTargetPos(skill, 1), 1500, 1, 0, False)
    ...
    def InitSuccess(cls, skill, i1, cartoon):
        if not skill.m_CheckType == CRT_CHECK_SERVER:
            if not cls.EnableCheck(skill, start = cl_action.GetCameraCenterPosition(skill, cartoon)):
                return None
            cls.EnableShow(skill, 1, cl_action.GetWeaponAttDis(skill), 100, targettype = OBJ_ENEMY, liveTime = 0, radius = 0, flyoverdis = 0, passid = 0, extCheck = CRT_EXTCHECK_NONE)
