# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/attack/p9313.pyc
# RelativePath: clientlogic/cl_platformdata/pc/attack/p9313.pyc
# Source Generated with Decompyle++
# File: p9313.pyc (Python 3.6)
...
class CCartoon1(RayCastCartoon):
    ...
    def Hit(cls, skill):
        if cl_action.CheckHasState(skill, 33567):
            cartoon = { }
    ...
    def InitSuccess(cls, skill, i1, cartoon):
        if not skill.m_CheckType == CRT_CHECK_SERVER:
            if not cls.EnableCheck(skill, start = cl_action.GetCameraCenterPosition(skill, cartoon)):
                return None
            cls.EnableShow(skill, skill.m_Cache['Pierce'], cl_action.GetWeaponAttDis(skill), skill.m_Cache['BulletSpeed'], targettype = OBJ_ENEMY, liveTime = 0, radius = 0.25 if cl_action.CheckHasState(skill, 33566) else 0, flyoverdis = 0, passid = 0, extCheck = CRT_EXTCHECK_NONE)
