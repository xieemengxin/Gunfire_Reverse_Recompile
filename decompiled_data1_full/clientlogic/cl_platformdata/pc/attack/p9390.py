# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/attack/p9390.pyc
# RelativePath: clientlogic/cl_platformdata/pc/attack/p9390.pyc
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if not skill.m_CheckType == CRT_CHECK_SERVER:
            ...
            cls.EnableShow(skill, [
                ...
                1,
                40,
                0], meshCount = 1, totalTime = 4, targettype = OBJ_ENEMY, pierceStatic = False, left2right = False, center2around = True, canCritical = False)
