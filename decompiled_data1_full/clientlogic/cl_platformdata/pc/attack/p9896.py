# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/attack/p9896.pyc
# RelativePath: clientlogic/cl_platformdata/pc/attack/p9896.pyc
# Source Generated with Decompyle++
# File: p9896.pyc (Python 3.6)
...
class CCartoon2(SkillSummonCartoon):
    ...
    def Hit(cls, skill):
        if cl_action.IsCurSkillTrigger(skill, 2) or cl_action.CheckHasInscription(skill, 13034):
            ...
            cl_action.WeaponDamage(skill, {
                'Att': 225 if cl_action.CheckHasInscription(skill, 13030) else 150 }, {
...
class CCartoon0(ChargeCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if not skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableShow(skill, 50, 2, 1, False, False, effect = None, halfEnd = False, offsetTime = 0, breaktips = True)
