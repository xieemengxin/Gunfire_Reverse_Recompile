# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/attack/p9791.pyc
# RelativePath: clientlogic/cl_platformdata/pc/attack/p9791.pyc
...
class CCartoon1(TimerRangeCheckCartoon):
    ...
    def InitSuccess(cls, skill, index, cartoon):
        if not skill.m_CheckType == CRT_CHECK_SERVER:
            cls.EnableShow(skill, 40000, cl_action.GetHeroTrans(skill) if cl_action.IsHeroCtrl(skill) else 0, 20, OBJ_ENEMY, isCloseGround = True)
...
def Action(skill):
    if cl_action.IsHeroCtrl(skill):
        cl_action.AttackerAddState(skill, 1882, 0, 1, { })
        cartoon = { }
