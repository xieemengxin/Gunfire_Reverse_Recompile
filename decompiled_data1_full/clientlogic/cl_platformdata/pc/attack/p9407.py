# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/attack/p9407.pyc
# RelativePath: clientlogic/cl_platformdata/pc/attack/p9407.pyc
# Source Generated with Decompyle++
# File: p9407.pyc (Python 3.6)
...
class CCartoon3(RayCastCartoon):
    ...
    def End(cls, skill):
        cl_action.AddSceneEventForState(skill, cl_action.GetEndPositionInCrt(skill, 3), 192, 1, {
            ...
            'ShapeInc': 0,
            'IncTime': 200 }, 1091, 192, 1, iFightType = WARRIOR_MONSTER, iLeaveSetTime = -1)
        cartoon = { }
    ...
    def InitSuccess(cls, skill, i1, cartoon):
        if not skill.m_CheckType == CRT_CHECK_SERVER:
            if not cls.EnableCheck(skill, start = cl_action.GetCameraCenterPosition(skill, cartoon)):
                return None
            cls.EnableShow(skill, 1, cl_action.GetWeaponAttDis(skill), skill.m_Cache['BulletSpeed'], targettype = OBJ_ENEMY, liveTime = 0, radius = 0.8 if cl_action.CheckHasInscription(skill, 13072) else 0.4, flyoverdis = 0, passid = 0, extCheck = CRT_EXTCHECK_NONE)
