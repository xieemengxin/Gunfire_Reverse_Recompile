# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/attack/p9501.pyc
# RelativePath: clientlogic/cl_platformdata/pc/attack/p9501.pyc
# Source Generated with Decompyle++
# File: p9501.pyc (Python 3.6)
    ...
    def InitSuccess(cls, skill, i1, cartoon):
        if not skill.m_CheckType == CRT_CHECK_SERVER:
            if not cls.EnableCheck(skill, start = cl_action.GetCameraCenterPosition(skill, cartoon)):
                return None
            cls.EnableShow(skill, skill.m_Cache['Pierce'], cl_action.GetWeaponAttDis(skill), skill.m_Cache['BulletSpeed'], targettype = OBJ_ENEMY, effect = 0, liveTime = 0, trailEffect = 0, effectLiveTime = 5, radius = 0.3, flyoverdis = 0, passid = 0, extCheck = CRT_EXTCHECK_NONE)
