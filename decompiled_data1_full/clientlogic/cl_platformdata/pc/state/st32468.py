# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/state/st32468.pyc
# RelativePath: clientlogic/cl_platformdata/pc/state/st32468.pyc
# Source Generated with Decompyle++
# File: st32468.pyc (Python 3.6)
...
def CallBack0(oEventCB, oTarget):
    if cl_evcon.CheckCostBulletType(oTarget, oEventCB, 4503):
        cl_evact.StateAddSelfCount(oTarget, oEventCB, (lambda *a: Func208(*a)), None)
        if cl_evcon.StateCBGetSelfCount(oTarget, oEventCB) >= cl_evcon.GetFormula(oTarget, oEventCB, (lambda *a: 70 - Func402(*a) * 10)):
            cl_evact.StateAddSelfCount(oTarget, oEventCB, (lambda *a: Func402(*a) * 10 - 70), None)
