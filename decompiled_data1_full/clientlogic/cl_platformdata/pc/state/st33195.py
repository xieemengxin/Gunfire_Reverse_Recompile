# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/state/st33195.pyc
# RelativePath: clientlogic/cl_platformdata/pc/state/st33195.pyc
# Source Generated with Decompyle++
# File: st33195.pyc (Python 3.6)
...
def CallBack1(oEventCB, oTarget):
    ...
    cl_evact.StateCBUsePerform(oTarget, oEventCB, 7304, 0, {
        'SelfBoom': 0,
        'vStart': cl_evact.EventCBGetTargetPos(oTarget, oEventCB),
        'vEnd': cl_evact.EventCBGetCurPos(oTarget, oEventCB) }, None)
