# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/state/st1858.pyc
# RelativePath: clientlogic/cl_platformdata/pc/state/st1858.pyc
# Source Generated with Decompyle++
# File: st1858.pyc (Python 3.6)
...
import cl_evcon
import cl_state
from cl_commondefines import ATTACKERSUBMSG_NORMAL, NWARRIOR_DROP_RELIC, OBJ_ATTACK, OBJ_SELF, STATE_ADD_REPLACE, STATE_CLS_HELP, STATE_EFF_NONE
...
'sKey': 'EndlessRecycle' })))
    ...
    cl_action.CommonListenMsgCallBack(oTarget, oLifeCycle, cl_msgcenter.MSG_WAR_RECYCLEGOLDENCUP, -1, 5, 0, 0)


def StateCountAction(oTarget, oLifeCycle):
    cl_action.CommonSetSavedData(oTarget, oLifeCycle, 'EndlessRecycle', (lambda *a: Func404(*a)))
    cl_action.CommonChangeCareerPerformAttr(oTarget, oLifeCycle, 'ColdTime', (lambda *a: max(int(-Func404(*a) * 50), -9000)), 0, None)
...
def CallBack2(oEventCB, oTarget):
    cl_evact.EventChangeDamFactor(oTarget, oEventCB, OBJ_ATTACK, (lambda *a: 1000 * Func404(*a)), 0, 0, '')


def CallBack3(oEventCB, oTarget):
    if cl_condition.CheckIsEndless(oTarget, oEventCB.GetCBLifeCycle()):
        cl_action.StateAddState(oTarget, oEventCB.GetCBLifeCycle(), 1862, 0, { }, 0)
