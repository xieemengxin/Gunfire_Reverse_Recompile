# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/state/st33726.pyc
# RelativePath: clientlogic/cl_platformdata/pc/state/st33726.pyc
# Source Generated with Decompyle++
# File: st33726.pyc (Python 3.6)
...
'sArg': 'StatusEffect' })), 0, 0, 0)
    cl_evact.StateCBSelfRemove(oTarget, oEventCB)


class CState(cl_state.CState):
    m_SID = 33726
    m_Name = '#NT#园丁E灵佑植物首次攻击伤害增加'
