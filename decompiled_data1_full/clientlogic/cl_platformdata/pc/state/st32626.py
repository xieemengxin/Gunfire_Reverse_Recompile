# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/state/st32626.pyc
# RelativePath: clientlogic/cl_platformdata/pc/state/st32626.pyc
# Source Generated with Decompyle++
# File: st32626.pyc (Python 3.6)
...
def CallBack0(oEventCB, oTarget):
    if cl_evcon.StateCBGetSelfCount(oTarget, oEventCB) > 0:
        ...
        cl_evact.EventCBChangeLuckyHit(oTarget, oEventCB, (lambda *a: 25 + 25 * Func402(*a)))
