# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/state/st1532.pyc
# RelativePath: clientlogic/cl_platformdata/pc/state/st1532.pyc
# Source Generated with Decompyle++
# File: st1532.pyc (Python 3.6)
...
from cl_newformula import Func207, Func364, Func404, Func437, Func598, Func707
...
def StateActAction(oTarget, oLifeCycle):
    ...
    cl_action.CommonListenMsgCallBack(oTarget, oLifeCycle, cl_msgcenter.MSG_WAR_UPDATE_STATECOUNTEFF, -1, 5, 0, 0)
    if cl_condition.CalFormula(oTarget, oLifeCycle, (lambda *a: Func598(*a, **{
'sKey': 'PF5850' }))) > 0:
        cl_action.StateSetSelfCount(oTarget, oLifeCycle, (lambda *a: (Func598(*a, **{
'sKey': 'PF5850' }) // 100) * Func707(*a)))
    else:
        cl_action.CommonListenWarMgrMsgCallBack(oTarget, oLifeCycle, cl_msgcenter.MSG_WARMGR_ADDALLPLAYER, -1, 4)
...
def CallBack4(oEventCB, oTarget):
    cl_evact.EventCBSetSavedData(oTarget, oEventCB, 'PF5850', (lambda *a: Func404(*a) * 100 + Func437(*a, **{
'sKey': 'st1532_WarCash' })), 1)
