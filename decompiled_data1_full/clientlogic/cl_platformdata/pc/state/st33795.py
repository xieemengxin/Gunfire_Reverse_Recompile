# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/state/st33795.pyc
# RelativePath: clientlogic/cl_platformdata/pc/state/st33795.pyc
# Source Generated with Decompyle++
# File: st33795.pyc (Python 3.6)
...
def StateActAction(oTarget, oLifeCycle):
    ...
    cl_action.StateRefreshStateExtraInfo(oTarget, oLifeCycle, {
        'SrcLV': oLifeCycle.m_Owner.GetArgValue('Att') })


def CallBack0(oEventCB, oTarget):
    cl_evact.EventChangeDamFactor(oTarget, oEventCB, OBJ_ATTACK, (lambda *a: Func429(*a, **{
'sArg': 'Att' }) * Func404(*a)), 0, DAM_TYPE_WEAPON, '')


def CallBack1(oEventCB, oTarget):
    cl_evact.StateAddSelfCount(oTarget, oEventCB, (lambda *a: Func208(*a)), (lambda *a: Func429(*a, **{
'sArg': 'StatusEffect' })))
