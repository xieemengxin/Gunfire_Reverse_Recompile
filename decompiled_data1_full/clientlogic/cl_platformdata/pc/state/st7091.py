# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/state/st7091.pyc
# RelativePath: clientlogic/cl_platformdata/pc/state/st7091.pyc
...
def CallBack0(oEventCB, oTarget):
    ...
    if cl_condition.CalFormula(oTarget, oEventCB.GetCBLifeCycle(), (lambda *a: Func205(*a))) < 2:
        cl_action.CommonChangeAttr(oTarget, oEventCB.GetCBLifeCycle(), 'MoveSpeed', -4300, 0, None)
    elif cl_condition.CalFormula(oTarget, oEventCB.GetCBLifeCycle(), (lambda *a: Func205(*a))) < 3:
        cl_action.CommonChangeAttr(oTarget, oEventCB.GetCBLifeCycle(), 'MoveSpeed', -5000, 0, None)
    else:
        cl_action.CommonChangeAttr(oTarget, oEventCB.GetCBLifeCycle(), 'MoveSpeed', -5200, 0, None)
...
def CallBack5(oEventCB, oTarget):
    if cl_condition.StateGetSelfCount(oTarget, oEventCB.GetCBLifeCycle()) < cl_condition.CalFormula(oTarget, oEventCB.GetCBLifeCycle(), (lambda *a: (Func205(*a) - 1) * 1 + 2)):
        cl_action.CommonChangeAttr(oTarget, oEventCB.GetCBLifeCycle(), 'MoveSpeed', (lambda *a: -4300 - Func404(*a) * 1500), 0, None)
    else:
        cl_evact.EventGetTargetByType(oTarget, oEventCB, OBJ_SELF)
        cl_evact.StateCBRemoveStateFromSelf(oTarget, oEventCB, 1009)
        cl_evact.StateCBSelfRemove(oTarget, oEventCB)
...
def CallBack6(oEventCB, oTarget):
    if cl_condition.StateGetSelfCount(oTarget, oEventCB.GetCBLifeCycle()) < cl_condition.CalFormula(oTarget, oEventCB.GetCBLifeCycle(), (lambda *a: (Func205(*a) - 1) * 1 + 2)):
        cl_action.CommonChangeAttr(oTarget, oEventCB.GetCBLifeCycle(), 'MoveSpeed', (lambda *a: -5000 - Func404(*a) * 600), 0, None)
    else:
        cl_evact.EventGetTargetByType(oTarget, oEventCB, OBJ_SELF)
        cl_evact.StateCBRemoveStateFromSelf(oTarget, oEventCB, 1009)
        cl_evact.StateCBSelfRemove(oTarget, oEventCB)
...
def CallBack7(oEventCB, oTarget):
    if cl_condition.StateGetSelfCount(oTarget, oEventCB.GetCBLifeCycle()) < cl_condition.CalFormula(oTarget, oEventCB.GetCBLifeCycle(), (lambda *a: (Func205(*a) - 1) * 1 + 2)):
        cl_action.CommonChangeAttr(oTarget, oEventCB.GetCBLifeCycle(), 'MoveSpeed', (lambda *a: -5200 - Func404(*a) * 400), 0, None)
    else:
        cl_evact.EventGetTargetByType(oTarget, oEventCB, OBJ_SELF)
        cl_evact.StateCBRemoveStateFromSelf(oTarget, oEventCB, 1009)
        cl_evact.StateCBSelfRemove(oTarget, oEventCB)
