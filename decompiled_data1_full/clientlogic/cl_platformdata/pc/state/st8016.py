# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/state/st8016.pyc
# RelativePath: clientlogic/cl_platformdata/pc/state/st8016.pyc
# Source Generated with Decompyle++
# File: st8016.pyc (Python 3.6)
...
def StateActAction(oTarget, oLifeCycle):
    ...
    cl_action.CommonListenMsgCallBack(oTarget, oLifeCycle, cl_msgcenter.MSG_WAR_ADDIMMOBILIZE, -1, 4, 0, 0)


def StateCountAction(oTarget, oLifeCycle):
    if cl_condition.StateGetSelfCount(oTarget, oLifeCycle) == 0:
        oTarget.m_State.RemoveItem(oLifeCycle.m_Owner.m_ID)
        cl_action.CommonHaltPointPerform(oTarget, oLifeCycle, 24013)


def StateRemoveAction(oTarget, oLifeCycle):
    cl_action.CommonRemoveOwnerState(oTarget, oLifeCycle, 8108, 0)
