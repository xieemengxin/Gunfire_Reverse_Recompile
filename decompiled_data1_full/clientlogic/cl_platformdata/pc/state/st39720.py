# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/state/st39720.pyc
# RelativePath: clientlogic/cl_platformdata/pc/state/st39720.pyc
# Source Generated with Decompyle++
# File: st39720.pyc (Python 3.6)
...
import cl_evcon
import cl_state
from cl_commondefines import DAM_TYPE_FIRE, DAM_TYPE_NORMAL, OBJECT_OWNER, OBJECT_SERVANT, OBJ_SELF, PF_SUBMSG_CAREERPF, PF_SUBMSG_THROW, PF_TYPE_CAREERPF, PF_TYPE_THROW, STATE_ADD_EXCLUDE, STATE_CLS_HELP, STATE_EFF_NONE
...
def CallBack4(oEventCB, oTarget):
    ...
    if cl_condition.CalFormula(oTarget, oEventCB.GetCBLifeCycle(), (lambda *a: Func402(*a))) >= 5:
        cl_action.CommonChangePositiveElementFactorByType(oTarget, oEventCB.GetCBLifeCycle(), DAM_TYPE_FIRE, 2500)
