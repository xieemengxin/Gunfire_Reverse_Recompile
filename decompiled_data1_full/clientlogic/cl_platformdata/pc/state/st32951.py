# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/state/st32951.pyc
# RelativePath: clientlogic/cl_platformdata/pc/state/st32951.pyc
# Source Generated with Decompyle++
# File: st32951.pyc (Python 3.6)
...
def StateActAction(oTarget, oLifeCycle):
    cl_action.CommonChangePerformAttr(oTarget, oLifeCycle, 1631, 'Att', 0, (lambda *a: 5000 * Func223(*a)))
...
def CallBack0(oEventCB, oTarget):
    cl_action.CommonChangePerformAttr(oTarget, oEventCB.GetCBLifeCycle(), 1631, 'Att', 0, (lambda *a: 5000 * Func223(*a)))
