# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/state/st32669.pyc
# RelativePath: clientlogic/cl_platformdata/pc/state/st32669.pyc
# Source Generated with Decompyle++
# File: st32669.pyc (Python 3.6)
...
def CallBack0(oEventCB, oTarget):
    ...
    if cl_evcon.EventCBCheckTargetCDByMark(oTarget, oEventCB, '32671', None) == 0:
        ...
        cl_evact.EventCBUsePerformEvtTarget(oTarget, oEventCB, 1703, {
            'PerformAtt': (lambda *a: 30000 + 4500 * Func526(*a)) }, None)
        cl_evact.EventGetTargetByType(oTarget, oEventCB, OBJ_SELF)
...
def CallBack2(oEventCB, oTarget):
    ...
    cl_evact.EventGetTargetByType(oTarget, oEventCB, OBJ_SELF)
    cl_evact.StateCBAddVictimState(oTarget, oEventCB, 32670, 0, 0, { }, 0, None, None)
