# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/state/st1539.pyc
# RelativePath: clientlogic/cl_platformdata/pc/state/st1539.pyc
# Source Generated with Decompyle++
# File: st1539.pyc (Python 3.6)
...
def CallBack0(oEventCB, oTarget):
    if cl_condition.StateGetSelfCount(oTarget, oEventCB.GetCBLifeCycle()) == 0:
        ...
        cl_evact.StateCBAddTargetStateTime(oTarget, oEventCB, 1538, 10, 10, None)
