# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/state/st1655.pyc
# RelativePath: clientlogic/cl_platformdata/pc/state/st1655.pyc
# Source Generated with Decompyle++
# File: st1655.pyc (Python 3.6)
...
def StateActAction(oTarget, oLifeCycle):
    ...
    cl_action.StateChangeSourceWeaponAttr(oTarget, oLifeCycle, 'CrazyEff', 20000, 0)
...
def StateCountAction(oTarget, oLifeCycle):
    if cl_condition.StateCheckSourceWeaponHasInscription(oTarget, oLifeCycle, 4962) and cl_condition.StateGetSelfCount(oTarget, oLifeCycle) > 1:
        cl_action.StateChangeSourceWeaponAttr(oTarget, oLifeCycle, 'CrazyEff', (lambda *a: Func404(*a) * 1000 + 20000), 0)


def StateRemoveAction(oTarget, oLifeCycle):
    cl_action.CommonDirectEventCBFunc(oTarget, oLifeCycle, 6, None, None)
    cl_action.StateChangeSourceWeaponAttr(oTarget, oLifeCycle, 'CrazyEff', 0, 0)


def CallBack0(oEventCB, oTarget):
    if not cl_evcon.CheckFromPointPerform(oTarget, oEventCB, 9215, 1, 0) and cl_evcon.StateCheckFromSameItem(oTarget, oEventCB) or cl_evcon.CheckHitPart(oTarget, oEventCB, MONSTER_PART_WEAKNESS):
