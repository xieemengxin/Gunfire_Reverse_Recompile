# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/state/st1294.pyc
# RelativePath: clientlogic/cl_platformdata/pc/state/st1294.pyc
# Source Generated with Decompyle++
# File: st1294.pyc (Python 3.6)
...
def CallBack0(oEventCB, oTarget):
    if cl_evcon.CheckEleDamType(oTarget, oEventCB, DAM_TYPE_CORRISION, None):
        cl_evact.EventChangeDamFactor(oTarget, oEventCB, OBJ_VICTIM, 5000, 0, DAM_TYPE_CORRISION, '')
