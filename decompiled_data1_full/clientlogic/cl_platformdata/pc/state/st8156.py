# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/state/st8156.pyc
# RelativePath: clientlogic/cl_platformdata/pc/state/st8156.pyc
# Source Generated with Decompyle++
# File: st8156.pyc (Python 3.6)
...
def CallBack0(oEventCB, oTarget):
    ...
    cl_evact.EventSetTargetMark(oTarget, oEventCB, 'StrengthLockState', 1)
    cl_action.CommonSendStateStartMessage(oTarget, oEventCB.GetCBLifeCycle(), 0, 1)


def CallBack1(oEventCB, oTarget):
    cl_evact.EventGetStateInfoTarget(oTarget, oEventCB)
    cl_evact.EventClearTargetMark(oTarget, oEventCB, 'StrengthLockState', 1, 1)
    cl_action.CommonSendStateMessage(oTarget, oEventCB.GetCBLifeCycle(), 0, {
        'TransFlag': (lambda *a: Func437(*a, **{
'sKey': 'TransFlag' })) })
