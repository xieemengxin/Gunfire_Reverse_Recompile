# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/state/st1284.pyc
# RelativePath: clientlogic/cl_platformdata/pc/state/st1284.pyc
# Source Generated with Decompyle++
# File: st1284.pyc (Python 3.6)
...
def CallBack0(oEventCB, oTarget):
    if cl_evcon.StateCheckFromSameItem(oTarget, oEventCB):
        ...
        if cl_evcon.GetTargetStateCount(oTarget, oEventCB, 1284, None, None) == 1:
