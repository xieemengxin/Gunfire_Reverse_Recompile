# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/state/st32295.pyc
# RelativePath: clientlogic/cl_platformdata/pc/state/st32295.pyc
# Source Generated with Decompyle++
# File: st32295.pyc (Python 3.6)
...
def CallBack1(oEventCB, oTarget):
    cl_evact.StateCBChangeSkillDamFactor(oTarget, oEventCB, (lambda *a: Func404(*a) * 4000), 0, DAM_TYPE_WEAPON, None, 0)
    cl_evact.StateSetSelfCount(oTarget, oEventCB, 0)


def CallBack2(oEventCB, oTarget):
    cl_evact.StateCBChangeSkillDamFactor(oTarget, oEventCB, (lambda *a: Func404(*a) * 4000), 0, DAM_TYPE_PERFORM, None, 0)
    cl_evact.StateSetSelfCount(oTarget, oEventCB, 0)
