# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/state/st33737.pyc
# RelativePath: clientlogic/cl_platformdata/pc/state/st33737.pyc
# Source Generated with Decompyle++
# File: st33737.pyc (Python 3.6)
...
def StateActAction(oTarget, oLifeCycle):
    ...
    cl_action.CommonRefreshStateExtraInfo(oTarget, oLifeCycle, {
        'SrcLV': (lambda *a: Func402(*a)) }, 33737)
    ...
    if oLifeCycle.m_Owner.GetArgValue('StatusEffect') == 3:
        cl_action.CommonChangePositiveElementFactorByType(oTarget, oLifeCycle, DAM_TYPE_CORRISION, 5000)
