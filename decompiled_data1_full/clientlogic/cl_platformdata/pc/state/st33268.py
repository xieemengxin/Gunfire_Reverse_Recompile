# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/state/st33268.pyc
# RelativePath: clientlogic/cl_platformdata/pc/state/st33268.pyc
# Source Generated with Decompyle++
# File: st33268.pyc (Python 3.6)
...
'b': 100 }))):
            cl_action.CommonSetPerformArgs(oTarget, oEventCB.GetCBLifeCycle(), 3615, 'ReturnThreshold', cl_evcon.GetWeaponPerformMaxPFBulletByHoldType(oTarget, oEventCB, MAIN_HOLD) * 33 // 100 + 1, None)
...
'sArgs': 'ReturnThreshold' }))):
                ...
                cl_action.CommonSetPerformArgs(oTarget, oEventCB.GetCBLifeCycle(), 3615, 'ReturnThreshold', cl_evcon.GetWeaponPerformMaxPFBulletByHoldType(oTarget, oEventCB, MAIN_HOLD) * 33 // 100, None)
                cl_evact.EventGetTargeIDtByType(oTarget, oEventCB, OBJ_SELF)
                if cl_evcon.GetWeaponPerformPFBulletCountByHoldType(oTarget, oEventCB, MAIN_HOLD) < cl_evcon.GetFormula(oTarget, oEventCB, (lambda *a: Func361(*a, **{
'sid': 3615,
'sArgs': 'ReturnThreshold' }))):
