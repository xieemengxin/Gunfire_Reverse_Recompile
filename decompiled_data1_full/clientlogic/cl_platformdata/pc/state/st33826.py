# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/state/st33826.pyc
# RelativePath: clientlogic/cl_platformdata/pc/state/st33826.pyc
...
def CustomAction(oTarget, oEventCB, dInfo):
    oGardencon = oTarget.m_GardenerCon
    if not oGardencon:
        return None
    dEventInfo = oEventCB.GetCBEventInfo()
    dMsgInfo = oEventCB.GetCBMsgInfo()
    iScale = cl_formula.GetResultByData(oTarget, dInfo['Scale'], dEventInfo, dMsgInfo)
    fScale = iScale / 100
    oGardencon.ResetBarrierExtraPhyModel(fScale)
