# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/state/st32587.pyc
# RelativePath: clientlogic/cl_platformdata/pc/state/st32587.pyc
# Source Generated with Decompyle++
# File: st32587.pyc (Python 3.6)
...
def CallBack0(oEventCB, oTarget):
    ...
    if cl_evcon.CheckTalentLevel(oTarget, oEventCB, 2918) == 1:
        cl_evact.StateSetSelfCount(oTarget, oEventCB, CustomAction(oTarget, oEventCB.GetCBLifeCycle(), {
            'Normal': 0.95,
            'Elite': 0.9,
            'Boss': 0.85,
            'Count': 1 }))
    elif cl_evcon.CheckTalentLevel(oTarget, oEventCB, 2918) == 2:
        cl_evact.StateSetSelfCount(oTarget, oEventCB, CustomAction(oTarget, oEventCB.GetCBLifeCycle(), {
            'Normal': 0.9,
            'Elite': 0.8,
            'Boss': 0.7,
