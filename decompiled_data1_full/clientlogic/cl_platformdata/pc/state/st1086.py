# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/state/st1086.pyc
# RelativePath: clientlogic/cl_platformdata/pc/state/st1086.pyc
# Source Generated with Decompyle++
# File: st1086.pyc (Python 3.6)
...
def StateCountAction(oTarget, oLifeCycle):
    if cl_condition.StateGetSelfCount(oTarget, oLifeCycle) >= 2:
        cl_action.StateAddState(oTarget, oLifeCycle, 1087, 300, { }, None)
