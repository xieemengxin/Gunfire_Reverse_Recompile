# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/state/st1741.pyc
# RelativePath: clientlogic/cl_platformdata/pc/state/st1741.pyc
# Source Generated with Decompyle++
# File: st1741.pyc (Python 3.6)
...
def CallBack0(oEventCB, oTarget):
    ...
    if not cl_evcon.CheckFightType(oTarget, oEventCB, WARRIOR_MONSTER) and cl_evcon.CheckTargetPointBaseMonsters(oTarget, oEventCB, {
        ...
        if cl_condition.StateGetSelfCount(oTarget, oEventCB.GetCBLifeCycle()) >= 40:
