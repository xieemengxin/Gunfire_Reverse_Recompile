# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/state/st32668.pyc
# RelativePath: clientlogic/cl_platformdata/pc/state/st32668.pyc
# Source Generated with Decompyle++
# File: st32668.pyc (Python 3.6)
...
def CallBack0(oEventCB, oTarget):
    ...
    if cl_evcon.EventCBCheckTargetCDByMark(oTarget, oEventCB, '32671', None) == 0:
        ...
        cl_evact.EventCBUsePerformEvtTarget(oTarget, oEventCB, 1701, {
            'PerformAtt': (lambda *a: 50000 + 7500 * Func526(*a)) }, None)
        cl_evact.EventGetTargetByType(oTarget, oEventCB, OBJ_SELF)
...
def CallBack2(oEventCB, oTarget):
    ...
    cl_evact.EventGetTargetByType(oTarget, oEventCB, OBJ_SELF)
    cl_evact.StateCBAddVictimState(oTarget, oEventCB, 32669, 0, 0, { }, 0, None, None)
