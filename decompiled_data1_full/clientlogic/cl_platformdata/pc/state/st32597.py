# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/state/st32597.pyc
# RelativePath: clientlogic/cl_platformdata/pc/state/st32597.pyc
# Source Generated with Decompyle++
# File: st32597.pyc (Python 3.6)
...
def CallBack2(oEventCB, oTarget):
    if cl_condition.CheckHasPerform(oTarget, oEventCB.GetCBLifeCycle(), 6079):
        cl_evact.EventCBStartThrowSkill(oTarget, oEventCB, 1421, None, { })
    else:
        cl_evact.EventCBStartClientSkill(oTarget, oEventCB, 12004, '', None, None, { })
