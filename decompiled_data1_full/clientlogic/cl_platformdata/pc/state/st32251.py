# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/state/st32251.pyc
# RelativePath: clientlogic/cl_platformdata/pc/state/st32251.pyc
# Source Generated with Decompyle++
# File: st32251.pyc (Python 3.6)
...
def CallBack0(oEventCB, oTarget):
    if cl_condition.CheckCurLevel(oTarget, oEventCB.GetCBLifeCycle(), 1301003):
        ...
        cl_evact.EventGetTargetByType(oTarget, oEventCB, OBJ_SELF)
        cl_evact.EventTargetGetRangeTargetByFightType(oTarget, oEventCB, 25, WARRIOR_MONSTER, 1, 0, 7, 0, None, None, None)
