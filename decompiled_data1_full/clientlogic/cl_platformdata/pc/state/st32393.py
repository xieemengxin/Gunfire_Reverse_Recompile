# Path: /Users/caoguangpei/个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_platformdata/pc/state/st32393.pyc
# RelativePath: clientlogic/cl_platformdata/pc/state/st32393.pyc
# Source Generated with Decompyle++
# File: st32393.pyc (Python 3.6)
...
def StateActAction(oTarget, oLifeCycle):
    ...
    if cl_condition.StateGetSelfCount(oTarget, oLifeCycle) <= 0:
        cl_action.StateSetSelfCount(oTarget, oLifeCycle, oLifeCycle.m_Owner.GetArgValue('TalentAffection'))
