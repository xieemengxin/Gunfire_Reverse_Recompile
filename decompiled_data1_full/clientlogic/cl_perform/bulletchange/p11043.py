# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_perform/bulletchange/p11043.pyc
# RelativePath: clientlogic/cl_perform/bulletchange/p11043.pyc
# Source Generated with Decompyle++
# File: p11043.pyc (Python 3.6)
...
def DoCallBackAction1(oWarrior, pfBulletChange, oSkill, dClientInfo):
    if condition.CheckBulletConsume(oWarrior, pfBulletChange, oSkill, dClientInfo):
        ...
        action.BulletChangeRevertBullet(oWarrior, pfBulletChange, oSkill, dClientInfo, (lambda *a: Func309(*a) * 1 + 1), 0)
