# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_perform/cartoon/crt_octopus.pyc
# RelativePath: clientlogic/cl_perform/cartoon/crt_octopus.pyc
# Source Generated with Decompyle++
# File: crt_octopus.pyc (Python 3.6)
...
class OctopusCartoon(CBaseCartoon):
    ...
    def InitTraceClient(cls, oSkill, dCartoon, iPierce, fDistance, targettype = OBJ_ALL, fRadius = 0, fBulletSpeed = 0, iMaxEffectCnt = 0, **kwargs):
        dCartoon['TargetType'] = targettype
        dCartoon['BulletSpeed'] = fBulletSpeed
        dCartoon['MaxEffectCnt'] = iMaxEffectCnt
        iNodeID = dCartoon['ID']
        dClient = oSkill.m_NetReceive[iNodeID]
        dCartoon['Distance'] = dClient['Distance']
    ...
    def InitTraceServer(cls, oSkill, dCartoon, vStart, vEnd, iPierce, fDistance, targettype = OBJ_ALL, fRadius = 0, fBulletSpeed = 0, iMaxEffectCnt = 0, **kwargs):
        pass
