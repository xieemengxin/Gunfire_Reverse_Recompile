# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_perform/cartoon/crt_scatterline.pyc
# RelativePath: clientlogic/cl_perform/cartoon/crt_scatterline.pyc
# Source Generated with Decompyle++
# File: crt_scatterline.pyc (Python 3.6)
...
class ScatterLineCartoon(CBaseCartoon):
    ...
    def HitTargetClient(cls, oSkill, dCartoon):
        ...
        if 'Ray' in dClient and 'Trigger' in dClient:
            iHit = 1
            lstRay = dClient['Ray']
            iPierce = dCartoon['Pierce'] * len(lstRay)
            lstVLST = []
            lstSend = []
            lstHitInfo = []
