# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_perform/monsteraf/p6101.pyc
# RelativePath: clientlogic/cl_perform/monsteraf/p6101.pyc
# Source Generated with Decompyle++
# File: p6101.pyc (Python 3.6)
...
from cl_commondefines import MAF_TYPE_FIRE, TYPE_PASSIVE_TIME_CYCLE
...
def DoCallBackAction0(oEventCB, oWarrior):
    if cl_evcon.GetFormula(oWarrior, oEventCB, (lambda *a: Func221(*a))) >= 9:
        cl_action.PassiveCycleExecCBFuncAction(oWarrior, oEventCB.GetCBLifeCycle(), 200, 1000, 3)
    else:
        cl_action.PassiveCycleExecCBFuncAction(oWarrior, oEventCB.GetCBLifeCycle(), 200, 1000, 3)
...
def DoCallBackAction1(oEventCB, oWarrior):
    if cl_evcon.GetFormula(oWarrior, oEventCB, (lambda *a: Func221(*a))) >= 9:
        cl_action.PassiveCycleExecCBFuncAction(oWarrior, oEventCB.GetCBLifeCycle(), 100, 600, 3)
    else:
        cl_action.PassiveCycleExecCBFuncAction(oWarrior, oEventCB.GetCBLifeCycle(), 200, 1000, 3)
