# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_season/pc/season3/gst1050.pyc
# RelativePath: clientlogic/cl_season/pc/season3/gst1050.pyc
# Source Generated with Decompyle++
# File: gst1050.pyc (Python 3.6)
...
def DoCallBackAction0(oEventCB, oTarget):
    if eventcondi.CommonCBCheckWarRound(oTarget, oEventCB) == 3:
        if eventcondi.CommonCBGetSeasonNum(oTarget, oEventCB) == 1 or eventcondi.CommonCBGetSeasonNum(oTarget, oEventCB) == 2:
