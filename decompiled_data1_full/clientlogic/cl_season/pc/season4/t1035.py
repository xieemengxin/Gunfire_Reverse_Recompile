# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_season/pc/season4/t1035.pyc
# RelativePath: clientlogic/cl_season/pc/season4/t1035.pyc
...
def DoCallBackAction0(oEventCB, oListener):
    if cl_evcon.EventCBGetMsgInfo(oListener, oEventCB, 'ChangeNum') < 0:
        cl_evact.CBAddWarSeasonTaskValue(oListener, oEventCB, (lambda *a: -Func725(*a)))


def DoCallBackAction1(oEventCB, oListener):
    if cl_evcon.CheckSettleType(oListener, oEventCB, SETTLE_FINISHWAR) and cl_evcon.SeasonTaskCBCheckWarValue(oListener, oEventCB, 6):
