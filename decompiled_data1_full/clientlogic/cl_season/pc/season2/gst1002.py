# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_season/pc/season2/gst1002.pyc
# RelativePath: clientlogic/cl_season/pc/season2/gst1002.pyc
...
def DoCallBackAction0(oEventCB, oTarget):
    if eventcondi.CommonCBGetSeasonNum(oTarget, oEventCB) == 1 and eventcondi.CommonCBCheckWarRound(oTarget, oEventCB) == 3:
