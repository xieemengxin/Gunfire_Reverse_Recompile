# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_season/pc/season2/gst1005.pyc
# RelativePath: clientlogic/cl_season/pc/season2/gst1005.pyc
# Source Generated with Decompyle++
# File: gst1005.pyc (Python 3.6)

from cl_commondefines import SEASONSUBTASK_TYPE_ADD, SEASONTASK_EXTINFO_TYPE_DEVICE, SETTLE_FINISHWAR
...
def DoCallBackAction0(oEventCB, oTarget):
    if eventcondi.CommonCBCheckWarEndType(oTarget, oEventCB, SETTLE_FINISHWAR) and eventcondi.CommonCBGetSeasonNum(oTarget, oEventCB) == 2:
        eventact.CBAddSeasonSonTaskValue(oTarget, oEventCB, 'Device', 1, SEASONSUBTASK_TYPE_ADD)
