# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_season/pc/season2/gst1046.pyc
# RelativePath: clientlogic/cl_season/pc/season2/gst1046.pyc
# Source Generated with Decompyle++
# File: gst1046.pyc (Python 3.6)
...
def DoCallBackAction0(oEventCB, oTarget):
    if eventcondi.CommonCBCheckWarEndType(oTarget, oEventCB, SETTLE_FINISHWAR):
        if eventcondi.CommonCBCheckHero(oTarget, oEventCB, 216) or eventcondi.CommonCBCheckHero(oTarget, oEventCB, 206):
