# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_season/pc/season2/gst1010.pyc
# RelativePath: clientlogic/cl_season/pc/season2/gst1010.pyc
# Source Generated with Decompyle++
# File: gst1010.pyc (Python 3.6)
...
def DoCallBackAction0(oEventCB, oTarget):
    if eventcondi.CommonCBCheckWarEndType(oTarget, oEventCB, SETTLE_FINISHWAR) and eventcondi.CommonCBGetSeasonNum(oTarget, oEventCB) == 2 and eventcondi.CommonCBSeasonDamageProportionFromReport(oTarget, oEventCB) > 40:
