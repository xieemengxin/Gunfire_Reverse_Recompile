# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_season/pc/season5/t1046.pyc
# RelativePath: clientlogic/cl_season/pc/season5/t1046.pyc
...
def DoCallBackAction0(oEventCB, oListener):
    if cl_evcon.CheckFromMinorPerform(oListener, oEventCB):
        cl_evact.CBAddSeasonTaskValue(oListener, oEventCB, (lambda *a: Func444(*a) // 100))


class CSeasonTask(CCustom):
    m_SID = 1046
    m_TargetValue = 1000000000
    m_TaskValue = 1500
    m_ShowTotalValue = 0
    m_ShowAccuracy = 1
    m_WarShowAccuracy = 1
