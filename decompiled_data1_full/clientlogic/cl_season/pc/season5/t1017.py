# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_season/pc/season5/t1017.pyc
# RelativePath: clientlogic/cl_season/pc/season5/t1017.pyc
...
def EnableAction(oListener, oLifeCycle):
    ...
    if cl_condition.CheckHero(oListener, oLifeCycle, 217):
        ...
        cl_action.CommonListenMsgCallBack(oListener, oLifeCycle, cl_msgcenter.MSG_WAR_PERFORM_END, PF_SUBMSG_THROW, 1, 0, 0)
        cl_action.CommonListenServantMsgCallBack(oListener, oLifeCycle, cl_msgcenter.MSG_WAR_PERFORM_END, PF_SUBMSG_THROW, 1)
...
def DoCallBackAction0(oEventCB, oListener):
    ...
    if cl_evcon.CheckPerformType(oListener, oEventCB, PF_TYPE_THROW, 0) and cl_evcon.CheckTargetSideType(oListener, oEventCB, OBJ_ENEMY):
        cl_evact.EventCBRecordSkillCollectTarget(oListener, oEventCB, 's5task1017', 0)


def DoCallBackAction1(oEventCB, oListener):
    if cl_evact.EventCBGetSkillCollectTargetNum(oListener, oEventCB, 's5task1017', 0) > cl_evcon.SeasonTaskCBGetWarValue(oListener, oEventCB):
        cl_evact.CBSetWarSeasonTaskValue(oListener, oEventCB, cl_evact.EventCBGetSkillCollectTargetNum(oListener, oEventCB, 's5task1017', None))
        if cl_evcon.SeasonTaskCBCheckWarValue(oListener, oEventCB, 10):
            cl_evact.CBAddSeasonTaskValue(oListener, oEventCB, 1)
    cl_evact.EventCBClearCollectInfo(oListener, oEventCB, 's5task1017', 0)
...
def DoCallBackAction3(oEventCB, oListener):
    cl_evact.EventGetTargetByType(oListener, oEventCB, OBJ_VICTIM)
    if cl_evcon.CheckDamFromSelf(oListener, oEventCB, 0):
        cl_evact.EventGetTargetByType(oListener, oEventCB, OBJ_VICTIM)
        if cl_evcon.CheckPerformType(oListener, oEventCB, PF_TYPE_THROW, 0) and cl_evcon.CheckTargetSideType(oListener, oEventCB, OBJ_ENEMY):
            cl_evact.EventCBRecordSkillCollectTarget(oListener, oEventCB, 's5task1017', 0)
...
def DoCallBackAction4(oEventCB, oListener):
    cl_evact.EventGetTargetByType(oListener, oEventCB, OBJ_VICTIM)
    if cl_evcon.CheckPerformType(oListener, oEventCB, PF_TYPE_THROW, 0) and cl_evcon.CheckTargetSideType(oListener, oEventCB, OBJ_ENEMY):
        cl_evact.EventCBRecordSkillCollectTarget(oListener, oEventCB, 's5task1017', 1)
        if cl_evact.EventCBGetSkillCollectTargetNum(oListener, oEventCB, 's5task1017', 1) > cl_evcon.SeasonTaskCBGetWarValue(oListener, oEventCB):
            cl_evact.CBSetWarSeasonTaskValue(oListener, oEventCB, cl_evact.EventCBGetSkillCollectTargetNum(oListener, oEventCB, 's5task1017', 1))
            if cl_evcon.SeasonTaskCBCheckWarValue(oListener, oEventCB, 10):
                cl_evact.CBAddSeasonTaskValue(oListener, oEventCB, 1)
