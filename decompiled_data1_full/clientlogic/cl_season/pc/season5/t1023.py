# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_season/pc/season5/t1023.pyc
# RelativePath: clientlogic/cl_season/pc/season5/t1023.pyc
...
def DoCallBackAction0(oEventCB, oListener):
    if cl_evcon.CheckEventWeaponBulletType(oListener, oEventCB, 4502):
        cl_evact.CBAddSeasonTaskValue(oListener, oEventCB, (lambda *a: Func208(*a)))


def DoCallBackAction1(oEventCB, oListener):
    if cl_evcon.CheckCostBulletType(oListener, oEventCB, 4502):
