# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_season/pc/season8/gst1040.pyc
# RelativePath: clientlogic/cl_season/pc/season8/gst1040.pyc
...
def DoCallBackAction0(oEventCB, oTarget):
    if eventcondi.CommonCBCheckWarRound(oTarget, oEventCB) == 3 and eventcondi.CommonCBGetSeasonNum(oTarget, oEventCB) > 0 and eventcondi.CommonCBGetSeasonNum(oTarget, oEventCB) < 7:
