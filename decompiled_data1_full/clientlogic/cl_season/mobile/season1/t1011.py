# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_season/mobile/season1/t1011.pyc
# RelativePath: clientlogic/cl_season/mobile/season1/t1011.pyc
# Source Generated with Decompyle++
# File: t1011.pyc (Python 3.6)

from cl_commondefines import ATTACKERSUBMSG_NORMAL, LEVEL_TYPE_BOSS, OBJ_ATTACK, OBJ_VICTIM
import cl_msgcenter
import cl_action
import cl_condition
import cl_evact
...
def DoCallBackAction0(oEventCB, oListener):
    if cl_evcon.CheckLevelType(oListener, oEventCB, LEVEL_TYPE_BOSS):
        ...
        cl_action.CommonSetCustomData(oListener, oEventCB.GetCBLifeCycle(), 'seasontask1_1011', 0)
...
def DoCallBackAction1(oEventCB, oListener):
    ...
    if cl_evcon.CheckInPointPerform(oListener, oEventCB, {
        39153: 1,
        39152: 1 }, 1, 1) or cl_evcon.CheckTargetPointBaseSummon(oListener, oEventCB, 1029):
        cl_evact.EventCBSetCustomData(oListener, oEventCB, 'seasontask1_1011', 1)


def DoCallBackAction2(oEventCB, oListener):
    cl_evact.EventGetTargetByType(oListener, oEventCB, OBJ_VICTIM)
    if cl_evcon.CheckTargetPointBaseMonster(oListener, oEventCB, 3915) and cl_evact.EventCBGetCustomData(oListener, oEventCB, 'seasontask1_1011') != 1:
