# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_season/mobile/season1/t1010.pyc
# RelativePath: clientlogic/cl_season/mobile/season1/t1010.pyc
...
def DoCallBackAction0(oEventCB, oListener):
    if cl_evcon.CheckLevelType(oListener, oEventCB, LEVEL_TYPE_BOSS):
        ...
        cl_action.CommonSetCustomData(oListener, oEventCB.GetCBLifeCycle(), 'seasontask1_1010', 0)
...
def DoCallBackAction1(oEventCB, oListener):
    if cl_evcon.CheckInPointPerform(oListener, oEventCB, {
        39138: 1 }, 1, 1):
        cl_evact.EventCBSetCustomData(oListener, oEventCB, 'seasontask1_1010', 1)


def DoCallBackAction2(oEventCB, oListener):
    cl_evact.EventGetTargetByType(oListener, oEventCB, OBJ_VICTIM)
    if cl_evcon.CheckTargetPointBaseMonster(oListener, oEventCB, 3913) and cl_evact.EventCBGetCustomData(oListener, oEventCB, 'seasontask1_1010') != 1:
