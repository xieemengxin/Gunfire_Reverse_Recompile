# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_season/mobile/season1/gst1042.pyc
# RelativePath: clientlogic/cl_season/mobile/season1/gst1042.pyc
...
def DoCallBackAction0(oEventCB, oTarget):
    if eventcondi.CommonCBCheckWarEndType(oTarget, oEventCB, SETTLE_FINISHWAR) and eventcondi.CommonCBWarEndHeroCount(oTarget, oEventCB, '213|216|217') >= 2 and eventcondi.CommonCBGetSeasonNum(oTarget, oEventCB) == 1:
