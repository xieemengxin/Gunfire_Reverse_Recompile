# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_season/mobile/season1/gst1040.pyc
# RelativePath: clientlogic/cl_season/mobile/season1/gst1040.pyc
...
def DoCallBackAction0(oEventCB, oTarget):
    if eventcondi.CommonCBCheckWarEndType(oTarget, oEventCB, SETTLE_FINISHWAR) and eventcondi.CommonCBCheckWarCycle(oTarget, oEventCB) and eventcondi.CommonCBGetSeasonNum(oTarget, oEventCB) == 1:
