# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_season/mobile/season1/t1023.pyc
# RelativePath: clientlogic/cl_season/mobile/season1/t1023.pyc
...
def DoCallBackAction0(oEventCB, oListener):
    cl_evact.CBAddWarSeasonTaskValue(oListener, oEventCB, (lambda *a: Func208(*a)))
    if cl_evcon.SeasonTaskCBCheckWarValue(oListener, oEventCB, 1500):
        cl_evact.CBAddSeasonTaskValue(oListener, oEventCB, 1)


def DoCallBackAction1(oEventCB, oListener):
    cl_evact.CBAddWarSeasonTaskValue(oListener, oEventCB, (lambda *a: Func215(*a)))
    if cl_evcon.SeasonTaskCBCheckWarValue(oListener, oEventCB, 1500):
        cl_evact.CBAddSeasonTaskValue(oListener, oEventCB, 1)
