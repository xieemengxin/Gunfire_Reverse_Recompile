# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_season/mobile/season1/gst1033.pyc
# RelativePath: clientlogic/cl_season/mobile/season1/gst1033.pyc
...
def DoCallBackAction0(oEventCB, oTarget):
    if eventcondi.CommonCBCheckWarEndType(oTarget, oEventCB, SETTLE_FINISHWAR) and eventcondi.CommonCBDieCntFromReport(oTarget, oEventCB) == 0 and eventcondi.CommonCBGetSeasonNum(oTarget, oEventCB) == 1:
