# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_achievement/pc/s1089.pyc
# RelativePath: clientlogic/cl_achievement/pc/s1089.pyc
# Source Generated with Decompyle++
# File: s1089.pyc (Python 3.6)

from cl_only import Frame2Time
from cl_commondefines import OBJ_VICTIM, PLAYMODE_ROGUELIKE, PLAY_TYPE_SINGLE, WARRIOR_ELITE
import cl_msgcenter
import cl_action
import cl_condition
import cl_evact
...
def DoCallBackAction0(oEventCB, oListener):
    if cl_evcon.EventCBCheckFromPointState(oListener, oEventCB, 32101) and cl_evcon.CheckVictimFightType(oListener, oEventCB, WARRIOR_ELITE):
        ...
        if not cl_evcon.EventCBCheckTargetIsDevil(oListener, oEventCB):
