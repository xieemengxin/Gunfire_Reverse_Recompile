# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_achievement/pc/s1209.pyc
# RelativePath: clientlogic/cl_achievement/pc/s1209.pyc
...
def DoCallBackAction0(oEventCB, oListener):
    ...
    if cl_evcon.CheckMonsterType(oListener, oEventCB) and cl_evcon.CheckFightType(oListener, oEventCB, WARRIOR_ELITE) and not cl_evcon.EventCBCheckTargetIsDevil(oListener, oEventCB):
