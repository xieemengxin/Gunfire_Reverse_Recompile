# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_achievement/pc/s1205.pyc
# RelativePath: clientlogic/cl_achievement/pc/s1205.pyc
# Source Generated with Decompyle++
# File: s1205.pyc (Python 3.6)

from cl_object.logging import CheekLog
from cl_commondefines import ATTACKERSUBMSG_NORMAL, LEVEL_TYPE_BOSS, OBJ_VICTIM, PLAYMODE_ROGUELIKE, PLAY_TYPE_SINGLE, WARRIOR_BOSS
...
def EnableAction(oListener, oLifeCycle):
    if cl_condition.CheckHero(oListener, oLifeCycle, 215) and cl_condition.CheckWarPlayMode(oListener, oLifeCycle, PLAYMODE_ROGUELIKE) and cl_condition.CheckWarPlayType(oListener, oLifeCycle, PLAY_TYPE_SINGLE) and cl_condition.CalFormula(oListener, oLifeCycle, (lambda *a: Func205(*a))) >= 3:
        ...
        cl_action.CommonListenWarMgrMsgCallBack(oListener, oLifeCycle, cl_msgcenter.MSG_WARMGR_LEVELNODEGOALOK, -1, 2)
