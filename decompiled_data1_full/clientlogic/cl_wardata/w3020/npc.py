# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_wardata/w3020/npc.pyc
# RelativePath: clientlogic/cl_wardata/w3020/npc.pyc
...
from cl_newformula import Func16, Func201, Func202, Func203, Func204, Func205, Func212, Func219, Func441, Func442
...
'b': 1 })), {
    ...
    npcaction.NpcGoodsRelife(oNpc, who, 10, 100, 999, OBTAIN_WARCASH, (lambda *a: 300 + 200 * Func442(*a)))
    npcaction.NpcGoodsRelife(oNpc, who, 11, 100, 999, OBTAIN_WARCASH, (lambda *a: 300 + 200 * Func442(*a)))
    npcaction.NpcGoodsRareItem(oNpc, who, 12, 300, 1, OBTAIN_WARCASH, (lambda *a: (Func441(*a) + 1) * 31 * Func16(*a, **{
'a': 0.9,
'b': 1 })), 701, 0)
...
class CNpcData1063(baseconfig.CNpcData1005):
    m_SID = 1063
    m_Name = '幸存者-行脚商'
    m_Info = {
...
class CNpcData1064(baseconfig.CNpcData1013):
    m_SID = 1064
    m_Name = '幸存者-工匠'
    m_Info = { }
...
class CNpcData3119(baseconfig.CNpcData3119):
    m_SID = 3119
    m_Name = '事件NPC-幸存者3119'
    m_Info = { }
