# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_wardata/w3001/minigame.pyc
# RelativePath: clientlogic/cl_wardata/w3001/minigame.pyc
...
from cl_minigame.mg_task import CChooseTaskGameData
from cl_minigame.mg_wand import CWandGameData
from cl_minigame.mg_diceselection import CDiceSelectionGameData
from cl_minigame.mg_dice import CDiceGameData
from cl_commondefines import DICE_PUTOUT_POLL_ONE, DICE_PUTOUT_POLL_THREE, DICE_PUTOUT_POLL_TWO, DICE_QUALITY_RARE, DICE_QUALITY_TALE, NWARRIOR_NPC_LOCKEDBOX, NWARRIOR_NPC_MAGICBOX, NWARRIOR_NPC_PASSBOX, QUALITY_TYPE_CURSE, QUALITY_TYPE_HIGH, QUALITY_TYPE_LOW, QUALITY_TYPE_NORMAL, WARRIOR_BOSS, WARRIOR_ELITE, WARRIOR_NORMAL, WARRIOR_OBSTACLE_NORMAL
from cl_newformula import Func16, Func201, Func202, Func205
...
class CMiniGameData105(CDropCashGameData):
    m_SID = 105
    m_TypeBase = {
        WARRIOR_OBSTACLE_NORMAL: (lambda *a: Func16(*a, **{
'a': 10,
'b': 100 })) }
...
class CMiniGameData2401(CDropRelicGameData):
    m_SID = 2401
    m_ChooseQuality = {
        QUALITY_TYPE_HIGH: (lambda *a: min(66, 12 + 3 * Func201(*a) + 9 * Func205(*a))),
        QUALITY_TYPE_NORMAL: (lambda *a: min(176, 120 + 2 * Func201(*a) + 11 * Func205(*a))),
        QUALITY_TYPE_LOW: (lambda *a: max(136, 180 - 7 * Func201(*a) - 0.5 * Func202(*a))) }
    m_ChooseWeight = {
        5701: 10,
        5708: 10,
        5710: 10,
...
class CMiniGameData2403(CRewardChooseRelicGameData):
    m_SID = 2403
    m_ChooseQuality = {
        QUALITY_TYPE_HIGH: (lambda *a: min(27, 1 + 3 * Func201(*a) + 2 * Func205(*a))),
...
class CMiniGameData2405(CRelicGameData):
    m_SID = 2405
    m_ChooseQuality = {
        QUALITY_TYPE_HIGH: 4,
        QUALITY_TYPE_NORMAL: 20,
        QUALITY_TYPE_LOW: 76 }
    m_ChooseWeight = {
        5701: 10,
        5708: 10,
...
class CMiniGameData2414(CDropRelicGameData):
    m_SID = 2414
    m_ChooseQuality = {
        QUALITY_TYPE_HIGH: (lambda *a: min(66, 12 + 3 * Func201(*a) + 9 * Func205(*a))),
        QUALITY_TYPE_NORMAL: (lambda *a: min(176, 120 + 2 * Func201(*a) + 11 * Func205(*a))),
...
class CMiniGameData2417(CRelicGameData):
    m_SID = 2417
    m_ChooseQuality = {
        QUALITY_TYPE_HIGH: (lambda *a: min(66, 12 + 3 * Func201(*a) + 9 * Func205(*a))),
        QUALITY_TYPE_NORMAL: (lambda *a: min(176, 120 + 2 * Func201(*a) + 11 * Func205(*a))),
...
class CMiniGameData2418(CRelicGameData):
    m_SID = 2418
    m_ChooseQuality = {
        QUALITY_TYPE_HIGH: (lambda *a: min(66, 12 + 3 * Func201(*a) + 9 * Func205(*a))),
        QUALITY_TYPE_NORMAL: (lambda *a: min(176, 120 + 2 * Func201(*a) + 11 * Func205(*a))) }
...
class CMiniGameData2419(CRelicGameData):
    m_SID = 2419
    m_ChooseQuality = {
        QUALITY_TYPE_HIGH: (lambda *a: min(66, 12 + 3 * Func201(*a) + 9 * Func205(*a))) }
    m_ChooseWeight = {
...
class CMiniGameData2420(CRewardChooseRelicGameData):
    m_SID = 2420
    m_ChooseQuality = {
        QUALITY_TYPE_CURSE: 10,
        QUALITY_TYPE_HIGH: 10,
        QUALITY_TYPE_NORMAL: 10,
        QUALITY_TYPE_LOW: 10 }
    m_ChooseWeight = {
        5701: 10,
        5702: 10,
...
class CMiniGameData2421(CRelicGameData):
    m_SID = 2421
    m_ChooseQuality = {
        QUALITY_TYPE_LOW: 30,
        QUALITY_TYPE_NORMAL: 20,
...
class CMiniGameData2422(CRelicGameData):
    m_SID = 2422
    m_ChooseQuality = {
        QUALITY_TYPE_LOW: 20,
        QUALITY_TYPE_NORMAL: 30,
...
class CMiniGameData2423(CRelicGameData):
    m_SID = 2423
    m_ChooseQuality = {
        QUALITY_TYPE_LOW: 30,
        QUALITY_TYPE_NORMAL: 20,
...
class CMiniGameData2424(CDropRelicGameData):
    m_SID = 2424
    m_ChooseQuality = { }
    m_ChooseWeight = {
        5701: 10,
...
class CMiniGameData2425(CDropRelicGameData):
    m_SID = 2425
    m_ChooseQuality = { }
    m_ChooseWeight = {
        5703: 10,
...
class CMiniGameData2426(CDropRelicGameData):
    m_SID = 2426
    m_ChooseQuality = { }
    m_ChooseWeight = {
        5702: 10,
...
class CMiniGameData2427(CRelicGameData):
    m_SID = 2427
    m_ChooseQuality = { }
    m_ChooseWeight = {
        5701: 10,
...
class CMiniGameData2428(CRelicGameData):
    m_SID = 2428
    m_ChooseQuality = { }
    m_ChooseWeight = {
        5703: 10,
...
class CMiniGameData2429(CRelicGameData):
    m_SID = 2429
    m_ChooseQuality = { }
    m_ChooseWeight = {
        5702: 10,
...
class CMiniGameData2430(CRelicGameData):
    m_SID = 2430
    m_ChooseQuality = {
        QUALITY_TYPE_LOW: 78,
        QUALITY_TYPE_NORMAL: 56,
...
class CMiniGameData409(CDropTriggerGameData):
    m_SID = 409
    m_ChooseWeight = {
        1809: 10 }
...
class CMiniGameData4002(CDirectRewardRandomTalentGameData):
    m_SID = 4002
    m_ChooseWeight = {
        101: {
            1: {
...
class CMiniGameData8001(CChooseTaskGameData):
    m_SID = 8001
    m_ChooseNum = 3
    m_ChooseWeight = {
        1001: 30,
...
class CMiniGameData601(CWandGameData):
    m_SID = 601
    m_ChooseLevelWeight = {
        1: 1,
        2: 1,
...
class CMiniGameData801(CDiceSelectionGameData):
    m_SID = 801
    m_LayerMaxDropNum = 2


class CMiniGameData901(CDiceGameData):
    m_SID = 901
    m_ChooseQualityWeight = {
        1: {
            DICE_QUALITY_RARE: 100 },
        2: {
            DICE_QUALITY_TALE: 20,
            DICE_QUALITY_RARE: 80 },
        3: {
            DICE_QUALITY_TALE: 100 },
        4: {
            DICE_QUALITY_TALE: 100 } }
    m_ChoosePutOutPoolWeight = {
        DICE_PUTOUT_POLL_THREE: 1,
        DICE_PUTOUT_POLL_TWO: 3,
        DICE_PUTOUT_POLL_ONE: 6 }
