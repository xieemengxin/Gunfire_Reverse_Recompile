# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_wardata/w3001/roomchallenge.pyc
# RelativePath: clientlogic/cl_wardata/w3001/roomchallenge.pyc
# Source Generated with Decompyle++
# File: roomchallenge.pyc (Python 3.6)

from cl_resmgr.resdata import CRoomChallengeData as CCustom
from cl_commondefines import ALLVERLAYER_VALID, CHALLENGE_ABERRANCE, CHALLENGE_APPENDSKILL, CHALLENGE_BOXFLASH, CHALLENGE_BOXMONSTER, CHALLENGE_COUNT_MUTANTMONSTER, CHALLENGE_DEFEND, CHALLENGE_DICESEASON_APPENDSKILL, CHALLENGE_ELITE, CHALLENGE_ELITEINTRUDE, CHALLENGE_EXTRAELITE, CHALLENGE_EXTRAMONSTER, CHALLENGE_KILLSUMMON, CHALLENGE_KILLSUMMON_TRAP, CHALLENGE_LIMITCONVOY, CHALLENGE_LIMITDEFEND, CHALLENGE_LIMITLIVE, CHALLENGE_LIMITTIME, CHALLENGE_MORALE_ELITEINTRUDE, CHALLENGE_NOTIFY, CHALLENGE_NOTIFYLIMITTIME, CHALLENGE_OBSTACLEALIENATION, CHALLENGE_PLAYERPERFORM, CHALLENGE_SIGHT, CHALLENGE_SUPERMONSTER, CHALLENGE_TRAP, NEWVERLAYER_VALID, OLDVERLAYER_VALID
from cl_newformula import Func235, Func527, Func572
...
class CRoomChallengeData1002(CCustom):
    ...
    m_ExcludeArea = [
        ...
        (1110502, 7),
        (1110502, 9)]
    m_ValidVerLayer = OLDVERLAYER_VALID
...
'sType': 'RidingAlone' }) + 1), 100, {
        ...
        (30212, 32422, 32012, 31422, 31252): 50 }, 0, 0, 0, 0)
    m_ExcludeLastRoom = 0
    m_ExcludeArea = []
    m_ValidVerLayer = OLDVERLAYER_VALID
...
'sType': 'RidingAlone' }) + 1), 100, {
        ...
        (30872, 31262, 32032, 32812, 32823): 50 }, 0, 0, 0, 0)
    m_ExcludeLastRoom = 0
    m_ExcludeArea = [
        (1130301, 3),
        (1130301, 4),
...
class CRoomChallengeData1091(CCustom):
    ...
    m_Param = ((lambda *a: Func235(*a, **{
'sType': 'RidingAlone' }) + 1), 50, {
        (31642, 33813, 31642, 33813, 33813): 50 }, 0, 0, 0, 0)
    m_ExcludeLastRoom = 0
    m_ExcludeArea = []
    m_ValidVerLayer = OLDVERLAYER_VALID
...
class CRoomChallengeData1101(CCustom):
    ...
    m_FailedNotify = '#s(182|对16米范围内的敌人造成的伤害提升50%，对16米范围外的敌人仅造成1点伤害！|9033)'
    m_EffectState = 0
    m_Reward = {
        1: {
            401: (10000, 1),
...
class CRoomChallengeData1107(CCustom):
    ...
    m_Type = CHALLENGE_BOXMONSTER
    m_ChallengeName = '钱龙秘藏'
    m_ChallengeNotify = '#s(175|运用<color=#C34BDF>凝时秒表</color>，找到并击败真正的钱龙获得奖励！| $remain#$total|9032)'
    m_SuccessNotify = '#s(185|运用<color=#C34BDF>凝时秒表</color>，找到并击败真正的钱龙获得奖励！|9032)'
    m_FailedNotify = '#s(186|运用<color=#C34BDF>凝时秒表</color>，找到并击败真正的钱龙获得奖励！|9033)'
    m_EffectState = 0
    m_Reward = { }
    m_Param = (23411, 300, 8000, 2132, 25, 2133, 2134, 1000, 500)
    m_ExcludeLastRoom = 0
    m_ExcludeArea = []


class CRoomChallengeData1108(CCustom):
    m_SID = 1108
    m_Type = CHALLENGE_BOXMONSTER
    m_ChallengeName = '钱龙秘藏'
    m_ChallengeNotify = '#s(175|运用<color=#C34BDF>凝时秒表</color>，找到并击败真正的钱龙获得奖励！| $remain#$total|9032)'
    ...
    m_EffectState = 0
    m_Reward = { }
    m_Param = (23421, 300, 8000, 2132, 25, 2133, 2134, 1000, 500)
    m_ExcludeLastRoom = 0
    m_ExcludeArea = []


class CRoomChallengeData1109(CCustom):
    m_SID = 1109
    m_Type = CHALLENGE_BOXMONSTER
    m_ChallengeName = '钱龙秘藏'
    m_ChallengeNotify = '#s(175|运用<color=#C34BDF>凝时秒表</color>，找到并击败真正的钱龙获得奖励！| $remain#$total|9032)'
    ...
    m_EffectState = 0
    m_Reward = { }
    m_Param = (23431, 300, 8000, 2132, 25, 2133, 2134, 1000, 500)
    m_ExcludeLastRoom = 0
    m_ExcludeArea = []


class CRoomChallengeData1110(CCustom):
    m_SID = 1110
    m_Type = CHALLENGE_EXTRAELITE
    m_ChallengeName = '群英荟萃'
    m_ChallengeNotify = '#s(215|1088|9032)'
...
'sType': 'RidingAlone' }) + 1), 50, {
    ...
    m_ExcludeArea = [
        ...
        (1110502, 8),
        (1110502, 9)]
    m_ValidVerLayer = NEWVERLAYER_VALID


class CRoomChallengeData1111(CCustom):
    m_SID = 1111
    m_Type = CHALLENGE_ABERRANCE
    m_ChallengeName = '妖气惊变'
    m_ChallengeNotify = '#s(215|1008|9032)'
    m_SuccessNotify = '#s(216|1008|9034)'
    m_FailedNotify = '#s(182|敌人都变成骑兵了！|9033)'
    m_EffectState = 0
    m_Reward = {
        1: {
            401: (10000, 1),
...
class CRoomChallengeData1112(CCustom):
    m_SID = 1112
    m_Type = CHALLENGE_ELITEINTRUDE
    m_ChallengeName = '精英突入'
    m_ChallengeNotify = '#s(215|1112|9032)'
    m_SuccessNotify = '#s(216|1112|9034)'
    m_FailedNotify = '#s(182|精英怪出现了！|9033)'
    m_EffectState = 0
    m_Reward = {
        1: {
            1001: (10000, 1) },
        ...
        3: {
            1001: (10000, 1) } }
    m_Param = ((30012, 31232, 30832), 20, 80, {
        (1, 4): {
            'InscriptionExclusive': 1,
            'SyncGrade': 0 } }, {
        (1, 4): {
            1: 100 } })
    m_ExcludeLastRoom = 0
...
class CRoomChallengeData1113(CCustom):
    m_SID = 1113
    m_Type = CHALLENGE_ELITEINTRUDE
    m_ChallengeName = '精英突入'
    m_ChallengeNotify = '#s(215|1113|9032)'
    m_SuccessNotify = '#s(216|1113|9034)'
    m_FailedNotify = '#s(182|精英怪出现了！|9033)'
    m_EffectState = 0
    m_Reward = {
        1: {
        ...
        3: {
            1001: (10000, 1) } }
    m_Param = ((31252, 31422, 32012, 32422, 30212), 20, 80, {
        (2, 3): {
            'InscriptionExclusive': 2,
            'SyncGrade': 0 },
        (2, 2): {
            'InscriptionExclusive': 1,
            'SyncGrade': 0 },
...
class CRoomChallengeData1114(CCustom):
    m_SID = 1114
    m_Type = CHALLENGE_ELITEINTRUDE
    m_ChallengeName = '精英突入'
    m_ChallengeNotify = '#s(215|1114|9032)'
    m_SuccessNotify = '#s(216|1114|9034)'
    m_FailedNotify = '#s(182|精英怪出现了！|9033)'
    m_EffectState = 0
    m_Reward = {
        1: {
        ...
        3: {
            1001: (10000, 1) } }
    m_Param = ((31262, 32812, 32032, 32823, 32832, 30872), 20, 80, {
        (3, 3): {
            'InscriptionExclusive': 2,
            'SyncGrade': 1 },
        (3, 2): {
...
class CRoomChallengeData1115(CCustom):
    m_SID = 1115
    m_Type = CHALLENGE_ELITEINTRUDE
    m_ChallengeName = '精英突入'
    m_ChallengeNotify = '#s(215|1115|9032)'
    m_SuccessNotify = '#s(216|1115|9034)'
    m_FailedNotify = '#s(182|精英怪出现了！|9033)'
    m_EffectState = 0
    m_Reward = {
        1: {
        ...
        3: {
            1001: (10000, 1) } }
    m_Param = ((31642, 33813), 20, 80, {
        (4, 2): {
            'InscriptionExclusive': 3,
            'SyncGrade': 1 },
        (4, 1): {
            'InscriptionExclusive': 3,
            'SyncGrade': 1 } }, {
...
class CRoomChallengeData1116(CCustom):
    m_SID = 1116
    m_Type = CHALLENGE_EXTRAELITE
    m_ChallengeName = '群英荟萃'
    m_ChallengeNotify = '#s(215|1116|9032)'
    m_SuccessNotify = '#s(216|1116|9034)'
    m_FailedNotify = '#s(182|大量精英怪出现！|9033)'
    m_EffectState = 0
    m_Reward = {
        1: {
    ...
    m_Param = ((lambda *a: Func235(*a, **{
'sType': 'RidingAlone' }) + 1), 100, {
        (31422, 31422, 31422, 31422, 31422): 50,
        (32012, 32012, 32012, 30212, 30212): 50,
        (32012, 32012, 32012, 32012, 32012): 50 }, 0, None, None, None)
    m_ExcludeLastRoom = 0
    m_ExcludeArea = []
    m_ValidVerLayer = OLDVERLAYER_VALID


class CRoomChallengeData1117(CCustom):
    m_SID = 1117
    m_Type = CHALLENGE_EXTRAELITE
    m_ChallengeName = '群英荟萃'
    m_ChallengeNotify = '#s(215|1117|9032)'
    m_SuccessNotify = '#s(216|1117|9034)'
    m_FailedNotify = '#s(182|大量精英怪出现！|9033)'
    m_EffectState = 0
    m_Reward = {
        1: {
    ...
    m_Param = ((lambda *a: Func235(*a, **{
'sType': 'RidingAlone' }) + 1), 100, {
        (32832, 32832, 32832, 32812, 32812): 50,
        (32832, 32832, 32832, 32832, 32832): 50 }, 0, None, None, None)
    m_ExcludeLastRoom = 0
    m_ExcludeArea = [
        (1130301, 3),
        (1130301, 4),
...
class CRoomChallengeData1118(CCustom):
    m_SID = 1118
    m_Type = CHALLENGE_EXTRAELITE
    m_ChallengeName = '群英荟萃'
    m_ChallengeNotify = '#s(215|1118|9032)'
    m_SuccessNotify = '#s(216|1118|9034)'
    m_FailedNotify = '#s(182|大量精英怪出现！|9033)'
    m_EffectState = 0
    m_Reward = {
        1: {
    ...
    m_Param = ((lambda *a: Func235(*a, **{
'sType': 'RidingAlone' }) + 1), 50, {
        (33813, 33813, 33813, 33813, 33813): 50 }, 0, None, None, None)
    m_ExcludeLastRoom = 0
    m_ExcludeArea = []
    m_ValidVerLayer = OLDVERLAYER_VALID


class CRoomChallengeData1119(CCustom):
    m_SID = 1119
    m_Type = CHALLENGE_PLAYERPERFORM
    m_ChallengeName = '急救演练'
    m_ChallengeNotify = '#s(215|1119|9032)'
    m_SuccessNotify = '#s(216|1119|9034)'
    m_FailedNotify = '#s(182|救助时间增加200%，倒地时间增加100%|9033)'
    m_EffectState = 0
    m_Reward = {
        1: {
            401: (10000, 1),
...
class CRoomChallengeData1120(CCustom):
    m_SID = 1120
    m_Type = CHALLENGE_APPENDSKILL
    m_ChallengeName = '元素衰减'
    m_ChallengeNotify = '#s(215|1120|9032)'
    m_SuccessNotify = '#s(216|1120|9034)'
    m_FailedNotify = ''
    m_EffectState = 0
    m_Reward = {
        1: {
        ...
        3: {
            401: (10000, 1),
            2401: (6667, 1) } }
    m_Param = (4369, None, None)
    m_ExcludeLastRoom = 0
    m_ExcludeArea = []


class CRoomChallengeData1121(CCustom):
    m_SID = 1121
    m_Type = CHALLENGE_PLAYERPERFORM
    m_ChallengeName = '不良反应'
    m_ChallengeNotify = '#s(215|1121|9032)'
    m_SuccessNotify = '#s(216|1121|9034)'
    m_FailedNotify = '#s(182|主要技能冷却期间，最终伤害-25%，每受到一次伤害，会使剩余冷却时间+1秒|9033)'
    m_EffectState = 0
    m_Reward = {
        1: {
            401: (10000, 1),
...
class CRoomChallengeData1122(CCustom):
    m_SID = 1122
    m_Type = CHALLENGE_KILLSUMMON
    m_ChallengeName = '妖气转生'
    m_ChallengeNotify = '#s(215|1122|9032)'
    m_SuccessNotify = '#s(216|1112|9034)'
    m_FailedNotify = '#s(182|敌人被击败后化身黑面流寇或大漠幼豚!|9033)'
    m_EffectState = 20033
    m_Reward = {
...
class CRoomChallengeData1123(CCustom):
    m_SID = 1123
    m_Type = CHALLENGE_KILLSUMMON
    m_ChallengeName = '妖气转生'
    m_ChallengeNotify = '#s(215|1123|9032)'
    m_SuccessNotify = '#s(216|1123|9034)'
    m_FailedNotify = '#s(182|敌人被击败后化身白鲛或自爆灯笼鬼!|9033)'
    m_EffectState = 20033
    m_Reward = {
        1: {
...
class CRoomChallengeData1124(CCustom):
    m_SID = 1124
    m_Type = CHALLENGE_APPENDSKILL
    m_ChallengeName = '移花接木'
    m_ChallengeNotify = '#s(215|1124|9032)'
    m_SuccessNotify = '#s(216|1124|9034)'
    m_FailedNotify = '#s(182|怪物会根据已损失生命值治疗周围的其他怪物！|9033)'
    m_EffectState = 0
    m_Reward = {
        1: {
        ...
        3: {
            ...
            2401: (1000, 1),
            501: (10000, 10) } }
    m_Param = (4374, None, None)
    m_ExcludeLastRoom = 0
    m_ExcludeArea = [
        (1110303, 5)]


class CRoomChallengeData1125(CCustom):
    m_SID = 1125
    m_Type = CHALLENGE_APPENDSKILL
    m_ChallengeName = '战损修复'
    m_ChallengeNotify = '#s(215|1125|9032)'
    m_SuccessNotify = '#s(216|1125|9034)'
    m_FailedNotify = '#s(182|怪物受到伤害后，4秒内回复此伤害80%的生命值！|9033)'
    m_EffectState = 0
    m_Reward = {
        1: {
            401: (10000, 1),
...
class CRoomChallengeData1126(CCustom):
    m_SID = 1126
    m_Type = CHALLENGE_APPENDSKILL
    m_ChallengeName = '愈战愈艰'
    m_ChallengeNotify = '#s(215|1126|9032)'
    m_SuccessNotify = '#s(216|1126|9034)'
    m_FailedNotify = '#s(182|剩余怪物数量越少，怪物属性越强！|9033)'
    m_EffectState = 0
    m_Reward = {
        1: {
        ...
        3: {
            ...
            2401: (1000, 1),
            501: (10000, 10) } }
    m_Param = (4375, None, None)
    m_ExcludeLastRoom = 0
    m_ExcludeArea = [
        (1110502, 8)]


class CRoomChallengeData1127(CCustom):
    m_SID = 1127
    m_Type = CHALLENGE_KILLSUMMON
    m_ChallengeName = '妖气转生'
    m_ChallengeNotify = '#s(215|1127|9032)'
    m_SuccessNotify = '#s(216|1127|9034)'
    m_FailedNotify = '#s(182|敌人被击败后化身雪山守卫或雪地原住！|9033)'
    m_EffectState = 20033
    m_Reward = {
        1: {
...
class CRoomChallengeData1128(CCustom):
    m_SID = 1128
    m_Type = CHALLENGE_PLAYERPERFORM
    m_ChallengeName = '抵近射击'
    m_ChallengeNotify = '#s(215|1128|9032)'
    m_SuccessNotify = '#s(216|1128|9034)'
    m_FailedNotify = '#s(182|对16米范围内的敌人造成的伤害提升20%，对16米范围外的敌人仅造成1点伤害！|9033)'
    m_EffectState = 0
    m_Reward = {
        1: {
            401: (10000, 1),
...
class CRoomChallengeData1129(CCustom):
    m_SID = 1129
    m_Type = CHALLENGE_PLAYERPERFORM
    m_ChallengeName = '返璞归真'
    m_ChallengeNotify = '#s(215|1129|9032)'
    m_SuccessNotify = '#s(216|1129|9034)'
    m_FailedNotify = '#s(182|敌人被熔炉命中弱点时会造成生命总值50%的真实伤害，非熔炉造成的伤害减少90%！|9033)'
    m_EffectState = 0
    m_Reward = {
        1: {
            401: (10000, 1),
...
class CRoomChallengeData1130(CCustom):
    m_SID = 1130
    m_Type = CHALLENGE_SUPERMONSTER
    m_ChallengeName = '全副武装'
    m_ChallengeNotify = '#s(215|1130|9032)'
    m_SuccessNotify = '#s(216|1130|9034)'
    m_FailedNotify = '#s(182|敌人都变成强化怪了！玩家获得临时灵佑【狩猎季节】!|9033)'
    m_EffectState = 0
    m_Reward = {
        1: {
...
class CRoomChallengeData1131(CCustom):
    m_SID = 1131
    m_Type = CHALLENGE_ELITEINTRUDE
    m_ChallengeName = '精英突入(无尽)'
    m_ChallengeNotify = '#s(215|1112|9032)'
    m_SuccessNotify = '#s(216|1112|9034)'
    m_FailedNotify = '#s(182|精英怪出现了！|9033)'
    m_EffectState = 0
...
class CRoomChallengeData1132(CCustom):
    m_SID = 1132
    m_Type = CHALLENGE_ELITEINTRUDE
    m_ChallengeName = '精英突入(无尽)'
    m_ChallengeNotify = '#s(215|1113|9032)'
...
class CRoomChallengeData1133(CCustom):
    m_SID = 1133
    m_Type = CHALLENGE_ELITEINTRUDE
    m_ChallengeName = '精英突入(无尽)'
    m_ChallengeNotify = '#s(215|1114|9032)'
...
class CRoomChallengeData1134(CCustom):
    m_SID = 1134
    m_Type = CHALLENGE_ELITEINTRUDE
    m_ChallengeName = '精英突入(无尽)'
    m_ChallengeNotify = '#s(215|1115|9032)'
...
class CRoomChallengeData1135(CCustom):
    m_SID = 1135
    m_Type = CHALLENGE_ELITEINTRUDE
    m_ChallengeName = '精英突入(无尽)'
    m_ChallengeNotify = '#s(215|1112|9032)'
...
class CRoomChallengeData1136(CCustom):
    m_SID = 1136
    m_Type = CHALLENGE_ELITEINTRUDE
    m_ChallengeName = '精英突入(无尽)'
    m_ChallengeNotify = '#s(215|1113|9032)'
...
class CRoomChallengeData1137(CCustom):
    m_SID = 1137
    m_Type = CHALLENGE_ELITEINTRUDE
    m_ChallengeName = '精英突入(无尽)'
    m_ChallengeNotify = '#s(215|1114|9032)'
...
class CRoomChallengeData1138(CCustom):
    m_SID = 1138
    m_Type = CHALLENGE_ELITEINTRUDE
    m_ChallengeName = '精英突入(无尽)'
    m_ChallengeNotify = '#s(215|1115|9032)'
...
class CRoomChallengeData1139(CCustom):
    m_SID = 1139
    m_Type = CHALLENGE_ABERRANCE
    m_ChallengeName = '妖气惊变'
    m_ChallengeNotify = '#s(215|1085|9032)'
...
class CRoomChallengeData1140(CCustom):
    m_SID = 1140
    m_Type = CHALLENGE_KILLSUMMON
    m_ChallengeName = '妖气转生'
    m_ChallengeNotify = '#s(215|1140|9032)'
    m_SuccessNotify = '#s(216|1140|9034)'
    m_FailedNotify = '#s(182|敌人被击败后会化身大漠蜘蛛或蜘蛛卫士|9033)'
    m_EffectState = 20033
    m_Reward = {
        1: {
            401: (10000, 1),
...
class CRoomChallengeData1141(CCustom):
    m_SID = 1141
    m_Type = CHALLENGE_KILLSUMMON
    m_ChallengeName = '妖气转生'
    m_ChallengeNotify = '#s(215|1141|9032)'
    m_SuccessNotify = '#s(216|1141|9034)'
    m_FailedNotify = '#s(182|敌人被击败后会化身大漠蜘蛛|9033)'
    m_EffectState = 20033
    m_Reward = {
        1: {
            401: (10000, 1),
...
class CRoomChallengeData1142(CCustom):
    m_SID = 1142
    m_Type = CHALLENGE_KILLSUMMON_TRAP
    m_ChallengeName = '流沙陷阱'
    m_ChallengeNotify = '#s(215|1142|9032)'
    m_SuccessNotify = '#s(216|1142|9034)'
    m_FailedNotify = '#s(182|杀死怪物后原地生成流沙陷阱！|9033)'
    m_EffectState = 0
    m_Reward = {
        1: {
            401: (10000, 1),
        ...
        3: {
            401: (10000, 1),
            2401: (6667, 1) } }
    m_Param = (1163, 1650, 400, 100)
    m_ExcludeLastRoom = 0
    m_ExcludeArea = []
    m_ValidVerLayer = NEWVERLAYER_VALID


class CRoomChallengeData1143(CCustom):
    m_SID = 1143
    m_Type = CHALLENGE_MORALE_ELITEINTRUDE
    m_ChallengeName = '精英突入'
    m_ChallengeNotify = '#s(215|1143|9032)'
    m_SuccessNotify = '#s(216|1143|9034)'
    m_FailedNotify = '#s(182|精英怪出现了！|9033)'
    m_EffectState = 0
    m_Reward = {
        1: {
    ...
    m_Param = ((34211,), 30, 70, { }, {
        (2, 2): {
            1: 100 },
        (2, 3): {
            1: 100 } }, 33242, (24221, 24231, 24211), 33243, None)
    m_ExcludeLastRoom = 0
    m_ExcludeArea = []
    m_ValidVerLayer = NEWVERLAYER_VALID


class CRoomChallengeData1144(CCustom):
    m_SID = 1144
    m_Type = CHALLENGE_OBSTACLEALIENATION
    m_ChallengeName = '蜘蛛卵异化挑战'
    m_ChallengeNotify = '#s(175|及时击爆异化的蜘蛛卵！| $remain#$total|9032)'
    m_SuccessNotify = '#s(185|及时击爆异化的蜘蛛卵！|9032)'
    m_FailedNotify = '#s(186|运及时击爆异化的蜘蛛卵！|9033)'
    m_EffectState = 20033
    m_Reward = {
        1: {
            1001: (10000, 1) },
...
class CRoomChallengeData1145(CCustom):
    m_SID = 1145
    m_Type = CHALLENGE_BOXFLASH
    m_ChallengeName = '钱龙闪现挑战'
    m_ChallengeNotify = '#s(215|1145|9032)'
    m_SuccessNotify = '#s(216|1145|9034)'
    m_FailedNotify = '#s(182|及时击杀钱龙！|9033)'
    m_EffectState = 0
    m_Reward = {
        1: {
            2401: (10000, 1) },
        ...
        3: {
            2401: (10000, 1) } }
    m_Param = (39992, 20, 30, 70, 80, 80, 33275, 1500)
    m_ExcludeLastRoom = 0
    m_ExcludeArea = []
    m_ValidVerLayer = NEWVERLAYER_VALID


class CRoomChallengeData1146(CCustom):
    m_SID = 1146
    m_Type = CHALLENGE_EXTRAELITE
    m_ChallengeName = '群英荟萃'
    m_ChallengeNotify = '#s(215|1146|9032)'
    m_SuccessNotify = '#s(216|1146|9034)'
    m_FailedNotify = '#s(182|大量精英怪出现！|9033)'
    m_EffectState = 0
    m_Reward = {
        1: {
        ...
        3: {
            ...
            2404: (10000, 1) } }
    m_Param = ((lambda *a: Func235(*a, **{
'sType': 'RidingAlone' }) + 1), 60, {
        (34212, 34212, 30212, 30212, 34212): 50,
        (34212, 34212, 30212, 31252, 34212): 50,
        (34212, 34212, 32012, 30212, 30212): 50,
        (34212, 34212, 31422, 31422, 34212): 50,
        (34212, 34212, 34212, 34212, 34212): 10 }, 0, 0, None, None)
    m_ExcludeLastRoom = 0
    m_ExcludeArea = []
    m_ValidVerLayer = NEWVERLAYER_VALID


class CRoomChallengeData1147(CCustom):
    m_SID = 1147
    m_Type = CHALLENGE_EXTRAELITE
    m_ChallengeName = '群英荟萃'
    m_ChallengeNotify = '#s(215|1147|9032)'
    m_SuccessNotify = '#s(216|1147|9034)'
    m_FailedNotify = '#s(182|大量精英怪出现！|9033)'
    m_EffectState = 0
    m_Reward = {
        1: {
    ...
    m_Param = ((lambda *a: Func235(*a, **{
'sType': 'RidingAlone' }) + 1), 100, {
        (34212, 31422, 31252, 32422, 32012): 50,
        (34212, 32422, 31252, 30212, 32012): 50,
        (34212, 30212, 31252, 30212, 31422): 50,
        (34212, 32422, 32012, 31422, 31252): 50 }, 0, None, None, None)
    m_ExcludeLastRoom = 0
    m_ExcludeArea = []
    m_ValidVerLayer = NEWVERLAYER_VALID


class CRoomChallengeData1148(CCustom):
    m_SID = 1148
    m_Type = CHALLENGE_EXTRAELITE
    m_ChallengeName = '群英荟萃'
    m_ChallengeNotify = '#s(215|1148|9032)'
    m_SuccessNotify = '#s(216|1148|9034)'
    m_FailedNotify = '#s(182|大量精英怪出现！|9033)'
    m_EffectState = 0
    m_Reward = {
        1: {
    ...
    m_Param = ((lambda *a: Func235(*a, **{
'sType': 'RidingAlone' }) + 1), 100, {
        (31422, 32422, 31252, 31252, 32422): 50,
        (32012, 32012, 32012, 30212, 30212): 50 }, 0, 0, 70, 80)
    m_ExcludeLastRoom = 0
    m_ExcludeArea = []
    m_ValidVerLayer = OLDVERLAYER_VALID


class CRoomChallengeData1149(CCustom):
    m_SID = 1149
    m_Type = CHALLENGE_EXTRAELITE
    m_ChallengeName = '群英荟萃'
    m_ChallengeNotify = '#s(215|1149|9032)'
    m_SuccessNotify = '#s(216|1149|9034)'
    m_FailedNotify = '#s(182|大量精英怪出现！|9033)'
    m_EffectState = 0
    m_Reward = {
        1: {
    ...
    m_Param = ((lambda *a: Func235(*a, **{
'sType': 'RidingAlone' }) + 1), 100, {
        (32032, 30872, 30872, 32812, 32812): 50,
        (31262, 31262, 32823, 32832, 32832): 50,
        (32832, 32832, 32832, 32812, 32812): 50 }, 0, 0, 70, 80)
    m_ExcludeLastRoom = 0
    m_ExcludeArea = [
        (1130301, 3),
        (1130301, 4),
...
class CRoomChallengeData1150(CCustom):
    m_SID = 1150
    m_Type = CHALLENGE_EXTRAELITE
    m_ChallengeName = '群英荟萃'
    m_ChallengeNotify = '#s(215|1150|9032)'
    m_SuccessNotify = '#s(216|1150|9034)'
    m_FailedNotify = '#s(182|大量精英怪出现！|9033)'
    m_EffectState = 0
    m_Reward = {
        1: {
    ...
    m_Param = ((lambda *a: Func235(*a, **{
'sType': 'RidingAlone' }) + 1), 50, {
        (31642, 33813, 33813, 33813, 33813): 50,
        (33813, 33813, 33813, 33813, 33813): 50 }, 0, 0, 70, 80)
    m_ExcludeLastRoom = 0
    m_ExcludeArea = []
    m_ValidVerLayer = OLDVERLAYER_VALID


class CRoomChallengeData1151(CCustom):
    m_SID = 1151
    m_Type = CHALLENGE_EXTRAELITE
    m_ChallengeName = '群英荟萃'
    m_ChallengeNotify = '#s(215|1151|9032)'
    m_SuccessNotify = '#s(216|1151|9034)'
    m_FailedNotify = '#s(182|大量精英怪出现！|9033)'
    m_EffectState = 0
    m_Reward = {
        1: {
    ...
    m_Param = ((lambda *a: Func235(*a, **{
'sType': 'RidingAlone' }) + 1), 60, {
        (34212, 34212, 31252, 31252, 32422): 50,
        (34212, 34212, 30212, 30212, 34212): 50,
        (34212, 34212, 30212, 31252, 34212): 50,
        (34212, 34212, 32012, 30212, 30212): 50,
        (34212, 34212, 31422, 30212, 34212): 50 }, 0, 0, 70, 80)
    m_ExcludeLastRoom = 0
    m_ExcludeArea = []
    m_ValidVerLayer = NEWVERLAYER_VALID


class CRoomChallengeData1152(CCustom):
    m_SID = 1152
    m_Type = CHALLENGE_DICESEASON_APPENDSKILL
    m_ChallengeName = '余烬复燃'
    m_ChallengeNotify = '#s(238|1152|9032|$DicePoint|9733)'
    m_SuccessNotify = '#s(216|1152|$DicePoint|9034)'
    m_FailedNotify = '#s(182|骰子挑战1！|9033)'
    m_EffectState = 0
    m_Reward = {
        1: {
            901: (10000, 1) },
...
class CRoomChallengeData1153(CCustom):
    m_SID = 1153
    m_Type = CHALLENGE_DICESEASON_APPENDSKILL
    m_ChallengeName = '潮汐壁垒'
    m_ChallengeNotify = '#s(238|1153|9032|$DicePoint|9733)'
    m_SuccessNotify = '#s(216|1153|$DicePoint|9034)'
    m_FailedNotify = '#s(182|骰子挑战2！|9033)'
    m_EffectState = 0
    m_Reward = {
        1: {
            901: (10000, 1) },
...
class CRoomChallengeData1154(CCustom):
    m_SID = 1154
    m_Type = CHALLENGE_DICESEASON_APPENDSKILL
    m_ChallengeName = '草木皆兵'
    m_ChallengeNotify = '#s(238|1154|9032|$DicePoint|9733)'
    m_SuccessNotify = '#s(216|1154|$DicePoint|9034)'
    m_FailedNotify = '#s(182|骰子挑战3！|9033)'
    m_EffectState = 0
    m_Reward = {
        1: {
            901: (10000, 1) },
...
class CRoomChallengeData1155(CCustom):
    m_SID = 1155
    m_Type = CHALLENGE_DICESEASON_APPENDSKILL
    m_ChallengeName = '撒豆成兵'
    m_ChallengeNotify = '#s(238|1155|9032|$DicePoint|9733)'
    m_SuccessNotify = '#s(216|1155|$DicePoint|9034)'
    m_FailedNotify = '#s(182|骰子挑战4！|9033)'
    m_EffectState = 0
    m_Reward = {
        1: {
            901: (10000, 1) },
...
class CRoomChallengeData1156(CCustom):
    m_SID = 1156
    m_Type = CHALLENGE_DICESEASON_APPENDSKILL
    m_ChallengeName = '同舟共济'
    m_ChallengeNotify = '#s(238|1156|9032|$DicePoint|9733)'
    m_SuccessNotify = '#s(216|1156|$DicePoint|9034)'
    m_FailedNotify = '#s(182|骰子挑战5！|9033)'
    m_EffectState = 0
    m_Reward = {
        1: {
            901: (10000, 1) },
...
class CRoomChallengeData1157(CCustom):
    m_SID = 1157
    m_Type = CHALLENGE_EXTRAELITE
    m_ChallengeName = '群英荟萃'
    m_ChallengeNotify = '#s(215|1157|9032)'
    m_SuccessNotify = '#s(216|1151|9034)'
    m_FailedNotify = '#s(182|大量精英怪出现！|9033)'
    m_EffectState = 0
    m_Reward = {
    ...
    m_Param = ((lambda *a: Func235(*a, **{
'sType': 'RidingAlone' }) + 1), 60, {
        (31832, 32812, 31832, 32812, 31262): 50,
        (31832, 32832, 31832, 32812, 32812): 50,
        (31832, 31262, 31832, 31262, 31832): 50,
        (31832, 31832, 31832, 31832, 31832): 50 }, 0, 0, 0, 0)
    m_ExcludeLastRoom = 0
    m_ExcludeArea = []
    m_ValidVerLayer = NEWVERLAYER_VALID


class CRoomChallengeData1158(CCustom):
    m_SID = 1158
    m_Type = CHALLENGE_EXTRAELITE
    m_ChallengeName = '群英荟萃'
    m_ChallengeNotify = '#s(215|1158|9032)'
    m_SuccessNotify = '#s(216|1151|9034)'
    m_FailedNotify = '#s(182|大量精英怪出现！|9033)'
    m_EffectState = 0
    m_Reward = {
...
'sType': 'RidingAlone' }) + 1), 60, {
        (31832, 32832, 31832, 32812, 32812): 50,
        (31832, 30872, 31832, 30872, 31832): 50,
        (31832, 31262, 31832, 31262, 31832): 50,
        (31832, 31832, 32832, 32812, 32812): 50,
        (31832, 31832, 31832, 31832, 31832): 50 }, 0, 0, 70, 80)
    m_ExcludeLastRoom = 0
    m_ExcludeArea = []
    m_ValidVerLayer = NEWVERLAYER_VALID


class CRoomChallengeData1159(CCustom):
    m_SID = 1159
    m_Type = CHALLENGE_COUNT_MUTANTMONSTER
    m_ChallengeName = '幽岚生息'
    m_ChallengeNotify = '#s(242|1159|9032|9737|9738|9743)'
    m_SuccessNotify = '#s(216|1159|9034)'
    m_FailedNotify = '#s(182|幽岚生息！|9033)'
    m_EffectState = 8164
    m_Reward = {
        1: {
            401: (10000, 1),
...
class CRoomChallengeData1160(CCustom):
    m_SID = 1160
    m_Type = CHALLENGE_COUNT_MUTANTMONSTER
    m_ChallengeName = '雷刃风暴'
    m_ChallengeNotify = '#s(242|1160|9032|9737|9740|9743)'
    m_SuccessNotify = '#s(216|1160|9034)'
    m_FailedNotify = '#s(182|雷刃风暴！|9033)'
    m_EffectState = 8164
    m_Reward = {
        1: {
            401: (10000, 1),
        ...
        3: {
            401: (10000, 1),
            501: (10000, 10) } }
    m_Param = (14612, None, None, {
        1: 30,
        2: 25,
        3: 20,
        4: 20 }, {
        1: (lambda *a: (Func572(*a) + 7) / 2 - 1),
        2: (lambda *a: (Func572(*a) + 9) / 2 - 1),
        3: (lambda *a: (Func572(*a) + 9) / 2 - 1),
        4: (lambda *a: (Func572(*a) + 11) / 2 - 2) }, {
        1: (lambda *a: (Func572(*a) + 7) / 2),
        2: (lambda *a: (Func572(*a) + 9) / 2),
        3: (lambda *a: (Func572(*a) + 9) / 2),
        4: (lambda *a: (Func572(*a) + 11) / 2) }, 0, 51226, {
        350: 1 }, { }, { })
    m_ExcludeLastRoom = 0
    m_ExcludeArea = []


class CRoomChallengeData1161(CCustom):
    m_SID = 1161
    m_Type = CHALLENGE_COUNT_MUTANTMONSTER
    m_ChallengeName = '焚宇流星'
    m_ChallengeNotify = '#s(242|1161|9032|9737|9741|9743)'
    m_SuccessNotify = '#s(216|1161|9034)'
    m_FailedNotify = '#s(182|焚宇流星！|9033)'
    m_EffectState = 8164
    m_Reward = {
        1: {
            401: (10000, 1),
...
class CRoomChallengeData1162(CCustom):
    m_SID = 1162
    m_Type = CHALLENGE_COUNT_MUTANTMONSTER
    m_ChallengeName = '玄符化生'
    m_ChallengeNotify = '#s(242|1162|9032|9737|9742|9743)'
    m_SuccessNotify = '#s(216|1162|9034)'
    m_FailedNotify = '#s(182|玄符化生！|9033)'
    m_EffectState = 8164
    m_Reward = {
        1: {
            401: (10000, 1),
    ...
    m_Param = (14614, None, None, {
        ...
        2: (lambda *a: (Func572(*a) + 9) / 2),
        3: (lambda *a: (Func572(*a) + 9) / 2),
        4: (lambda *a: (Func572(*a) + 11) / 2) }, 51229, 51226, {
        400: 1,
        700: (lambda *a: (Func572(*a) + 3) / 2),
        900: (lambda *a: (Func572(*a) + 5) / 2) }, { }, {
        (3, 1): 20071,
        4: 23614,
        3: 23211,
        2: 20022,
...
class CRoomChallengeData1163(CCustom):
    m_SID = 1163
    m_Type = CHALLENGE_EXTRAMONSTER
    m_ChallengeName = '精英坐镇'
    m_ChallengeNotify = '#s(215|1002|9032)'
    m_SuccessNotify = '#s(216|1002|9034)'
    m_FailedNotify = '#s(186|精英幽焰剑卫出现了！|9033)'
    m_EffectState = 0
    m_Reward = { }
    m_Param = (31341,)
    m_ExcludeLastRoom = 0
