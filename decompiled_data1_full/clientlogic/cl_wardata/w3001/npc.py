# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_wardata/w3001/npc.pyc
# RelativePath: clientlogic/cl_wardata/w3001/npc.pyc
...
from cl_commondefines import MG_EQUIP, MG_RELIC, NPC_ACTION_ITEMBOX, NPC_ACTION_MAPCHOOSE, NPC_ACTION_NONE, NPC_ACTION_SETTLELEVEL, NPC_ACTION_SHOP, OBTAIN_CASH, OBTAIN_WARCASH, PET_QUALITY_NORMAL, PET_QUALITY_RARE, VIRTUAL_ITEM_WARCASH, WANDCOMP_RARITY_NORMAL, WANDCOMP_RARITY_RARE, WANDCOMP_RARITY_TALE, WAND_QUALITY_NORMAL, WAND_QUALITY_RARE, WAND_QUALITY_TALE
from cl_newformula import Func16, Func201, Func202, Func203, Func204, Func205, Func212, Func219, Func678
...
def NpcAction1005(oNpc, who):
    npcaction.NpcGoodsConfig(oNpc, who, 0, 100, 1, OBTAIN_WARCASH, (lambda *a: min(250, Func201(*a) * 50 + Func202(*a) * 5)), 1007, 0, { })
    npcaction.NpcGoodsConfig(oNpc, who, 1, 100, 1, OBTAIN_WARCASH, (lambda *a: min(300, Func201(*a) * 60 + Func202(*a) * 5)), 1001, 0, { })
    npcaction.NpcGoodsConfig(oNpc, who, 2, 100, 1, OBTAIN_WARCASH, (lambda *a: min(300, Func201(*a) * 60 + Func202(*a) * 5)), 1008, 0, { })
    npcaction.NpcGoodsEquip(oNpc, who, 3, 100, 1, (lambda *a: min(750, 40 + Func201(*a) * 120 + Func202(*a) * 30)), {
        1: 1001,
        2: 1001,
        3: 1001 }, 0, OBTAIN_WARCASH, 0, { })
    npcaction.NpcGoodsRelic(oNpc, who, 4, 0, 1, OBTAIN_WARCASH, (lambda *a: min(700, Func201(*a) * 120 + Func202(*a) * 30 + 40) * Func203(*a) * Func16(*a, **{
'a': 0.9,
'b': 1 })), {
        1: 2401,
        2: 2401,
        3: 2401 }, 0, 1, { }, 0)
    npcaction.NpcGoodsEquip(oNpc, who, 4, 100, 1, (lambda *a: min(750, 40 + Func201(*a) * 120 + Func202(*a) * 30)), {
        1: 1001,
        2: 1001,
        3: 1001 }, 0, OBTAIN_WARCASH, 0, { })
    npcaction.NpcGoodsRelic(oNpc, who, 5, 0, 1, OBTAIN_WARCASH, (lambda *a: min(700, Func201(*a) * 120 + Func202(*a) * 30 + 40) * Func203(*a) * Func16(*a, **{
'a': 0.9,
'b': 1 })), {
        1: 2401,
        2: 2401,
        3: 2401 }, 0, 1, { }, 0)
    npcaction.NpcGoodsEquip(oNpc, who, 5, 100, 1, (lambda *a: min(750, 40 + Func201(*a) * 120 + Func202(*a) * 30)), {
        1: 1001,
        2: 1001,
        3: 1001 }, 0, OBTAIN_WARCASH, 0, { })
    npcaction.NpcGoodsConfig(oNpc, who, 6, 100, 0, OBTAIN_CASH, 0, 1002, 0, { })
    npcaction.NpcGoodsRelic(oNpc, who, 7, 0, 1, OBTAIN_WARCASH, (lambda *a: min(700, Func201(*a) * 120 + Func202(*a) * 30 + 40) * Func203(*a) * Func16(*a, **{
'a': 0.9,
'b': 1 })), {
        1: 2401,
        2: 2401,
        3: 2401 }, 1, 1, { }, 0)
    npcaction.NpcGoodsEquip(oNpc, who, 7, 100, 1, (lambda *a: min(750, 40 + Func201(*a) * 120 + Func202(*a) * 30)), {
        1: 1001,
        2: 1001,
        3: 1001 }, 1, OBTAIN_WARCASH, 0, { })
    npcaction.NpcGoodsRelic(oNpc, who, 8, 0, 1, OBTAIN_WARCASH, (lambda *a: min(700, Func201(*a) * 120 + Func202(*a) * 30 + 40) * Func203(*a) * Func16(*a, **{
'a': 0.9,
'b': 1 })), {
        1: 2401,
        2: 2401,
        3: 2401 }, 1, 1, { }, 0)
    npcaction.NpcGoodsEquip(oNpc, who, 8, 100, 1, (lambda *a: min(750, 40 + Func201(*a) * 120 + Func202(*a) * 30)), {
        1: 1001,
        2: 1001,
        3: 1001 }, 1, OBTAIN_WARCASH, 0, { })
    npcaction.NpcGoodsRelife(oNpc, who, 9, 100, 1, OBTAIN_WARCASH, (lambda *a: min(400, 30 * (1 + (Func201(*a) - 1) * 1.6 + (Func202(*a) - 1) * 0.25) * (1 + (Func204(*a) - 1) * 0.1) * (1 + (Func205(*a) - 1) * 0.15))))
    npcaction.NpcGoodsRelife(oNpc, who, 10, 100, 1, OBTAIN_WARCASH, (lambda *a: min(400, 30 * (1 + (Func201(*a) - 1) * 1.6 + (Func202(*a) - 1) * 0.25) * (1 + (Func204(*a) - 1) * 0.1) * (1 + (Func205(*a) - 1) * 0.15))))
    npcaction.NpcGoodsRelife(oNpc, who, 11, 100, 1, OBTAIN_WARCASH, (lambda *a: min(400, 30 * (1 + (Func201(*a) - 1) * 1.6 + (Func202(*a) - 1) * 0.25) * (1 + (Func204(*a) - 1) * 0.1) * (1 + (Func205(*a) - 1) * 0.15))))
    npcaction.NpcRandomPlusGoodsEquipOrRelic(oNpc, who, 12, 100, 1, (lambda *a: min(750, 40 + Func201(*a) * 120 + Func202(*a) * 30)), (lambda *a: ceil(min(140, Func201(*a) * 20 + Func202(*a) * 5) * Func678(*a) / 100)), {
        1: 1001,
        2: 1001,
        3: 1001 }, (lambda *a: min(700, Func201(*a) * 120 + Func202(*a) * 30 + 40) * Func203(*a) * Func16(*a, **{
'a': 0.9,
'b': 1 })), (lambda *a: ceil(Func219(*a) * Func678(*a) / 100)), {
        1: 2401,
        2: 2401,
        3: 2401 }, OBTAIN_WARCASH, OBTAIN_CASH, 1, 1, 2, 0, {
        MG_EQUIP: 100,
        MG_RELIC: 100 }, {
        MG_RELIC: 30,
        MG_EQUIP: 70 })
...
def NpcAction1054(oNpc, who):
    npcaction.NpcGoodsEquip(oNpc, who, 0, 100, 1, (lambda *a: ceil(min(140, Func201(*a) * 20 + Func202(*a) * 5) * Func678(*a) / 100)), {
        3: 1006 }, 0, OBTAIN_CASH, 1, { })
    npcaction.NpcGoodsEquip(oNpc, who, 1, 100, 1, (lambda *a: ceil(min(140, Func201(*a) * 20 + Func202(*a) * 5) * Func678(*a) / 100)), {
        3: 1006 }, 0, OBTAIN_CASH, 1, { })
    npcaction.NpcGoodsEquipOrRelic(oNpc, who, 2, 100, 1, (lambda *a: ceil(min(140, Func201(*a) * 20 + Func202(*a) * 5) * Func678(*a) / 100)), {
        3: 1006 }, (lambda *a: Func219(*a)), {
        3: 2407 }, OBTAIN_CASH, 0, 1, 2)
    npcaction.NpcGoodsRelic(oNpc, who, 3, 100, 1, OBTAIN_CASH, (lambda *a: ceil(Func219(*a) * Func678(*a) / 100)), {
        3: 2407 }, 0, 2, { }, 0)
...
def NpcAction1068(oNpc, who):
    npcaction.NpcGoodsPet(oNpc, who, 4, OBTAIN_WARCASH, (lambda *a: min(700, Func201(*a) * 120 + Func202(*a) * 30 + 40) * Func203(*a) * Func16(*a, **{
'a': 0.9,
'b': 1 })), {
...
def NpcAction1072(oNpc, who):
    npcaction.NpcGoodsWandShopCardPack(oNpc, who, {
        1: 1,
        2: 1,
        3: 2,
        4: 2 }, (lambda *a: Func201(*a) * 60 + Func202(*a) * 15 + 20), {
        1: {
            WAND_QUALITY_NORMAL: 100 },
        2: {
            WAND_QUALITY_NORMAL: 100 },
        3: {
            WAND_QUALITY_RARE: 100 },
        4: {
            WAND_QUALITY_RARE: 100 } }, {
        1: {
            WANDCOMP_RARITY_RARE: 30,
            WANDCOMP_RARITY_NORMAL: 70 },
        2: {
            WANDCOMP_RARITY_TALE: 3,
            WANDCOMP_RARITY_RARE: 42,
            WANDCOMP_RARITY_NORMAL: 55 },
        3: {
            WANDCOMP_RARITY_TALE: 8,
            WANDCOMP_RARITY_RARE: 52,
            WANDCOMP_RARITY_NORMAL: 40 },
        4: {
            WANDCOMP_RARITY_TALE: 15,
            WANDCOMP_RARITY_RARE: 70,
            WANDCOMP_RARITY_NORMAL: 15 } }, 1, (lambda *a: (Func201(*a) * 60 + Func202(*a) * 15) * Func16(*a, **{
'a': 0.9,
'b': 1 })), 6, (lambda *a: (Func201(*a) * 10 + Func202(*a) * 2 + 20) * Func16(*a, **{
'a': 0.9,
'b': 1 })), {
        WAND_QUALITY_TALE: 4,
        WAND_QUALITY_RARE: 2,
        WAND_QUALITY_NORMAL: 1 }, 2)
    npcaction.NpcWandShopAbilityRollInfo(oNpc, who, {
        1: {
            'OptionNum': 1,
            'NegativeRatio': 0,
            'Certainl': { },
...
def NpcAction1073(oNpc, who):
    npcaction.NpcGoodsDice(oNpc, who)
...
def NpcAction1114(oNpc, who):
    npcaction.NpcVoteNextLayer(oNpc, who, 1, 3000, 500)


def NpcAction1115(oNpc, who):
    npcaction.NpcVoteNextLayer(oNpc, who, 1, 3000, 500)


def NpcAction1116(oNpc, who):
    npcaction.NpcVoteNextLayer(oNpc, who, 1, 3000, 500)


def NpcAction1117(oNpc, who):
    npcaction.NpcVoteNextLayer(oNpc, who, 1, 3000, 500)


def NpcAction1118(oNpc, who):
...
def NpcAction1408(oNpc, who):
    npcaction.NpcVoteNextLayer(oNpc, who, 1, 3000, 500)


def NpcAction1409(oNpc, who):
    npcaction.NpcVoteNextLayer(oNpc, who, 1, 3000, 500)
...
class CNpcData1064(baseconfig.CNpcData1054):
    m_SID = 1064
    m_Name = '灵界宝库NPC'
    m_Info = { }


class CNpcData1065(baseconfig.CNpcData1055):
    m_SID = 1065
    m_Name = '天降大任NPC'
    m_Info = {
        'Action': NpcAction1065,
        'ActionType': NPC_ACTION_NONE }


class CNpcData1066(baseconfig.CNpcData1060):
    m_SID = 1066
    m_Name = '天赋替换金爵'
    m_Info = {
        'Action': NpcAction1066,
        'ActionType': NPC_ACTION_ITEMBOX }


class CNpcData1067(baseconfig.CNpcData1008):
    m_SID = 1067
    m_Name = '否极泰来金爵'
    m_Info = {
...
class CNpcData1068(baseconfig.CNpcData1068):
    m_SID = 1068
    m_Name = '妖灵商人NPC'
    m_Info = {
...
class CNpcData1069(baseconfig.CNpcData1069):
    m_SID = 1069
    m_Name = '秘卷重组NPC'
    m_Info = { }


class CNpcData1071(baseconfig.CNpcData1071):
    m_SID = 1071
    m_Name = '秘卷商店NPC'
    m_Info = { }


class CNpcData1072(baseconfig.CNpcData1072):
    m_SID = 1072
    m_Name = '法杖商人NPC'
    m_Info = {
        'Action': NpcAction1072,
        'ActionType': NPC_ACTION_NONE }


class CNpcData1073(baseconfig.CNpcData1073):
    m_SID = 1073
    m_Name = 'S6骰子商人'
    m_Info = {
        'Action': NpcAction1073,
        'ActionType': NPC_ACTION_NONE }


class CNpcData1074(baseconfig.CNpcData1074):
    m_SID = 1074
    m_Name = 'S7水晶商人'
    m_Info = { }


class CNpcData1075(baseconfig.CNpcData1075):
    m_SID = 1075
    m_Name = 'S8技能商人'
    m_Info = { }
...
class CNpcData1114(baseconfig.CNpcData1061):
    m_SID = 1114
    m_Name = '陆吾关-新传送门'
    m_Info = {
        'Action': NpcAction1114,
        'ActionType': NPC_ACTION_SETTLELEVEL }


class CNpcData1115(baseconfig.CNpcData1062):
    m_SID = 1115
    m_Name = 'BOSS关传送门'
    m_Info = {
        'Action': NpcAction1115,
        'ActionType': NPC_ACTION_SETTLELEVEL }


class CNpcData1116(baseconfig.CNpcData1063):
    m_SID = 1116
    m_Name = '二幕通关传送门'
    m_Info = {
        'Action': NpcAction1116,
        'ActionType': NPC_ACTION_SETTLELEVEL }


class CNpcData1117(baseconfig.CNpcData1064):
    m_SID = 1117
    m_Name = '四幕通关传送门'
    m_Info = {
        'Action': NpcAction1117,
        'ActionType': NPC_ACTION_SETTLELEVEL }


class CNpcData1118(baseconfig.CNpcData1065):
    m_SID = 1118
    m_Name = '返回客栈传送门'
    m_Info = {
        'Action': NpcAction1118,
        'ActionType': NPC_ACTION_SETTLELEVEL }
...
class CNpcData1204(baseconfig.CNpcData1059):
    m_SID = 1204
    m_Name = '一幕准备室保存点'
    m_Info = {
        'Action': NpcAction1204,
        'ActionType': NPC_ACTION_ITEMBOX }
...
class CNpcData1408(baseconfig.CNpcData1067):
    m_SID = 1408
    m_Name = '四幕进下一关传送门-共用2-无尽模式'
    m_Info = {
        'Action': NpcAction1408,
        'ActionType': NPC_ACTION_SETTLELEVEL }


class CNpcData1409(baseconfig.CNpcData1066):
    m_SID = 1409
    m_Name = '四幕进下一关传送门-共用1-无尽模式'
    m_Info = {
        'Action': NpcAction1409,
        'ActionType': NPC_ACTION_SETTLELEVEL }
...
class CNpcData1521(baseconfig.CNpcData1017):
    m_SID = 1521
    m_Name = '隐藏-三选一-无条件'
    m_Info = {
        'Action': NpcAction1521,
        'ActionType': NPC_ACTION_ITEMBOX }
...
class CNpcData2301(baseconfig.CNpcData2301):
    m_SID = 2301
    m_Name = '事件NPC-秘能玉'
    m_Info = { }


class CNpcData2302(baseconfig.CNpcData2302):
    m_SID = 2302
    m_Name = '事件NPC-秘能玉'
    m_Info = { }
...
class CNpcData7001(baseconfig.CNpcData7001):
    m_SID = 7001
    m_Name = '钩索NPC'
    m_Info = { }
