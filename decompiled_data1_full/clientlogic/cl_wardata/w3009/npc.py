# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_wardata/w3009/npc.pyc
# RelativePath: clientlogic/cl_wardata/w3009/npc.pyc
...
from cl_commondefines import NPC_ACTION_ITEMBOX, NPC_ACTION_MAPCHOOSE, NPC_ACTION_SETTLELEVEL, NPC_ACTION_SHOP, OBTAIN_CASH, OBTAIN_WARCASH, VIRTUAL_ITEM_RELIC, VIRTUAL_ITEM_WARCASH
from cl_newformula import Func16, Func201, Func202, Func203, Func204, Func205, Func212
...
def NpcAction1005(oNpc, who):
    ...
    npcaction.NpcGoodsEquip(oNpc, who, 3, 100, 1, (lambda *a: 0 + Func201(*a) * 150 + Func202(*a) * 30), {
        ...
        2: 1001,
        3: 1001 }, 0, None, None, { })
    npcaction.NpcGoodsRelic(oNpc, who, 4, 0, 1, OBTAIN_WARCASH, (lambda *a: (Func201(*a) * 150 + Func202(*a) * 30) * Func203(*a) * Func16(*a, **{
'a': 0.9,
'b': 1 })), {
        1: 2401,
        2: 2401,
    ...
    npcaction.NpcGoodsEquip(oNpc, who, 4, 100, 1, (lambda *a: 0 + Func201(*a) * 150 + Func202(*a) * 30), {
        ...
        2: 1001,
        3: 1001 }, 0, None, None, { })
    npcaction.NpcGoodsRelic(oNpc, who, 5, 0, 1, OBTAIN_WARCASH, (lambda *a: (Func201(*a) * 150 + Func202(*a) * 30) * Func203(*a) * Func16(*a, **{
'a': 0.9,
'b': 1 })), {
        1: 2401,
        2: 2401,
        3: 2401 }, 0, None, { }, None)
    npcaction.NpcGoodsEquip(oNpc, who, 5, 100, 1, (lambda *a: 0 + Func201(*a) * 150 + Func202(*a) * 30), {
        1: 1001,
        2: 1001,
        3: 1001 }, 0, None, None, { })
    npcaction.NpcGoodsConfig(oNpc, who, 6, 100, 0, OBTAIN_CASH, 0, 1002, 0, { })
    npcaction.NpcGoodsRelic(oNpc, who, 7, 0, 1, OBTAIN_WARCASH, (lambda *a: (Func201(*a) * 150 + Func202(*a) * 30) * Func203(*a) * Func16(*a, **{
'a': 0.9,
'b': 1 })), {
        1: 2401,
        2: 2401,
        3: 2401 }, 1, None, { }, 0)
    npcaction.NpcGoodsEquip(oNpc, who, 7, 100, 1, (lambda *a: 0 + Func201(*a) * 150 + Func202(*a) * 30), {
        1: 1001,
        2: 1001,
        3: 1001 }, 1, None, None, { })
    npcaction.NpcGoodsRelic(oNpc, who, 8, 100, 1, OBTAIN_WARCASH, (lambda *a: (Func201(*a) * 150 + Func202(*a) * 30) * Func203(*a) * Func16(*a, **{
'a': 0.9,
'b': 1 })), {
        1: 2401,
        2: 2401,
        3: 2401 }, 1, None, { }, None)
    npcaction.NpcGoodsEquip(oNpc, who, 8, 100, 1, (lambda *a: 0 + Func201(*a) * 150 + Func202(*a) * 30), {
        1: 1001,
        2: 1001,
        3: 1001 }, 1, None, None, { })
...
def NpcAction1018(oNpc, who):
    npcaction.NpcSetSmithAction(oNpc, who, 1, 100)
...
def NpcAction6001(oNpc, who):
    npcaction.NpcGoodsConfig(oNpc, who, 0, 100, 1, OBTAIN_WARCASH, (lambda *a: 0 + Func201(*a) * 60 + Func202(*a) * 5), 1001, 0, { })
    npcaction.NpcGoodsConfig(oNpc, who, 1, 100, 1, OBTAIN_WARCASH, (lambda *a: 0 + Func201(*a) * 60 + Func202(*a) * 5), 1008, 0, { })
    npcaction.NpcGoodsEquip(oNpc, who, 2, 100, 1, (lambda *a: 0 + Func201(*a) * 150 + Func202(*a) * 30), {
        1: 1001,
        2: 1001,
        3: 1001 }, 0, None, None, { })
    npcaction.NpcGoodsEquip(oNpc, who, 3, 100, 1, (lambda *a: 0 + Func201(*a) * 150 + Func202(*a) * 30), {
        ...
        2: 1001,
        3: 1001 }, 0, None, None, { })
    npcaction.NpcGoodsRelic(oNpc, who, 4, 100, 1, OBTAIN_WARCASH, (lambda *a: (Func201(*a) * 150 + Func202(*a) * 30) * Func203(*a) * Func16(*a, **{
'a': 0.9,
'b': 1 })), {
        1: 2401,
        2: 2401,
    ...
    npcaction.NpcGoodsEquip(oNpc, who, 4, 100, 1, (lambda *a: 0 + Func201(*a) * 150 + Func202(*a) * 30), {
        ...
        2: 1001,
        3: 1001 }, 0, None, None, { })
    npcaction.NpcGoodsConfig(oNpc, who, 5, 100, 0, OBTAIN_CASH, 0, 1002, 0, { })
    npcaction.NpcGoodsRelic(oNpc, who, 7, 0, 1, OBTAIN_WARCASH, (lambda *a: (Func201(*a) * 150 + Func202(*a) * 30) * Func203(*a) * Func16(*a, **{
'a': 0.9,
'b': 1 })), {
        1: 2401,
...
def NpcAction6004(oNpc, who):
    ...
    npcaction.NpcGoodsEquip(oNpc, who, 3, 100, 1, (lambda *a: 0 + Func201(*a) * 150 + Func202(*a) * 30), {
        ...
        2: 1001,
        3: 1001 }, 0, None, None, { })
    npcaction.NpcGoodsRelic(oNpc, who, 4, 0, 1, OBTAIN_WARCASH, (lambda *a: (190 + Func201(*a) * 210 + Func202(*a) * 25) * Func203(*a) * Func16(*a, **{
'a': 0.9,
'b': 1 })), {
        1: 2401,
        2: 2401,
    ...
    npcaction.NpcGoodsEquip(oNpc, who, 4, 100, 1, (lambda *a: 0 + Func201(*a) * 150 + Func202(*a) * 30), {
        ...
        2: 1001,
        3: 1001 }, 0, None, None, { })
    npcaction.NpcGoodsRelic(oNpc, who, 5, 100, 1, OBTAIN_WARCASH, (lambda *a: (190 + Func201(*a) * 210 + Func202(*a) * 25) * Func203(*a) * Func16(*a, **{
'a': 0.9,
'b': 1 })), {
        1: 2401,
        2: 2401,
    ...
    npcaction.NpcGoodsEquip(oNpc, who, 5, 100, 1, (lambda *a: 0 + Func201(*a) * 150 + Func202(*a) * 30), {
        ...
        3: 1001 }, 0, None, None, { })
    npcaction.NpcGoodsConfig(oNpc, who, 6, 100, 0, OBTAIN_CASH, 0, 1002, 0, { })
    npcaction.NpcGoodsRelic(oNpc, who, 7, 0, 1, OBTAIN_WARCASH, (lambda *a: (190 + Func201(*a) * 210 + Func202(*a) * 25) * Func203(*a) * Func16(*a, **{
'a': 0.9,
'b': 1 })), {
        1: 2401,
        2: 2401,
    ...
    npcaction.NpcGoodsEquip(oNpc, who, 7, 100, 1, (lambda *a: 0 + Func201(*a) * 150 + Func202(*a) * 30), {
        ...
        2: 1001,
        3: 1001 }, 1, None, None, { })
    npcaction.NpcGoodsRelic(oNpc, who, 8, 100, 1, OBTAIN_WARCASH, (lambda *a: (190 + Func201(*a) * 210 + Func202(*a) * 25) * Func203(*a) * Func16(*a, **{
'a': 0.9,
'b': 1 })), {
        1: 2401,
        2: 2401,
    ...
    npcaction.NpcGoodsRelife(oNpc, who, 10, 100, 1, OBTAIN_WARCASH, (lambda *a: 150 * (1 + (Func201(*a) - 1) * 1.6 + (Func202(*a) - 1) * 0.25) * (1 + (Func204(*a) - 1) * 0.1) * (1 + (Func205(*a) - 1) * 0.15)))
    npcaction.NpcGoodsRelife(oNpc, who, 11, 100, 1, OBTAIN_WARCASH, (lambda *a: 150 * (1 + (Func201(*a) - 1) * 1.6 + (Func202(*a) - 1) * 0.25) * (1 + (Func204(*a) - 1) * 0.1) * (1 + (Func205(*a) - 1) * 0.15)))
    npcaction.NpcSetBuyGoodsGenCash(oNpc, who)
...
def NpcAction6006(oNpc, who):
    npcaction.NpcGoodsConfig(oNpc, who, 0, 100, 1, OBTAIN_WARCASH, (lambda *a: 0 + Func201(*a) * 50 + Func202(*a) * 5), 1010, 0, { })
    npcaction.NpcGoodsConfig(oNpc, who, 1, 100, 1, OBTAIN_WARCASH, (lambda *a: 0 + Func201(*a) * 60 + Func202(*a) * 5), 1001, 0, { })
    npcaction.NpcGoodsConfig(oNpc, who, 2, 100, 1, OBTAIN_WARCASH, (lambda *a: 0 + Func201(*a) * 60 + Func202(*a) * 5), 1008, 0, { })
    npcaction.NpcGoodsEquip(oNpc, who, 3, 100, 1, (lambda *a: 0 + Func201(*a) * 150 + Func202(*a) * 30), {
        1: 1001,
...
'b': 1 })), {
    ...
    npcaction.NpcGoodsRelife(oNpc, who, 10, 100, 1, OBTAIN_WARCASH, (lambda *a: 150 * (1 + (Func201(*a) - 1) * 1.6 + (Func202(*a) - 1) * 0.25) * (1 + (Func204(*a) - 1) * 0.1) * (1 + (Func205(*a) - 1) * 0.15)))
    npcaction.NpcGoodsRelife(oNpc, who, 11, 100, 1, OBTAIN_WARCASH, (lambda *a: 150 * (1 + (Func201(*a) - 1) * 1.6 + (Func202(*a) - 1) * 0.25) * (1 + (Func204(*a) - 1) * 0.1) * (1 + (Func205(*a) - 1) * 0.15)))
    npcaction.NpcSetBuyRelicRewardGoods(oNpc, who, VIRTUAL_ITEM_RELIC, 1)
    npcaction.NpcSetBuyGoodsGenCash(oNpc, who)
    npcaction.NpcChangeWeaponGrade(oNpc, who, 0, 2)


def NpcAction6007(oNpc, who):
    npcaction.NpcSetSmithAction(oNpc, who, 1, -100)


def NpcAction6008(oNpc, who):
    npcaction.NpcStartMiniGame(oNpc, who, {
        1: 4101,
        2: 4101,
        3: 4101 }, 150, {
...
class CNpcData1401(baseconfig.CNpcData1031):
    m_SID = 1401
    m_Name = '四幕通关传送门'
    m_Info = {
...
class CNpcData1520(baseconfig.CNpcData1003):
    m_SID = 1520
    m_Name = '隐藏-第四幕普通-随机秘卷'
    m_Info = {
        'Action': NpcAction1520,
        'ActionType': NPC_ACTION_ITEMBOX }


class CNpcData1598(baseconfig.CNpcData1006):
    m_SID = 1598
    m_Name = '每日挑战-无条件'
    m_Info = {
        'Action': NpcAction1598,
        'ActionType': NPC_ACTION_ITEMBOX }


class CNpcData1599(baseconfig.CNpcData1003):
    m_SID = 1599
    m_Name = '每日挑战-通关'
    m_Info = {
        'Action': NpcAction1599,
        'ActionType': NPC_ACTION_ITEMBOX }
...
class CNpcData4001(baseconfig.CNpcData4001):
    m_SID = 4001
    m_Name = '秘卷回收'
    m_Info = { }


class CNpcData4002(baseconfig.CNpcData4002):
    m_SID = 4002
    m_Name = '秘卷销毁'
    m_Info = { }


class CNpcData4003(baseconfig.CNpcData4003):
    m_SID = 4003
    m_Name = '秘卷获得'
    m_Info = { }


class CNpcData4004(baseconfig.CNpcData4004):
    m_SID = 4004
    m_Name = '每日挑战-卖血'
    m_Info = { }


class CNpcData4005(baseconfig.CNpcData4005):
    m_SID = 4005
    m_Name = '每日挑战-卖血'
    m_Info = { }


class CNpcData4006(baseconfig.CNpcData4006):
    m_SID = 4006
    m_Name = '每日挑战-卖血'
    m_Info = { }


class CNpcData4007(baseconfig.CNpcData4007):
    m_SID = 4007
    m_Name = '每日挑战-卖血'
    m_Info = { }


class CNpcData4008(baseconfig.CNpcData4008):
    m_SID = 4008
    m_Name = '每日挑战-卖血'
    m_Info = { }


class CNpcData4009(baseconfig.CNpcData4009):
    m_SID = 4009
    m_Name = '刷新npc'
    m_Info = { }


class CNpcData4010(baseconfig.CNpcData4010):
    m_SID = 4010
    m_Name = '每日挑战-卖血'
    m_Info = { }


class CNpcData4011(baseconfig.CNpcData4011):
    m_SID = 4011
    m_Name = '每日挑战-卖血'
    m_Info = { }


class CNpcData4012(baseconfig.CNpcData4012):
    m_SID = 4012
    m_Name = '每日挑战-卖血'
    m_Info = { }


class CNpcData4013(baseconfig.CNpcData4013):
    m_SID = 4013
    m_Name = '每日挑战-卖血'
    m_Info = { }


class CNpcData4014(baseconfig.CNpcData4014):
    m_SID = 4014
    m_Name = '每日挑战-卖血'
    m_Info = { }


class CNpcData4015(baseconfig.CNpcData4015):
    m_SID = 4015
    m_Name = '每日挑战-卖血'
    m_Info = { }


class CNpcData4101(baseconfig.CNpcData4101):
    m_SID = 4101
    m_Name = '每日挑战-卖血'
    m_Info = { }


class CNpcData4102(baseconfig.CNpcData4102):
    m_SID = 4102
    m_Name = '每日挑战-卖血'
    m_Info = { }


class CNpcData4103(baseconfig.CNpcData4103):
    m_SID = 4103
    m_Name = '每日挑战-经济-事件'
    m_Info = { }


class CNpcData4104(baseconfig.CNpcData4104):
    m_SID = 4104
    m_Name = '每日挑战-经济-事件'
    m_Info = { }


class CNpcData4105(baseconfig.CNpcData4105):
    m_SID = 4105
    m_Name = '每日挑战-经济-事件'
    m_Info = { }
...
class CNpcData6001(baseconfig.CNpcData1005):
    m_SID = 6001
    m_Name = '无包子商店'
    m_Info = {
...
class CNpcData6002(baseconfig.CNpcData1006):
    m_SID = 6002
    m_Name = '每日试炼金爵宝箱'
    m_Info = {
...
class CNpcData6003(baseconfig.CNpcData1037):
    m_SID = 6003
    m_Name = '每日试炼金爵'
    m_Info = {
...
class CNpcData6004(baseconfig.CNpcData1005):
    m_SID = 6004
    m_Name = '每日试炼经济压力主题商店'
    m_Info = {
...
class CNpcData6005(baseconfig.CNpcData1006):
    m_SID = 6005
    m_Name = '3把武器宝箱'
    m_Info = {
...
class CNpcData6006(baseconfig.CNpcData1005):
    m_SID = 6006
    m_Name = '每日试炼经济压力条目商店'
    m_Info = {
...
class CNpcData6007(baseconfig.CNpcData1013):
    m_SID = 6007
    m_Name = '每日试炼经济压力工匠'
    m_Info = {
        'Action': NpcAction6007,
        'ActionType': NPC_ACTION_SHOP }


class CNpcData6008(baseconfig.CNpcData1003):
    m_SID = 6008
    m_Name = '【经济压力】【第一幕】通关金爵宝箱'
    m_Info = {
        'Action': NpcAction6008,
        'ActionType': NPC_ACTION_ITEMBOX }


class CNpcData6009(baseconfig.CNpcData1003):
    m_SID = 6009
    m_Name = '【经济压力】【第二幕】通关金爵宝箱'
    m_Info = {
        'Action': NpcAction6009,
        'ActionType': NPC_ACTION_ITEMBOX }


class CNpcData6010(baseconfig.CNpcData1003):
    m_SID = 6010
    m_Name = '【经济压力】【第三幕】通关金爵宝箱'
    m_Info = {
        'Action': NpcAction6010,
        'ActionType': NPC_ACTION_ITEMBOX }


class CNpcData6011(baseconfig.CNpcData1006):
    m_SID = 6011
    m_Name = '3把武器宝箱（妖晶遗华）'
    m_Info = {
        'Action': NpcAction6011,
        'ActionType': NPC_ACTION_ITEMBOX }
