# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_wardata/w3010/minigame.pyc
# RelativePath: clientlogic/cl_wardata/w3010/minigame.pyc
...
class CMiniGameData2401(CDropRelicGameData):
    m_SID = 2401
    m_ChooseQuality = {
        QUALITY_TYPE_HIGH: (lambda *a: 12 + Func201(*a) * 3 + Func202(*a) * 0 + Func205(*a) * 9),
        QUALITY_TYPE_NORMAL: (lambda *a: 120 + Func201(*a) * 2 + Func202(*a) * 0 + Func205(*a) * 11),
