# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_wardata/w3010/npc.pyc
# RelativePath: clientlogic/cl_wardata/w3010/npc.pyc
...
def NpcAction1005(oNpc, who):
    npcaction.NpcGoodsConfig(oNpc, who, 0, 100, 1, OBTAIN_WARCASH, (lambda *a: 0 + Func201(*a) * 30 + Func202(*a) * 2), 1007, 0, { })
    npcaction.NpcGoodsConfig(oNpc, who, 1, 100, 1, OBTAIN_WARCASH, (lambda *a: 0 + Func201(*a) * 30 + Func202(*a) * 3), 1001, 0, { })
    npcaction.NpcGoodsConfig(oNpc, who, 2, 100, 1, OBTAIN_WARCASH, (lambda *a: 0 + Func201(*a) * 30 + Func202(*a) * 3), 1008, 0, { })
    npcaction.NpcGoodsEquip(oNpc, who, 3, 100, 1, (lambda *a: 40 + Func201(*a) * 60 + Func202(*a) * 10), {
        1: 1001,
        2: 1001,
        3: 1001 }, 0, OBTAIN_WARCASH, 0, { })
    npcaction.NpcGoodsEquip(oNpc, who, 4, 100, 1, (lambda *a: 40 + Func201(*a) * 60 + Func202(*a) * 10), {
        1: 1001,
        2: 1001,
        3: 1001 }, 0, OBTAIN_WARCASH, 0, { })
...
'b': 1 })), {
        ...
        2: 2401,
        3: 2401 }, 0, 1, { }, None)
    npcaction.NpcGoodsEquip(oNpc, who, 5, 100, 1, (lambda *a: 40 + Func201(*a) * 60 + Func202(*a) * 10), {
        1: 1001,
        2: 1001,
        3: 1001 }, 0, OBTAIN_WARCASH, 0, { })
    npcaction.NpcGoodsConfig(oNpc, who, 6, 100, 0, OBTAIN_CASH, 0, 1002, 0, { })
    npcaction.NpcGoodsEquip(oNpc, who, 7, 100, 1, (lambda *a: 40 + Func201(*a) * 60 + Func202(*a) * 10), {
        1: 1001,
        2: 1001,
...
'b': 1 })), {
        ...
        2: 2401,
        3: 2401 }, 1, 1, { }, None)
    npcaction.NpcGoodsEquip(oNpc, who, 8, 100, 1, (lambda *a: 40 + Func201(*a) * 60 + Func202(*a) * 10), {
        1: 1001,
        2: 1001,
        3: 1001 }, 1, OBTAIN_WARCASH, 0, { })
