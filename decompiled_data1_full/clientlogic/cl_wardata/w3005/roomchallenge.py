# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_wardata/w3005/roomchallenge.pyc
# RelativePath: clientlogic/cl_wardata/w3005/roomchallenge.pyc
...
class CRoomChallengeData1053(CCustom):
    ...
    m_ChallengeNotify = '#s(171|所有怪物持续恢复生命值！|9032)'
    m_SuccessNotify = '#s(181|所有怪物持续恢复生命值！|9034)'
    m_FailedNotify = '#s(182|所有怪物持续恢复生命值！|9033)'
    m_EffectState = 0
    m_Reward = {
        1: {
            401: (10000, 1),
