# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_wardata/w3007/roomchallenge.pyc
# RelativePath: clientlogic/cl_wardata/w3007/roomchallenge.pyc
# Source Generated with Decompyle++
# File: roomchallenge.pyc (Python 3.6)

from cl_resmgr.resdata import CRoomChallengeData as CCustom
from cl_commondefines import ALLVERLAYER_VALID, CHALLENGE_ABERRANCE, CHALLENGE_APPENDSKILL, CHALLENGE_BOXMONSTER, CHALLENGE_DEFEND, CHALLENGE_ELITE, CHALLENGE_ELITEINTRUDE, CHALLENGE_EXTRAELITE, CHALLENGE_EXTRAMONSTER, CHALLENGE_KILLSUMMON, CHALLENGE_LIMITCONVOY, CHALLENGE_LIMITDEFEND, CHALLENGE_LIMITLIVE, CHALLENGE_LIMITTIME, CHALLENGE_NOTIFY, CHALLENGE_NOTIFYLIMITTIME, CHALLENGE_PLAYERPERFORM, CHALLENGE_SIGHT, CHALLENGE_SUPERMONSTER, CHALLENGE_TRAP
...
'sType': 'RidingAlone' }) + 1), 50, {
        (30832, 31232): 50,
        (30012, 30832): 50 }, 2, None, None, None)
    m_ExcludeLastRoom = 0
    m_ExcludeArea = [
        (1110502, 1),
        (1110502, 6),
...
'sType': 'RidingAlone' }) + 1), 100, {
        ...
        (30212, 32422, 32012, 31422, 31252): 50 }, 2, None, None, None)
    m_ExcludeLastRoom = 0
    m_ExcludeArea = []
...
'sType': 'RidingAlone' }) + 1), 100, {
        ...
        (30872, 31262, 32032, 32812, 32823): 50 }, 2, None, None, None)
    m_ExcludeLastRoom = 0
    m_ExcludeArea = [
        (1130301, 3),
        (1130301, 4),
...
class CRoomChallengeData1091(CCustom):
    ...
    m_Param = ((lambda *a: Func235(*a, **{
'sType': 'RidingAlone' }) + 1), 100, {
        (31642, 33813, 31642, 33813, 33813): 50 }, 2, None, None, None)
    m_ExcludeLastRoom = 0
    m_ExcludeArea = []
...
class CRoomChallengeData1113(CCustom):
    ...
    m_Reward = {
        ...
        3: {
            1001: (10000, 1) } }
    m_Param = ((31252, 31422, 32012, 32422, 30212), 20, 50, {
        (2, 3): {
...
class CRoomChallengeData1114(CCustom):
    ...
    m_Reward = {
        ...
        3: {
            1001: (10000, 1) } }
    m_Param = ((31262, 32812, 32032, 32823, 32832, 30872), 20, 50, {
        (3, 3): {
            'InscriptionExclusive': 2,
            'SyncGrade': 1 },
        (3, 2): {
...
'sType': 'RidingAlone' }) + 1), 100, {
        ...
        (32012, 32012, 32012, 32012, 32012): 50 }, 2, None, None, None)
    m_ExcludeLastRoom = 0
    m_ExcludeArea = []
...
'sType': 'RidingAlone' }) + 1), 100, {
        ...
        (32832, 32832, 32832, 32832, 32832): 50 }, 2, None, None, None)
    m_ExcludeLastRoom = 0
    m_ExcludeArea = [
        (1130301, 3),
        (1130301, 4),
...
class CRoomChallengeData1118(CCustom):
    ...
    m_Param = ((lambda *a: Func235(*a, **{
'sType': 'RidingAlone' }) + 1), 50, {
        (33813, 33813, 33813, 33813, 33813): 50 }, 2, None, None, None)
    m_ExcludeLastRoom = 0
    m_ExcludeArea = []
