# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_wardata/w3007/npc.pyc
# RelativePath: clientlogic/cl_wardata/w3007/npc.pyc
...
from cl_commondefines import NPC_ACTION_ITEMBOX, NPC_ACTION_MAPCHOOSE, NPC_ACTION_NONE, NPC_ACTION_SETTLELEVEL, NPC_ACTION_SHOP, OBTAIN_CASH, OBTAIN_WARCASH, VIRTUAL_ITEM_WARCASH
...
'b': 1 })), {
    ...
    npcaction.NpcGoodsEquip(oNpc, who, 8, 100, 1, (lambda *a: min(750, 40 + Func201(*a) * 120 + Func202(*a) * 30)), {
        ...
        2: 1001,
        3: 1001 }, 1, OBTAIN_WARCASH, 0, { })
    npcaction.NpcGoodsRelife(oNpc, who, 9, 100, 1, OBTAIN_WARCASH, (lambda *a: min(2000, 150 * (1 + (Func201(*a) - 1) * 1.6 + (Func202(*a) - 1) * 0.25) * (1 + (Func204(*a) - 1) * 0.1) * (1 + (Func205(*a) - 1) * 0.15))))
    npcaction.NpcGoodsRelife(oNpc, who, 10, 100, 1, OBTAIN_WARCASH, (lambda *a: min(2000, 150 * (1 + (Func201(*a) - 1) * 1.6 + (Func202(*a) - 1) * 0.25) * (1 + (Func204(*a) - 1) * 0.1) * (1 + (Func205(*a) - 1) * 0.15))))
    npcaction.NpcGoodsRelife(oNpc, who, 11, 100, 1, OBTAIN_WARCASH, (lambda *a: min(2000, 150 * (1 + (Func201(*a) - 1) * 1.6 + (Func202(*a) - 1) * 0.25) * (1 + (Func204(*a) - 1) * 0.1) * (1 + (Func205(*a) - 1) * 0.15))))
...
def NpcAction1054(oNpc, who):
    npcaction.NpcGoodsEquip(oNpc, who, 0, 100, 1, (lambda *a: min(140, Func201(*a) * 20 + Func202(*a) * 5)), {
        3: 1006 }, 0, OBTAIN_CASH, 1, { })
    npcaction.NpcGoodsEquip(oNpc, who, 1, 100, 1, (lambda *a: min(140, Func201(*a) * 20 + Func202(*a) * 5)), {
        3: 1006 }, 0, OBTAIN_CASH, 1, { })
    npcaction.NpcGoodsEquipOrRelic(oNpc, who, 2, 100, 1, (lambda *a: min(140, Func201(*a) * 20 + Func202(*a) * 5)), {
...
'b': 1 })), {
    ...
    npcaction.NpcGoodsRelife(oNpc, who, 10, 100, 1, OBTAIN_WARCASH, (lambda *a: min(2000, 150 * (1 + (Func201(*a) - 1) * 1.6 + (Func202(*a) - 1) * 0.25) * (1 + (Func204(*a) - 1) * 0.1) * (1 + (Func205(*a) - 1) * 0.15))))
    npcaction.NpcGoodsRelife(oNpc, who, 11, 100, 1, OBTAIN_WARCASH, (lambda *a: min(2000, 150 * (1 + (Func201(*a) - 1) * 1.6 + (Func202(*a) - 1) * 0.25) * (1 + (Func204(*a) - 1) * 0.1) * (1 + (Func205(*a) - 1) * 0.15))))
    npcaction.NpcGoodsRelic(oNpc, who, 12, 100, 1, OBTAIN_WARCASH, (lambda *a: min(700, Func201(*a) * 120 + Func202(*a) * 30 + 40) * Func203(*a) * Func16(*a, **{
'a': 0.9,
'b': 1 })), {
        1: 2401,
        2: 2401,
        3: 2401 }, 1, 1, { }, 0)
    npcaction.NpcGoodsEquip(oNpc, who, 12, 100, 1, (lambda *a: min(750, 40 + Func201(*a) * 120 + Func202(*a) * 30)), {
        1: 1001,
        2: 1001,
        3: 1001 }, 1, OBTAIN_WARCASH, 0, { })
...
class CNpcData1063(baseconfig.CNpcData1053):
    m_SID = 1063
    m_Name = '赌侠NPC'
    m_Info = { }
