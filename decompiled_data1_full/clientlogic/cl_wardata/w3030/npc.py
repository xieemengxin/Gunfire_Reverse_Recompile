# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_wardata/w3030/npc.pyc
# RelativePath: clientlogic/cl_wardata/w3030/npc.pyc
...
from cl_commondefines import NPC_ACTION_ITEMBOX, NPC_ACTION_MAPCHOOSE, NPC_ACTION_SETTLELEVEL, NPC_ACTION_SHOP, OBTAIN_CASH, OBTAIN_WARCASH, VIRTUAL_ITEM_WARCASH, WARRIOR_NORMAL
from cl_newformula import Func16, Func201, Func202, Func203, Func204, Func205, Func211, Func212, Func219, Func441, Func442
...
def NpcAction1005(oNpc, who):
    npcaction.NpcGoodsConfig(oNpc, who, 0, 100, 1, OBTAIN_WARCASH, (lambda *a: 5 * (Func441(*a) - 1) + 50), 1007, 0, { })
    npcaction.NpcGoodsConfig(oNpc, who, 1, 100, 1, OBTAIN_WARCASH, (lambda *a: 6 * (Func441(*a) - 1) + 60), 1001, 0, { })
    npcaction.NpcGoodsConfig(oNpc, who, 2, 100, 1, OBTAIN_WARCASH, (lambda *a: 6 * (Func441(*a) - 1) + 60), 1008, 0, { })
    npcaction.NpcGoodsEquip(oNpc, who, 3, 100, 1, (lambda *a: 15 * (Func441(*a) - 1) + 100), {
        1: 1001,
        2: 1001,
        3: 1001 }, 0, OBTAIN_WARCASH, 0, { })
    npcaction.NpcGoodsRelic(oNpc, who, 4, 0, 1, OBTAIN_WARCASH, (lambda *a: (20 * (Func441(*a) - 1) + 160) * Func203(*a) * Func16(*a, **{
'a': 0.9,
'b': 1 })), {
        1: 2401,
        2: 2401,
        3: 2401 }, 0, 1, { }, 0)
    npcaction.NpcGoodsEquip(oNpc, who, 4, 100, 1, (lambda *a: 15 * (Func441(*a) - 1) + 100), {
        1: 1001,
        2: 1001,
        3: 1001 }, 0, OBTAIN_WARCASH, 0, { })
    npcaction.NpcGoodsRelic(oNpc, who, 5, 200, 1, OBTAIN_WARCASH, (lambda *a: (20 * (Func441(*a) - 1) + 160) * Func203(*a) * Func16(*a, **{
'a': 0.9,
'b': 1 })), {
        1: 2401,
        2: 2401,
        3: 2401 }, 0, 1, { }, None)
    npcaction.NpcGoodsEquip(oNpc, who, 5, 100, 1, (lambda *a: 15 * (Func441(*a) - 1) + 100), {
        1: 1001,
        2: 1001,
        3: 1001 }, 0, OBTAIN_WARCASH, 0, { })
    npcaction.NpcGoodsConfig(oNpc, who, 6, 100, 0, OBTAIN_CASH, 0, 1002, 0, { })
    npcaction.NpcGoodsRelic(oNpc, who, 7, 0, 1, OBTAIN_WARCASH, (lambda *a: (20 * (Func441(*a) - 1) + 160) * Func203(*a) * Func16(*a, **{
'a': 0.9,
'b': 1 })), {
        1: 2401,
        2: 2401,
        3: 2401 }, 0, 1, { }, 0)
    npcaction.NpcGoodsEquip(oNpc, who, 7, 100, 1, (lambda *a: 15 * (Func441(*a) - 1) + 100), {
        1: 1001,
        2: 1001,
        3: 1001 }, 0, OBTAIN_WARCASH, 0, { })
    npcaction.NpcGoodsRelic(oNpc, who, 8, 200, 1, OBTAIN_WARCASH, (lambda *a: (20 * (Func441(*a) - 1) + 160) * Func203(*a) * Func16(*a, **{
'a': 0.9,
'b': 1 })), {
        1: 2401,
        2: 2401,
        3: 2401 }, 0, 1, { }, None)
    npcaction.NpcGoodsEquip(oNpc, who, 8, 100, 1, (lambda *a: 15 * (Func441(*a) - 1) + 100), {
        1: 1001,
        2: 1001,
        3: 1001 }, 0, OBTAIN_WARCASH, 0, { })
    npcaction.NpcGoodsRelife(oNpc, who, 9, 100, 1, OBTAIN_WARCASH, (lambda *a: (25 * (Func441(*a) - 1) + 240) * (1 + (Func204(*a) - 1) * 0.1)))
    npcaction.NpcGoodsRelife(oNpc, who, 10, 100, 1, OBTAIN_WARCASH, (lambda *a: (25 * (Func441(*a) - 1) + 240) * (1 + (Func204(*a) - 1) * 0.1)))
    npcaction.NpcGoodsRelife(oNpc, who, 11, 100, 1, OBTAIN_WARCASH, (lambda *a: (25 * (Func441(*a) - 1) + 240) * (1 + (Func204(*a) - 1) * 0.1)))
...
def NpcAction1051(oNpc, who):
    npcaction.NpcRewardItemListByPhase(oNpc, who, {
        1: {
            101: {
                'Prop': 10000,
                'Times': 10 },
...
def NpcAction1054(oNpc, who):
    ...
    npcaction.NpcGoodsEquip(oNpc, who, 1, 100, 1, (lambda *a: Func201(*a) * 20 + Func202(*a) * 5), {
        3: 1006 }, 0, OBTAIN_CASH, 1, { })
    npcaction.NpcGoodsEquipOrRelic(oNpc, who, 2, 100, 1, (lambda *a: Func201(*a) * 20 + Func202(*a) * 5), {
        3: 1006 }, (lambda *a: Func219(*a)), {
        3: 2407 }, OBTAIN_CASH, 0, 1, 2)
    npcaction.NpcGoodsRelic(oNpc, who, 3, 100, 1, OBTAIN_CASH, (lambda *a: Func219(*a)), {
        3: 2407 }, 0, 2, { }, None)
    npcaction.NpcGoodsConfig(oNpc, who, 4, 100, 0, OBTAIN_CASH, 0, 1002, 0, { })


def NpcAction1055(oNpc, who):
    npcaction.NpcStartMiniGame(oNpc, who, {
        1: 4104,
        2: 4104,
        3: 4104 }, 150, {
...
def NpcAction1056(oNpc, who):
    npcaction.NpcDelayTransferPos(oNpc, who, 3000, 0, 100, 1)


def NpcAction1057(oNpc, who):
    npcaction.NpcTransferHideLevel(oNpc, who)


def NpcAction1058(oNpc, who):
    npcaction.NpcTransferLevel(oNpc, who)


def NpcAction1059(oNpc, who):
    ...
    npcaction.NpcGoodsEquip(oNpc, who, 3, 100, 1, (lambda *a: 40 + Func201(*a) * 120 + Func202(*a) * 30), {
        ...
        2: 1001,
        3: 1001 }, 0, OBTAIN_WARCASH, 0, { })
    npcaction.NpcGoodsRelic(oNpc, who, 4, 0, 1, OBTAIN_WARCASH, (lambda *a: (Func201(*a) * 120 + Func202(*a) * 30 + 40) * Func203(*a) * Func16(*a, **{
'a': 0.9,
'b': 1 })), {
        1: 2401,
        2: 2401,
...
'b': 1 })), {
    ...
    npcaction.NpcGoodsEquip(oNpc, who, 5, 100, 1, (lambda *a: 40 + Func201(*a) * 120 + Func202(*a) * 30), {
        ...
        3: 1001 }, 0, OBTAIN_WARCASH, 0, { })
    npcaction.NpcGoodsConfig(oNpc, who, 6, 100, 0, OBTAIN_CASH, 0, 1002, 0, { })
    npcaction.NpcGoodsRelic(oNpc, who, 7, 0, 1, OBTAIN_WARCASH, (lambda *a: (Func201(*a) * 120 + Func202(*a) * 30 + 40) * Func203(*a) * Func16(*a, **{
'a': 0.9,
'b': 1 })), {
        1: 2401,
        2: 2401,
    ...
    npcaction.NpcGoodsRelic(oNpc, who, 8, 0, 1, OBTAIN_WARCASH, (lambda *a: (Func201(*a) * 120 + Func202(*a) * 30 + 40) * Func203(*a) * Func16(*a, **{
'a': 0.9,
'b': 1 })), {
        1: 2401,
        2: 2401,
...
def NpcAction1063(oNpc, who):
    npcaction.NpcGoodsConfig(oNpc, who, 0, 100, 1, OBTAIN_WARCASH, (lambda *a: Func441(*a) * 10 + 100), 1018, 0, { })
    npcaction.NpcGoodsEquip(oNpc, who, 1, 100, 1, (lambda *a: Func441(*a) * 20 + 150), {
        1: 1001,
        2: 1001,
        3: 1001 }, 0, OBTAIN_WARCASH, 0, { })
    npcaction.NpcGoodsEquip(oNpc, who, 2, 100, 1, (lambda *a: Func441(*a) * 20 + 150), {
        1: 1001,
        2: 1001,
        3: 1001 }, 0, OBTAIN_WARCASH, 0, { })
    npcaction.NpcGoodsEquip(oNpc, who, 3, 100, 1, (lambda *a: Func441(*a) * 20 + 150), {
        1: 1001,
        2: 1001,
        3: 1001 }, 0, OBTAIN_WARCASH, 0, { })
    npcaction.NpcGoodsEquip(oNpc, who, 4, 50, 1, (lambda *a: Func441(*a) * 20 + 150), {
        1: 1001,
        2: 1001,
        3: 1001 }, 0, OBTAIN_WARCASH, 0, { })
    npcaction.NpcGoodsRelic(oNpc, who, 4, 50, 1, OBTAIN_WARCASH, (lambda *a: (230 + Func441(*a) * 20) * Func203(*a) * Func16(*a, **{
'a': 0.9,
'b': 1 })), {
        1: 2401,
        2: 2401,
        3: 2401 }, 0, 1, { }, 0)
    npcaction.NpcGoodsRelic(oNpc, who, 5, 100, 1, OBTAIN_WARCASH, (lambda *a: (230 + Func441(*a) * 20) * Func203(*a) * Func16(*a, **{
'a': 0.9,
'b': 1 })), {
        1: 2401,
        2: 2401,
        3: 2401 }, 0, 1, { }, 0)
    npcaction.NpcGoodsConfig(oNpc, who, 6, 100, -1, OBTAIN_WARCASH, (lambda *a: min(int((30 + Func441(*a) * 3) * 7.41), int((30 + Func441(*a) * 3) * 1.65 ** Func211(*a)))), 1002, 0, { })
    npcaction.NpcGoodsEquip(oNpc, who, 0, 100, 1, (lambda *a: Func441(*a) * 20 + 150), {
        1: 1001,
        2: 1001,
        3: 1001 }, 0, OBTAIN_WARCASH, 0, {
        'Refresh': 1 })
...
'b': 1 })), {
        ...
        3: 2401 }, 0, 1, {
        'Refresh': 1 }, 0)
    npcaction.NpcGoodsRelic(oNpc, who, 5, 75, 1, OBTAIN_WARCASH, (lambda *a: (230 + Func441(*a) * 20) * Func203(*a) * Func16(*a, **{
'a': 0.9,
'b': 1 })), {
        1: 2401,
        2: 2401,
        3: 2401 }, 0, 1, {
        'Refresh': 1 }, 0)
    npcaction.NpcGoodsRelic(oNpc, who, 5, 5, 1, OBTAIN_WARCASH, (lambda *a: -(400 + Func441(*a) * 100)), {
        1: 2421,
        2: 2421,
        3: 2421 }, 0, 1, {
        'Refresh': 1 }, 1)
    npcaction.NpcGoodsConfig(oNpc, who, 5, 5, 1, OBTAIN_WARCASH, (lambda *a: 700 + Func441(*a) * 50), 1019, 0, {
        'Refresh': 1 })
    npcaction.NpcGoodsConfig(oNpc, who, 6, 100, -1, OBTAIN_WARCASH, (lambda *a: min(int((30 + Func441(*a) * 3) * 7.41), int((30 + Func441(*a) * 3) * 1.65 ** Func211(*a)))), 1002, 0, {
        'Refresh': 1 })
    npcaction.NpcGoodsRareItem(oNpc, who, 5, 15, 1, OBTAIN_WARCASH, (lambda *a: (Func441(*a) / 10 + 0.8) * 300 * Func16(*a, **{
'a': 0.9,
'b': 1.2 })), 701, 0)


def NpcAction1067(oNpc, who):
    npcaction.NpcStartMiniGame(oNpc, who, {
        1: 4003,
        2: 4003,
        3: 4003 }, 0, {
...
'b': 1 })), {
    ...
    npcaction.NpcGoodsEquip(oNpc, who, 8, 100, 1, (lambda *a: 15 * (Func441(*a) - 1) + 100), {
        ...
        2: 1001,
        3: 1001 }, 0, OBTAIN_WARCASH, 0, { })
    npcaction.NpcGoodsRelife(oNpc, who, 9, 100, 999, OBTAIN_WARCASH, (lambda *a: 300 + 200 * Func442(*a)))
    npcaction.NpcGoodsRelife(oNpc, who, 10, 100, 999, OBTAIN_WARCASH, (lambda *a: 300 + 200 * Func442(*a)))
    npcaction.NpcGoodsRelife(oNpc, who, 11, 100, 999, OBTAIN_WARCASH, (lambda *a: 300 + 200 * Func442(*a)))
    npcaction.NpcGoodsRareItem(oNpc, who, 12, 100, 1, OBTAIN_WARCASH, (lambda *a: (Func441(*a) / 10 + 0.8) * 300 * Func16(*a, **{
'a': 0.9,
'b': 1.2 })), 701, 0)


def NpcAction1069(oNpc, who):
    npcaction.NpcStartMiniGame(oNpc, who, {
        1: 4004,
        2: 4004,
        3: 4004 }, 0, { })
...
def NpcAction1203(oNpc, who):
    ...
    npcaction.NpcSaveWarRecord(oNpc, who)
...
def NpcAction1401(oNpc, who):
    npcaction.NpcDelayTransferLevel(oNpc, who, 3000)


def NpcAction1402(oNpc, who):
    npcaction.NpcDelayTransferLevel(oNpc, who, 3000)
...
def NpcAction1406(oNpc, who):
    npcaction.NpcVoteNextLayer(oNpc, who, 0, 3000, 500)


def NpcAction1407(oNpc, who):
    npcaction.NpcVoteNextLayer(oNpc, who, 0, 3000, 500)
...
def NpcAction6001(oNpc, who):
    npcaction.NpcTriggerClientBehavior(oNpc, who, 6001, 1, 0)


def NpcAction6002(oNpc, who):
    npcaction.NpcTriggerClientBehavior(oNpc, who, 6002, 0, 0)
    npcaction.NpcKillAroundMonster(oNpc, who, 6, WARRIOR_NORMAL)


def NpcAction6003(oNpc, who):
    npcaction.NpcVoteNextLayer(oNpc, who, 0, 3000, 500)
    npcaction.NpcCancelCheckDistance(oNpc, who, 1)


def NpcAction6004(oNpc, who):
    npcaction.NpcTriggerClientBehavior(oNpc, who, 6001, 1, 0)


def NpcAction6005(oNpc, who):
    npcaction.NpcTriggerClientBehavior(oNpc, who, 6003, 0, 0)
    npcaction.NpcKillAroundMonster(oNpc, who, 6, WARRIOR_NORMAL)


def NpcAction6006(oNpc, who):
    npcaction.NpcDelayTransferLevel(oNpc, who, 3000)
    npcaction.NpcCancelCheckDistance(oNpc, who, 1)
...
class CNpcData1025(baseconfig.CNpcData1051):
    m_SID = 1025
    m_Name = '初始武器魔盒'
    m_Info = {
...
class CNpcData1051(baseconfig.CNpcData1039):
    m_SID = 1051
    m_Name = '瞄准关通关宝箱'
    m_Info = {
        'Action': NpcAction1051,
        'ActionType': NPC_ACTION_ITEMBOX }


class CNpcData1052(baseconfig.CNpcData1040):
    m_SID = 1052
    m_Name = '瞄准关武器宝箱（狙击）'
    m_Info = { }
...
class CNpcData1055(baseconfig.CNpcData1003):
    m_SID = 1055
    m_Name = '【第四幕】通关金爵宝箱'
    m_Info = {
        'Action': NpcAction1055,
        'ActionType': NPC_ACTION_ITEMBOX }


class CNpcData1056(baseconfig.CNpcData1043):
    m_SID = 1056
    m_Name = '妖王传送npc'
    m_Info = {
        'Action': NpcAction1056,
        'ActionType': NPC_ACTION_MAPCHOOSE }


class CNpcData1057(baseconfig.CNpcData1044):
    m_SID = 1057
    m_Name = '四幕隐藏关传送门'
    m_Info = {
        'Action': NpcAction1057,
        'ActionType': NPC_ACTION_MAPCHOOSE }


class CNpcData1058(baseconfig.CNpcData1044):
    m_SID = 1058
    m_Name = '四幕出隐藏关传送门'
    m_Info = {
        'Action': NpcAction1058,
        'ActionType': NPC_ACTION_MAPCHOOSE }


class CNpcData1059(baseconfig.CNpcData1005):
    m_SID = 1059
    m_Name = '【第四幕】商店'
    m_Info = {
        'Action': NpcAction1059,
        'ActionType': NPC_ACTION_SHOP }


class CNpcData1061(baseconfig.CNpcData1050):
    m_SID = 1061
    m_Name = '普通天赋金爵-只显示一个'
    m_Info = {
        'Action': NpcAction1061,
        'ActionType': NPC_ACTION_ITEMBOX }


class CNpcData1062(baseconfig.CNpcData1049):
    m_SID = 1062
    m_Name = '【第四幕】祝福使者'
    m_Info = { }


class CNpcData1063(baseconfig.CNpcData1056):
    m_SID = 1063
    m_Name = '幸存者-行脚商'
    m_Info = {
        'Action': NpcAction1063,
        'ActionType': NPC_ACTION_SHOP }


class CNpcData1064(baseconfig.CNpcData1057):
    m_SID = 1064
    m_Name = '幸存者-工匠'
    m_Info = { }


class CNpcData1065(baseconfig.CNpcData1005):
    m_SID = 1065
    m_Name = '幸存者-宝叔'
    m_Info = { }


class CNpcData1066(baseconfig.CNpcData1005):
    m_SID = 1066
    m_Name = '幸存者-骆驼'
    m_Info = { }


class CNpcData1067(baseconfig.CNpcData1052):
    m_SID = 1067
    m_Name = '幸存者-稀有金爵'
    m_Info = {
        'Action': NpcAction1067,
        'ActionType': NPC_ACTION_ITEMBOX }


class CNpcData1068(baseconfig.CNpcData1005):
    m_SID = 1068
    m_Name = '幸存者-行脚商-稀有道具'
    m_Info = {
        'Action': NpcAction1068,
        'ActionType': NPC_ACTION_SHOP }


class CNpcData1069(baseconfig.CNpcData1058):
    m_SID = 1069
    m_Name = '幸存者-金爵'
    m_Info = {
        'Action': NpcAction1069,
        'ActionType': NPC_ACTION_ITEMBOX }
...
class CNpcData1401(baseconfig.CNpcData1045):
    m_SID = 1401
    m_Name = '四幕通关传送门'
    m_Info = {
        'Action': NpcAction1401,
        'ActionType': NPC_ACTION_SETTLELEVEL }


class CNpcData1402(baseconfig.CNpcData1045):
    m_SID = 1402
    m_Name = '四幕入口传送门'
    m_Info = {
        'Action': NpcAction1402,
        'ActionType': NPC_ACTION_MAPCHOOSE }
...
class CNpcData1406(baseconfig.CNpcData1047):
    m_SID = 1406
    m_Name = '四幕通关传送门-共用1'
    m_Info = {
        'Action': NpcAction1406,
        'ActionType': NPC_ACTION_SETTLELEVEL }


class CNpcData1407(baseconfig.CNpcData1048):
    m_SID = 1407
    m_Name = '四幕通关传送门-共用2'
    m_Info = {
        'Action': NpcAction1407,
        'ActionType': NPC_ACTION_SETTLELEVEL }
...
class CNpcData1519(baseconfig.CNpcData1024):
    m_SID = 1519
    m_Name = '隐藏-第四幕精英-秘卷三选一'
    m_Info = {
        'Action': NpcAction1519,
        'ActionType': NPC_ACTION_ITEMBOX }


class CNpcData1520(baseconfig.CNpcData1003):
    m_SID = 1520
    m_Name = '隐藏-第四幕普通-掉落一个秘卷'
    m_Info = {
        'Action': NpcAction1520,
        'ActionType': NPC_ACTION_ITEMBOX }
...
class CNpcData2201(baseconfig.CNpcData2201):
    m_SID = 2201
    m_Name = '事件NPC-轮回'
    m_Info = { }


class CNpcData2202(baseconfig.CNpcData2202):
    m_SID = 2202
    m_Name = '事件NPC-轮回'
    m_Info = { }


class CNpcData2203(baseconfig.CNpcData2203):
    m_SID = 2203
    m_Name = '刷新NPC-轮回'
    m_Info = { }


class CNpcData2204(baseconfig.CNpcData2204):
    m_SID = 2204
    m_Name = '事件NPC-轮回'
    m_Info = { }


class CNpcData2205(baseconfig.CNpcData2205):
    m_SID = 2205
    m_Name = '事件NPC-轮回'
    m_Info = { }


class CNpcData2206(baseconfig.CNpcData2206):
    m_SID = 2206
    m_Name = '事件NPC-轮回'
    m_Info = { }
...
class CNpcData3101(baseconfig.CNpcData3101):
    m_SID = 3101
    m_Name = '事件NPC-幸存者3101'
    m_Info = { }


class CNpcData3102(baseconfig.CNpcData3102):
    m_SID = 3102
    m_Name = '事件NPC-幸存者3102'
    m_Info = { }


class CNpcData3103(baseconfig.CNpcData3103):
    m_SID = 3103
    m_Name = '事件NPC-幸存者3103'
    m_Info = { }


class CNpcData3105(baseconfig.CNpcData3105):
    m_SID = 3105
    m_Name = '事件NPC-幸存者3105'
    m_Info = { }


class CNpcData3109(baseconfig.CNpcData3109):
    m_SID = 3109
    m_Name = '刷新NPC-幸存者3109'
    m_Info = { }


class CNpcData3112(baseconfig.CNpcData3112):
    m_SID = 3112
    m_Name = '事件NPC-幸存者3112'
    m_Info = { }


class CNpcData3113(baseconfig.CNpcData3113):
    m_SID = 3113
    m_Name = '事件NPC-幸存者3113'
    m_Info = { }


class CNpcData3115(baseconfig.CNpcData3115):
    m_SID = 3115
    m_Name = '事件NPC-幸存者3115'
    m_Info = { }


class CNpcData3116(baseconfig.CNpcData3116):
    m_SID = 3116
    m_Name = '事件NPC-幸存者3116'
    m_Info = { }


class CNpcData3117(baseconfig.CNpcData3117):
    m_SID = 3117
    m_Name = '事件NPC-幸存者3117'
    m_Info = { }


class CNpcData3118(baseconfig.CNpcData3118):
    m_SID = 3118
    m_Name = '事件NPC-幸存者3118'
    m_Info = { }


class CNpcData3121(baseconfig.CNpcData3121):
    m_SID = 3121
    m_Name = '事件NPC-幸存者3121'
    m_Info = { }


class CNpcData3122(baseconfig.CNpcData3122):
    m_SID = 3122
    m_Name = '事件NPC-幸存者3122'
    m_Info = { }


class CNpcData3201(baseconfig.CNpcData3201):
    m_SID = 3201
    m_Name = '事件NPC-幸存者3201'
    m_Info = { }


class CNpcData3202(baseconfig.CNpcData3202):
    m_SID = 3202
    m_Name = '事件NPC-幸存者3202'
    m_Info = { }


class CNpcData3203(baseconfig.CNpcData3203):
    m_SID = 3203
    m_Name = '事件NPC-幸存者3203'
    m_Info = { }


class CNpcData3205(baseconfig.CNpcData3205):
    m_SID = 3205
    m_Name = '事件NPC-幸存者3205'
    m_Info = { }


class CNpcData3209(baseconfig.CNpcData3209):
    m_SID = 3209
    m_Name = '刷新NPC-幸存者3209'
    m_Info = { }


class CNpcData3212(baseconfig.CNpcData3212):
    m_SID = 3212
    m_Name = '事件NPC-幸存者3212'
    m_Info = { }


class CNpcData3213(baseconfig.CNpcData3213):
    m_SID = 3213
    m_Name = '事件NPC-幸存者3213'
    m_Info = { }


class CNpcData3215(baseconfig.CNpcData3215):
    m_SID = 3215
    m_Name = '事件NPC-幸存者3215'
    m_Info = { }


class CNpcData3216(baseconfig.CNpcData3216):
    m_SID = 3216
    m_Name = '事件NPC-幸存者3216'
    m_Info = { }


class CNpcData3217(baseconfig.CNpcData3217):
    m_SID = 3217
    m_Name = '事件NPC-幸存者3217'
    m_Info = { }


class CNpcData3218(baseconfig.CNpcData3218):
    m_SID = 3218
    m_Name = '事件NPC-幸存者3218'
    m_Info = { }


class CNpcData3221(baseconfig.CNpcData3221):
    m_SID = 3221
    m_Name = '事件NPC-幸存者3221'
    m_Info = { }


class CNpcData3222(baseconfig.CNpcData3222):
    m_SID = 3222
    m_Name = '事件NPC-幸存者3222'
    m_Info = { }


class CNpcData3223(baseconfig.CNpcData3223):
    m_SID = 3223
    m_Name = '事件NPC-幸存者3223'
    m_Info = { }


class CNpcData3224(baseconfig.CNpcData3224):
    m_SID = 3224
    m_Name = '事件NPC-幸存者3224'
    m_Info = { }
...
class CNpcData6001(baseconfig.CNpcData6001):
    m_SID = 6001
    m_Name = '新模式传送门'
    m_Info = {
        'Action': NpcAction6001,
        'ActionType': NPC_ACTION_ITEMBOX }


class CNpcData6002(baseconfig.CNpcData6002):
    m_SID = 6002
    m_Name = '新模式传送门'
    m_Info = {
        'Action': NpcAction6002,
        'ActionType': NPC_ACTION_ITEMBOX }


class CNpcData6003(baseconfig.CNpcData6003):
    m_SID = 6003
    m_Name = '新模式boss通关传送门'
    m_Info = {
        'Action': NpcAction6003,
        'ActionType': NPC_ACTION_SETTLELEVEL }


class CNpcData6004(baseconfig.CNpcData6004):
    m_SID = 6004
    m_Name = '新模式传送门2'
    m_Info = {
        'Action': NpcAction6004,
        'ActionType': NPC_ACTION_ITEMBOX }


class CNpcData6005(baseconfig.CNpcData6005):
    m_SID = 6005
    m_Name = '新模式传送门2'
    m_Info = {
        'Action': NpcAction6005,
        'ActionType': NPC_ACTION_ITEMBOX }


class CNpcData6006(baseconfig.CNpcData6006):
    m_SID = 6006
    m_Name = '新模式传送门-二幕'
    m_Info = {
        'Action': NpcAction6006,
        'ActionType': NPC_ACTION_SETTLELEVEL }
