# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_wardata/w3030/summon.pyc
# RelativePath: clientlogic/cl_wardata/w3030/summon.pyc
...
def SummonDieAction1026(oSummon, oKiller):
    summonaction.SummonDieRewardItemList(oSummon, oKiller, {
        204: {
            'Prop': 10000,
            'Times': 1 },
...
class CSummonData1026(baseconfig.CSummonData):
    ...
    m_DataSID = 1026
    m_Name = '虚无僧'
    m_DieAction = SummonDieAction1026
