# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/MonsterBigShield/DesertAntShieldFsm.pyc
# RelativePath: clientlogic/cl_betreedata/MonsterBigShield/DesertAntShieldFsm.pyc
# Source Generated with Decompyle++
# File: DesertAntShieldFsm.pyc (Python 3.6)
...
def Func8(oAgent):
    return cl_betree.monsteragent.CAgent.CheckHasState(7152, oAgent) == False
            ...
            'Node': [
                    ...
                    'ReferenceBehavior': 'Common.patrolGoback' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'TargetFSMNodeID': 58,
                        'TransitionPhase': 1 }),
                    'ReferenceBehavior': 'MonsterBigShield.DesertAntShieldAttack' },
                {
                    'ID': 58,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
                        ...
                        'TargetFSMNodeID': 47,
                        'TransitionPhase': 1 },),
                    'ReferenceBehavior': 'MonsterBigShield.DesertAntShieldAttackNoSheild' }] }] }
