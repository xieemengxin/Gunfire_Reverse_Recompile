# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/EliteFar/BloodEilteFsm.pyc
# RelativePath: clientlogic/cl_betreedata/EliteFar/BloodEilteFsm.pyc
# Source Generated with Decompyle++
# File: BloodEilteFsm.pyc (Python 3.6)
            ...
            'Node': [
                    ...
                    'ReferenceBehavior': 'Common.farAttackmsg' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'Flag': 'transition',
                        'TargetFSMNodeID': 115 }),
                    'ReferenceBehavior': 'EliteFar.bloodEilteFarAttack' },
                {
                    'ID': 115,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
                        ...
                        'TargetFSMNodeID': 129,
                        'TransitionPhase': 2 }),
                    'ReferenceBehavior': 'EliteFar.bloodEilteGuerrilla' },
                {
                    'ID': 125,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
                        ...
                        'Flag': 'transition',
                        'TargetFSMNodeID': 115 }),
                    'ReferenceBehavior': 'EliteFar.bloodEilteSuck' },
                {
                    'ID': 129,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
                        ...
                        'Flag': 'transition',
                        'TargetFSMNodeID': 115 }),
                    'ReferenceBehavior': 'EliteFar.bloodEilteHeal' },
                {
                    'ID': 133,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
                        ...
                        'Flag': 'precondition',
                        'BinaryOperator': 'And' }),
                    'ReferenceBehavior': 'EliteFar.bloodEilteDodge' }] }] }
