# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/EliteFar/SummonEliteFsm.pyc
# RelativePath: clientlogic/cl_betreedata/EliteFar/SummonEliteFsm.pyc
# Source Generated with Decompyle++
# File: SummonEliteFsm.pyc (Python 3.6)
...
def Func8(oAgent):
    return cl_betree.monsteragent.CAgent.GetChoosePF(oAgent) == 32825
            ...
            'Node': [
                    ...
                    'ReferenceBehavior': 'Common.farAttackmsg' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'TargetFSMNodeID': 141,
                        'TransitionPhase': 1 }),
                    'ReferenceBehavior': 'EliteFar.SummonAttack' },
                {
                    'ID': 141,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
                        ...
                        'Flag': 'transition',
                        'TargetFSMNodeID': 138 },),
                    'ReferenceBehavior': 'EliteFar.SummonComboAttack' }] }] }
