# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/EliteFar/EliteSniperFsm.pyc
# RelativePath: clientlogic/cl_betreedata/EliteFar/EliteSniperFsm.pyc
# Source Generated with Decompyle++
# File: EliteSniperFsm.pyc (Python 3.6)
...
def Func8(oAgent):
    return cl_betree.monsteragent.CAgent.CheckHasState(7119, oAgent) == True
            ...
            'Node': [
                    ...
                    'ReferenceBehavior': 'Common.patrolGoback' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'Flag': 'precondition',
                        'BinaryOperator': 'And' }),
                    'ReferenceBehavior': 'EliteFar.EliteSniperAttack' },
                {
                    'ID': 97,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
                        ...
                        'Flag': 'precondition',
                        'BinaryOperator': 'And' }),
                    'ReferenceBehavior': 'EliteFar.EliteSniperDodge' },
                {
                    'ID': 101,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
                        ...
                        'Flag': 'precondition',
                        'BinaryOperator': 'And' }),
                    'ReferenceBehavior': 'EliteFar.EliteSniperFirstDodge' }] }] }
