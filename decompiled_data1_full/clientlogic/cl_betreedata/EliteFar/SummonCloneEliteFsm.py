# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/EliteFar/SummonCloneEliteFsm.pyc
# RelativePath: clientlogic/cl_betreedata/EliteFar/SummonCloneEliteFsm.pyc
# Source Generated with Decompyle++
# File: SummonCloneEliteFsm.pyc (Python 3.6)
...
def Func8(oAgent):
    return oAgent.GetData('Flag') == 1


def Func9(oAgent):
    return oAgent.GetData('Flag') == 0

data = {
    'Name': 'SummonCloneEliteFsm',
    'ID': 0,
            ...
            'Node': [
                    ...
                    'ReferenceBehavior': 'Common.farAttackmsg' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'TargetFSMNodeID': 143,
                        'TransitionPhase': 1 }),
                    'ReferenceBehavior': 'EliteFar.SummonCloneAttack' },
                {
                    'ID': 143,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
                        ...
                        'TargetFSMNodeID': 140,
                        'TransitionPhase': 1 },),
                    'ReferenceBehavior': 'EliteFar.SummonCloneComboAttack' }] }] }
