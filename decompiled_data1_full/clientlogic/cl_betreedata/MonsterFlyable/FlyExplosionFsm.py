# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/MonsterFlyable/FlyExplosionFsm.pyc
# RelativePath: clientlogic/cl_betreedata/MonsterFlyable/FlyExplosionFsm.pyc
# Source Generated with Decompyle++
# File: FlyExplosionFsm.pyc (Python 3.6)
            ...
            'Node': [
                    ...
                    'ReferenceBehavior': 'Common.patrolFace' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'Flag': 'precondition',
                        'BinaryOperator': 'And' }),
                    'ReferenceBehavior': 'MonsterFlyable.FlyExplosionPatrolPos' },
                {
                    'ID': 47,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
                    ...
                    'ReferenceBehavior': 'Common.patrolGoback' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'TargetFSMNodeID': 73,
                        'TransitionPhase': 1 }),
                    'ReferenceBehavior': 'MonsterFlyable.FlyExplosionAttack' },
                {
                    'ID': 71,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
                        ...
                        'Flag': 'transition',
                        'TargetFSMNodeID': 38 },),
                    'ReferenceBehavior': 'MonsterFlyable.FlyToShowPos' },
                {
                    'ID': 73,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
                        ...
                        'TargetFSMNodeID': 60,
                        'TransitionPhase': 4 },),
                    'ReferenceBehavior': 'MonsterFlyable.FlyExplosionRushAttack' }] }] }
