# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/MonsterFlyable/FlyableFsm.pyc
# RelativePath: clientlogic/cl_betreedata/MonsterFlyable/FlyableFsm.pyc
# Source Generated with Decompyle++
# File: FlyableFsm.pyc (Python 3.6)
            ...
            'Node': [
                    ...
                    'ReferenceBehavior': 'Common.farAttackmsg' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'Flag': 'transition',
                        'TargetFSMNodeID': 69 },),
                    'ReferenceBehavior': 'MonsterFlyable.moveToShowPos' },
                {
                    'ID': 60,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
                    ...
                    'ReferenceBehavior': 'Common.patrolGoback' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'TargetFSMNodeID': 60,
                        'TransitionPhase': 4 },),
                    'ReferenceBehavior': 'MonsterFlyable.FlyableAttack' }] }] }
