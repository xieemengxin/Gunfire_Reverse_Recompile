# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/MonsterMediumFar/MediumFarFsm.pyc
# RelativePath: clientlogic/cl_betreedata/MonsterMediumFar/MediumFarFsm.pyc
# Source Generated with Decompyle++
# File: MediumFarFsm.pyc (Python 3.6)
            ...
            'Node': [
                    ...
                    'IsEndState': False },
                {
                    ...
                    'Attachment': ({
                        ...
                        'Flag': 'transition',
                        'TargetFSMNodeID': 79 }),
                    'ReferenceBehavior': 'MonsterMediumFar.MediumFarGuerrillaAttack' },
                {
                    'ID': 92,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
                        ...
                        'Flag': 'transition',
                        'TargetFSMNodeID': 79 }),
                    'ReferenceBehavior': 'MonsterMediumFar.MediumFarRetreatAttack' },
                {
                    'ID': 99,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
                        ...
                        'Flag': 'transition',
                        'TargetFSMNodeID': 79 }),
                    'ReferenceBehavior': 'MonsterMediumFar.MediumFarChargeAttack' },
                {
                    'ID': 100,
                    'Class': 'State',
                    'Attachment': ({
