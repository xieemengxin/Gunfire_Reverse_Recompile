# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/MonsterNear/GlobalNearFsm.pyc
# RelativePath: clientlogic/cl_betreedata/MonsterNear/GlobalNearFsm.pyc
# Source Generated with Decompyle++
# File: GlobalNearFsm.pyc (Python 3.6)
            ...
            'Node': [
                    ...
                    'IsEndState': False },
                {
                    ...
                    'Attachment': ({
                        ...
                        'TargetFSMNodeID': 52,
                        'TransitionPhase': 1 }),
                    'ReferenceBehavior': 'MonsterNear.GlobalNearAttack' },
                {
                    'ID': 52,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
