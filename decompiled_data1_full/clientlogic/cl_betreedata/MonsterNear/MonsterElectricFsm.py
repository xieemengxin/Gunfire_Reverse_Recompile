# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/MonsterNear/MonsterElectricFsm.pyc
# RelativePath: clientlogic/cl_betreedata/MonsterNear/MonsterElectricFsm.pyc
# Source Generated with Decompyle++
# File: MonsterElectricFsm.pyc (Python 3.6)
            ...
            'Node': [
                    ...
                    'IsEndState': False },
                {
                    ...
                    'Attachment': ({
                        ...
                        'Flag': 'transition',
                        'TargetFSMNodeID': 110 }),
                    'ReferenceBehavior': 'MonsterNear.MonsterElectricRetreatAttack' },
                {
                    'ID': 110,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
                        ...
                        'Flag': 'transition',
                        'TargetFSMNodeID': 79 }),
                    'ReferenceBehavior': 'MonsterNear.MonsterElectricAttack' },
                {
                    'ID': 114,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
                        ...
                        'TargetFSMNodeID': 117,
                        'TransitionPhase': 1 }),
                    'ReferenceBehavior': 'MonsterNear.MonsterElectricGuerrillaAttack' },
                {
                    'ID': 117,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
