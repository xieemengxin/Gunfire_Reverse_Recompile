# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/DemoScene/farElitefsm.pyc
# RelativePath: clientlogic/cl_betreedata/DemoScene/farElitefsm.pyc
# Source Generated with Decompyle++
# File: farElitefsm.pyc (Python 3.6)
            ...
            'Node': [
                    ...
                    'ReferenceBehavior': 'DemoScene.farattackmsg' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'TargetFSMNodeID': 27,
                        'TransitionPhase': 1 }),
                    'ReferenceBehavior': 'DemoScene.farEliteattack' },
                {
                    'ID': 25,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
