# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/DemoScene/farShieldAreafsm.pyc
# RelativePath: clientlogic/cl_betreedata/DemoScene/farShieldAreafsm.pyc
# Source Generated with Decompyle++
# File: farShieldAreafsm.pyc (Python 3.6)
            ...
            'Node': [
                    ...
                    'ReferenceBehavior': 'DemoScene.farattackmsg' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'TargetFSMNodeID': 26,
                        'TransitionPhase': 1 },),
                    'ReferenceBehavior': 'DemoScene.farShieldAreaAttack' },
                {
                    'ID': 26,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
                    ...
                    'ReferenceBehavior': 'DemoScene.goback' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'Flag': 'transition',
                        'TargetFSMNodeID': 4 },),
                    'ReferenceBehavior': 'DemoScene.farShieldstate' }] }] }
