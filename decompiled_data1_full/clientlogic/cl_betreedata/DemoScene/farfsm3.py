# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/DemoScene/farfsm3.pyc
# RelativePath: clientlogic/cl_betreedata/DemoScene/farfsm3.pyc
# Source Generated with Decompyle++
# File: farfsm3.pyc (Python 3.6)
            ...
            'Node': [
                    ...
                    'ReferenceBehavior': 'DemoScene.farattackmsg' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'TargetFSMNodeID': 27,
                        'TransitionPhase': 1 }),
                    'ReferenceBehavior': 'DemoScene.farattack3' },
                {
                    'ID': 25,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
                    ...
                    'ReferenceBehavior': 'DemoScene.dodge' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'Flag': 'transition',
                        'TargetFSMNodeID': 18 },),
                    'ReferenceBehavior': 'DemoScene.farareamove' }] }] }
