# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/DemoScene/farescapefsm.pyc
# RelativePath: clientlogic/cl_betreedata/DemoScene/farescapefsm.pyc
# Source Generated with Decompyle++
# File: farescapefsm.pyc (Python 3.6)
            ...
            'Node': [
                    ...
                    'ReferenceBehavior': 'DemoScene.farattackmsg' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'EffectorsFunc': [],
                        'TargetFSMNodeID': 27 },),
                    'ReferenceBehavior': 'DemoScene.escapemgc' },
                {
                    'ID': 27,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
                        ...
                        'Flag': 'transition',
                        'TargetFSMNodeID': 18 },),
                    'ReferenceBehavior': 'DemoScene.escape' },
                {
                    'ID': 39,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
                        ...
                        'EffectorsFunc': [],
                        'TargetFSMNodeID': 27 },),
                    'ReferenceBehavior': 'DemoScene.escapewait' }] }] }
