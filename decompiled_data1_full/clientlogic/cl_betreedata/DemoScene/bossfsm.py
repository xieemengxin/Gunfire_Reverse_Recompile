# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/DemoScene/bossfsm.pyc
# RelativePath: clientlogic/cl_betreedata/DemoScene/bossfsm.pyc
# Source Generated with Decompyle++
# File: bossfsm.pyc (Python 3.6)
            ...
            'Node': [
                    ...
                    'ReferenceBehavior': 'DemoScene.patrolpos' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'Flag': 'precondition',
                        'BinaryOperator': 'And' }),
                    'ReferenceBehavior': 'DemoScene.bossattackmsg' },
                {
                    'ID': 18,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
                        ...
                        'TargetFSMNodeID': 25,
                        'TransitionPhase': 1 },),
                    'ReferenceBehavior': 'DemoScene.bossattack' },
                {
                    'ID': 25,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
                    ...
                    'ReferenceBehavior': 'DemoScene.goback' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'Flag': 'transition',
                        'TargetFSMNodeID': 4 },),
                    'ReferenceBehavior': 'DemoScene.bossappear' }] }] }
