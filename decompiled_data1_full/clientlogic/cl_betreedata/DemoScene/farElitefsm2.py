# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/DemoScene/farElitefsm2.pyc
# RelativePath: clientlogic/cl_betreedata/DemoScene/farElitefsm2.pyc
# Source Generated with Decompyle++
# File: farElitefsm2.pyc (Python 3.6)
            ...
            'Node': [
                    ...
                    'ReferenceBehavior': 'DemoScene.patrolface' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'Flag': 'precondition',
                        'BinaryOperator': 'And' }),
                    'ReferenceBehavior': 'DemoScene.farElitePatrolpos' },
                {
                    'ID': 14,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
                    ...
                    'ReferenceBehavior': 'DemoScene.farattackmsg' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'TargetFSMNodeID': 27,
                        'TransitionPhase': 1 }),
                    'ReferenceBehavior': 'DemoScene.farEliteattack2' },
                {
                    'ID': 25,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
