# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/MonsterSelfExplosion/revlanternSelfExplosionFsm.pyc
# RelativePath: clientlogic/cl_betreedata/MonsterSelfExplosion/revlanternSelfExplosionFsm.pyc
# Source Generated with Decompyle++
# File: revlanternSelfExplosionFsm.pyc (Python 3.6)
...
def Func8(oAgent):
    return cl_betree.monsteragent.CAgent.CheckHasState(33193, oAgent) == 0

data = {
    'Name': 'revlanternSelfExplosionFsm',
    'ID': 0,
            ...
            'Node': [
                    ...
                    'ReferenceBehavior': 'Common.patrolPos' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'TargetFSMNodeID': 59,
                        'TransitionPhase': 1 },),
                    'ReferenceBehavior': 'MonsterSelfExplosion.selfExplosionAttack' },
                {
                    'ID': 59,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
                    ...
                    'ReferenceBehavior': 'Common.nearAttackmsg' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'TargetFSMNodeID': 36,
                        'TransitionPhase': 1 },),
                    'ReferenceBehavior': 'MonsterSelfExplosion.selfExplosionFollowOwner' }] }] }
