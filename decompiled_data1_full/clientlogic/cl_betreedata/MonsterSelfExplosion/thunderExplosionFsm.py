# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/MonsterSelfExplosion/thunderExplosionFsm.pyc
# RelativePath: clientlogic/cl_betreedata/MonsterSelfExplosion/thunderExplosionFsm.pyc
# Source Generated with Decompyle++
# File: thunderExplosionFsm.pyc (Python 3.6)
            ...
            'Node': [
                    ...
                    'ReferenceBehavior': 'Common.patrolPos' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'Flag': 'precondition',
                        'BinaryOperator': 'And' }),
                    'ReferenceBehavior': 'MonsterSelfExplosion.thunderExplosionAttackmsg' },
                {
                    'ID': 48,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
                    ...
                    'ReferenceBehavior': 'MonsterSelfExplosion.selfExplosionAttack' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'Flag': 'precondition',
                        'BinaryOperator': 'And' }),
                    'ReferenceBehavior': 'MonsterSelfExplosion.selfExplosionDodge' },
                {
                    'ID': 56,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
