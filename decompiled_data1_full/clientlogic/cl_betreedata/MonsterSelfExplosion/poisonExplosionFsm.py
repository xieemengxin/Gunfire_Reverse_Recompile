# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/MonsterSelfExplosion/poisonExplosionFsm.pyc
# RelativePath: clientlogic/cl_betreedata/MonsterSelfExplosion/poisonExplosionFsm.pyc
# Source Generated with Decompyle++
# File: poisonExplosionFsm.pyc (Python 3.6)
            ...
            'Node': [
                    ...
                    'ReferenceBehavior': 'Common.patrolPos' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'Flag': 'precondition',
                        'BinaryOperator': 'And' }),
                    'ReferenceBehavior': 'MonsterSelfExplosion.poisonExplosionAttackmsg' },
                {
                    'ID': 48,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
