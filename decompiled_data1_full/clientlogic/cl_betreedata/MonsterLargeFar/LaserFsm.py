# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/MonsterLargeFar/LaserFsm.pyc
# RelativePath: clientlogic/cl_betreedata/MonsterLargeFar/LaserFsm.pyc
# Source Generated with Decompyle++
# File: LaserFsm.pyc (Python 3.6)
            ...
            'Node': [
                    ...
                    'IsEndState': False },
                {
                    ...
                    'Attachment': ({
                        ...
                        'Flag': 'precondition',
                        'BinaryOperator': 'And' }),
                    'ReferenceBehavior': 'MonsterLargeFar.LaserFarAttack' },
                {
                    'ID': 90,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
