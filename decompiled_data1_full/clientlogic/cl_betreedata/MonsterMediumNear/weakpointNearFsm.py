# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/MonsterMediumNear/weakpointNearFsm.pyc
# RelativePath: clientlogic/cl_betreedata/MonsterMediumNear/weakpointNearFsm.pyc
# Source Generated with Decompyle++
# File: weakpointNearFsm.pyc (Python 3.6)
            ...
            'Node': [
                    ...
                    'ReferenceBehavior': 'Common.moveToShowPos' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'TargetFSMNodeID': 67,
                        'TransitionPhase': 1 }),
                    'ReferenceBehavior': 'MonsterMediumNear.weakpointNearAttack' },
                {
                    'ID': 58,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
                    ...
                    'ReferenceBehavior': 'Common.dodge' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'Flag': 'transition',
                        'TargetFSMNodeID': 56 }),
                    'ReferenceBehavior': 'MonsterMediumNear.weakpointNearFirstAttack' },
                {
                    'ID': 74,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
