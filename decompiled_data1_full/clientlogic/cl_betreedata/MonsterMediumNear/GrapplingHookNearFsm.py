# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/MonsterMediumNear/GrapplingHookNearFsm.pyc
# RelativePath: clientlogic/cl_betreedata/MonsterMediumNear/GrapplingHookNearFsm.pyc
# Source Generated with Decompyle++
# File: GrapplingHookNearFsm.pyc (Python 3.6)
            ...
            'Node': [
                    ...
                    'ReferenceBehavior': 'Common.moveToShowPos' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'TargetFSMNodeID': 67,
                        'TransitionPhase': 1 }),
                    'ReferenceBehavior': 'MonsterMediumNear.GrapplingHookNearAttack' },
                {
                    'ID': 58,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
                    ...
                    'ReferenceBehavior': 'Common.dodge' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'TargetFSMNodeID': 74,
                        'TransitionPhase': 1 }),
                    'ReferenceBehavior': 'MonsterMediumNear.GrapplingHookNearFirstAttack' },
                {
                    'ID': 74,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
