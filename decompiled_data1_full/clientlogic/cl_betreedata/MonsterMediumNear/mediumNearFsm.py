# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/MonsterMediumNear/mediumNearFsm.pyc
# RelativePath: clientlogic/cl_betreedata/MonsterMediumNear/mediumNearFsm.pyc
# Source Generated with Decompyle++
# File: mediumNearFsm.pyc (Python 3.6)
            ...
            'Node': [
                    ...
                    'ReferenceBehavior': 'Common.moveToShowPos' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'TargetFSMNodeID': 67,
                        'TransitionPhase': 1 }),
                    'ReferenceBehavior': 'MonsterMediumNear.mediumNearAttack' },
                {
                    'ID': 58,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
