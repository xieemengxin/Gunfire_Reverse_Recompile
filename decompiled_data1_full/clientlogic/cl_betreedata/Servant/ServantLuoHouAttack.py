# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/Servant/ServantLuoHouAttack.pyc
# RelativePath: clientlogic/cl_betreedata/Servant/ServantLuoHouAttack.pyc
# Source Generated with Decompyle++
# File: ServantLuoHouAttack.pyc (Python 3.6)
                            ...
                            'Node': [
                                {
                                    'ID': 114,
                                    'Class': 'Action',
                                    'Method': (cl_betree.servantagent.CAgent.ChoosePFByArgs, (30,)),
                                    'ResultOption': 0,
                                    'ResultFunctor': None },
                                {
                                    'ID': 122,
                                    ...
                                    'Node': [
                                            ...
                                            'Method': (Func0, ()) },
                                        {
                                            'ID': 124,
                                            'Class': 'Action',
                                            'Method': (cl_betree.servantagent.CAgent.TargetAwayPos, (30, False, True)),
                                            'ResultOption': 0,
                                            'ResultFunctor': None },
                                        {
                                            'ID': 125,
                            ...
                            'Node': [
                                {
                                    'ID': 110,
                                    'Class': 'Action',
                                    'Method': (cl_betree.servantagent.CAgent.TargetAwayPos, (30, True, False)),
                                    'ResultOption': 0,
                                    'ResultFunctor': None },
                                {
                                    'ID': 118,
