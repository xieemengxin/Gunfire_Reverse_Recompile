# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/MonsterCrab/CrabFsm.pyc
# RelativePath: clientlogic/cl_betreedata/MonsterCrab/CrabFsm.pyc
# Source Generated with Decompyle++
# File: CrabFsm.pyc (Python 3.6)
            ...
            'Node': [
                    ...
                    'ReferenceBehavior': 'Common.patrolmsg' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'TargetFSMNodeID': 60,
                        'TransitionPhase': 4 },),
                    'ReferenceBehavior': 'MonsterCrab.crabAttack' },
                {
                    'ID': 71,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
                        ...
                        'TargetFSMNodeID': 75,
                        'TransitionPhase': 4 }),
                    'ReferenceBehavior': 'MonsterCrab.patrolGoback' },
                {
                    'ID': 75,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
                        ...
                        'Flag': 'precondition',
                        'BinaryOperator': 'And' }),
                    'ReferenceBehavior': 'MonsterCrab.patrolPos' },
                {
                    'ID': 79,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
                        ...
                        'Flag': 'transition',
                        'TargetFSMNodeID': 69 },),
                    'ReferenceBehavior': 'MonsterCrab.moveToShowPos' }] }] }
