# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/MonsterFar/throwFuzzyAreamoveFsm.pyc
# RelativePath: clientlogic/cl_betreedata/MonsterFar/throwFuzzyAreamoveFsm.pyc
# Source Generated with Decompyle++
# File: throwFuzzyAreamoveFsm.pyc (Python 3.6)
            ...
            'Node': [
                    ...
                    'IsEndState': False },
                {
                    ...
                    'Attachment': ({
                        ...
                        'Flag': 'precondition',
                        'BinaryOperator': 'And' }),
                    'ReferenceBehavior': 'MonsterFar.throwFuzzyAreamoveAttack' },
                {
                    'ID': 77,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
