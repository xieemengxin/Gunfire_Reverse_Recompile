# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/MonsterFar/handbombAreamoveFsm.pyc
# RelativePath: clientlogic/cl_betreedata/MonsterFar/handbombAreamoveFsm.pyc
# Source Generated with Decompyle++
# File: handbombAreamoveFsm.pyc (Python 3.6)
            ...
            'Node': [
                    ...
                    'ReferenceBehavior': 'Common.dodge' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'TargetFSMNodeID': 54,
                        'TransitionPhase': 1 }),
                    'ReferenceBehavior': 'MonsterFar.handbombAreamoveAttack' },
                {
                    'ID': 61,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
