# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/Hero/CangJueFsm.pyc
# RelativePath: clientlogic/cl_betreedata/Hero/CangJueFsm.pyc
# Source Generated with Decompyle++
# File: CangJueFsm.pyc (Python 3.6)
...
def Func2(oAgent):
    return cl_betree.heroagent.CAgent.CheckHasState(33604, oAgent) == True


def Func3(oAgent):
    return cl_betree.heroagent.CAgent.CanUseCangJueTurnPerform(oAgent) == True
...
def Func12(oAgent):
    return cl_betree.heroagent.CAgent.CheckHasState(33604, oAgent) == False
            ...
            'Node': [
                    ...
                    'IsEndState': False },
                {
                    ...
                    'Attachment': ({
                        ...
                        'Flag': 'precondition',
                        'BinaryOperator': 'And' }),
                    'ReferenceBehavior': 'Hero.SmallCangJueAttack' },
                {
                    'ID': 55,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
                    ...
                    'ReferenceBehavior': 'Hero.HeroShare' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'TargetFSMNodeID': 54,
                        'TransitionPhase': 1 }),
                    'ReferenceBehavior': 'Hero.BigCangJueAttack' }] }] }
