# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/Hero/XiuMoNearFsm.pyc
# RelativePath: clientlogic/cl_betreedata/Hero/XiuMoNearFsm.pyc
# Source Generated with Decompyle++
# File: XiuMoNearFsm.pyc (Python 3.6)
            ...
            'Node': [
                    ...
                    'IsEndState': False },
                {
                    ...
                    'Attachment': ({
                        ...
                        'Flag': 'precondition',
                        'BinaryOperator': 'And' }),
                    'ReferenceBehavior': 'Hero.XiuMoNearAttack' },
                {
                    'ID': 55,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
