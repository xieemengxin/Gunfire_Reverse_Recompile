# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/MonsterSniper/blinkfsm.pyc
# RelativePath: clientlogic/cl_betreedata/MonsterSniper/blinkfsm.pyc
# Source Generated with Decompyle++
# File: blinkfsm.pyc (Python 3.6)
            ...
            'Node': [
                    ...
                    'ReferenceBehavior': 'Common.moveToShowPos' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'TargetFSMNodeID': 53,
                        'TransitionPhase': 1 }),
                    'ReferenceBehavior': 'MonsterSniper.blinkAttack' },
                {
                    'ID': 53,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
