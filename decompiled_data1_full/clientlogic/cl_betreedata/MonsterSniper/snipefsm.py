# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/MonsterSniper/snipefsm.pyc
# RelativePath: clientlogic/cl_betreedata/MonsterSniper/snipefsm.pyc
# Source Generated with Decompyle++
# File: snipefsm.pyc (Python 3.6)
            ...
            'Node': [
                    ...
                    'ReferenceBehavior': 'Common.moveToShowPos' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'TargetFSMNodeID': 53,
                        'TransitionPhase': 1 }),
                    'ReferenceBehavior': 'MonsterSniper.snipeAttack' },
                {
                    'ID': 53,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
