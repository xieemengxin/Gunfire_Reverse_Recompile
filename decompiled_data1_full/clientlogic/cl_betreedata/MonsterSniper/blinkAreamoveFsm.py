# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/MonsterSniper/blinkAreamoveFsm.pyc
# RelativePath: clientlogic/cl_betreedata/MonsterSniper/blinkAreamoveFsm.pyc
# Source Generated with Decompyle++
# File: blinkAreamoveFsm.pyc (Python 3.6)
            ...
            'Node': [
                    ...
                    'ReferenceBehavior': 'Common.moveToShowPos' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'TargetFSMNodeID': 54,
                        'TransitionPhase': 1 }),
                    'ReferenceBehavior': 'MonsterSniper.blinkAreamoveAttack' },
                {
                    'ID': 54,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
