# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/MonsterSniper/BrokenshieldFuzzyAreamoveFsm.pyc
# RelativePath: clientlogic/cl_betreedata/MonsterSniper/BrokenshieldFuzzyAreamoveFsm.pyc
# Source Generated with Decompyle++
# File: BrokenshieldFuzzyAreamoveFsm.pyc (Python 3.6)
...
data = {
    'Name': 'BrokenshieldFuzzyAreamoveFsm',
    'ID': 0,
            ...
            'Node': [
                    ...
                    'IsEndState': False },
                {
                    ...
                    'Attachment': ({
                        ...
                        'Flag': 'precondition',
                        'BinaryOperator': 'And' }),
                    'ReferenceBehavior': 'MonsterSniper.BrokenshieldFuzzyAreamoveAttack' },
                {
                    'ID': 62,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
                        ...
                        'Flag': 'precondition',
                        'BinaryOperator': 'And' }),
                    'ReferenceBehavior': 'MonsterSniper.BrokenshieldFuzzyAreamoveAwait' },
                {
                    'ID': 71,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
