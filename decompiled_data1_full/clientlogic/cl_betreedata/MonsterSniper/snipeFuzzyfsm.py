# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/MonsterSniper/snipeFuzzyfsm.pyc
# RelativePath: clientlogic/cl_betreedata/MonsterSniper/snipeFuzzyfsm.pyc
# Source Generated with Decompyle++
# File: snipeFuzzyfsm.pyc (Python 3.6)
            ...
            'Node': [
                    ...
                    'ReferenceBehavior': 'Common.dodge' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'Flag': 'precondition',
                        'BinaryOperator': 'And' }),
                    'ReferenceBehavior': 'MonsterSniper.snipeFuzzyAttack' },
                {
                    'ID': 60,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
                        ...
                        'Flag': 'precondition',
                        'BinaryOperator': 'And' }),
                    'ReferenceBehavior': 'MonsterSniper.snipeFuzzyAwait' },
                {
                    'ID': 63,
                    'Class': 'State',
                    'Attachment': ({
