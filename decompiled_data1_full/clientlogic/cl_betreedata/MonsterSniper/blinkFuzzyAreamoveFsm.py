# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/MonsterSniper/blinkFuzzyAreamoveFsm.pyc
# RelativePath: clientlogic/cl_betreedata/MonsterSniper/blinkFuzzyAreamoveFsm.pyc
# Source Generated with Decompyle++
# File: blinkFuzzyAreamoveFsm.pyc (Python 3.6)
            ...
            'Node': [
                    ...
                    'IsEndState': False },
                {
                    ...
                    'Attachment': ({
                        ...
                        'Flag': 'precondition',
                        'BinaryOperator': 'And' }),
                    'ReferenceBehavior': 'MonsterSniper.blinkFuzzyAreamoveAwait' },
                {
                    'ID': 63,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
                        ...
                        'Flag': 'precondition',
                        'BinaryOperator': 'And' }),
                    'ReferenceBehavior': 'MonsterSniper.blinkFuzzyAreamoveAttack' },
                {
                    'ID': 73,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
