# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/MonsterSniper/GlobalSniperAreaMoveFsm.pyc
# RelativePath: clientlogic/cl_betreedata/MonsterSniper/GlobalSniperAreaMoveFsm.pyc
# Source Generated with Decompyle++
# File: GlobalSniperAreaMoveFsm.pyc (Python 3.6)
            ...
            'Node': [
                    ...
                    'IsEndState': False },
                {
                    ...
                    'Attachment': ({
                        ...
                        'TargetFSMNodeID': 4,
                        'TransitionPhase': 1 }),
                    'ReferenceBehavior': 'MonsterSniper.GlobalSniperAreamoveAttack' },
                {
                    'ID': 47,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
                        ...
                        'TargetFSMNodeID': 4,
                        'TransitionPhase': 1 }),
                    'ReferenceBehavior': 'MonsterSniper.GlobalSniperAreaMove' },
                {
                    'ID': 48,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
                        ...
                        'TargetFSMNodeID': 4,
                        'TransitionPhase': 1 }),
                    'ReferenceBehavior': 'MonsterSniper.GlobalSniperAreaMoveWait' }] }] }
