# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/MonsterSniper/EliteillusionFuzzyfsm.pyc
# RelativePath: clientlogic/cl_betreedata/MonsterSniper/EliteillusionFuzzyfsm.pyc
# Source Generated with Decompyle++
# File: EliteillusionFuzzyfsm.pyc (Python 3.6)
            ...
            'Node': [
                    ...
                    'IsEndState': False },
                {
                    ...
                    'Attachment': ({
                        ...
                        'Flag': 'precondition',
                        'BinaryOperator': 'And' }),
                    'ReferenceBehavior': 'MonsterSniper.EliteillusionFuzzyAttack' },
                {
                    'ID': 64,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
                        ...
                        'Flag': 'precondition',
                        'BinaryOperator': 'And' }),
                    'ReferenceBehavior': 'MonsterSniper.EliteillusionFuzzyAwait' },
                {
                    'ID': 77,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
