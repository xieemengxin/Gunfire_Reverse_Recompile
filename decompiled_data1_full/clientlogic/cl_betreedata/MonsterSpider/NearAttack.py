# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/MonsterSpider/NearAttack.pyc
# RelativePath: clientlogic/cl_betreedata/MonsterSpider/NearAttack.pyc
                                            ...
                                            'ResultFunctor': None }] }] },
                        {
                            ...
                            'Node': [
                                    ...
                                    'Method': (Func1, ()) },
                                {
                                    'ID': 41,
                                    'Class': 'Action',
                                    'Method': (cl_betree.monsteragent.CAgent.ChooseCertainPF, (24221,)),
                                    'ResultOption': 0,
                                    'ResultFunctor': None }] }] },
                {
                    'ID': 12,
                                    ...
                                    'ResultFunctor': None },
                                {
                                    ...
                                    'Node': [
                                            ...
                                            'Method': (Func3, ()) },
                                        {
                                            'ID': 37,
                                            'Class': 'Action',
                                            'Method': (cl_betree.monsteragent.CAgent.ChooseCertainPF, (24223,)),
                                            'ResultOption': 0,
                                            'ResultFunctor': None }] }] },
                        {
                            'ID': 14,
