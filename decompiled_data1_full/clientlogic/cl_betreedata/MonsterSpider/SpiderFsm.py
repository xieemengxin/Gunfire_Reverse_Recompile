# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/MonsterSpider/SpiderFsm.pyc
# RelativePath: clientlogic/cl_betreedata/MonsterSpider/SpiderFsm.pyc
# Source Generated with Decompyle++
# File: SpiderFsm.pyc (Python 3.6)

import cl_betree.monsteragent

def Func0(oAgent):
    return oAgent.GetConfig('ShowWay') != 1
            ...
            'Node': [
                    ...
                    'ReferenceBehavior': 'Common.patrolGoback' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'TargetFSMNodeID': 47,
                        'TransitionPhase': 1 },),
                    'ReferenceBehavior': 'MonsterSpider.NearAttack' },
                {
                    'ID': 65,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
                        ...
                        'Flag': 'transition',
                        'TargetFSMNodeID': 61 },),
                    'ReferenceBehavior': 'MonsterSpider.dashToShowPos' }] }] }
