# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/MonsterWizard/BloodFsm.pyc
# RelativePath: clientlogic/cl_betreedata/MonsterWizard/BloodFsm.pyc
# Source Generated with Decompyle++
# File: BloodFsm.pyc (Python 3.6)
            ...
            'Node': [
                    ...
                    'ReferenceBehavior': 'Common.farAttackmsg' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'Flag': 'precondition',
                        'BinaryOperator': 'And' }),
                    'ReferenceBehavior': 'MonsterWizard.wizardAttack' },
                {
                    'ID': 101,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
                        ...
                        'Flag': 'transition',
                        'TargetFSMNodeID': 48 }),
                    'ReferenceBehavior': 'MonsterWizard.wizardHideAttack' },
                {
                    'ID': 104,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
