# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/MonsterWizard/BloodAreamoveFsm.pyc
# RelativePath: clientlogic/cl_betreedata/MonsterWizard/BloodAreamoveFsm.pyc
# Source Generated with Decompyle++
# File: BloodAreamoveFsm.pyc (Python 3.6)
            ...
            'Node': [
                    ...
                    'ReferenceBehavior': 'Common.patrolGoback' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'Flag': 'precondition',
                        'BinaryOperator': 'And' }),
                    'ReferenceBehavior': 'Common.FuzzyAreamoveAwait' },
                {
                    'ID': 103,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
                        ...
                        'Flag': 'precondition',
                        'BinaryOperator': 'And' }),
                    'ReferenceBehavior': 'MonsterWizard.BloodAreamoveAttack' }] }] }
