# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/MonsterWizard/SurvivalBloodFsm.pyc
# RelativePath: clientlogic/cl_betreedata/MonsterWizard/SurvivalBloodFsm.pyc
# Source Generated with Decompyle++
# File: SurvivalBloodFsm.pyc (Python 3.6)
            ...
            'Node': [
                    ...
                    'ReferenceBehavior': 'Common.farAttackmsg' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'Flag': 'precondition',
                        'BinaryOperator': 'And' }),
                    'ReferenceBehavior': 'MonsterWizard.wizardDodge' },
                {
                    'ID': 111,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
                        ...
                        'Flag': 'precondition',
                        'BinaryOperator': 'And' }),
                    'ReferenceBehavior': 'MonsterWizard.SurvivalwizardAttack' }] }] }
