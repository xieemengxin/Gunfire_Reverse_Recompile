# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/Pet/CombatPetFsm.pyc
# RelativePath: clientlogic/cl_betreedata/Pet/CombatPetFsm.pyc
# Source Generated with Decompyle++
# File: CombatPetFsm.pyc (Python 3.6)
            ...
            'Node': [
                    ...
                    'ReferenceBehavior': 'Pet.CombatPatrol' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'Phase': 1,
                        'Flag': 'effector' }),
                    'ReferenceBehavior': 'Pet.CombatAttack' },
                {
                    'ID': 9,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
