# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/Pet/CombatShieldPetFsm.pyc
# RelativePath: clientlogic/cl_betreedata/Pet/CombatShieldPetFsm.pyc
# Source Generated with Decompyle++
# File: CombatShieldPetFsm.pyc (Python 3.6)
            ...
            'Node': [
                    ...
                    'ReferenceBehavior': 'Pet.CombatPatrol' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'Phase': 1,
                        'Flag': 'effector' }),
                    'ReferenceBehavior': 'Pet.CombatShieldAttack' },
                {
                    'ID': 9,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
