# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/Pet/RemotePetKeepFireFsm.pyc
# RelativePath: clientlogic/cl_betreedata/Pet/RemotePetKeepFireFsm.pyc
# Source Generated with Decompyle++
# File: RemotePetKeepFireFsm.pyc (Python 3.6)
            ...
            'Node': [
                    ...
                    'IsEndState': False },
                {
                    ...
                    'Attachment': ({
                        ...
                        'ID': 28,
                        'Class': 'Precondition',
                        'Method': (cl_betree.servantagent.CAgent.SetActionSMArgs, (2, 'KeepFiring', '0')),
                        'Phase': 1,
                        'Flag': 'precondition',
                        'BinaryOperator': 'And' }),
                    'ReferenceBehavior': 'Pet.RemotePatrol' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'ID': 27,
                        'Class': 'Precondition',
                        'Method': (cl_betree.servantagent.CAgent.SetActionSMArgs, (2, 'KeepFiring', '1')),
                        'Phase': 1,
                        'Flag': 'precondition',
                        'BinaryOperator': 'And' }),
                    'ReferenceBehavior': 'Pet.RemoteAttack' },
                {
                    'ID': 9,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
