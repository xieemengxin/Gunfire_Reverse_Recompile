# Path: /Users//个人空间/04 Gunfire/converted/converted_data1/clientlogic/cl_betreedata/Common/GlobalAreaMoveFsm.pyc
# RelativePath: clientlogic/cl_betreedata/Common/GlobalAreaMoveFsm.pyc
# Source Generated with Decompyle++
# File: GlobalAreaMoveFsm.pyc (Python 3.6)
            ...
            'Node': [
                    ...
                    'ReferenceBehavior': 'Common.GlobalAreaMove' },
                {
                    ...
                    'Attachment': ({
                        ...
                        'TargetFSMNodeID': 4,
                        'TransitionPhase': 1 }),
                    'ReferenceBehavior': 'Common.GlobalAreaMoveAttack' },
                {
                    'ID': 24,
                    'Class': 'ReferenceBehavior',
                    'Attachment': ({
