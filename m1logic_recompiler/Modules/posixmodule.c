...
#endif
#ifdef __APPLE__
/* Older CPython 3.6 source expects sendfile() to be visible here.
 * Newer macOS SDKs may hide the prototype behind feature macros, so
 * provide a matching forward declaration for the compiler build. */
